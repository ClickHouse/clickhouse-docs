...
cat experimental-settings.md >> "$root/docs/settings/beta-and-experimental-settings.md" || { echo "Failed to append experimental settings.md"; exit 1; }
cat beta-settings.md >> "$root/docs/settings/beta-and-experimental-settings.md" || { echo "Failed to append beta settings.md"; exit 1; }
