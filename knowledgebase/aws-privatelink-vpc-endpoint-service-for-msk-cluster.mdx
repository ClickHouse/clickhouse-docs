...
You can also create the reverse private endpoints with [OpenAPI](https://clickhouse.com/docs/cloud/manage/api/swagger#tag/ReversePrivateEndpoint) or Terraform.
