...
7. **Optional**: Enable Cross-region support in case your database region is different from the ClickPipes region
    ...
    - Add the regions where you want to allow access to the endpoint service, [refer here](https://clickhouse.com/docs/integrations/clickpipes#list-of-static-ips) for the list of ClickPipes regions.
