...
- [system.instrumentation](https://clickhouse.com/docs/operations/system-tables/instrumentation.md)
  — Inspect instrumented points.
- [system.symbols](https://clickhouse.com/docs/operations/system-tables/symbols.md) — Inspect
