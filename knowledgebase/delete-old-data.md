...
More details on [configuring TTL](../docs/en/engines/table-engines/mergetree-family/mergetree#table_engine-mergetree-ttl).
...
More details on [mutations](../docs/en/sql-reference/statements/alter/#alter-mutations).
...
More details on [manipulating partitions](../docs/en/sql-reference/statements/alter/partition/#alter_drop-partition).
