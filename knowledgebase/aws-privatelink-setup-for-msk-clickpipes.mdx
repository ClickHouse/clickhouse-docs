...
MSK cluster VPC must be located in one of our ClickPipes regions. See [ClickPipes regions](/integrations/data-ingestion/clickpipes/aws-privatelink.md#aws-privatelink-regions) for the list of supported regions.
