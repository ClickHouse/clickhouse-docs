...
The short answer is **“no”**. The key-value workload is among top positions in the list of cases when <span class="text-danger">**NOT**</span> to use ClickHouse. It’s an [OLAP](../docs/en/faq/general/olap) system after all, while there are many excellent key-value storage systems out there.
