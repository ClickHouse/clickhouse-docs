...
No automatic Unicode normalization is performed, if you need it you can use the [normalizeUTF8*()](https://clickhouse.com/docs/analyze/sql-reference/functions/string-functions/) functions for that.
...
Case insensitive variant of [like](https://clickhouse.com/docs/analyze/sql-reference/functions/string-search-functions/#function-like) function. You can use `ILIKE` operator instead of the `ilike` function.
...
-   [like](https://clickhouse.com/docs/analyze/sql-reference/functions/string-search-functions/#function-like) <!--hide-->
