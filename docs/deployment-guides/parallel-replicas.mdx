...
![sharded architecture](@site/docs/deployment-guides/images/parallel-replicas-1.png)
...
![non-sharded architecture](@site/docs/deployment-guides/images/parallel-replicas-2.png)
...
![Parallel replicas](@site/docs/deployment-guides/images/parallel-replicas-3.png)
...
<ol className="docs-ordered-list">
    ...
    <li>
        The node analyzes the index, and selects the right parts and
        granules to process.
    </li>
    <li>
...
![Announcements](@site/docs/deployment-guides/images/parallel-replicas-4.png)
...
![Dynamic Coordination - part 1](@site/docs/deployment-guides/images/parallel-replicas-4.png)
...
![Dynamic Coordination - part 2](@site/docs/deployment-guides/images/parallel-replicas-5.png)
...
![Dynamic Coordination - part 3](@site/docs/deployment-guides/images/parallel-replicas-6.png)
...
![EXPLAIN without parallel_replica](@site/docs/deployment-guides/images/parallel-replicas-7.png)
...
![EXPLAIN without parallel_replica](@site/docs/deployment-guides/images/parallel-replicas-8.png)
