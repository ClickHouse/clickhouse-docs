...
> In this quick start tutorial, we'll get you set up with open-source ClickHouse in 8
...
> 
> Are you looking for the Cloud quick start instead? [Go here](/get-started/quick-start).
