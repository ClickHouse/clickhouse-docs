...
:::tip[Optional: use ClickHouse Cloud instead of local setup]
If you prefer not to manage local infrastructure, you can [create a ClickHouse Cloud service](https://console.clickhouse.cloud/signUp?loc=docs-quick-start-oss) and follow the Cloud quick start.
:::
