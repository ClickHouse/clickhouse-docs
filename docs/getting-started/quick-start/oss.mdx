...
then downloads an appropriate ClickHouse binary from the master branch.
...
If you are looking to install a production instance of ClickHouse, please see the [install page](/install) rather.
:::
