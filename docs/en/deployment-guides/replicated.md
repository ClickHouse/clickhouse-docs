...
```xml title="/etc/clickhouse-keeper/keeper.xml on clickhouse-keeper-01"
<clickhouse>
    <logger>
        <level>trace</level>
...
```xml title="/etc/clickhouse-keeper/keeper.xml on clickhouse-keeper-02"
<clickhouse>
    <logger>
        <level>trace</level>
        <log>/var/log/clickhouse-keeper/clickhouse-keeper.log</log>
...
```xml title="/etc/clickhouse-keeper/keeper.xml on clickhouse-keeper-03"
<clickhouse>
    <logger>
        <level>trace</level>
        <log>/var/log/clickhouse-keeper/clickhouse-keeper.log</log>
