...
The following list of companies are using ClickHouse and their success stories are assembled from public sources, thus might differ from the current reality. We’d appreciate it if you shared the story of how your company has adopted ClickHouse and [add it to the list](https://github.com/ClickHouse/clickhouse-docs/blob/main/docs/en/about-us/adopters.md), but please make sure you won’t have any NDA issues by doing so. Providing updates with publications from other companies is also useful.
