...
an `ENGINE` clause. Use [`MergeTree`](/docs/en/engines/table-engines/mergetree-family/mergetree)
...
The next step is to get your own data into ClickHouse. We have lots of [table functions](/docs/en/sql-reference/table-functions/index.md)
and [integrations](/docs/en/integrations) for ingesting data. We have some examples in the tabs
below, or you can check out our [Integrations](/docs/en/integrations) page for a long list of
technologies that integrate with ClickHouse.

<Tabs groupId="read_data">
<TabItem value="S3" label="S3" default>

Use the [`s3` table function](/docs/en/sql-reference/table-functions/s3.md) to
...
The [`s3` table function](/docs/en/sql-reference/table-functions/s3.md) used for
...
The [`url` table function](/docs/en/sql-reference/table-functions/url) reads
...
Use the [`file` table engine](/docs/en/sql-reference/table-functions/file) to
...
View the [`file` table function](/docs/en/sql-reference/table-functions/file)
...
View the [`postgresql` table function](/docs/en/sql-reference/table-functions/postgresql)
docs page for more details.
<br/>
</TabItem>
<TabItem value="MySQL" label="MySQL">

Use the [`mysql` table function](/docs/en/sql-reference/table-functions/mysql)
...
View the [`mysql` table function](/docs/en/sql-reference/table-functions/mysql)
docs page for more details.
<br/>
</TabItem>
...
View the [`odbc` table function](/docs/en/sql-reference/table-functions/odbc)
and the [`jdbc` table function](/docs/en/sql-reference/table-functions/jdbc) docs
...
- Check out our [Core Concepts](/docs/en/managing-data/core-concepts) section to learn some of the fundamentals of how ClickHouse works under the hood.
