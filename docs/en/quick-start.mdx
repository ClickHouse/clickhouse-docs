...
1. From your organization page, open the connection details of the service that you want to connect to:
  ...
  ![Open connection details](./_snippets/images/connect1.png)
  </div>

2. Click the **Connect to SQL console** button:

  ![Connect to SQL console](./_snippets/images/connect2.png)

3. Notice the username is populated with `default`. You will need to enter your password in the password field:

  ![Enter password](./_snippets/images/connect3.png)
  ...
  View the [IP Access List](./manage/security/ip-access-list) docs page for details on how to add your local IP address.
  :::
...
4. Enter a simple query to verify that your connection is working:
  ...
  ![Show databases](./_snippets/images/connect4.png)
...
rows at once. Don't worry - ClickHouse can easily handle that type of volume - and it will [save you money](/docs/en/manage/tuning-for-cloud-cost-efficiency.md) by sending fewer write requests to your service.
:::
