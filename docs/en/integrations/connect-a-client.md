...
- The [**SQL console**](/docs/en/cloud/get-started/sql-console/) is a core component of ClickHouse Cloud used to explore your databases and tables, run and save queries, and create charts.
