...
Refer to the [installation instructions](/docs/en/get-started/install.md/#available-installation-options) when performing the deployment steps on the ClickHouse server nodes.
...
Refer to the [installation instructions](/docs/en/get-started/install.md/#install-standalone-clickhouse-keeper) when performing the deployment steps on the ClickHouse Keeper nodes.
