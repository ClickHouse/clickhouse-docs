...
| `$__fromTime`                                | Replaced by the starting time of the Grafana panel range cast to a [DateTime](/docs/en/sql-reference/data-types/datetime.md).                                                     | `toDateTime(1415792726)`                                                                                          |
| `$__fromTime_ms`                             | Replaced by the starting time of the panel range cast to a [DateTime64](/docs/en/sql-reference/data-types/datetime64.md).                                                         | `fromUnixTimestamp64Milli(1415792726123)`                                                                         |
| `$__toTime`                                  | Replaced by the ending time of the Grafana panel range cast to a [DateTime](/docs/en/sql-reference/data-types/datetime.md).                                                       | `toDateTime(1447328726)`                                                                                          |
| `$__toTime_ms`                               | Replaced by the ending time of the panel range cast to a [DateTime64](/docs/en/sql-reference/data-types/datetime64.md).                                                           | `fromUnixTimestamp64Milli(1447328726456)`                                                                         |
