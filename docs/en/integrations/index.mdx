...
|MindsDB| |AI/ML|MindsDB introduces ML to the data’s source – inside the database|[Website](https://mindsdb.com/clickhouse-machine-learning )|
...
|Redpanda| |Data ingestion|Kafka-compatible streaming data platform|[Blog](https://redpanda.com/blog/real-time-olap-database-clickhouse-redpanda)|
...
|Flink| |Data ingestion|Flink sink for ClickHouse database, powered by Async Http Client|[GitHub](https://github.com/ivi-ru/flink-clickhouse-sink)|
...
|Rust| |Language client|A typed client for ClickHouse|[GitHub](https://github.com/loyd/clickhouse.rs)|
