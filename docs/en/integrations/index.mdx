...
|Kafka|<KafkaSVG style={{width: '3rem'}} />|Data ingestion|Integration with Apache Kafka, the open-source distributed event streaming platform.|[Documentation](./data-ingestion/kafka)|
|Amazon MSK|<AmazonMskSVG style={{width: '3rem'}} />|Data ingestion|Integration with Amazon Managed Streaming for Apache Kafka (MSK).|[Documentation](./data-ingestion/kafka/msk)|
</div>
<br/>
...
|Name|Logo|Category|Description|Resources|
|------|----|----------------|------------------|-------------|
|Confluent|<ConfluentSVG style={{width: '3rem'}} />|Data ingestion|Integration with Apache Kafka on Confluent platform.|[Documentation](./kafka/confluent)|
