...
|Jupyter notebooks|<img src={require('./images/logos/jupyter.png').default} class="image" alt="Vector logo" style={{width: '3rem', 'background-color': 'transparent'}}/>|The native SQL client for Jupyter notebooks.|[Documentation](https://clickhouse.com/docs/en/integrations/sql-clients/jupysql/)|
