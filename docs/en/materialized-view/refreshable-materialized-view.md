...
For example, consider the following query to denormalize the `postlinks` dataset onto the `posts` table for the StackOverflow dataset. We explored why users may wish to do this in the [denormalizing data guide](/en/data-modeling/denormalization).
