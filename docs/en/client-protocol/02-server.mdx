...
| 1     | Data                             | Same as [client data](./client.mdx#data)                        |
...
Response to [client hello](./client.mdx#hello).
...
[codes]: https://clickhouse.com/codebrowser/html_report/ClickHouse/src/Common/ErrorCodes.cpp.html "List of error codes"
