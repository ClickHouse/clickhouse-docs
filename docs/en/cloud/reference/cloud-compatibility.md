...
Increased this per-server setting from the default of 100 to 1000 to allow for more concurrency. This will result in 2,000 concurrent queries for Basic tier services and 3,000 for Scale or Enterprise tier services.
