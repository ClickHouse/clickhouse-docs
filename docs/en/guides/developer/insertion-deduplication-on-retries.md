...
When a table has one or several materialized views, the inserted data is also inserted to the destination of those views with some defined transformation.
