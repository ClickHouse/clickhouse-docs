...
### 64-bit integers in JSON output {#json-integers}
...
### Async insert behavior {#async-insert}
...
### JDBC PreparedStatement batches {#jdbc-ps-batches}
...
### Materialized views inflate row counts {#mv-row-counts}
...
### Mutations are asynchronous {#mutations-async}
...
### JSON inserts and DEFAULT expressions {#json-defaults}
