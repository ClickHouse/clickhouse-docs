...
settings, even for `SELECT` queries.

:::tip
See the [ClickHouse settings modified by the ODBC driver](#odbc-used-settings-list) section below for the list of
settings and why they’re enabled by the driver.
:::
