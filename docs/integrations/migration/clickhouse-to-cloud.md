...
<img src={self_managed_01} class="image" alt="Migrating Self-managed ClickHouse" style={{width: '80%', padding: '30px'}} />
...
<img src={self_managed_02} class="image" alt="Migrating Self-managed ClickHouse" style={{width: '30%', padding: '30px'}} />
...
<img src={self_managed_03} class="image" alt="Migrating Self-managed ClickHouse" style={{width: '30%', padding: '30px'}} />
...
<img src={self_managed_04} class="image" alt="Migrating Self-managed ClickHouse" style={{width: '30%', padding: '30px'}} />
...
<img src={self_managed_05} class="image" alt="Migrating Self-managed ClickHouse" style={{width: '80%', padding: '30px'}} />
...
<img src={self_managed_06} class="image" alt="Migrating Self-managed ClickHouse" style={{width: '80%', padding: '30px'}} />
