...
| `bufferFlushTime` (since v1.3.6)                | Maximum time in milliseconds to buffer records before flush. `0` disables time-based flushing. Only effective when `bufferCount > 0`.                                                                                           | `"0"`                                                    |
