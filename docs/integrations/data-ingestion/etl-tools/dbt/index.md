...
|-----------------------------------------|-----------------------------------------------|-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| Materialized View materialization       | Yes. Creation with explicit target is in Beta | Creates a [materialized view](/sql-reference/statements/create/view#materialized-view).                                                                                                 |
| Distributed table materialization       | Yes, Experimental                             | Creates a [distributed table](/engines/table-engines/special/distributed).                                                                                                              |
| Distributed incremental materialization | Yes, Experimental                             | Incremental model based on the same idea as distributed table. Note that not all strategies are supported, visit [their docs section](/integrations/dbt/materializations#materialization-distributed-incremental) for more info. |
| Dictionary materialization              | Yes, Experimental                             | Creates a [dictionary](/engines/table-engines/special/dictionary).                                                                                                                      |
