...
:::warning
For AWS RDS Postgres and Aurora Postgres IAM for replication is support from version 11 onwarnds and require parameter `rds.iam_auth_for_replication` to be set.
