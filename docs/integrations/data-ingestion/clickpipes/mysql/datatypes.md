...
| Float                                                                      | Float32                                   | Precision on ClickHouse may differ from MySQL from during initial load due to text protocols.                 |
| Double                                                                     | Float64                                   | Precision on ClickHouse may differ from MySQL from during initial load due to text protocols.                 |
| Date                                                                       | Date32                                    |                                                                                        |
