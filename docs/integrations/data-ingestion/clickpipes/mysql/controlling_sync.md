...
### An exception: Long-running transactions on source {#exception-long-running-transactions}
...
### Monitoring sync control behaviour {#monitoring-sync-control-behaviour}
