...
④ These potentially relevant granules are then loaded and [processed](todo link to other doc) in memory, along with positionally aligned granules from any other columns needed for the query.
