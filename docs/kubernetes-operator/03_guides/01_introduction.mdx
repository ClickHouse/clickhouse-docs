...
:::tip Best practice
Always use the [Replicated](https://clickhouse.com/docs/engines/database-engines/replicated) database engine for production deployments.
:::
...
- [Configuration Guide](./guides/configuration.mdx) - Detailed configuration options
- [API Reference](./reference/api_reference.mdx) - Complete API documentation