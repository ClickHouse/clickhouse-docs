...
Otherwise, you can [download the binary](/get-started/quick-start/oss/#download-the-binary) and run the tool as described above without installing ClickHouse.
:::
