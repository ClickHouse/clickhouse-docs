...
function to find the value of the first argument that corresponds to the maximum value of the second argument, only for rows that match the given condition, using the `argMaxIf` aggregate combinator function.
