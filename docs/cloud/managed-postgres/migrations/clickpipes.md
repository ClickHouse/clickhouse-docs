...
import automatedSchema from '@site/static/images/managed-postgres/pg_dump_restore/automated.png';
import manualSchema from '@site/static/images/managed-postgres/pg_dump_restore/manual.png';
import newDb from '@site/static/images/managed-postgres/pg_dump_restore/newdb.png';
...
<Image img={automatedSchema} alt="Step 2: Automated schema migration with destination database selector" size="lg" border />
...
<Image img={manualSchema} alt="Step 2: Manual schema migration with pg_dump export command" size="lg" border />
