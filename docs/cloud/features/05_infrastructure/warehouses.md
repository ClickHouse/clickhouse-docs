...
- **Primary service idling** Previously, the default behavior is that the primary service cannot auto-idling. As of May 2026, Parent service auto-idling is enabled by default. Existing services will have access to the feature, new services will have it enabled by default. 
