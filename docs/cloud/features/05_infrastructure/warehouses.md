...
- **Primary service idling** Previously, the default behavior is that the primary service cannot auto-idling. As of May 2026, primary service auto-idling is enabled by default. As part of the rollout, existing services have access to the feature while new services created post have it enabled by default. 
