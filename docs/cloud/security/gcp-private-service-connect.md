...
<Image img={gcp_psc_create_zone} size="md" alt="Create DNS Zone for PSC" border />
...
<Image img={gcp_psc_zone_type} size="md" alt="Private DNS Zone Type Selection" border />
...
<Image img={gcp_psc_dns_record} size="md" alt="Creating a DNS Record for PSC" border />
