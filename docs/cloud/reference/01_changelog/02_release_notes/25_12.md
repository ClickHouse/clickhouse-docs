...
* Add data masking policy support. ([pufit](https://github.com/pufit)).
...
* Improve state parsing speed with improved cache in Shared Catalog. ([Nikolay Degterinsky](https://github.com/evillique)).
* Fix batching of znode create requests when locking a lightweight snapshot. ([Julia Kartseva](https://github.com/jkartseva)).
* Introduce a more precise lock for state sync to improve state application time. ([Nikolay Degterinsky](https://github.com/evillique)).
* Speed up SMT startup by batching Keeper requests together. ([Nikolay Degterinsky](https://github.com/evillique)).
...
* SMT: Avoid waiting for other queries when running SYNC REPLICA. ([Raúl Marín](https://github.com/Algunenano)).
...
* Fix setting constraints check in ALTERs on secondary replicas with Shared Catalog. ([Nikolay Degterinsky](https://github.com/evillique)).
...
* Remove checks for MV ALTERs on secondary replicas. ([Nikolay Degterinsky](https://github.com/evillique)).