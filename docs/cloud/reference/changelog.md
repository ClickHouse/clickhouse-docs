...
- **Cross-region private link** is now Generally Available. Please refer to the [documentation](/manage/security/aws-privatelink) for the list of supported regions.
