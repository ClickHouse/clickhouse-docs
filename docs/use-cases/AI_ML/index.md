...
| [Semantic Layer](/use-cases/AI_ML/AIChat/semantic-layer)                      | Learn how to customize the ClickHouse Assistant chat agent with AGENTS.md to provide business-specific rules, calculations, and data structure guidance.    |
