...
| [Querying data in Azure using ClickHouse and the OneLake Catalog](/use-cases/data-lake/onelake-catalog) | Query your data using the OneLake via the Iceberg catalog. |
