...
<Image img={hyperdx} alt="ClickStack UI" size="lg" force/>
...
<Image img={copy_api_key} alt="Copy API key" size="lg" force/>
...
<Image img={hyperdx_10} alt="HyperDX search" size="lg" force/>
...
<Image img={hyperdx_11} alt="Sessions" size="lg" force/>
...
<Image img={hyperdx_12} alt="Session replay" size="lg" force/>
...
<Image img={hyperdx_13} alt="Error in session" size="lg" force/>
...
<Image img={hyperdx_14} alt="Session trace" size="lg" force/>

Scroll down the trace to see the origin of the error - the `checkout` service span. Select the `Payment` service span. 

<Image img={hyperdx_15} alt="Span" size="lg" force/>

Select the tab `Column Values` and scroll down. We can see the issue is associated with a cache being full.

<Image img={hyperdx_16} alt="Column values" size="lg" force/>

Scrolling up and returning to the trace, we can see logs are correlated with the span, thanks to our earlier configuration. These provide further context.

<Image img={hyperdx_17} alt="Correlated log" size="lg" force/>
...
<Image img={hyperdx_18} alt="Logs" size="lg" force/>
...
<Image img={hyperdx_19} alt="Metrics" size="lg" force/>
