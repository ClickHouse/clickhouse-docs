...
In order to send data to ClickStack via the OTel collector, SDKs will need to specify an ingestion API key. This API key is generated by the HyperDX application is available via the app in `Team Settings → API Keys`.
