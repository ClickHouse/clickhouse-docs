...
The following tables are created for each data type in the `default` databse. Users can change this target database by modifying the environment variable `CLICKHOUSE_DATABASE` for the image hosting the OTel collector.
