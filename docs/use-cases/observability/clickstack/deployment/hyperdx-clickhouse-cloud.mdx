...
import {TrackedLink} from '@site/src/components/TrackedLink/TrackedLink.tsx'
...
:::note[New to ClickHouse Cloud?]
<TrackedLink href="/docs/cloud/overview" eventName="clickstack.deployment.cloud_learn_more.cta">Learn more about ClickHouse Cloud</TrackedLink> or <TrackedLink href="https://clickhouse.cloud/signUp" eventName="clickstack.deployment.cloud_signup.cta" target="_blank" rel="noopener noreferrer">sign up for a free trial</TrackedLink> to get started.
:::
