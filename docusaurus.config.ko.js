...
const config = {
  ...
  tagline:
    "문서, 빠른 시작 가이드, 사용자 가이드, 기술 참조 자료, FAQ 등 다양한 정보를 제공합니다.",
  ...
  presets: [
    [
      ...
      ({
        ...
        blog: {
          path: "knowledgebase",
          blogTitle: "ClickHouse 지식 베이스",
          blogDescription: "지식 베이스",
          ...
          feedOptions: {
            type: "all",
            title: "ClickHouse 지식 베이스 피드",
            description: "ClickHouse 지식 베이스에 게시된 문서 피드",
