...
## 启用多 VPC 连接 \{#enabling-multi-vpc-connectivity\}

1. 导航到 MSK 集群。
   * 在 Amazon MSK 控制台左侧导航栏中选择 &quot;Clusters&quot;。
   * 选择你要配置多 VPC 连接的目标 MSK 集群。
2. 启用 MSK 多 VPC 连接
...
:::tip
集群的 IAM 策略使 ClickPipes 能够从 ClickPipes 端主动发起到你的 MSK 集群的连接。
如果你希望为 MSK 集群配置 IAM 认证，请参考 [IAM 认证文档](/integrations/clickpipes/kafka/best-practices#iam)。
:::
