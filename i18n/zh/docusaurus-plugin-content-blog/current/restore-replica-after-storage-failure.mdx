...
<VerticalStepper headerLevel="h2">
  ## 从健康副本复制访问配置 \{#copy-access-config\}
  ...
  ## 从健康副本备份 metadata 目录 \{#back-up-the-metadata-folder-from-the-healthy-replica\}
  ...
  ## 在故障副本上恢复 metadata \{#restore-the-metadata-on-the-faulty-replica\}
  ...
  ## 创建强制恢复标志文件 \{#create-force-restore-flag\}
