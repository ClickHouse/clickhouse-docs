...
创建一个名为 `MyCertificate.crt` 的证书。有关更多详细信息，请参阅 [&quot;Create SSL certificates&quot;](/guides/sre/tls/configuring-tls#2-create-tls-certificates)。
...
## 更新 Nginx 配置 \{#update-nginx-config\}
...
## 使用别名连接到 Cloud \{#connect-to-cloud-using-alias\}
