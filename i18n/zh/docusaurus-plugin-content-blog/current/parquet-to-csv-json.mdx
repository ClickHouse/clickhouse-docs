...
## 将文件从 Parquet 转换为 CSV 或 JSON \{#converting-files-from-parquet-to-csv-or-json\}
...
## 使用表函数访问数据 \{#accessing-the-data-using-a-table-function\}
...
## 将 Parquet 文件转换为 CSV \{#convert-the-parquet-file-to-a-csv\}
...
## 将 Parquet 文件转换为 JSON \{#convert-the-parquet-file-to-a-json\}
...
## 将 CSV 转换为 Parquet \{#convert-csv-to-parquet\}
