...
必须先将你的数据（文档、图像或结构化数据）转换为 _embeddings_。我们建议使用 [OpenAI Embeddings API](https://platform.openai.com/docs/api-reference/embeddings) 或开源 Python 库 [SentenceTransformers](https://www.sbert.net/) 来创建 embeddings。
