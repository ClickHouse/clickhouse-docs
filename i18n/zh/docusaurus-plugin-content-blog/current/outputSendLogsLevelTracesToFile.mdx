---
title: "如何使用 clickhouse-client 将日志级 trace 输出到文件"
description: "如何使用 clickhouse-client 将日志级 trace 输出到文件"
date: 2024-11-21
tags: ['Data Export']
...
使用 ClickHouse Client 时，如何将针对多条语句产生的多行 `send_logs_level` 输出写入文件？

## 答案

* 创建一个包含这些语句的 SQL 文件，例如 `send_logs_level_example.sql`：
