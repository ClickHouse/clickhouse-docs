---
title: 解决 ClickHouse 中的 "parts 过多" 错误
description: 了解如何通过优化插入速率、配置 MergeTree 参数以及有效管理分区来解决 ClickHouse 中的 "parts 过多" 错误。
date: 2023-03-20
tags: ['错误与异常']
keywords: ['parts 过多']
---
...
## DB::Exception: 数据部分过多 (错误: 252)。合并处理明显慢于插入 \{#dbexception-too-many-parts-252-merges-are-processing-significantly-slower-than-inserts\}
