...
description: "了解如何使用 Kafka 表引擎、物化视图和 MergeTree 表将数据从 topic 摄取到 ClickHouse。"
date: 2024-04-27
tags: ['数据摄取']
keywords: ['Kafka']
---
...
# 1. 在 Ubuntu 上部署 Kafka \{#1-setup-kafka-on-ubuntu\}
...
# 2. 将 Wikimedia 数据流摄取到 Kafka 中 \{#2-ingest-the-wikimedia-stream-into-kafka\}
...
# 3. 将数据摄取到 ClickHouse \{#3-ingest-the-data-into-clickhouse\}
