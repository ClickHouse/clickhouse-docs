...
## 将数据摄取到 Kafka \{#ingest-data-into-kafka\}
...
## 将数据摄取到 ClickHouse \{#ingest-data-into-clickhouse\}
...
## 在 ClickHouse 中查询 JSON 数据 \{#querying-json-data-in-clickhouse\}
