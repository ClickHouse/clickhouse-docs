...
keywords: ['常见问题', '问题', '是什么']
title: '关于 ClickHouse 的常见问题'
description: '列出关于 ClickHouse 一般问题的索引页面'
...
- [如何选择主键？](../../guides/best-practices/sparse-primary-indexes.md)
- [为什么不使用类似 MapReduce 的方案？](../../faq/general/mapreduce.md)
- [如何向 ClickHouse 贡献代码？](/knowledgebase/how-do-i-contribute-code-to-clickhouse)

:::info 没有找到你要找的内容？
请查看我们的[知识库](/knowledgebase/)，并浏览本手册中许多实用的文章。
:::