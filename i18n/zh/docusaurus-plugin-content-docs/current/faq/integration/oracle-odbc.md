...
如果您通过 Oracle ODBC 驱动程序将 Oracle 用作 ClickHouse 外部字典的数据源,需要在 `/etc/default/clickhouse` 中为 `NLS_LANG` 环境变量设置正确的值。更多信息请参阅 [Oracle NLS_LANG FAQ](https://www.oracle.com/technetwork/products/globalization/nls-lang-099431.html)。
