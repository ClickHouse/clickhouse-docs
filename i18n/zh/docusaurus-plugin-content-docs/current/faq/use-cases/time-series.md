...
toc_hidden: true
toc_priority: 101
description: '描述如何将 ClickHouse 用作时序数据库的页面'
doc_type: 'guide'
keywords: ['时序', '时间数据', '用例', '基于时间的分析', 'timeseries']
---

*注意：有关在 ClickHouse 中处理时序数据的更多示例，请参阅博客 [Working with Time series data in ClickHouse](https://clickhouse.com/blog/working-with-time-series-data-and-functions-ClickHouse)。*
