...
列出当前工作 directory 下 clickhouse-local 可访问的所有 File。
...
- [使用 clickhouse-local 从本地File中提取、转换和查询数据](https://clickhouse.com/blog/extracting-converting-querying-local-files-with-sql-clickhouse-local)
...
- 博客：[使用 clickhouse-local 从本地File中提取、转换和查询数据](https://clickhouse.com/blog/extracting-converting-querying-local-files-with-sql-clickhouse-local)