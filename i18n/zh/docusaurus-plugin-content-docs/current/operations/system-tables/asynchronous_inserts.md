...
- `entries.query_id` ([Array(String)](../../sql-reference/data-types/array.md)) - 等待在队列中的插入的查询 id 数组。
...
- [system.query_log](/operations/system-tables/query_log) — `query_log` 系统表的描述，该表包含有关查询执行的常见信息。
- [system.asynchronous_insert_log](/operations/system-tables/asynchronous_insert_log) — 该表包含有关执行的异步插入的信息。
