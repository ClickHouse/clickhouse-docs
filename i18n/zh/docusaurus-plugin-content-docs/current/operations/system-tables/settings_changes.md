...
- `changes` （[Array](../../sql-reference/data-types/array.md) 的 [Tuple](../../sql-reference/data-types/tuple.md)） — 设置更改的描述：（设置名称，先前值，新值，更改原因）
