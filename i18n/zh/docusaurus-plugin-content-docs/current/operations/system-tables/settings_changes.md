...
包含有关 ClickHouse 历史版本中设置变更的信息。

## 列 \{#columns\}

{/*AUTOGENERATED_START*/ }

* `type` ([Enum8(&#39;Session&#39; = 0, &#39;MergeTree&#39; = 1)](../../sql-reference/data-types/)) — 设置所属的组 (Session、MergeTree...)
* `version` ([String](../../sql-reference/data-types/)) — ClickHouse 服务端版本。
* `changes` ([Array(Tuple(name String, previous&#95;value String, new&#95;value String, reason String))](../../sql-reference/data-types/)) — 导致 ClickHouse 行为发生变化的设置变更列表。
