...
- `path` ([String](../../sql-reference/data-types/string.md)) — 文件系统中的挂载点路径。
...
- `unreserved_space` ([UInt64](../../sql-reference/data-types/int-uint.md)) — 未被保留的可用空间（`free_space` 减去当前运行的合并、插入和其他磁盘写操作所占用的保留大小）。
