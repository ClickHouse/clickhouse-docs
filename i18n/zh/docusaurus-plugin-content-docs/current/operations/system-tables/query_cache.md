...
- `stale` ([UInt8](../../sql-reference/data-types/int-uint.md)) — 如果查询缓存条目已过期。
- `shared` ([UInt8](../../sql-reference/data-types/int-uint.md)) — 如果查询缓存条目在多个用户之间共享。
- `compressed` ([UInt8](../../sql-reference/data-types/int-uint.md)) — 如果查询缓存条目已压缩。
