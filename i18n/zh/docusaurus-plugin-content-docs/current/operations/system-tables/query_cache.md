...
- `query_id` ([String](../../sql-reference/data-types/)) — 查询ID。
...
- `expires_at` ([DateTime](../../sql-reference/data-types/)) — 查询缓存条目的过期时间。
- `key_hash` ([UInt64](../../sql-reference/data-types/)) — 查询字符串的哈希值，用作查找查询缓存条目的键。
<!--AUTOGENERATED_END-->
