...
* `content_type` ([Enum8(&#39;None&#39; = 0, &#39;Metadata&#39; = 1, &#39;ManifestListMetadata&#39; = 2, &#39;ManifestListEntry&#39; = 3, &#39;ManifestFileMetadata&#39; = 4, &#39;ManifestFileEntry&#39; = 5)](/sql-reference/data-types/enum)) — 内容类型。
* `table_path` ([String](/sql-reference/data-types/string)) — 表路径。
* `file_path` ([String](/sql-reference/data-types/string)) — 文件路径。
* `content` ([String](/sql-reference/data-types/string)) — JSON 格式的内容 (JSON 文件内容、Avro 元数据或 Avro 条目) 。
* `row_in_file` ([Nullable(UInt64)](/sql-reference/data-types/nullable)) — 文件中的行。
* `pruning_status` ([Nullable(Enum8(&#39;NotPruned&#39; = 0, &#39;PartitionPruned&#39; = 1, &#39;MinMaxIndexPruned&#39; = 2))](/sql-reference/data-types/nullable)) — 该文件的分区剪枝或最小-最大索引剪枝状态。
