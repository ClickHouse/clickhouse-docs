...
* `name` ([String](../../sql-reference/data-types/)) — 服务器设置名称。
* `value` ([String](../../sql-reference/data-types/)) — 服务器设置值。
* `default` ([String](../../sql-reference/data-types/)) — 服务器设置默认值。
* `changed` ([UInt8](../../sql-reference/data-types/)) — 显示某项设置是否在 config.xml 中指定。
* `description` ([String](../../sql-reference/data-types/)) — 服务器设置的简要说明。
* `type` ([String](../../sql-reference/data-types/)) — 服务器设置值的类型。
* `changeable_without_restart` ([Enum8(&#39;No&#39; = 0, &#39;IncreaseOnly&#39; = 1, &#39;DecreaseOnly&#39; = 2, &#39;Yes&#39; = 3)](../../sql-reference/data-types/)) — 显示某项设置是否可在运行时修改。
* `is_obsolete` ([UInt8](../../sql-reference/data-types/)) — 显示某项设置是否已废弃。

{/*AUTOGENERATED_END*/ }

## 示例 \{#example\}

以下示例说明如何获取名称包含 `thread_pool` 的服务器设置信息。
