...
* `comment` ([String](../../sql-reference/data-types/)) — 数据库备注。
* `is_external` ([UInt8](../../sql-reference/data-types/)) — 是否为外部数据库（例如 PostgreSQL/DataLakeCatalog）。
