...
<VersionHistory rows={[{"id": "row-1","items": [{"label": "26.3"},{"label": "minmax, uniq"},{"label": "默认启用自动统计信息"}]}, {"id": "row-2","items": [{"label": "26.2"},{"label": "minmax, uniq"},{"label": "默认启用自动统计信息"}]}, {"id": "row-3","items": [{"label": "25.10"},{"label": ""},{"label": "新设置"}]}]} />
...
<VersionHistory rows={[{"id": "row-1","items": [{"label": "26.3"},{"label": "300"},{"label": "新设置"}]}]}/>
