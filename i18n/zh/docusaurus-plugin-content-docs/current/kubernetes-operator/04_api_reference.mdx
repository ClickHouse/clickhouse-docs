...
| Field          | Type                    | Required | Default     | Description                                                                                                                                                                                                                                                    |
|----------------|-------------------------|----------|-------------|----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| `passwordType` | `string`                | No       | `plaintext` | 密码编码类型。可选值：`plaintext`、`sha256_password`、`sha256_hash`、`double_sha1_password`、`double_sha1_hash`。详情参见 [ClickHouse 文档](/operations/settings/settings-users#password)。 |
