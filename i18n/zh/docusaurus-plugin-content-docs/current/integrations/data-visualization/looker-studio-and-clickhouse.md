...
keywords: ['clickhouse', 'looker', 'studio', '连接', 'mysql', '集成', '界面']
description: 'Looker Studio（前称 Google Data Studio）是一款在线工具，可将数据转换为可自定义的分析报告和仪表板。'
title: 'Looker Studio'
doc_type: 'guide'
integration:
  - support_level: 'core'
...
Looker Studio 可以通过 MySQL 接口，使用 Google 官方 MySQL 数据源连接到 ClickHouse。
