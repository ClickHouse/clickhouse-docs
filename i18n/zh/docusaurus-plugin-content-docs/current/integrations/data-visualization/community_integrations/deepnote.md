...
<a href="https://www.deepnote.com/" target="_blank">Deepnote</a> 是一款面向团队的数据协作笔记本，帮助用户发现并分享洞察。它不仅兼容 Jupyter，还运行在云端，为你提供一个集中化的平台，用于高效协作和开展数据科学项目。
...
1. 在 Deepnote 中,选择"Integrations"概览并点击 ClickHouse 磁贴。

<Image size='lg' img={deepnote_01} alt='ClickHouse 集成磁贴' border />
