...
description: 'Explo 是一款易于使用的开源 UI 工具，可用于对数据提出问题。'
...
面向客户的分析能力，适用于任何平台。为精美可视化而设计，为简单易用而打造。



## 目标 {#goal}

在本指南中,您将把 ClickHouse 中的数据连接到 Explo 并进行可视化展示。图表效果如下:
...
<Image img={explo_06} size='md' alt='安全' border />
...
3. 在 X 轴中填入 **county**,在 Y 轴部分填入 **Price**,如下所示:
...
欲了解更多关于 Explo 及如何构建仪表板的信息,请<a href="https://docs.explo.co/" target="_blank">访问 Explo 文档</a>。
