...
description: 'Explo 是一个易于使用的开源 UI 工具，可帮助你就数据提出问题并获取答案。'
...
2. 点击右上角的 **Create Dashboard**，并为你的仪表板命名。现在你就已经创建好一个仪表板了！
...
2. 选择数据集。此时你应当看到如下图所示的界面：

<Image img={explo_12} size="sm" alt="Explo Dashboard" border />

3. 像下面这样，在 X 轴中设置 **county**，在 Y 轴中设置 **Price**：
