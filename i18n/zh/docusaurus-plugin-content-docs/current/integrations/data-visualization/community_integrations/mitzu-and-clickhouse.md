...
Mitzu 是一款无代码、原生面向数据仓库的产品分析应用。与 Amplitude、Mixpanel 和 PostHog 等工具类似，Mitzu 让用户无需掌握 SQL 或 Python 等专业技能即可分析产品使用数据。
...
如果已完成营收配置，Mitzu 可以根据你的支付事件计算总 MRR 和订阅数量。
...
如果你在使用过程中感到困惑，欢迎通过 [support@mitzu.io](email://support@mitzu.io) 联系我们。
