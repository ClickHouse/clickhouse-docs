...
description: '将 Chartbrew 连接到 ClickHouse，用于创建实时仪表板和客户报告。'
doc_type: 'guide'
integration:
...
:::tip 添加一些数据
如果您当前没有可用的数据集，可以添加一个示例数据集。本指南使用的是 [UK Price Paid](/getting-started/example-datasets/uk-price-paid.md) 数据集。
:::
...
如需了解更多详情，请查看这篇关于 [Chartbrew 和 ClickHouse](https://chartbrew.com/blog/visualizing-clickhouse-data-with-chartbrew-a-step-by-step-guide/) 的博客文章。