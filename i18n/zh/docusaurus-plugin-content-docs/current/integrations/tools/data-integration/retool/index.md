...
- 'nocode'
- 'no-code'
'description': '快速构建具有丰富用户界面的 web 和移动应用，自动化复杂任务，并集成 AI——一切都由您的数据驱动。'
...
登录到您的 Retool 账户并导航到 _资源_ 选项卡。选择 "创建新资源" -> "资源":
...
现在，您应该能够使用您的 ClickHouse 资源继续您的应用程序。
