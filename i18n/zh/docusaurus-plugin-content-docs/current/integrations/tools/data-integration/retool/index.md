...
description: '基于你的数据，快速构建具备丰富用户界面的 Web 和移动应用，自动化复杂任务，并集成 AI。'
...
如果您的实例需要 SSL 或您正在使用 ClickHouse Cloud，请在连接字符串中添加 `&ssl=true`，使其变为 `jdbc:clickhouse://HOST:PORT/DATABASE?user=USERNAME&password=PASSWORD&ssl=true`
...
现在，您可以在应用程序中使用您的 ClickHouse 资源了。
