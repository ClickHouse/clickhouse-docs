...
| Distributed table 物化                  | 是，Experimental                                | 创建一个 [distributed table](/engines/table-engines/special/distributed)。                                                                                                                                                                               |
| Distributed incremental 物化            | 是，Experimental                                | 基于与 distributed table 相同理念的 incremental model。请注意，并非所有策略都受支持，更多信息请参见[其文档章节](/integrations/dbt/materializations#materialization-distributed-incremental)。                                                              |
