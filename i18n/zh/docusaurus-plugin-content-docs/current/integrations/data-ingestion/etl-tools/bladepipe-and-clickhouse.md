...
<a href="https://www.bladepipe.com/" target="_blank">BladePipe</a> 是一款实时端到端数据集成工具，具备亚秒级低延迟，可实现跨平台之间的数据无缝流动。
...
<VerticalStepper headerLevel="h2">
  ...
  4. 选择 `ClickHouse`，填写 ClickHouse 主机和端口、用户名和密码等配置，然后点击 &quot;Test Connection&quot;。

     <Image img={bp_ck_1} size="lg" border alt="将 ClickHouse 添加为目标" />

  5. 点击底部的 &quot;Add DataSource&quot;，即可添加一个 ClickHouse 实例。
  ...
  :::note
  要将 MySQL 用作源，请确保该用户具有<a href="https://doc.bladepipe.com/dataMigrationAndSync/datasource_func/MySQL/privs_for_mysql" target="_blank">所需权限</a>。
  :::
