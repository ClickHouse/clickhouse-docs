...
sidebar_label: '将 Kafka 集成到 ClickHouse'
sidebar_position: 1
...
有关这些选项的详细比较,请参阅[选择合适的选项](#choosing-an-option)。
...
[Kafka 表引擎](./kafka-table-engine.md)可用于从 Apache Kafka 和其他兼容 Kafka API 的代理读取和写入数据。此选项与开源 ClickHouse 捆绑在一起,适用于所有部署类型。
