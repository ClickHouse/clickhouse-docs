...
以多种格式加载和导出 JSON,包括对象格式和行分隔的 NDJSON。
...
需要将 SQL 转储导入到 MySQL 或 PostgreSQL?这里就是您要找的。

如果您希望连接 Grafana、Tableau 等 BI 工具,请查看文档的[可视化类别](../../data-visualization/index.md)。
