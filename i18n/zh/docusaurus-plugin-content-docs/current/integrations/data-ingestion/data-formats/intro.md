...
title: '从多种数据格式导入 ClickHouse'
description: '介绍如何将多种数据格式导入 ClickHouse 的页面'
...
在本节文档中,您可以找到从各种文件类型加载数据的示例。

### [**二进制格式**](/integrations/data-ingestion/data-formats/binary.md) {#binary}
...
导入和导出 CSV 系列格式,包括 TSV,支持自定义标题和分隔符。
...
需要将 SQL 转储文件导入到 MySQL 或 PostgreSQL?本节内容可以帮到您。

如果您需要连接 Grafana、Tableau 等 BI 工具,请查看文档的[可视化类别](../../data-visualization/index.md)。
