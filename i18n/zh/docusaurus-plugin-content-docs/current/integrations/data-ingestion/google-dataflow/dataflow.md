---
sidebar_label: '将 Google Dataflow 与 ClickHouse 集成'
slug: /integrations/google-dataflow/dataflow
sidebar_position: 1
description: '用户可以使用 Google Dataflow 将数据导入 ClickHouse'
title: '将 Google Dataflow 与 ClickHouse 集成'
doc_type: 'guide'
keywords: ['Google Dataflow ClickHouse', 'Dataflow ClickHouse 集成', 'Apache Beam ClickHouse', 'ClickHouseIO 连接器', 'Google Cloud ClickHouse 集成']
---
...
将 Google Dataflow 与 ClickHouse 结合使用主要有两种方式，这两种方式都依赖 [`ClickHouseIO Apache Beam connector`](/integrations/apache-beam)：
