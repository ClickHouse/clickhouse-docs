...
# 创建你的第一个 GCS ClickPipe \{#creating-your-first-gcs-clickpipe\}

GCS ClickPipe 提供了一种完全托管且具有弹性的方式，用于从 Google Cloud Storage (GCS) 摄取数据。它支持具有恰好一次语义的 **一次性摄取** 和 **持续摄取**。

GCS ClickPipes 既可以使用 ClickPipes UI 手动部署和管理，也可以通过 [OpenAPI](https://clickhouse.com/docs/cloud/manage/api/swagger#tag/ClickPipes/paths/~1v1~1organizations~1%7BorganizationId%7D~1services~1%7BserviceId%7D~1clickpipes/post) 和 [Terraform](https://registry.terraform.io/providers/ClickHouse/clickhouse/latest/docs/resources/clickpipe) 以编程方式进行部署和管理。
