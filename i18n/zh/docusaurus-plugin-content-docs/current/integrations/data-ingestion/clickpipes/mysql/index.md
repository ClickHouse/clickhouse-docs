...
| 名称                 | Logo | 详细信息           |
|----------------------|------|-------------------|
| **Amazon RDS MySQL** <br /> *一次性加载，CDC（变更数据捕获）* |  | 请参阅 [Amazon RDS MySQL](./mysql/source/rds) 配置指南。 |
| **Amazon Aurora MySQL** <br /> *一次性加载，CDC（变更数据捕获）* |  | 请参阅 [Amazon Aurora MySQL](./mysql/source/aurora) 配置指南。 |
| **Cloud SQL for MySQL** <br /> *一次性加载，CDC（变更数据捕获）* | |  请参阅 [Cloud SQL for MySQL](./mysql/source/gcp) 配置指南。 |
| **Azure Flexible Server for MySQL** <br /> *一次性加载* |  | 请参阅 [Azure Flexible Server for MySQL](./mysql/source/azure-flexible-server-mysql) 配置指南。 |
| **自托管 MySQL** <br /> *一次性加载，CDC（变更数据捕获）* | |  请参阅 [通用 MySQL](./mysql/source/generic) 配置指南。 |
| **Amazon RDS MariaDB** <br /> *一次性加载，CDC（变更数据捕获）* |  | 请参阅 [Amazon RDS MariaDB](./mysql/source/rds_maria) 配置指南。 |
| **自托管 MariaDB** <br /> *一次性加载，CDC（变更数据捕获）* | |  请参阅 [通用 MariaDB](./mysql/source/generic_maria) 配置指南。 |
