...
既可以使用 ClickPipes UI 手动部署和管理 MySQL ClickPipes，也可以通过 [OpenAPI](/integrations/clickpipes/programmatic-access/openapi) 和 [Terraform](/integrations/clickpipes/programmatic-access/terraform) 以编程方式进行部署和管理。
