...
description: '将 MongoDB Atlas 配置为 ClickPipes 源的分步指南'
...
你现在可以[创建你的 ClickPipe](../index.md)，并开始将 MongoDB 实例中的数据摄取到 ClickHouse Cloud。
请务必记录在配置 MongoDB 实例时使用的连接信息，因为在创建 ClickPipe 的过程中你将需要这些信息。