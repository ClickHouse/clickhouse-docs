...
ClickPipes 使用 [Postgres 逻辑解码](https://www.pgedge.com/blog/logical-replication-evolution-in-chronological-order-clustering-solution-built-around-logical-replication)来捕获 Postgres 中实时发生的变更。Postgres 中的逻辑解码过程使 ClickPipes 等客户端能够以人类可读的格式接收变更,即一系列 INSERT、UPDATE 和 DELETE 操作。
...
### 像使用 Postgres 一样查询 {#query-like-with-postgres}
