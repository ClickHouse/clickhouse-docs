...
如果您需要限制对 RDS 实例的流量访问,请将[文档中列出的静态 NAT IP 地址](../../index.md#list-of-static-ips)添加到 RDS 安全组的 `Inbound rules` 中。
...
要通过私有网络连接到 RDS 实例,您可以使用 AWS PrivateLink。请参考我们的 [ClickPipes 的 AWS PrivateLink 设置指南](/knowledgebase/aws-privatelink-setup-for-clickpipes)来建立连接。
