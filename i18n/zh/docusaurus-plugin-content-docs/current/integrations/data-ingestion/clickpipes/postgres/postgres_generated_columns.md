...
description: '说明在对表进行复制时使用 PostgreSQL 生成列需要牢记的重要注意事项的页面'
doc_type: 'guide'
keywords: ['clickpipes', 'postgresql', 'cdc', 'data ingestion', 'real-time sync']
---

在对正在复制的表中使用 PostgreSQL 的生成列时，需要注意一些重要事项。这些“坑点”可能会影响复制过程以及目标系统中的数据一致性。
...
## UI 即将改进 {#upcoming-improvements-to-ui}
