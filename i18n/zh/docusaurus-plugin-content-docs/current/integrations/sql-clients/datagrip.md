...
<Image img={datagrip_5} size="lg" border alt="DataGrip 的 Data Sources 选项卡，高亮显示的 + 图标" />
...
- 切换到 **Drivers** 选项卡并加载 ClickHouse 驱动程序
  ...
  为了尽量减小下载包大小，DataGrip 默认不内置驱动程序。在 **Drivers** 选项卡中，
  从 **Complete Support** 列表中选择 **ClickHouse**，然后展开 **+** 图标。从 **Provided Driver** 选项中选择 **Latest stable** 驱动程序：

<Image img={datagrip_1} size="lg" border alt="DataGrip Drivers 选项卡显示 ClickHouse 驱动的安装" />
...
<Image img={datagrip_7} border alt="包含 ClickHouse 设置的 DataGrip 连接详情表单" />
