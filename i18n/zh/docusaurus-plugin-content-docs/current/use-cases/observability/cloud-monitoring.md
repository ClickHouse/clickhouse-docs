...
本指南为正在评估 ClickHouse Cloud 的 Enterprise 团队提供有关生产环境部署中监控与可观测性能力的全面信息。Enterprise 客户经常询问开箱即用的监控功能、如何与现有可观测性技术栈集成 (包括 Datadog 和 AWS CloudWatch 等工具) ，以及 ClickHouse 的监控能力与自托管部署相比有何差异。
