...
sidebar_position: 7
description: '适用于 ClickStack 的 Ruby on Rails SDK - ClickHouse 可观测性技术栈'
title: 'Ruby on Rails'
doc_type: 'guide'
...
<table>
  <tbody>
    <tr>
      ...
      <td className="pe-2">✅ 跟踪（Traces）</td>
    </tr>
  </tbody>
</table>

_若要将日志发送到 ClickStack，请通过 [OpenTelemetry collector](/use-cases/observability/clickstack/ingesting-data/otel-collector) 发送日志。_
...
接下来,您需要初始化 OpenTelemetry 追踪工具,并为 Rails 日志记录器配置日志消息格式化器,以便日志可以自动关联到追踪。如果没有自定义格式化器,日志将无法在 ClickStack 中自动关联。
