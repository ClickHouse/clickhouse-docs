...
您需要先安装 [uv](https://docs.astral.sh/uv/) 才能按照本指南的说明操作。
如果您不想使用 uv,则需要更新 MCP Server 配置以使用其他包管理器。


## 启动 Open WebUI {#launch-open-webui}

要启动 Open WebUI,请运行以下命令:
...
要在 Open WebUI 中使用这些端点,需要进入设置页面:
