...
title: '如何使用 Agno 和 ClickHouse MCP Server 构建 AI 智能体'
pagination_prev: null
pagination_next: null
description: '了解如何使用 Agno 和 ClickHouse MCP Server 构建 AI 智能体'
...
在本指南中，您将学习如何构建一个 [Agno](https://github.com/agno-agi/agno) AI agent，使其能够通过 [ClickHouse 的 MCP Server](https://github.com/ClickHouse/mcp-clickhouse) 与 [ClickHouse 的 SQL playground](https://sql.clickhouse.com/) 进行交互。

:::note 示例 notebook
该示例作为 notebook 提供，位于 [examples 仓库](https://github.com/ClickHouse/examples/blob/main/ai/mcp/agno/agno.ipynb) 中。
:::
...
您可以在 [Agno 文档](https://docs.agno.com/concepts/models/introduction) 中找到设置凭据的说明
:::
...
┏━ Response (34.9s) ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━┓
┃                                                                                                                 ┃
┃ 要回答您关于 2025 年获得星标最多的项目的问题,我需要查询 ClickHouse 数据库。     ┃
┃ 但在此之前,我需要收集一些信息并确保我们查看的是正确的数据。 ┃
┃ 让我先检查可用的数据库和表。感谢您提供数据库列表。我可以看到  ┃
┃ 有一个 "github" 数据库,它很可能包含我们要查找的信息。让我们检查 ┃
┃ 该数据库中的表。现在我们已经获得了 github 数据库中表的信息,可以查询  ┃
┃ 相关数据来回答您关于 2025 年获得星标最多的项目的问题。我们将使用 repo_events_per_day ┃
┃ 表,该表包含每个代码仓库的每日事件计数,包括星标事件(WatchEvents)。              ┃
┃                                                                                                                 ┃
