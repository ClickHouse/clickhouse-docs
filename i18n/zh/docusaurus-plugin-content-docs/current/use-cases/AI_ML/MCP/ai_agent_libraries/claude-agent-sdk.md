...
<VerticalStepper headerLevel="h2">
  ...
  ## 初始化 MCP 服务器和 Claude Agent SDK agent \{#initialize-mcp-and-agent\}

  现在将 ClickHouse MCP 服务器配置为指向 ClickHouse SQL playground，然后初始化我们的agent并向它提出一个问题：
