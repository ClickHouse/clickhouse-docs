...
| [Databricks Unity 目录](/use-cases/data-lake/unity-catalog) | Delta, Iceberg |     ✅ Beta     |    ✅ Beta    | ✅ Beta | [Unity 目录指南](/use-cases/data-lake/unity-catalog)             |
| [Iceberg REST](/use-cases/data-lake/rest-catalog)         | Iceberg        |     ✅ Beta     |       ❌      |    ❌   | [REST 目录指南](/use-cases/data-lake/rest-catalog)               |
| [Lakekeeper](/use-cases/data-lake/lakekeeper-catalog)     | Iceberg        |     ✅ Beta     |       ❌      |    ❌   | [Lakekeeper 目录指南](/use-cases/data-lake/lakekeeper-catalog)   |
| [Project Nessie](/use-cases/data-lake/nessie-catalog)     | Iceberg        | ✅ Experimental |       ❌      |    ❌   | [Nessie 目录指南](/use-cases/data-lake/nessie-catalog)           |
| [Microsoft OneLake](/use-cases/data-lake/onelake-catalog) | Iceberg        |     ✅ Beta     |    ✅ Beta    | ✅ Beta | [OneLake 目录指南](/use-cases/data-lake/onelake-catalog)         |

目前所有目录集成都需要启用实验性或 Beta 设置。除 Microsoft OneLake 和 Databricks Unity 目录外，所有目录都仅提供**只读**访问——可以通过目录连接查询表，但不能创建或写入。要从目录中将数据加载到 ClickHouse 中以加速分析，请使用 `INSERT INTO SELECT`，具体说明参见[加速分析指南](/use-cases/data-lake/getting-started/accelerating-analytics)。要将数据写回开放表格式，请按照[写入数据指南](/use-cases/data-lake/getting-started/writing-data)中的说明创建独立的 Iceberg 表。