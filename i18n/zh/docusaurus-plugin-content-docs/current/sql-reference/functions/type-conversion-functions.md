...
`to<type>` 函数和 [cast](#cast) 在某些情况下表现得不同，例如在 [LowCardinality](../data-types/lowcardinality.md) 的情况下： [cast](#cast) 会移除 [LowCardinality](../data-types/lowcardinality.md) 特性，而 `to<type>` 函数不会。同样的情况适用于 [Nullable](../data-types/nullable.md)，这种行为与 SQL 标准不兼容，可以使用 [cast_keep_nullable](../../operations/settings/settings.md/#cast_keep_nullable) 设置进行更改。

:::note
如果某种数据类型的值转换为较小的数据类型（例如从 `Int64` 转换为 `Int32`）或在不兼容的数据类型之间转换（例如从 `String` 到 `Int`），请注意可能的数据丢失。确保仔细检查结果是否符合预期。
:::
...
将输入值转换为 [`Bool`](../data-types/boolean.md) 类型的值。出错时会抛出异常。
...
将输入值转换为 [`Int8`](../data-types/int-uint.md) 类型的值。出错时会抛出异常。
...
不支持的参数：
- Float32/64 值的字符串表示，包含 `NaN` 和 `Inf`。
- 二进制和十六进制值的字符串表示，例如 `SELECT toInt8('0xc0fe');`。

:::note
如果输入值无法在 [Int8](../data-types/int-uint.md) 的范围内表示，则结果会发生溢出或下溢。这不被认为是错误。
...
与 [`toInt8`](#toint8) 相似，该函数将输入值转换为 [Int8](../data-types/int-uint.md) 类型的值，但在出错时返回 `0`。
...
与 [`toInt8`](#toint8) 相似，该函数将输入值转换为 [Int8](../data-types/int-uint.md) 类型的值，但在出错时返回 `NULL`。
...
与 [`toInt8`](#toint8) 相似，该函数将输入值转换为 [Int8](../data-types/int-uint.md) 类型的值，但在出错时返回默认值。
如果没有传递 `default` 值，则在出错时返回 `0`。
...
- `default` （可选） — 如果解析为 `Int8` 失败，则返回的默认值。 [Int8](../data-types/int-uint.md)。
...
- 如果成功，则返回 8 位整数值，否则返回提供的默认值（如果提供）或 `0`（如果未提供）。 [Int8](../data-types/int-uint.md)。
...
将输入值转换为 [`Int16`](../data-types/int-uint.md) 类型的值。出错时会抛出异常。
...
:::note
如果输入值无法在 [Int16](../data-types/int-uint.md) 的范围内表示，则结果会发生溢出或下溢。这不被认为是错误。
...
与 [`toInt16`](#toint16) 相似，该函数将输入值转换为 [Int16](../data-types/int-uint.md) 类型的值，但在出错时返回 `0`。
...
与 [`toInt16`](#toint16) 相似，该函数将输入值转换为 [Int16](../data-types/int-uint.md) 类型的值，但在出错时返回 `NULL`。
...
与 [`toInt16`](#toint16) 相似，该函数将输入值转换为 [Int16](../data-types/int-uint.md) 类型的值，但在出错时返回默认值。
如果没有传递 `default` 值，则在出错时返回 `0`。
...
- `expr` — 返回数字或数字字符串表示的表达式。 [表达式](/sql-reference/syntax#expressions) / [字符串](../data-types/string.md)。
- `default` （可选） — 如果解析为 `Int16` 失败，则返回的默认值。 [Int16](../data-types/int-uint.md)。
...
- 如果成功，则返回 16 位整数值，否则返回提供的默认值（如果提供）或 `0`（如果未提供）。 [Int16](../data-types/int-uint.md)。
...
将输入值转换为 [`Int32`](../data-types/int-uint.md) 类型的值。出错时会抛出异常。
...
:::note
如果输入值无法在 [Int32](../data-types/int-uint.md) 的范围内表示，则结果会发生溢出或下溢。这不被认为是错误。
...
与 [`toInt32`](#toint32) 相似，该函数将输入值转换为 [Int32](../data-types/int-uint.md) 类型的值，但在出错时返回 `0`。
...
与 [`toInt32`](#toint32) 相似，该函数将输入值转换为 [Int32](../data-types/int-uint.md) 类型的值，但在出错时返回 `NULL`。
...
与 [`toInt32`](#toint32) 相似，该函数将输入值转换为 [Int32](../data-types/int-uint.md) 类型的值，但在出错时返回默认值。
如果没有传递 `default` 值，则在出错时返回 `0`。
...
- `expr` — 返回数字或数字字符串表示的表达式。 [表达式](/sql-reference/syntax#expressions) / [字符串](../data-types/string.md)。
- `default` （可选） — 如果解析为 `Int32` 失败，则返回的默认值。 [Int32](../data-types/int-uint.md)。
...
- 如果成功，则返回 32 位整数值，否则返回提供的默认值（如果提供）或 `0`（如果未提供）。 [Int32](../data-types/int-uint.md)。
...
:::note
如果输入值无法在 [Int64](../data-types/int-uint.md) 的范围内表示，则结果会发生溢出或下溢。这不被认为是错误。
...
与 [`toInt64`](#toint64) 相似，该函数将输入值转换为 [Int64](../data-types/int-uint.md) 类型的值，但在出错时返回 `0`。
...
与 [`toInt64`](#toint64) 相似，该函数将输入值转换为 [Int64](../data-types/int-uint.md) 类型的值，但在出错时返回 `NULL`。
...
与 [`toInt64`](#toint64) 相似，该函数将输入值转换为 [Int64](../data-types/int-uint.md) 类型的值，但在出错时返回默认值。
如果没有传递 `default` 值，则在出错时返回 `0`。
...
- `expr` — 返回数字或数字字符串表示的表达式。 [表达式](/sql-reference/syntax#expressions) / [字符串](../data-types/string.md)。
- `default` （可选） — 如果解析为 `Int64` 失败，则返回的默认值。 [Int64](../data-types/int-uint.md)。
...
- 如果成功，则返回 64 位整数值，否则返回提供的默认值（如果提供）或 `0`（如果未提供）。 [Int64](../data-types/int-uint.md)。
...
将输入值转换为 [`Int128`](../data-types/int-uint.md) 类型的值。出错时会抛出异常。
...
:::note
如果输入值无法在 [Int128](../data-types/int-uint.md) 的范围内表示，则结果会发生溢出或下溢。这不被认为是错误。
:::
...
与 [`toInt128`](#toint128) 相似，该函数将输入值转换为 [Int128](../data-types/int-uint.md) 类型的值，但在出错时返回 `0`。
...
与 [`toInt128`](#toint128) 相似，该函数将输入值转换为 [Int128](../data-types/int-uint.md) 类型的值，但在出错时返回 `NULL`。
...
将输入值转换为[`Int256`](../data-types/int-uint.md)类型的值。发生错误时会抛出异常。
...
支持的参数：
- (U)Int8/16/32/64/128/256类型的值或字符串表示。
- Float32/64类型的值。

不支持的参数：
- Float32/64值的字符串表示，包括`NaN`和`Inf`。
- 二进制和十六进制值的字符串表示，例如`SELECT toInt256('0xc0fe');`。

:::note
如果输入值不能在[Int256](../data-types/int-uint.md)的范围内表示，则结果会溢出或下溢。
这不被视为错误。
:::

**返回值**

- 256位整数值。 [Int256](../data-types/int-uint.md)。
...
像[`toInt256`](#toint256)一样，该函数将输入值转换为[Int256](../data-types/int-uint.md)类型的值，但在发生错误时返回`0`。
...
- 如果成功，返回256位整数值；否则返回`0`。 [Int256](../data-types/int-uint.md)。
...
像[`toInt256`](#toint256)一样，该函数将输入值转换为[Int256](../data-types/int-uint.md)类型的值，但在发生错误时返回`NULL`。
...
- 如果成功，返回256位整数值；否则返回`NULL`。 [Int256](../data-types/int-uint.md) / [NULL](../data-types/nullable.md)。
...
像[`toInt256`](#toint256)一样，该函数将输入值转换为[Int256](../data-types/int-uint.md)类型的值，但在发生错误时返回默认值。
...
- 如果成功，返回256位整数值；否则返回传递的默认值，如果没有，则返回`0`。 [Int256](../data-types/int-uint.md)。
...
将输入值转换为[`UInt8`](../data-types/int-uint.md)类型的值。发生错误时抛出异常。
...
:::note
如果输入值不能在[UInt8](../data-types/int-uint.md)的范围内表示，则结果会溢出或下溢。
这不被视为错误。
...
- 8位无符号整数值。 [UInt8](../data-types/int-uint.md)。
...
像[`toUInt8`](#touint8)一样，该函数将输入值转换为[UInt8](../data-types/int-uint.md)类型的值，但在发生错误时返回`0`。
...
不支持的参数（返回`0`）：
- 普通Float32/64值的字符串表示，包括`NaN`和`Inf`。
...
- 如果成功，返回8位无符号整数值；否则返回`0`。 [UInt8](../data-types/int-uint.md)。
...
像[`toUInt8`](#touint8)一样，该函数将输入值转换为[UInt8](../data-types/int-uint.md)类型的值，但在发生错误时返回`NULL`。
...
- 如果成功，返回8位无符号整数值；否则返回`NULL`。 [UInt8](../data-types/int-uint.md) / [NULL](../data-types/nullable.md)。
...
像[`toUInt8`](#touint8)一样，该函数将输入值转换为[UInt8](../data-types/int-uint.md)类型的值，但在发生错误时返回默认值。
如果没有传递`default`值，则在发生错误时返回`0`。
...
- 如果成功，返回8位无符号整数值；否则返回传递的默认值，如果没有，则返回`0`。 [UInt8](../data-types/int-uint.md)。
...
将输入值转换为[`UInt16`](../data-types/int-uint.md)类型的值。发生错误时抛出异常。
...
:::note
如果输入值不能在[UInt16](../data-types/int-uint.md)的范围内表示，则结果会溢出或下溢。
这不被视为错误。
...
- 16位无符号整数值。 [UInt16](../data-types/int-uint.md)。
...
像[`toUInt16`](#touint16)一样，该函数将输入值转换为[UInt16](../data-types/int-uint.md)类型的值，但在发生错误时返回`0`。
...
- 如果成功，返回16位无符号整数值；否则返回`0`。 [UInt16](../data-types/int-uint.md)。
...
像[`toUInt16`](#touint16)一样，该函数将输入值转换为[UInt16](../data-types/int-uint.md)类型的值，但在发生错误时返回`NULL`。
...
- 如果成功，返回16位无符号整数值；否则返回`NULL`。 [UInt16](../data-types/int-uint.md) / [NULL](../data-types/nullable.md)。
...
像[`toUInt16`](#touint16)一样，该函数将输入值转换为[UInt16](../data-types/int-uint.md)类型的值，但在发生错误时返回默认值。
如果没有传递`default`值，则在发生错误时返回`0`。
...
- 如果成功，返回16位无符号整数值；否则返回传递的默认值，如果没有，则返回`0`。 [UInt16](../data-types/int-uint.md)。
...
将输入值转换为[`UInt32`](../data-types/int-uint.md)类型的值。发生错误时抛出异常。
...
:::note
如果输入值不能在[UInt32](../data-types/int-uint.md)的范围内表示，则结果会溢出或下溢。
这不被视为错误。
...
- 32位无符号整数值。 [UInt32](../data-types/int-uint.md)。
...
像[`toUInt32`](#touint32)一样，该函数将输入值转换为[UInt32](../data-types/int-uint.md)类型的值，但在发生错误时返回`0`。
...
- 如果成功，返回32位无符号整数值；否则返回`0`。 [UInt32](../data-types/int-uint.md)。
...
像[`toUInt32`](#touint32)一样，该函数将输入值转换为[UInt32](../data-types/int-uint.md)类型的值，但在发生错误时返回`NULL`。
...
- 如果成功，返回32位无符号整数值；否则返回`NULL`。 [UInt32](../data-types/int-uint.md) / [NULL](../data-types/nullable.md)。
...
像[`toUInt32`](#touint32)一样，该函数将输入值转换为[UInt32](../data-types/int-uint.md)类型的值，但在发生错误时返回默认值。
如果没有传递`default`值，则在发生错误时返回`0`。
...
- 如果成功，返回32位无符号整数值；否则返回传递的默认值，如果没有，则返回`0`。 [UInt32](../data-types/int-uint.md)。
...
将输入值转换为[`UInt64`](../data-types/int-uint.md)类型的值。发生错误时抛出异常。
...
- 64位无符号整数值。 [UInt64](../data-types/int-uint.md)。
...
像[`toUInt64`](#touint64)一样，该函数将输入值转换为[UInt64](../data-types/int-uint.md)类型的值，但在发生错误时返回`0`。
...
- 如果成功，返回64位无符号整数值；否则返回`0`。 [UInt64](../data-types/int-uint.md)。
...
像[`toUInt64`](#touint64)一样，该函数将输入值转换为[UInt64](../data-types/int-uint.md)类型的值，但在发生错误时返回`NULL`。
...
- 如果成功，返回64位无符号整数值；否则返回`NULL`。 [UInt64](../data-types/int-uint.md) / [NULL](../data-types/nullable.md)。
...
像[`toUInt64`](#touint64)一样，该函数将输入值转换为[UInt64](../data-types/int-uint.md)类型的值，但在发生错误时返回默认值。
如果没有传递`default`值，则在发生错误时返回`0`。
...
- `expr` — 返回数字或数字字符串表示的表达式。 [表达式](/sql-reference/syntax#expressions) / [字符串](../data-types/string.md)。
- `defauult`（可选） — 如果解析为`UInt64`类型失败，则返回的默认值。 [UInt64](../data-types/int-uint.md)。
...
- 如果成功，返回64位无符号整数值；否则返回传递的默认值，如果没有，则返回`0`。 [UInt64](../data-types/int-uint.md)。
...
- 128位无符号整数值。 [UInt128](../data-types/int-uint.md)。
...
- `expr` — 返回一个数字或数字字符串表示的表达式。 [Expression](/sql-reference/syntax#expressions) / [String](../data-types/string.md)。
...
:::note
如果输入值无法表示在 [UInt128](../data-types/int-uint.md) 的范围内，则会发生溢出或下溢。
这不被视为错误。
:::
...
- `x` — 数字字符串表示。 [Expression](/sql-reference/syntax#expressions) / [String](../data-types/string.md)。
...
- 如果成功，则返回 128 位无符号整数值，否则返回传递的默认值（如果传递）或 `0`（如果未传递）。 [UInt128](../data-types/int-uint.md)。
...
- `expr` — 返回一个数字或数字字符串表示的表达式。 [Expression](/sql-reference/syntax#expressions)。
...
:::note
如果输入值无法表示在 [UInt256](../data-types/int-uint.md) 的范围内，则结果发生上溢或下溢。
这不被视为错误。
:::
...
- `x` — 数字字符串表示。 [String](../data-types/string.md)。
...
:::note
如果输入值无法表示在 [UInt256](../data-types/int-uint.md) 的范围内，则发生溢出或下溢。
这不被视为错误。
:::
...
- 如果成功，则返回 256 位无符号整数值，否则返回传递的默认值（如果传递）或 `0`（如果未传递）。 [UInt256](../data-types/int-uint.md)。
...
支持的参数：
- (U)Int8/16/32/64/128/256 的值或字符串表示。
- (U)Int8/16/32/128/256 的 Float32/64 类型的值。
- 包括 `NaN` 和 `Inf` 的 Float32/64 类型的字符串表示。
...
- 如果成功，则返回 32 位浮点值，否则返回传递的默认值（如果传递）或 `0`（如果未传递）。 [Float32](../data-types/float.md)。
...
- 如果成功，则返回 64 位浮点值，否则返回传递的默认值（如果传递）或 `0`（如果未传递）。 [Float64](../data-types/float.md)。
...
如果参数是 [DateTime](../data-types/datetime.md) 或 [DateTime64](../data-types/datetime64.md)，则它会被截断并保留 DateTime 的日期部分：
...
如果参数是 [String](../data-types/string.md)，则解析为 [Date](../data-types/date.md) 或 [DateTime](../data-types/datetime.md)。如果解析为 [DateTime](../data-types/datetime.md)，则使用日期组件：
...
如果参数是数字并且看起来像 UNIX 时间戳（大于 65535），则将其解释为 [DateTime](../data-types/datetime.md)，然后在当前时区截断为 [Date](../data-types/date.md)。时区参数可以作为函数的第二个参数指定。截断为 [Date](../data-types/date.md) 取决于时区：
...
上面的示例演示了在不同的时区中，同一 UNIX 时间戳可以解释为不同的日期。

如果参数是数字并且小于 65536，则将其解释为自 1970-01-01（第一个 UNIX 日）以来的天数，并转换为 [Date](../data-types/date.md)。它对应于 `Date` 数据类型的内部数字表示。示例：
...
如果参数不适合日期类型的范围，则会导致实现定义的行为，可能饱和到最大支持日期或溢出：
```sql
...
与 [toDate](#todate) 相同，但如果收到无效参数，返回 [Date](../data-types/date.md) 的下边界。仅支持 [String](../data-types/string.md) 参数。
...
与 [toDate](#todate) 相同，但如果收到无效参数，则返回 `NULL`。仅支持 [String](../data-types/string.md) 参数。
...
与 [toDate](#todate) 相同，但如果不成功，返回一个默认值，该值是第二个参数（如果指定），否则是 [Date](../data-types/date.md) 的下边界。
...
:::note
如果 `expr` 是数字，则将其解释为自 Unix 纪元开始以来的秒数（作为 Unix 时间戳）。
如果 `expr` 是 [String](../data-types/string.md)，则可以将其解释为 Unix 时间戳或日期的字符串表示/带时间的日期。
因此，短数字字符串表示（最多 4 位）的解析明确禁用以避免歧义，例如字符串 `'1999'` 可能像年份（日期/DateTime 的不完整字符串表示）或 Unix 时间戳。更长的数字字符串是允许的。
:::
...
与 [toDateTime](#todatetime) 相同，但如果收到无效参数，返回 [DateTime](../data-types/datetime.md) 的下边界。仅支持 [String](../data-types/string.md) 参数。
...
与 [toDateTime](#todatetime) 相同，但如果收到无效参数，则返回 `NULL`。仅支持 [String](../data-types/string.md) 参数。
...
与 [toDateTime](#todatetime) 类似，但如果不成功，则返回一个默认值，该值是第三个参数（如果指定），否则是 [DateTime](../data-types/datetime.md) 的下边界。
...
将参数转换为 [Date32](../data-types/date32.md) 数据类型。如果值超出范围，`toDate32` 返回 [Date32](../data-types/date32.md) 所支持的边界值。如果参数具有 [Date](../data-types/date.md) 类型，则会考虑其边界。
...
与 [toDate32](#todate32) 相同，但如果收到无效参数，返回 [Date32](../data-types/date32.md) 的最小值。
...
与 [toDate32](#todate32) 相同，但如果收到无效参数，则返回 `NULL`。
...
将参数转换为 [Date32](../data-types/date32.md) 数据类型。如果值超出范围，`toDate32OrDefault` 返回 [Date32](../data-types/date32.md) 所支持的下边界值。如果参数具有 [Date](../data-types/date.md) 类型，则会考虑其边界。如果收到无效参数，则返回默认值。
...
- `scale` - 时钟周期大小（精度）：10<sup>-precision</sup> 秒。有效范围：[ 0 : 9 ]。
- `timezone`（可选） - 指定的 datetime64 对象的时区。

**返回值**

- 日历日期和时间，具有亚秒精度。 [DateTime64](../data-types/datetime64.md)。
...
与 [toDateTime64](#todatetime64) 类似，此函数将输入值转换为 [DateTime64](../data-types/datetime64.md) 类型的值，但如果收到无效参数，返回 [DateTime64](../data-types/datetime64.md) 的最小值。
...
- 日历日期和时间，具有亚秒精度，否则返回 `DateTime64` 的最小值：`1970-01-01 01:00:00.000`。 [DateTime64](../data-types/datetime64.md)。
...
类似于 [toDateTime64](#todatetime64)，此函数将输入值转换为 [DateTime64](../data-types/datetime64.md) 类型的值，但如果接收到无效的参数，则返回 `NULL`。
...
- 带有亚秒精度的日历日期和时间，否则为 `NULL`。 [DateTime64](../data-types/datetime64.md)/[NULL](../data-types/nullable.md)。
...
类似于 [toDateTime64](#todatetime64)，此函数将输入值转换为 [DateTime64](../data-types/datetime64.md) 类型的值，但如果接收到无效参数，则返回 [DateTime64](../data-types/datetime64.md) 的默认值或提供的默认值。
...
- `scale` - Tick 大小（精度）：10<sup>-precision</sup> 秒。有效范围：[ 0 : 9 ]。
- `timezone`（可选） - 指定 DateTime64 对象的时区。
- `default`（可选） - 如果接收到无效参数，则返回的默认值。 [DateTime64](../data-types/datetime64.md)。

**返回值**

- 带有亚秒精度的日历日期和时间，否则返回 `DateTime64` 的最小值或提供的 `default` 值（如果已提供）。 [DateTime64](../data-types/datetime64.md)。
...
将输入值转换为类型为 [`Decimal(9, S)`](../data-types/decimal.md) 的值，精度为 `S`。如果出现错误，将抛出异常。
...
- `expr` — 返回数字或其字符串表示的表达式。 [Expression](/sql-reference/syntax#expressions)。
- `S` — 区间参数，介于 0 和 9 之间，指定数字的小数部分可以包含多少位数。 [UInt8](../data-types/int-uint.md)。
...
不支持的参数：
- Float32/64 值 `NaN` 和 `Inf`（不区分大小写）的字符串表示。
...
:::warning
在处理 Float32/Float64 输入时，转换会丢失多余的位数，并可能以意想不到的方式工作，因为操作使用浮点指令执行。
例如：`toDecimal32(1.15, 2)` 等价于 `1.14`，因为 1.15 * 100 在浮点数下为 114.99。
您可以使用字符串输入，以便操作使用基础整数类型：`toDecimal32('1.15', 2) = 1.15`。
:::
...
类似于 [`toDecimal32`](#todecimal32)，此函数将输入值转换为类型为 [Decimal(9, S)](../data-types/decimal.md) 的值，但在出现错误时返回 `0`。
...
- 如果成功，则返回类型为 `Decimal(9, S)` 的值，否则为 `0`，并有 `S` 位小数。 [Decimal32(S)](../data-types/decimal.md)。
...
类似于 [`toDecimal32`](#todecimal32)，此函数将输入值转换为类型为 [Nullable(Decimal(9, S))](../data-types/decimal.md) 的值，但在发生错误时返回 `0`。
...
类似于 [`toDecimal32`](#todecimal32)，此函数将输入值转换为类型为 [Decimal(9, S)](../data-types/decimal.md) 的值，但在发生错误时返回默认值。
...
- `expr` — 数字的字符串表示。 [String](../data-types/string.md)。
- `S` — 区间参数，介于 0 和 9 之间，指定数字的小数部分可以包含多少位数。 [UInt8](../data-types/int-uint.md)。
- `default`（可选） — 如果解析为 `Decimal32(S)` 失败，则返回的默认值。 [Decimal32(S)](../data-types/decimal.md)。
...
:::warning
在处理 Float32/Float64 输入时，转换会丢失多余的位数，并可能以意想不到的方式工作，因为操作使用浮点指令执行。
例如：`toDecimal32OrDefault(1.15, 2)` 等价于 `1.14`，因为 1.15 * 100 在浮点数下为 114.99。
您可以使用字符串输入，以便操作使用基础整数类型：`toDecimal32OrDefault('1.15', 2) = 1.15`。
:::

**返回值**

- 如果成功，则返回类型为 `Decimal(9, S)` 的值，否则返回默认值（如果已传入）或 `0`（如果未传入）。 [Decimal32(S)](../data-types/decimal.md)。
...
将输入值转换为类型为 [`Decimal(18, S)`](../data-types/decimal.md) 的值，精度为 `S`。如果出现错误，将抛出异常。
...
- `expr` — 返回数字或其字符串表示的表达式。 [Expression](/sql-reference/syntax#expressions)。
- `S` — 区间参数，介于 0 和 18 之间，指定数字的小数部分可以包含多少位数。 [UInt8](../data-types/int-uint.md)。
...
不支持的参数：
- Float32/64 值 `NaN` 和 `Inf` 的字符串表示（不区分大小写）。
...
:::warning
在处理 Float32/Float64 输入时，转换会丢失多余的位数，并可能以意想不到的方式工作，因为操作使用浮点指令执行。
例如：`toDecimal64(1.15, 2)` 等价于 `1.14`，因为 1.15 * 100 在浮点数下为 114.99。
您可以使用字符串输入，以便操作使用基础整数类型：`toDecimal64('1.15', 2) = 1.15`。
:::
...
类似于 [`toDecimal64`](#todecimal64)，此函数将输入值转换为类型为 [Decimal(18, S)](../data-types/decimal.md) 的值，但在出现错误时返回 `0`。
...
- 如果成功，则返回类型为 `Decimal(18, S)` 的值，否则为 `0`，并有 `S` 位小数。 [Decimal64(S)](../data-types/decimal.md)。
...
类似于 [`toDecimal64`](#todecimal64)，此函数将输入值转换为类型为 [Nullable(Decimal(18, S))](../data-types/decimal.md) 的值，但在发生错误时返回 `0`。
...
类似于 [`toDecimal64`](#todecimal64)，此函数将输入值转换为类型为 [Decimal(18, S)](../data-types/decimal.md) 的值，但在发生错误时返回默认值。
...
- `expr` — 数字的字符串表示。 [String](../data-types/string.md)。
- `S` — 区间参数，介于 0 和 18 之间，指定数字的小数部分可以包含多少位数。 [UInt8](../data-types/int-uint.md)。
- `default`（可选） — 如果解析为 `Decimal64(S)` 失败，则返回的默认值。 [Decimal64(S)](../data-types/decimal.md)。
...
:::warning
在处理 Float32/Float64 输入时，转换会丢失多余的位数，并可能以意想不到的方式工作，因为操作使用浮点指令执行。
例如：`toDecimal64OrDefault(1.15, 2)` 等价于 `1.14`，因为 1.15 * 100 在浮点数下为 114.99。
您可以使用字符串输入，以便操作使用基础整数类型：`toDecimal64OrDefault('1.15', 2) = 1.15`。
:::

**返回值**

- 如果成功，则返回类型为 `Decimal(18, S)` 的值，否则返回默认值（如果已传入）或 `0`（如果未传入）。 [Decimal64(S)](../data-types/decimal.md)。
...
将输入值转换为类型为 [`Decimal(38, S)`](../data-types/decimal.md) 的值，精度为 `S`。如果出现错误，将抛出异常。
...
- `expr` — 返回数字或其字符串表示的表达式。 [Expression](/sql-reference/syntax#expressions)。
- `S` — 区间参数，介于 0 和 38 之间，指定数字的小数部分可以包含多少位数。 [UInt8](../data-types/int-uint.md)。
...
:::warning
在处理 Float32/Float64 输入时，转换会丢失多余的位数，并可能以意想不到的方式工作，因为操作使用浮点指令执行。
例如：`toDecimal128(1.15, 2)` 等价于 `1.14`，因为 1.15 * 100 在浮点数下为 114.99。
您可以使用字符串输入，以便操作使用基础整数类型：`toDecimal128('1.15', 2) = 1.15`。
:::
...
类似于 [`toDecimal128`](#todecimal128)，此函数将输入值转换为类型为 [Decimal(38, S)](../data-types/decimal.md) 的值，但在出现错误时返回 `0`。
...
- 如果成功，则返回类型为 `Decimal(38, S)` 的值，否则为 `0`，并有 `S` 位小数。 [Decimal128(S)](../data-types/decimal.md)。
...
类似于 [`toDecimal128`](#todecimal128)，此函数将输入值转换为类型为 [Nullable(Decimal(38, S))](../data-types/decimal.md) 的值，但在出现错误时返回 `0`。
...
类似于 [`toDecimal128`](#todecimal128)，此函数将输入值转换为类型为 [Decimal(38, S)](../data-types/decimal.md) 的值，但在出现错误时返回默认值。
...
- `expr` — 数字的字符串表示。 [String](../data-types/string.md)。
- `S` — 区间参数，介于 0 和 38 之间，指定数字的小数部分可以包含多少位数。 [UInt8](../data-types/int-uint.md)。
- `default`（可选） — 如果解析为 `Decimal128(S)` 失败，则返回的默认值。 [Decimal128(S)](../data-types/decimal.md)。
...
:::warning
在处理 Float32/Float64 输入时，转换会丢失多余的位数，并可能以意想不到的方式工作，因为操作使用浮点指令执行。
例如：`toDecimal128OrDefault(1.15, 2)` 等价于 `1.14`，因为 1.15 * 100 在浮点数下为 114.99。
您可以使用字符串输入，以便操作使用基础整数类型：`toDecimal128OrDefault('1.15', 2) = 1.15`。
:::

**返回值**

- 如果成功，则返回类型为 `Decimal(38, S)` 的值，否则返回默认值（如果已传入）或 `0`（如果未传入）。 [Decimal128(S)](../data-types/decimal.md)。
...
将输入值转换为类型为 [`Decimal(76, S)`](../data-types/decimal.md) 的值，精度为 `S`。如果出现错误，将抛出异常。
...
- `expr` — 返回数字或其字符串表示的表达式。 [Expression](/sql-reference/syntax#expressions)。
- `S` — 区间参数，介于 0 和 76 之间，指定数字的小数部分可以包含多少位数。 [UInt8](../data-types/int-uint.md)。
...
:::warning
在处理 Float32/Float64 输入时，转换会丢失多余的位数，并可能以意想不到的方式工作，因为操作使用浮点指令执行。
例如：`toDecimal256(1.15, 2)` 等价于 `1.14`，因为 1.15 * 100 在浮点数下为 114.99。
您可以使用字符串输入，以便操作使用基础整数类型：`toDecimal256('1.15', 2) = 1.15`。
:::
...
类似于 [`toDecimal256`](#todecimal256)，此函数将输入值转换为类型为 [Decimal(76, S)](../data-types/decimal.md) 的值，但在出现错误时返回 `0`。
...
- 如果成功，则返回类型为 `Decimal(76, S)` 的值，否则为 `0`，并有 `S` 位小数。 [Decimal256(S)](../data-types/decimal.md)。
...
类似于 [`toDecimal256`](#todecimal256)，此函数将输入值转换为类型为 [Nullable(Decimal(76, S))](../data-types/decimal.md) 的值，但在发生错误时返回 `0`。
...
用于在数字、字符串（但不是固定字符串）、日期和带时间的日期之间转换的函数。
所有这些函数接受一个参数。

在将值转换为字符串或从字符串转换时，该值使用与 TabSeparated 格式（以及几乎所有其他文本格式）相同的规则进行格式化或解析。如果字符串无法解析，将抛出异常并取消请求。

将日期转换为数字或反之时，日期对应于自 Unix 纪元开始以来的天数。
将带时间的日期转换为数字或反之时，带时间的日期对应于自 Unix 纪元开始以来的秒数。
...
作为例外，如果从 UInt32、Int32、UInt64 或 Int64 数值类型转换为 Date，并且数字大于或等于 65536，则该数字被解释为 Unix 时间戳（而不是天数），并四舍五入到日期。这使得支持常见的写法 `toDate(unix_timestamp)` 成为可能，否则将会出错，需要编写更繁琐的 `toDate(toDateTime(unix_timestamp))`。

日期与带时间的日期之间的转换是以自然的方式进行的：通过添加一个空时间或丢弃时间。

数值类型之间的转换遵循与 C++ 中不同数值类型之间赋值的相同规则。

此外，DateTime 参数的 toString 函数可以接受第二个字符串参数，该参数包含时区的名称。例如：`Asia/Yekaterinburg`。在这种情况下，时间根据指定的时区进行格式化。
...
将 [String](../data-types/string.md) 类型参数转换为 [FixedString(N)](../data-types/fixedstring.md) 类型（长度为 N 的固定字符串）。
如果字符串的字节少于 N，则用 null 字节在右侧填充。如果字符串的字节超过 N，则抛出异常。
...
接受一个字符串或固定字符串参数。返回内容在第一个零字节处截断的字符串。
...
- `scale` — 分数位数， [UInt8](../data-types/int-uint.md)。
    * 对于 [Decimal](../data-types/decimal.md) 和 [Int, UInt](../data-types/int-uint.md) 类型，最大尺度为 77（这是 Decimal 可表示的最大有效数字数量），
    * 对于 [Float](../data-types/float.md)，最大尺度为 60。

**返回值**

- 输入值按给定分数位数（尺度）表示为 [String](../data-types/string.md)。
    如果请求的尺度小于原始数字的尺度，数字将根据常见算术向上或向下舍入。
...
通过将输入值视为 UInt8 类型的值来执行字节重解释。与 [`CAST`](#cast) 不同，该函数不尝试保持原始值 - 如果目标类型无法表示输入类型，输出则无意义。
...
- `x`: 要重新解释为 UInt8 的值。 [(U)Int*](../data-types/int-uint.md)、[Float](../data-types/float.md)、[Date](../data-types/date.md)、[DateTime](../data-types/datetime.md)、[UUID](../data-types/uuid.md)、[String](../data-types/string.md) 或 [FixedString](../data-types/fixedstring.md)。

**返回值**

- 重新解释的值 `x` 作为 UInt8。 [UInt8](/sql-reference/data-types/int-uint).
...
通过将输入值视为 UInt16 类型的值来执行字节重解释。与 [`CAST`](#cast) 不同，该函数不尝试保持原始值 - 如果目标类型无法表示输入类型，输出则无意义。
...
- `x`: 要重新解释为 UInt16 的值。 [(U)Int*](../data-types/int-uint.md)、[Float](../data-types/float.md)、[Date](../data-types/date.md)、[DateTime](../data-types/datetime.md)、[UUID](../data-types/uuid.md)、[String](../data-types/string.md) 或 [FixedString](../data-types/fixedstring.md)。

**返回值**

- 重新解释的值 `x` 作为 UInt16。 [UInt16](/sql-reference/data-types/int-uint).
...
通过将输入值视为 UInt32 类型的值来执行字节重解释。与 [`CAST`](#cast) 不同，该函数不尝试保持原始值 - 如果目标类型无法表示输入类型，输出则无意义。
...
- `x`: 要重新解释为 UInt32 的值。 [(U)Int*](../data-types/int-uint.md)、[Float](../data-types/float.md)、[Date](../data-types/date.md)、[DateTime](../data-types/datetime.md)、[UUID](../data-types/uuid.md)、[String](../data-types/string.md) 或 [FixedString](../data-types/fixedstring.md)。

**返回值**

- 重新解释的值 `x` 作为 UInt32。 [UInt32](/sql-reference/data-types/int-uint).
...
通过将输入值视为 UInt64 类型的值来执行字节重解释。与 [`CAST`](#cast) 不同，该函数不尝试保持原始值 - 如果目标类型无法表示输入类型，输出则无意义。
...
- `x`: 要重新解释为 UInt64 的值。 [(U)Int*](../data-types/int-uint.md)、[Float](../data-types/float.md)、[Date](../data-types/date.md)、[DateTime](../data-types/datetime.md)、[UUID](../data-types/uuid.md)、[String](../data-types/string.md) 或 [FixedString](../data-types/fixedstring.md)。

**返回值**

- 重新解释的值 `x` 作为 UInt64。 [UInt64](/sql-reference/data-types/int-uint).
...
通过将输入值视为 UInt128 类型的值来执行字节重解释。与 [`CAST`](#cast) 不同，该函数不尝试保持原始值 - 如果目标类型无法表示输入类型，输出则无意义。
...
- `x`: 要重新解释为 UInt128 的值。 [(U)Int*](../data-types/int-uint.md)、[Float](../data-types/float.md)、[Date](../data-types/date.md)、[DateTime](../data-types/datetime.md)、[UUID](../data-types/uuid.md)、[String](../data-types/string.md) 或 [FixedString](../data-types/fixedstring.md)。

**返回值**

- 重新解释的值 `x` 作为 UInt128。 [UInt128](/sql-reference/data-types/int-uint).
...
通过将输入值视为 UInt256 类型的值来执行字节重解释。与 [`CAST`](#cast) 不同，该函数不尝试保持原始值 - 如果目标类型无法表示输入类型，输出则无意义。
...
- `x`: 要重新解释为 UInt256 的值。 [(U)Int*](../data-types/int-uint.md)、[Float](../data-types/float.md)、[Date](../data-types/date.md)、[DateTime](../data-types/datetime.md)、[UUID](../data-types/uuid.md)、[String](../data-types/string.md) 或 [FixedString](../data-types/fixedstring.md)。

**返回值**

- 重新解释的值 `x` 作为 UInt256。 [UInt256](/sql-reference/data-types/int-uint).
...
通过将输入值视为 Int8 类型的值来执行字节重解释。与 [`CAST`](#cast) 不同，该函数不尝试保持原始值 - 如果目标类型无法表示输入类型，输出则无意义。
...
- `x`: 要重新解释为 Int8 的值。 [(U)Int*](../data-types/int-uint.md)、[Float](../data-types/float.md)、[Date](../data-types/date.md)、[DateTime](../data-types/datetime.md)、[UUID](../data-types/uuid.md)、[String](../data-types/string.md) 或 [FixedString](../data-types/fixedstring.md)。

**返回值**

- 重新解释的值 `x` 作为 Int8。 [Int8](/sql-reference/data-types/int-uint#integer-ranges).
...
通过将输入值视为 Int16 类型的值来执行字节重解释。与 [`CAST`](#cast) 不同，该函数不尝试保持原始值 - 如果目标类型无法表示输入类型，输出则无意义。
...
- `x`: 要重新解释为 Int16 的值。 [(U)Int*](../data-types/int-uint.md)、[Float](../data-types/float.md)、[Date](../data-types/date.md)、[DateTime](../data-types/datetime.md)、[UUID](../data-types/uuid.md)、[String](../data-types/string.md) 或 [FixedString](../data-types/fixedstring.md)。

**返回值**

- 重新解释的值 `x` 作为 Int16。 [Int16](/sql-reference/data-types/int-uint#integer-ranges).
...
通过将输入值视为 Int32 类型的值来执行字节重解释。与 [`CAST`](#cast) 不同，该函数不尝试保持原始值 - 如果目标类型无法表示输入类型，输出则无意义。
...
- `x`: 要重新解释为 Int32 的值。 [(U)Int*](../data-types/int-uint.md)、[Float](../data-types/float.md)、[Date](../data-types/date.md)、[DateTime](../data-types/datetime.md)、[UUID](../data-types/uuid.md)、[String](../data-types/string.md) 或 [FixedString](../data-types/fixedstring.md)。

**返回值**

- 重新解释的值 `x` 作为 Int32。 [Int32](/sql-reference/data-types/int-uint#integer-ranges).
...
通过将输入值视为 Int64 类型的值来执行字节重解释。与 [`CAST`](#cast) 不同，该函数不尝试保持原始值 - 如果目标类型无法表示输入类型，输出则无意义。
...
- `x`: 要重新解释为 Int64 的值。 [(U)Int*](../data-types/int-uint.md)、[Float](../data-types/float.md)、[Date](../data-types/date.md)、[DateTime](../data-types/datetime.md)、[UUID](../data-types/uuid.md)、[String](../data-types/string.md) 或 [FixedString](../data-types/fixedstring.md)。

**返回值**

- 重新解释的值 `x` 作为 Int64。 [Int64](/sql-reference/data-types/int-uint#integer-ranges).
...
通过将输入值视为 Int128 类型的值来执行字节重解释。与 [`CAST`](#cast) 不同，该函数不尝试保持原始值 - 如果目标类型无法表示输入类型，输出则无意义。
...
- `x`: 要重新解释为 Int128 的值。 [(U)Int*](../data-types/int-uint.md)、[Float](../data-types/float.md)、[Date](../data-types/date.md)、[DateTime](../data-types/datetime.md)、[UUID](../data-types/uuid.md)、[String](../data-types/string.md) 或 [FixedString](../data-types/fixedstring.md)。

**返回值**

- 重新解释的值 `x` 作为 Int128。 [Int128](/sql-reference/data-types/int-uint#integer-ranges).
...
通过将输入值视为 Int256 类型的值来执行字节重解释。与 [`CAST`](#cast) 不同，该函数不尝试保持原始值 - 如果目标类型无法表示输入类型，输出则无意义。
...
- `x`: 要重新解释为 Int256 的值。 [(U)Int*](../data-types/int-uint.md)、[Float](../data-types/float.md)、[Date](../data-types/date.md)、[DateTime](../data-types/datetime.md)、[UUID](../data-types/uuid.md)、[String](../data-types/string.md) 或 [FixedString](../data-types/fixedstring.md)。

**返回值**

- 重新解释的值 `x` 作为 Int256。 [Int256](/sql-reference/data-types/int-uint#integer-ranges).
...
通过将输入值视为 Float32 类型的值来执行字节重解释。与 [`CAST`](#cast) 不同，该函数不尝试保持原始值 - 如果目标类型无法表示输入类型，输出则无意义。
...
- 重新解释的值 `x` 作为 Float32。 [Float32](../data-types/float.md).
...
通过将输入值视为 Float64 类型的值来执行字节重解释。与 [`CAST`](#cast) 不同，该函数不尝试保持原始值 - 如果目标类型无法表示输入类型，输出则无意义。
...
- 重新解释的值 `x` 作为 Float64。 [Float64](../data-types/float.md).
...
接受字符串、固定字符串或数值，并将字节解释为主机顺序（小端）的数字。它返回从解释的数字中获得的日期，作为自 Unix 纪元开始的天数。
...
:::note
如果提供的字符串长度不足，该函数将像字符串用所需数量的 null 字节填充一样工作。如果字符串比所需的长，则额外的字节将被忽略。
:::
...
这些函数接受字符串并将放置在字符串开头的字节解释为主机顺序（小端）中的数字。返回时间和日期的解释，作为自 Unix 纪元开始的秒数。
...
该函数接受数字、日期或带时间的日期，并返回包含代表主机顺序（小端）中的对应值的字节的字符串。结尾的 null 字节被丢弃。例如， UInt32 类型值 255 是一个长度为一个字节的字符串。
...
该函数接受数字、日期或带时间的日期，并返回包含表示主机顺序（小端）中的对应值的字节的 FixedString。结尾的 null 字节被丢弃。例如， UInt32 类型值 255 是一个长度为一个字节的 FixedString。
...
接受一个 16 字节的字符串，并通过解释每个 8 字节的半部分为小端字节顺序返回一个 UUID。如果字符串长度不足，该函数将像字符串用所需数量的 null 字节填充一样工作。如果字符串长度超过 16 字节，则末尾的额外字节将被忽略。
...
- UUID 类型值。 [UUID](/sql-reference/data-types/uuid).
...
将输入值转换为指定的数据类型。与 [reinterpret](#reinterpret) 函数不同，`CAST` 尝试使用新的数据类型呈现相同的值。如果转换无法完成，则会引发异常。
支持几种语法变体。
...
:::note
如果输入值超出目标类型的边界，则结果会溢出。例如，`CAST(-1, 'UInt8')` 返回 `255`。
:::
...
类型转换为 [Nullable](../data-types/nullable.md) 及其返回同样被支持。
...
与 [cast](#cast) 的区别在于 `accurateCast` 不允许在类型 `T` 的边界内转换时发生数值类型溢出。例如，`accurateCast(-1, 'UInt8')` 会抛出异常。
...
将输入值 `x` 转换为指定的数据类型 `T`。如果转换值无法在目标类型中表示，则返回默认值或指定的 `default_value`。
...
从数值和间隔单位（例如 'second' 或 'day'）创建一个 [Interval](../../sql-reference/data-types/special-data-types/interval.md) 数据类型的值。
...
- `value` — 间隔的长度。整数或其字符串表示，以及浮点数。 [(U)Int*](../data-types/int-uint.md)/[Float*](../data-types/float.md)/[String](../data-types/string.md)。
...
返回 `n` 年的间隔，数据类型为 [IntervalYear](../data-types/special-data-types/interval.md)。
...
返回 `n` 季度的间隔，数据类型为 [IntervalQuarter](../data-types/special-data-types/interval.md)。
...
返回 `n` 个月的间隔，数据类型为 [IntervalMonth](../data-types/special-data-types/interval.md)。
...
返回 `n` 周的间隔，数据类型为 [IntervalWeek](../data-types/special-data-types/interval.md)。
...
返回 `n` 天的间隔，数据类型为 [IntervalDay](../data-types/special-data-types/interval.md)。
...
返回 `n` 小时的间隔，数据类型为 [IntervalHour](../data-types/special-data-types/interval.md)。
...
返回 `n` 分钟的间隔，数据类型为 [IntervalMinute](../data-types/special-data-types/interval.md)。
...
返回 `n` 秒的间隔，数据类型为 [IntervalSecond](../data-types/special-data-types/interval.md)。
...
返回 `n` 毫秒的间隔，数据类型为 [IntervalMillisecond](../data-types/special-data-types/interval.md)。
...
- `n` — 纳秒的数量。可以是整数或其字符串表示，或浮点数。[(U)Int*](../data-types/int-uint.md)/[Float*](../data-types/float.md)/[String](../data-types/string.md)。
...
根据[MySQL格式字符串](https://dev.mysql.com/doc/refman/8.0/en/date-and-time-functions.html#function_date-format)将[String](../data-types/string.md)转换为[DateTime](../data-types/datetime.md)。
...
返回根据MySQL风格格式字符串解析的[String](../data-types/string.md)值。
...
与[parseDateTime](#parsedatetime)类似，不同之处在于格式字符串采用[Joda](https://joda-time.sourceforge.net/apidocs/org/joda/time/format/DateTimeFormat.html)而不是MySQL语法。
...
返回根据Joda风格格式字符串解析的[DateTime](../data-types/datetime.md)值。

**支持的格式说明符**

支持在[formatDateTimeInJoda](/sql-reference/functions/date-time-functions#formatdatetime)中列出的所有格式说明符，除了：
- S: 秒的分数
- z: 时区
- Z: 时区偏移/标识
...
根据[MySQL格式字符串](https://dev.mysql.com/doc/refman/8.0/en/date-and-time-functions.html#function_date-format)将[String](../data-types/string.md)转换为[DateTime64](../data-types/datetime64.md)。
...
返回根据MySQL风格格式字符串解析的[DateTime64](../data-types/datetime64.md)值。
返回值的精度为6。
...
根据[Joda格式字符串](https://joda-time.sourceforge.net/apidocs/org/joda/time/format/DateTimeFormat.html)将[String](../data-types/string.md)转换为[DateTime64](../data-types/datetime64.md)。
...
返回根据Joda风格格式字符串解析的[DateTime64](../data-types/datetime64.md)值。
返回值的精度等于格式字符串中`S`占位符的数量（最多为6）。
...
该函数解析[ISO 8601](https://en.wikipedia.org/wiki/ISO_8601)、[RFC 1123 - 5.2.14 RFC-822 日期和时间规范](https://tools.ietf.org/html/rfc1123#page-55)、ClickHouse及其他一些日期和时间格式。
...
- `time_string` — 包含日期和时间的字符串。 [String](../data-types/string.md)。
- `time_zone` — 时区。该函数根据时区解析`time_string`。 [String](../data-types/string.md)。

**支持的非标准格式**

- 9到10位数字字符串的[unix时间戳](https://en.wikipedia.org/wiki/Unix_time)。
...
- 包含日期和时间的字符串：`DD`，`DD hh`，`DD hh:mm`。在这种情况下，`MM`被替换为`01`。
- 包含日期，时间及时区偏移信息的字符串：`YYYY-MM-DD hh:mm:ss ±h:mm`等。例如，`2020-12-12 17:36:00 -5:00`。
- [syslog时间戳](https://datatracker.ietf.org/doc/html/rfc3164#section-4.1.2)：`Mmm dd hh:mm:ss`。例如，`Jun  9 14:20:32`。

对于所有带分隔符的格式，该函数解析完整名称或前面三个字母表示的月份名称。例如：`24/DEC/18`，`24-Dec-18`，`01-September-2018`。
如果年份未指定，则默认等于当前年份。如果结果的DateTime恰好在未来（即使只在当前时刻之后的一秒内），则将当前年份替换为上一年。
...
- [toDate](#todate)
- [toDateTime](#todatetime)
- [ISO 8601公告由 @xkcd](https://xkcd.com/1179/)
- [RFC 3164](https://datatracker.ietf.org/doc/html/rfc3164#section-4.1.2)

## parseDateTimeBestEffortUS {#parsedatetimebesteffortus}

该函数在处理ISO日期格式时表现得像[parseDateTimeBestEffort](#parsedatetimebesteffort)，例如`YYYY-MM-DD hh:mm:ss`，以及其他可以明确提取月份和日期组件的日期格式，例如`YYYYMMDDhhmmss`，`YYYY-MM`，`DD hh`或`YYYY-MM-DD hh:mm:ss ±h:mm`。如果月份和日期组件无法明确提取，例如`MM/DD/YYYY`，`MM-DD-YYYY`或`MM-DD-YY`，则优先考虑美国日期格式，而不是`DD/MM/YYYY`，`DD-MM-YYYY`或`DD-MM-YY`。作为例外，如果月份大于12且小于或等于31，则此函数将回退到[parseDateTimeBestEffort](#parsedatetimebesteffort)的行为，例如`15/08/2020`被解析为`2020-08-15`。
...
与[parseDateTimeBestEffort](#parsedatetimebesteffort)函数相同，但也解析毫秒和微秒并返回[DateTime](/sql-reference/data-types/datetime)数据类型。
...
- `time_zone` — [Timezone](/operations/server-configuration-parameters/settings.md#timezone)。该函数根据时区解析`time_string`。可选。 [String](../data-types/string.md)。
...
与[parseDateTime64BestEffort](#parsedatetime64besteffort)相同，但在模糊情况下该函数优先考虑美国日期格式（`MM/DD/YYYY`等）。
...
与[parseDateTime64BestEffort](#parsedatetime64besteffort)相同，但在模糊情况下该函数优先考虑美国日期格式（`MM/DD/YYYY`等），并在遇到无法处理的日期格式时返回`NULL`。

## parseDateTime64BestEffortUSOrZero {#parsedatetime64besteffortusorzero}

与[parseDateTime64BestEffort](#parsedatetime64besteffort)相同，但在模糊情况下该函数优先考虑美国日期格式（`MM/DD/YYYY`等），并在遇到无法处理的日期格式时返回零日期或零日期时间。
...
将`DateTime64`转换为具有固定秒精度的`Int64`值。输入值根据其精度适当地缩放。

:::note
输出值为UTC时间戳，而不是`DateTime64`的时区。
:::
...
- `value` — 具有任意精度的DateTime64值。 [DateTime64](../data-types/datetime64.md)。
...
将`DateTime64`转换为具有固定毫秒精度的`Int64`值。输入值根据其精度适当地缩放。
...
将`DateTime64`转换为具有固定微秒精度的`Int64`值。输入值根据其精度适当地缩放。
...
将`DateTime64`转换为具有固定纳秒精度的`Int64`值。输入值根据其精度适当地缩放。
...
将`Int64`转换为具有固定秒精度的`DateTime64`值，并可选指定时区。输入值根据其精度适当地缩放。
...
- 将`value`转换为精度为`0`的DateTime64。 [DateTime64](../data-types/datetime64.md)。
...
将`Int64`转换为具有固定毫秒精度的`DateTime64`值，并可选指定时区。输入值根据其精度适当地缩放。
...
- 将`value`转换为精度为`3`的DateTime64。 [DateTime64](../data-types/datetime64.md)。
...
将`Int64`转换为具有固定微秒精度的`DateTime64`值，并可选指定时区。输入值根据其精度适当地缩放。
...
- 将`value`转换为精度为`6`的DateTime64。 [DateTime64](../data-types/datetime64.md)。
...
将`Int64`转换为具有固定纳秒精度的`DateTime64`值，并可选指定时区。输入值根据其精度适当地缩放。
...
- 将`value`转换为精度为`9`的DateTime64。 [DateTime64](../data-types/datetime64.md)。
...
通过给定格式将任意表达式转换为字符串。与formatRow的不同之处在于，当有换行符时该函数将去掉最后的`\n`。
