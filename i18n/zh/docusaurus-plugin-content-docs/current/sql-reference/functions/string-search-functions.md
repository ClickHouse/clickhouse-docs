...
使用 [splitByNonAlpha](/sql-reference/functions/splitting-merging-functions.md/#splitByNonAlpha) 作为分词器，其中 token 定义为由连续字符 `[0-9A-Za-z_]` 构成的最长可能子序列，即数字、ASCII 字母和下划线。
