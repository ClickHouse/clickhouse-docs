...
用于在字符串中[搜索](string-search-functions.md)和[替换](string-replace-functions.md)的函数另有单独说明。
...
{/* 
  下面标签内的内容会在构建文档框架时被替换为
  由 system.functions 生成的文档。请不要修改或删除这些标签。
  详情请参阅：https://github.com/ClickHouse/clickhouse-docs/blob/main/contribute/autogenerated-documentation-from-source.md
  */ }
