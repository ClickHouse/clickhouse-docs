---
description: '为 Amazon S3 中的 Apache Hudi 表提供类似表的只读接口。'
sidebar_label: 'hudi'
sidebar_position: 85
...
| `extra_credentials`                          | 可选参数。用于传递 `role_arn`，以在 ClickHouse Cloud 中进行基于角色的访问。有关配置步骤，请参见 [Secure S3](/cloud/data-sources/secure-s3)。                                                                                                               |
