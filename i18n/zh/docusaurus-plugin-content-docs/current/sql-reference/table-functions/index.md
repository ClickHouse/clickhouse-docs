...
| [mergeTreeIndex](/sql-reference/table-functions/mergeTreeIndex)                        | 表示 MergeTree 表中索引文件和 marks 文件的内容。可用于内部信息查看。                                                                             |
| [mergeTreeProjection](/sql-reference/table-functions/mergeTreeProjection)              | 表示 MergeTree 表中某个 PROJECTION 的内容。可用于内部信息查看。                                                                             |
| [mergeTreeTextIndex](/sql-reference/table-functions/mergeTreeTextIndex)                | 表示 MergeTree 表中文本索引的字典。可用于内部信息查看。                                                                                       |
...
| [hudiCluster Table Function](/sql-reference/table-functions/hudiCluster)               | `hudi` 表函数的扩展。允许在指定集群的多个节点上并行处理存储在 Amazon S3 中的 Apache Hudi 表的文件。                                                       |
