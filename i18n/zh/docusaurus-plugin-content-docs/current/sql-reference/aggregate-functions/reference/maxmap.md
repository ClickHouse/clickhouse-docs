...
* 对于每一行参与汇总的数据，`key` 和 `value` 中的元素数量必须相同。
  :::
...
* 返回一个由两个数组组成的元组：按排序顺序排列的键，以及为对应键计算得到的值。[Tuple](../../data-types/tuple.md)([Array](../../data-types/array.md), [Array](../../data-types/array.md))。
