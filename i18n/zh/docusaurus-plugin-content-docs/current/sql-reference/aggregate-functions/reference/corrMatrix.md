...
* `x1[, x2, ...]` — 一个或多个参与相关矩阵计算的参数。[`(U)Int8/16/32/64`](/sql-reference/data-types/int-uint) 或 [`Float*`](/sql-reference/data-types/float)

**返回值**

返回相关矩阵。[`Array(Array(Float64))`](/sql-reference/data-types/array)
