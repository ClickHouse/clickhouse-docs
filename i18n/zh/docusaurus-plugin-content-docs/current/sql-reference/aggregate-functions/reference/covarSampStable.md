...
计算 `Σ((x - x̅)(y - y̅)) / (n - 1)` 的值。与 [covarSamp](../reference/covarSamp.md) 类似，但计算速度较慢，不过能提供更低的计算误差。
...
* `x` — 第一个变量，类型为 [(U)Int*](../../data-types/int-uint.md)、[Float*](../../data-types/float.md)、[Decimal](../../data-types/decimal.md)。
* `y` — 第二个变量，类型为 [(U)Int*](../../data-types/int-uint.md)、[Float*](../../data-types/float.md)、[Decimal](../../data-types/decimal.md)。
