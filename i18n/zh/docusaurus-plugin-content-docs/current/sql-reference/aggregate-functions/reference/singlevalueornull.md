...
* `x` — 任意[数据类型](../../data-types/index.md)的列（但不包括 [Map](../../data-types/map.md)、[Array](../../data-types/array.md) 或 [Tuple](../../data-types/tuple)，这些类型不能为 [Nullable](../../data-types/nullable.md)）。
