...
* `timeunit` — 时间单位。[Integer](../../../sql-reference/data-types/int-uint.md)、[Float](../../../sql-reference/data-types/float.md)、[Decimal](../../../sql-reference/data-types/decimal.md)、[DateTime](../../data-types/datetime.md) 或 [DateTime64](../../data-types/datetime64.md)。
...
* 返回在 `t` 和 `t-1` 处的指数平滑加权移动平均值中的最大值。[Float64](../../data-types/float.md)。
