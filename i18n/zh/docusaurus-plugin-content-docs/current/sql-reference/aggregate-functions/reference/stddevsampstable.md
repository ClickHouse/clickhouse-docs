---
'description': '结果等于varSamp的平方根。与此函数不同的是，它使用了一个数值稳定的算法。'
...
结果等于 [varSamp](../../../sql-reference/aggregate-functions/reference/varsamp.md) 的平方根。与 [`stddevSamp`](../reference/stddevsamp.md) 不同，此函数使用数值稳定的算法。它运行较慢但提供更低的计算误差。
