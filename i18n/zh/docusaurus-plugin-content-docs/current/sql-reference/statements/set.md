...
`timezone` 值必须是 [IANA Time Zone Database](https://www.iana.org/time-zones) 中的有效名称。无效的时区名称将导致错误。

有关 `session_timezone` 设置的更多信息，请参阅 [session_timezone](/operations/settings/settings#session_timezone)。
