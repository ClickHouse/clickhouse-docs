...
* 添加一个 Docker 镜像，用于为我们的代码库生成交互式代码浏览器 HTML 报告。 [#8781](https://github.com/ClickHouse/ClickHouse/pull/8781) ([alesapin](https://github.com/alesapin)) 参见 [Woboq Code Browser](https://clickhouse-test-reports.s3.yandex.net/codebrowser/ClickHouse/dbms/index.html)
