...
# 下载 ClickHouse GPG 密钥并将其存储在密钥环中
...
clickhouse-client # 如果已设置密码，则使用 &quot;clickhouse-client --password&quot;。
