---
description: '包含 4 亿张带有英文图像描述的图像数据集'
...
[Laion-400M 数据集](https://laion.ai/blog/laion-400-open-dataset/) 包含 4 亿张带有英文图像描述的图像。Laion 目前还提供了[更大的数据集](https://laion.ai/blog/laion-5b/)，但使用方式与其类似。
...
用于创建索引和执行搜索的参数以及性能方面的注意事项在[文档](../../engines/table-engines/mergetree-family/annindexes.md)中有详细说明。
