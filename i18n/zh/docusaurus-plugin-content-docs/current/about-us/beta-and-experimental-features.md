...
**Beta** 功能由 ClickHouse 团队正式支持。**Experimental** 功能是由 ClickHouse 团队或社区推动的早期原型，并未获得正式支持。

下文各节将明确定义 **Beta** 和 **Experimental** 功能的特性：

## 测试版特性 \{#beta-features\}

- 正在积极开发中，目标是实现全面可用（GA）
- 主要已知问题可以在 GitHub 上进行跟踪
- 功能在未来可能会发生变化
- 可能在 ClickHouse Cloud 中已启用
- ClickHouse 团队为测试版特性提供支持

以下是当前在 ClickHouse Cloud 中被视为测试版、并可在你的 ClickHouse Cloud 服务中使用的特性。

注意：请确保你正在使用当前版本的 ClickHouse [`compatibility`](/operations/settings/settings#compatibility) 设置，以便使用最近引入的特性。
...
请注意：除上述列为 Beta 的特性外，不允许在 ClickHouse Cloud 中启用任何额外的实验性特性。

{/* 下方标签内的内容会在构建时被替换为根据源数据生成的表格
     请不要修改或移除这些标签
  */ }
...
| [启用&#95;物化&#95;CTE](/operations/settings/settings#enable_materialized_cte)                                                                                                                                                          | `0`                     |
| [分析器&#95;内联&#95;视图](/operations/settings/settings#analyzer_inline_views)                                                                                                                                                            | `0`                     |
| [允许&#95;实验性&#95;Kafka&#95;偏移量&#95;存储&#95;在&#95;Keeper&#95;中](/operations/settings/settings#allow_experimental_kafka_offsets_storage_in_keeper)                                                                                      | `0`                     |
| [允许&#95;实验性&#95;Delta&#95;Lake&#95;写入](/operations/settings/settings#allow_experimental_delta_lake_writes)                                                                                                                          | `0`                     |
| [自动&#95;并行&#95;副本&#95;模式](/operations/settings/settings#automatic_parallel_replicas_mode)                                                                                                                                           | `0`                     |
