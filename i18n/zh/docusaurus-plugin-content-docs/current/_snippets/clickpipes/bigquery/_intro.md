...
:::note
你可以在[这里](https://clickhouse.com/cloud/clickpipes/bigquery-connector)注册加入 Private Preview 候补名单。
:::
...
可以通过 ClickPipes UI 手动部署和管理 BigQuery ClickPipes，也可以通过 [OpenAPI](/integrations/clickpipes/programmatic-access/openapi) 和 [Terraform](/integrations/clickpipes/programmatic-access/terraform) 以编程方式进行管理。