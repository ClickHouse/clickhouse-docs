...
打开 **Cloud Storage > Settings > Interoperability**,然后选择现有的 **Access key**,或点击 **CREATE A KEY FOR A SERVICE ACCOUNT**。本指南介绍为新服务账号创建新密钥的操作步骤。
...
创建服务账号需要三个步骤。在第一步中,为账号指定有意义的名称、ID 和描述。
...
在互操作性设置对话框中,建议使用 IAM 角色 **Storage Object Admin**;请在第二步中选择该角色。
