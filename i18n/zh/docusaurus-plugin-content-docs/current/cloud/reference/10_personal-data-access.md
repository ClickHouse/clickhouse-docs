...
根据您所在的地区,适用法律可能赋予您针对 ClickHouse 所持有的个人数据的额外权利(数据主体权利),具体说明请参见 ClickHouse 隐私政策。行使数据主体权利的流程称为数据主体访问请求 (DSAR)。
...
以下是 ClickHouse 在账户设置和服务使用期间收集的数据摘要,以及可在 ClickHouse 控制台中查看特定个人数据的位置信息。
