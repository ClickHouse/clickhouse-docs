...
<VerticalStepper headerLevel="h3">
  ...
  此时设置尚未完成，您的 ClickHouse Cloud 组织也尚未通过 Marketplace 计费。您现在需要在 Marketplace 订阅页面中点击 **Set up your account**，跳转到 ClickHouse Cloud 完成最终设置。
...
如果您遇到任何问题，请联系[我们的支持团队](https://clickhouse.com/support/program)。