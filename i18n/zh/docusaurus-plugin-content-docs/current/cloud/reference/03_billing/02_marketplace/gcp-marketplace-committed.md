...
通过在 [GCP Marketplace](https://console.cloud.google.com/marketplace) 订立承诺合约来开始使用 ClickHouse Cloud。承诺合约（也称为 Private Offer）允许客户在一段时间内承诺在 ClickHouse Cloud 上花费一定金额。
...
2. 点击电子邮件中的 **Review Offer** 链接。这将带您进入包含专属优惠详情的 GCP Marketplace 页面。
...
如果您是新的 ClickHouse Cloud 用户,请点击页面底部的 **Register**。系统将提示您创建新用户并验证电子邮件。验证电子邮件后,您可以离开 ClickHouse Cloud 登录页面,并使用新用户名在 [https://console.clickhouse.cloud](https://console.clickhouse.cloud) 登录。
