...
description: '通过 AWS Marketplace 以承诺合同订阅 ClickHouse Cloud'
...
通过在 [AWS Marketplace](https://aws.amazon.com/marketplace) 上签订承诺合约，即可开始使用 ClickHouse Cloud。
承诺合约（也称为 Private Offer）允许客户在一定期限内预先承诺在 ClickHouse Cloud 上支出约定金额。


## 前提条件 {#prerequisites}

- 基于特定合同条款的 ClickHouse Private Offer。
- 要将 ClickHouse 组织连接到您的承诺消费优惠,您必须是该组织的管理员。
