...
# 将计费方式从按需付费 (PAYG) 迁移至云市场承诺消费合同 {#migrate-payg-to-committed}

如果您的 ClickHouse 组织当前通过有效的云市场按需付费 (PAYG) 订阅(或订单)进行计费,且您希望迁移至通过同一云市场的承诺消费合同进行计费,请先接受新的报价,然后根据您的云服务提供商执行以下步骤。
...
在您的云市场订阅被取消后,如果您的 ClickHouse 组织已登记信用卡,我们将在计费周期结束时向该卡收费,除非事先关联了新的云市场订阅。
...
订阅取消后产生的任何使用量将按以下优先顺序向下一个已配置的有效付款方式收费:预付费余额、云市场订阅或信用卡。
...
5. **取消订阅:**
   - 在"Agreement"下,点击 ClickHouse Cloud 列表旁的"Actions"下拉菜单或按钮
...
接下来,请按照这些[步骤](/cloud/billing/marketplace/gcp-marketplace-committed-contract)将您的 ClickHouse 组织配置到新的 GCP 承诺消费合同。
