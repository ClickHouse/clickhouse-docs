...
本节介绍 Marketplace 的计费相关主题。

| Page                                                                                                                | Description                                                                                                                                                                                                                                    |
|---------------------------------------------------------------------------------------------------------------------|------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| [Marketplace Billing](/cloud/marketplace/marketplace-billing)                                               | 有关 Marketplace 计费的常见问题解答。                                                                                                                                                                                                          |
| [AWS Marketplace PAYG](/cloud/billing/marketplace/aws-marketplace-payg)                                     | 通过 AWS Marketplace 上的 PAYG（按使用量付费）公共方案开始使用 ClickHouse Cloud。                                                                                                                                                              |
...
| [GCP Marketplace PAYG](/cloud/billing/marketplace/gcp-marketplace-payg)                                     | 通过 GCP Marketplace 上的 PAYG（按使用量付费）公共方案开始使用 ClickHouse Cloud。                                                                                                                                                              |
...
| [Azure Marketplace PAYG](/cloud/billing/marketplace/azure-marketplace-payg)                                 | 通过 Azure Marketplace 上的 PAYG（按使用量付费）公共方案开始使用 ClickHouse Cloud。                                                                                                                                                            |
