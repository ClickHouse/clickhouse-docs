...
对于 Enterprise 等级中的服务，所有发布通道均支持计划升级。该功能允许您在一周内选定某一天并配置一个时间窗口用于执行升级。
...
- 已配置升级时间窗的服务会在通道开始推送后，于其预定时间窗内进行升级
...
<ReleaseSchedule releases={[
   {
     ...
     slow_progress: 'green',
     fast_delay_note: '已配置升级时间窗的服务将在 1 月 12 日所在周的预定时间窗内接收 25.10 版本',
   },
   {
    ...
    regular_progress: 'green',
    slow_progress: 'green',
    regular_delay_note: '已配置升级时间窗的服务将从 1 月 13 日起开始升级。',
  }
]} />