...
title: '资源导览'
description: 'ClickHouse Cloud 文档资源概览，涵盖查询优化、扩缩容策略、监控及最佳实践'
...
| [Prometheus 集成](/integrations/prometheus)          | 使用 Prometheus 监控 Cloud 服务  |
| [Cloud 监控功能](/use-cases/observability/cloud-monitoring) | 概览内置监控功能以及可用的集成选项    |
