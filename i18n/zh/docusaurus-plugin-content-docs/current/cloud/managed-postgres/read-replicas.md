...
要管理读取副本，单击 warehouse 上的编辑图标：

<Image img={warehouseView} alt="带有编辑图标的 warehouse 视图" size="md" border />

这会打开 warehouse 对话框，你可以在其中查看现有服务并创建新的读取副本：

<Image img={readReplicaDialog} alt="读取副本管理对话框" size="md" border />
