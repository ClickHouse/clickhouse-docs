...
其中: - `testchbackups` 是要导出备份的 S3 存储桶名称。 - `backups` 是可选的子目录。
...
更多详细信息请参阅:[配置 BACKUP/RESTORE 使用 S3 端点](/operations/backup#configuring-backuprestore-to-use-an-s3-endpoint)。
