...
title: 'BYOC 安全作战手册'
description: '本页面展示客户可用于识别潜在安全事件的方法'
doc_type: 'guide'
...
ClickHouse 基于安全责任共担模型运营 Bring Your Own Cloud (BYOC) 服务,该模型可从我们的信任中心 https://trust.clickhouse.com 下载。以下信息为 BYOC 客户提供了识别潜在安全事件的示例。客户应结合自身安全计划考虑这些信息,以确定是否需要配置额外的检测和告警机制。
