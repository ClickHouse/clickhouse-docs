...
title: "PCI 入门"
description: "了解如何开始使用符合 PCI 标准的服务"
doc_type: "guide"
keywords:
  ["pci", "合规", "支付安全", "数据保护", "安全"]
---
...
本页面介绍了在 ClickHouse Cloud 中启用部署符合 PCI 标准的服务的流程。
...
强烈建议客户在必要时将服务部署到合规环境。将服务从标准区域迁移到 PCI 合规区域的过程需要从备份进行恢复,可能会导致一定的停机时间。
