...
使用 ClickHouse 遇到问题?请在此处查找常见问题的解决方案。


## 性能和错误 {#performance-and-errors}

查询运行缓慢、超时或收到特定错误消息,例如"Memory limit exceeded"或"Connection refused"。
...
- [运行诊断查询以找出瓶颈](/docs/knowledgebase/useful-queries-for-troubleshooting)
  <br />
...
- **"Network timeouts"** → [网络故障排除](/docs/interfaces/http)
...
内存使用率过高、内存不足导致崩溃，或需要帮助确定 ClickHouse 部署的规模。
