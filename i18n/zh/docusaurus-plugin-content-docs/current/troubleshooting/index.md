...
- [查找资源占用最多的查询](/knowledgebase/find-expensive-queries)
- [查询优化完整指南](/docs/optimize/query-optimization)
- [优化 JOIN 操作](/docs/best-practices/minimize-optimize-joins)
- [运行诊断查询定位性能瓶颈](/docs/knowledgebase/useful-queries-for-troubleshooting)
  <br />
...
- [查看当前运行的进程](/docs/knowledgebase/which-processes-are-currently-running)
...
初始安装、服务器配置、数据库创建、数据导入问题或复制配置。

<details>
<summary><strong>显示安装与配置解决方案</strong></summary>

### 初始安装 {#initial-setup}

- [配置服务器参数](/docs/operations/server-configuration-parameters/settings)
- [配置安全性与访问控制](/docs/operations/access-rights)
...
1. **询问 AI** - <KapaLink>询问 AI</KapaLink> 获取即时答案。
