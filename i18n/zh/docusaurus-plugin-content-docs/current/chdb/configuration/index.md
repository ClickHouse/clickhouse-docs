...
| **Compat** | `compat_mode` | "pandas", "performance" | "pandas" | Pandas 兼容性与 SQL 优先吞吐量之间的取舍 |
...
有关详细信息，请参阅 [性能模式](performance-mode.md)。
...
- [Performance Mode](performance-mode.md) - 以实现最大吞吐量的 SQL 优先模式
