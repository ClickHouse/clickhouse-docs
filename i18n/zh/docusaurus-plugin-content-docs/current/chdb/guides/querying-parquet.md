...
当今世界上有大量数据存储在 Amazon S3 存储桶中。
在本指南中，我们将学习如何使用 chDB 来查询这些数据。
...
接下来,让我们查询文件的内容。
我们可以通过调整上述查询来实现这一点,移除 `ParquetMetadata`,然后计算所有评论中最常见的 `star_rating`:
...
看起来人们喜欢亚马逊上的产品,或者如果他们不喜欢,就干脆不提交评分。
