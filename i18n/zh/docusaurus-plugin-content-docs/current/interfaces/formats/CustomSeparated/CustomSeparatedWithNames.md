---
alias: []
description: 'CustomSeparatedWithNames 格式文档'
input_format: true
...
同时会输出包含列名的表头行，类似于 [TabSeparatedWithNames](../TabSeparated/TabSeparatedWithNames.md)。
...
:::note
如果将 [`input_format_with_names_use_header`](../../../operations/settings/settings-formats.md/#input_format_with_names_use_header) 设为 `1`，
则会根据名称将输入数据中的列映射到表中的列；
如果将 [`input_format_skip_unknown_fields`](../../../operations/settings/settings-formats.md/#input_format_skip_unknown_fields) 设为 `1`，则会跳过名称未知的列。
否则，将跳过第一行。
:::