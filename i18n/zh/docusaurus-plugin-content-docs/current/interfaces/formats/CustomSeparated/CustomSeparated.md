...
类似于 [Template](../Template/Template.md)，但是它打印或读取所有列的名称和类型，并使用来自 [format_custom_escaping_rule](../../../operations/settings/settings-formats.md/#format_custom_escaping_rule) 设置的转义规则和以下设置中的分隔符：
...
| 设置                                                                                                                                                        | 描述                                                                                                                       | 默认值 |
|----------------------------------------------------------------------------------------------------------------------------------------------------------------|----------------------------------------------------------------------------------------------------------------------------|---------|
| [input_format_custom_detect_header](../../../operations/settings/settings-formats.md/#input_format_custom_detect_header)                                       | 如果存在，则启用自动检测包含名称和类型的表头。                                                                         | `true`  |
...
| [input_format_custom_allow_variable_number_of_columns](../../../operations/settings/settings-formats.md/#input_format_custom_allow_variable_number_of_columns) | 允许在 CustomSeparated 格式中使用可变数量的列，忽略多余的列并对缺失的列使用默认值。                                     | `false` |
