...
<VerticalStepper headerLevel="h4">
  #### `Connect your app` を選択する \{#select-connect-your-app\}
  ...
  #### MySQL インターフェイスを有効化する \{#enable-mysql-interface\}
...
### ClickHouse Cloud で複数の MySQL ユーザーに関するトラブルシューティング \{#troubleshooting-multiple-mysql-users-in-clickhouse-cloud\}
