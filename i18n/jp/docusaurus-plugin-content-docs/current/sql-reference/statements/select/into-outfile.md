...
* この機能は [command-line client](../../../interfaces/client.md) と [clickhouse-local](../../../operations/utilities/clickhouse-local.md) で利用できます。したがって、[HTTP interface](/interfaces/http) 経由で送信されたクエリはエラーになります。
