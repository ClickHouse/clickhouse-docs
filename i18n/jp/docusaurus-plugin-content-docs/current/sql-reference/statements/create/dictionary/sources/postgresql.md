...
| `invalidate_query`     | Dictionary の状態を確認するためのクエリ。省略可能です。詳しくは [LIFETIME を使用した Dictionary データの更新](../lifetime.md#refreshing-dictionary-data-using-lifetime) セクションを参照してください。 |
