...
[XXH3](https://github.com/Cyan4973/xxHash) 128 ビットのハッシュ値を計算します。
...
計算された 128 ビットの `xxh3` ハッシュ値を返します。型は [`UInt128`](/sql-reference/data-types/int-uint) です。
