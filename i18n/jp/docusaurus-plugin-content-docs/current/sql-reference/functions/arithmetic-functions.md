...
3. 結果をビッグエンディアンとして整数に戻す。例: CD FB C7 C7 -&gt; 3455829959
   この関数の代表的なユースケースの 1 つは、IPv4 アドレスのバイト順を反転させることです。
...
`x` のバイト順序を反転した値を返します。[`(U)Int*`](/sql-reference/data-types/int-uint)
...
* `x` — 第1引数の値: [Decimal](/sql-reference/data-types/decimal). - `y` — 第2引数の値: [Decimal](/sql-reference/data-types/decimal). - `result_scale` — 結果のスケール。型 [Int/UInt](/sql-reference/data-types/int-uint).
...
[三項演算子](/sql-reference/functions/conditional-functions#if) を使用して、同様の結果を得ることができます: `isFinite(x) ? x : y`。
...
* `x` — 無限大かどうかを判定する値。[`Float*`](/sql-reference/data-types/float)
...
* `a` — 左辺オペランド。[`(U)Int*`](/sql-reference/data-types/int-uint)
* `b` — 右辺オペランド。[`(U)Int*`](/sql-reference/data-types/int-uint)
...
`x` と `y` のうち、より大きい値を返します。[`Float64`](/sql-reference/data-types/float)
...
* `x` — 1 番目の値。型は [`(U)Int8/16/32/64`](/sql-reference/data-types/int-uint) または [`Float*`](/sql-reference/data-types/float) または [`Decimal`](/sql-reference/data-types/decimal)
* `y` — 2 番目の値。型は [`(U)Int8/16/32/64`](/sql-reference/data-types/int-uint) または [`Float*`](/sql-reference/data-types/float) または [`Decimal`](/sql-reference/data-types/decimal)

**返り値**

`x` と `y` のうち小さい方の値を返します。型は [`Float64`](/sql-reference/data-types/float) です。
...
* `x` — 係数。[`(U)Int*`](/sql-reference/data-types/int-uint) または [`Float*`](/sql-reference/data-types/float) または [`Decimal`](/sql-reference/data-types/decimal)
* `y` — 係数。[`(U)Int*`](/sql-reference/data-types/int-uint) または [`Float*`](/sql-reference/data-types/float) または [`Decimal`](/sql-reference/data-types/decimal)
...
精度を厳密に制御する必要がない、あるいは高速な計算が必要な場合は、[multiply](#multiply) の使用を検討してください。
:::
...
* `a` — 1 番目の値。[`Decimal`](/sql-reference/data-types/decimal)
* `b` — 2 番目の値。[`Decimal`](/sql-reference/data-types/decimal)
