...
Returns an array of differences between adjacent array elements. [UInt\*](/data_types/int_uint/#uint-ranges), [Int\*](/data_types/int_uint/#int-ranges), [Float\*](/data_types/float/).
...
- Returns an array of the partial sums of the elements in the source array. [UInt\*](/data_types/int_uint/#uint-ranges), [Int\*](/data_types/int_uint/#int-ranges), [Float\*](/data_types/float/).
...
- Returns an array of non-negative partial sums of elements in the source array. [UInt\*](/data_types/int_uint/#uint-ranges), [Int\*](/data_types/int_uint/#int-ranges), [Float\*](/data_types/float/).
