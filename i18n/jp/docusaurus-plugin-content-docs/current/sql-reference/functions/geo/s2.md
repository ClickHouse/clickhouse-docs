...
* `s2Rect1PointLow`, `s2Rect1PointHi` — 第1の長方形に対応する S2 ポイントインデックスの下限値および上限値。[UInt64](../../data-types/int-uint.md)。
* `s2Rect2PointLow`, `s2Rect2PointHi` — 第2の長方形に対応する S2 ポイントインデックスの下限値および上限値。[UInt64](../../data-types/int-uint.md)。
