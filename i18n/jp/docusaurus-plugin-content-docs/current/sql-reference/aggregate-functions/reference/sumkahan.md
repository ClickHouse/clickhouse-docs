---
description: 'Kahan 補償和アルゴリズムで数値の合計を計算します'
...
* 数値の合計であり、その型は [Integer](../../../sql-reference/data-types/int-uint.md)、[Float](../../../sql-reference/data-types/float.md)、または [Decimal](../../../sql-reference/data-types/decimal.md) となり、入力引数の型に依存します。
