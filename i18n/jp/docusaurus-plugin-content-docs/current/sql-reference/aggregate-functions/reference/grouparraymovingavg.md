...
この関数はウィンドウサイズをパラメータとして受け取ることができます。指定されていない場合、関数は列内の行数と同じウィンドウサイズを使用します。
...
この関数は[ゼロ方向への丸め](https://en.wikipedia.org/wiki/Rounding#Rounding_towards_zero)を使用します。結果のデータ型で表現されない小数部分を切り捨てます。
