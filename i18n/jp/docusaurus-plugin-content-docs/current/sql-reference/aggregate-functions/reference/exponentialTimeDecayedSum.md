...
* `x` — 値の重みが 1/e に減衰するまでに必要な時間差。[Integer](../../../sql-reference/data-types/int-uint.md)、[Float](../../../sql-reference/data-types/float.md) または [Decimal](../../../sql-reference/data-types/decimal.md)。

**返される値**

* 指定した時点における指数平滑移動平均値の合計を返します。[Float64](../../data-types/float.md)。
