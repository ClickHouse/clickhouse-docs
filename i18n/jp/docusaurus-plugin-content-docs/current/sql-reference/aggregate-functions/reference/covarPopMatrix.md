---
description: 'N 個の変数から母共分散行列を返します。'
...
* `x1[, x2, ...]` — 可変個の引数。[`(U)Int*`](/sql-reference/data-types/int-uint)、[`Float*`](/sql-reference/data-types/float)、または [`Decimal`](/sql-reference/data-types/decimal)

**戻り値**

母集団共分散行列を返します。[`Array(Array(Float64))`](/sql-reference/data-types/array)
