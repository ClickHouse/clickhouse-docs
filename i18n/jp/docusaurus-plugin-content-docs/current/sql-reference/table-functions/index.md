...
| [filesystem](/sql-reference/table-functions/filesystem)                                | ファイルシステムにアクセスし、ファイルの一覧表示、メタデータ、および内容を返します。                                                                                                                                                                |
...
| [timeSeriesSamples](/sql-reference/table-functions/timeSeriesSamples)                  | timeSeriesSamples は、テーブルエンジンが TimeSeries であるテーブル `db_name.time_series_table` が使用するサンプルテーブルを返します。                                                                                                          |
