...
description: '高速性を重視して設計されているからです。クエリ実行性能は開発プロセス全体を通じて常に最優先事項でしたが、ClickHouse を真のプロダクションシステムにするために、使いやすさ、スケーラビリティ、セキュリティといった他の重要な特性も考慮されました。'
title: 'なぜ ClickHouse はこれほど高速なのか？'
slug: /concepts/why-clickhouse-is-so-fast
keywords: ['アーキテクチャ', 'VLDB', '性能']
...
アーキテクチャの観点から見ると、データベースは少なくともストレージ層とクエリ処理レイヤーで構成されます。ストレージ層はテーブルデータの保存・読み込み・管理を担い、クエリ処理レイヤーはユーザーのクエリを実行します。ClickHouse は他のデータベースと比べて、この両方のレイヤーにおいて革新的な仕組みを備えており、非常に高速な挿入処理と SELECT クエリを実現しています。

## ストレージ層：同時に行われる INSERT は互いに独立している \{#storage-layer-concurrent-inserts-are-isolated-from-each-other\}

<iframe width="1024" height="576" src="https://www.youtube.com/embed/vsykFYns0Ws?si=hE2qnOf6cDKn-otP" title="YouTube 動画プレーヤー" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen />
...
<iframe width="1024" height="576" src="https://www.youtube.com/embed/dvGlPh2bJFo?si=F3MSALPpe0gAoq5k" title="YouTube 動画プレーヤー" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen />
...
<iframe width="1024" height="576" src="https://www.youtube.com/embed/_w3zQg695c0?si=g0Wa_Petn-LcmC-6" title="YouTube 動画プレーヤー" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen />
...
<iframe width="1024" height="576" src="https://www.youtube.com/embed/O5qecdQ7Y18?si=XVtOIuVd8NLbqyox" title="YouTube 動画プレーヤー" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen />
...
<iframe width="1024" height="576" src="https://www.youtube.com/embed/dccGLSuYWy0?si=rQ-Jp-z5Ik_-Rb8S" title="YouTube 動画プレーヤー" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen />
...
2024年8月、私たちの最初の研究論文が VLDB で採択・掲載されました。
VLDB は、超大規模データベースに関する国際会議であり、データマネジメント分野における主要な会議の1つとして広く認識されています。
何百件にも及ぶ投稿論文の中から選ばれ、VLDB の採択率はおおよそ 20% 程度です。

論文の [PDF](https://www.vldb.org/pvldb/vol17/p3731-schulze.pdf) や、その [Web 版](/docs/academic_overview) をお読みいただけます。Web 版では、ClickHouse が非常に高速である理由となっている、最も興味深いアーキテクチャおよびシステム設計コンポーネントについて簡潔に説明しています。

ClickHouse の創設者であり CTO である Alexey Milovidov がこの論文を発表しました (スライドは [こちら](https://raw.githubusercontent.com/ClickHouse/clickhouse-presentations/master/2024-vldb/VLDB_2024_presentation.pdf)) 。続いて行われた Q&amp;A は、あっという間に時間切れとなってしまいました。
発表の録画は次から視聴できます。
