...
* コードベース向けのインタラクティブなコードブラウザ HTML レポートを生成できる Docker イメージを追加。 [#8781](https://github.com/ClickHouse/ClickHouse/pull/8781) ([alesapin](https://github.com/alesapin)) [Woboq Code Browser](https://clickhouse-test-reports.s3.yandex.net/codebrowser/ClickHouse/dbms/index.html) を参照。
