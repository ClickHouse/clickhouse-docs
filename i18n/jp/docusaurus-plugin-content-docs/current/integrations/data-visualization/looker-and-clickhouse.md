...
description: 'Looker は、BI、データアプリケーション、埋め込み分析向けのエンタープライズプラットフォームで、リアルタイムでのインサイトの探索と共有を可能にします。'
title: 'Looker'
doc_type: 'guide'
integration:
...
Looker は公式の ClickHouse データソースを使用して、ClickHouse Cloud 環境やオンプレミス環境にデプロイされた ClickHouse に接続できます。
