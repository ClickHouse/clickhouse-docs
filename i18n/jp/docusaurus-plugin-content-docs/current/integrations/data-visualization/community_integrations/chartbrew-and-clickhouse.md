...
[Chartbrew](https://chartbrew.com) は、ユーザーがダッシュボードを作成し、データをリアルタイムで監視できるデータの可視化プラットフォームです。ClickHouse を含む複数のデータソースをサポートし、チャートやレポートをノーコードで構築できるインターフェースを提供します。
...
3. ClickHouseデータベースの接続詳細を入力します:
   - **Display Name**: Chartbrewで接続を識別するための名前
