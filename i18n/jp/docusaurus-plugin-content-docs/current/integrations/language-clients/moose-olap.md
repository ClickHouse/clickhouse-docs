...
[Moose OLAP](https://docs.fiveonefour.com/moosestack/olap) は [Moose Stack](https://docs.fiveonefour.com/moosestack) の中核モジュールであり、TypeScript と Python でリアルタイム分析バックエンドを構築するためのオープンソースの開発者向けツールキットです。

Moose OLAP は、ClickHouse 向けにネイティブに構築されており、開発者にとって使いやすい抽象化と ORM ライクな機能を提供します。
...
最新かつ最適なインストール手順と Getting Started ガイドについては、[Moose Stack ドキュメント](https://docs.fiveonefour.com/moosestack/getting-started/from-clickhouse)を参照してください。
...
<VerticalStepper headerLevel="h3">
  ...
  #### オプション A: 既存の ClickHouse デプロイメントを使用する
  ...
  **重要**: 本番環境の ClickHouse には一切変更を加えません。これは、ClickHouse テーブルから派生したデータモデルを含む新しい Moose OLAP プロジェクトを初期化するだけです。
  ...
  #### オプション B: ClickHouse Playground を使用する
  ...
  * [Moose API](https://docs.fiveonefour.com/moosestack/apis) を使って REST API を構築する
  * [Moose Workflows](https://docs.fiveonefour.com/moosestack/workflows) や [Moose Streaming](https://docs.fiveonefour.com/moosestack/workflows) を使ってデータを取り込んだり変換したりする
  * [Moose Build](https://docs.fiveonefour.com/moosestack/deploying) と [Moose Migrate](https://docs.fiveonefour.com/moosestack/migrate) を使用して本番環境への移行を検討する
</VerticalStepper>
