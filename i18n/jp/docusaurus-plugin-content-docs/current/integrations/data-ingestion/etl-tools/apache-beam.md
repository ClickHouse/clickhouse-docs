...
description: 'Apache Beam を使用して ClickHouse にデータを取り込めます'
...
この統合では、基盤となるデータ書き込みレイヤーとして、ClickHouse の公式 [JDBC コネクタ](https://github.com/ClickHouse/clickhouse-java) を活用します。
