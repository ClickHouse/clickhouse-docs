...
| [Databricks](/integrations/data-ingestion/apache-spark/databricks) | Apache Spark 上に構築された統合アナリティクスプラットフォームであり、データエンジニアリング、データサイエンス、および機械学習ワークロード向けのコラボレーティブな環境を提供し、ClickHouse と連携します。 |
