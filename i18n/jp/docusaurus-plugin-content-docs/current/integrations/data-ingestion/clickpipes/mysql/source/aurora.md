...
doc_type: 'guide'
keywords: ['aurora mysql', 'clickpipes', 'binlog の保持期間', 'GTID モード', 'aws']
integration:
   - support_level: 'core'
   - category: 'clickpipes'
---
...
このステップバイステップガイドでは、[MySQL ClickPipe](../index.md) を使用して Amazon Aurora MySQL から ClickHouse Cloud へデータをレプリケートするよう設定する方法を説明します。MySQL の CDC (変更データキャプチャ) に関する一般的な質問については、[MySQL よくある質問ページ](/integrations/data-ingestion/clickpipes/mysql/faq.md) を参照してください。
