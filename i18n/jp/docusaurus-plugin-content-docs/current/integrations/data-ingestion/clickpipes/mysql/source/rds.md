...
:::tip
MySQL ClickPipeはGTIDモードなしでのレプリケーションもサポートしています。ただし、パフォーマンスの向上とトラブルシューティングの容易化のため、GTIDモードの有効化を推奨します。
:::
...
<br />
:::tip MySQL ClickPipeはGTIDモードなしでのレプリケーションもサポートしています。ただし、パフォーマンスの向上とトラブルシューティングの容易化のため、GTIDモードの有効化を推奨します。 :::
