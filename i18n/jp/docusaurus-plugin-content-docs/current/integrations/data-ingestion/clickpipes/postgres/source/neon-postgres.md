...
description: 'Neon Postgres インスタンスを ClickPipes のソースとして設定する'
...
これは、ClickPipes でレプリケーションに使用できる Neon Postgres のセットアップ手順を説明するガイドです。
セットアップを開始する前に、[Neon コンソール](https://console.neon.tech/app/projects) にサインインしていることを確認してください。
...
**Run** をクリックして、パブリケーションとユーザーを準備してください。
...
Neon Enterpriseプランをご利用の場合、[ClickPipes IP](../../index.md#list-of-static-ips)をホワイトリストに登録することで、ClickPipesからNeon Postgresインスタンスへのレプリケーションを許可することができます。
