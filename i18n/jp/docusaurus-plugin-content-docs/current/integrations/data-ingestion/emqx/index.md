...
EMQX は強力な [rule engine](https://docs.emqx.com/en/cloud/latest/data_integration/rules.html) を提供しており、サードパーティシステムに送信する前に、生の MQTT メッセージを変換および拡張できます。
