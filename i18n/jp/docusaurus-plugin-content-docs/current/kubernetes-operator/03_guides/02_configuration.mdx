...
title: '設定'
keywords: ['kubernetes']
description: 'このガイドでは、ClickHouse オペレーター を使用して ClickHouse および Keeper クラスターを設定する方法について説明します。'
doc_type: 'guide'
---

このガイドでは、オペレーターを使用して ClickHouse および Keeper クラスターを設定する方法について説明します。'
