...
* `untracked_memory` ([Int64](../../sql-reference/data-types/)) — まだ親の MemoryTracker に反映されていないメモリ割り当て量を表す、スレッドごとのカウンターです。前回の flush 以降、割り当てた量より解放した量のほうが多い場合は、負の値になることがあります。
