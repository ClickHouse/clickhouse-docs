...
[system.columns](../../operations/system-tables/columns.md) system テーブルから読み取られたカラムと、ClickHouse でサポートされていない、または意味をなさないものの、標準上必要であるため含まれているカラム (常に `NULL`) を含みます。
...
[system.databases](../../operations/system-tables/databases.md) system テーブルから読み取られるカラムと、ClickHouse ではサポートされていない、または意味を持たない (常に `NULL`) が、標準上は存在している必要があるカラムを含みます。
...
[system.tables](../../operations/system-tables/tables.md) system テーブルから読み取ったカラムを含みます。
...
テーブルエンジン [View](../../engines/table-engines/special/view.md) が使用されている場合に、[system.tables](../../operations/system-tables/tables.md) system テーブルから読み込まれるカラムが含まれます。
...
制約によって制限されている [system.tables](../../operations/system-tables/tables.md) system テーブル内のカラムを含みます。
