...
&#39;system.zookeeper&#95;connection&#95;log&#39; テーブルは、ZooKeeper への接続履歴 (補助的な ZooKeeper を含む) を示します。各行は、接続に関する 1 件のイベント情報を表します。
...
* `hostname` ([LowCardinality(String)](/sql-reference/data-types/lowcardinality)) — ZooKeeper に接続または切断されたサーバーのホスト名。
* `type` ([Enum8(&#39;Connected&#39; = 0, &#39;Disconnected&#39; = 1)](/sql-reference/data-types/enum)) — イベントの種類。設定可能な値: Connected、Disconnected。
...
* `name` ([String](/sql-reference/data-types/string)) — ZooKeeper クラスター名。
* `host` ([String](/sql-reference/data-types/string)) — ClickHouse が接続または切断した ZooKeeper ノードのホスト名/IP アドレス。
* `port` ([UInt16](/sql-reference/data-types/int-uint)) — ClickHouse が接続または切断した ZooKeeper ノードのポート。
* `index` ([UInt8](/sql-reference/data-types/int-uint)) — ClickHouse が接続または切断した ZooKeeper ノードのインデックス。このインデックスは ZooKeeper の設定に基づきます。
* `client_id` ([Int64](/sql-reference/data-types/int-uint)) — 接続のセッション ID。
* `keeper_api_version` ([UInt8](/sql-reference/data-types/int-uint)) — Keeper API のバージョン。
* `enabled_feature_flags` ([Array(Enum16(&#39;FILTERED&#95;LIST&#39; = 0, &#39;MULTI&#95;READ&#39; = 1, &#39;CHECK&#95;NOT&#95;EXISTS&#39; = 2, &#39;CREATE&#95;IF&#95;NOT&#95;EXISTS&#39; = 3, &#39;REMOVE&#95;RECURSIVE&#39; = 4, &#39;MULTI&#95;WATCHES&#39; = 5, &#39;CHECK&#95;STAT&#39; = 6, &#39;PERSISTENT&#95;WATCHES&#39; = 7, &#39;CREATE&#95;WITH&#95;STATS&#39; = 8, &#39;TRY&#95;REMOVE&#39; = 9, &#39;LIST&#95;WITH&#95;STAT&#95;AND&#95;DATA&#39; = 10, &#39;GET&#95;CHILDREN&#95;RECURSIVE&#39; = 11))](/sql-reference/data-types/array)) — 有効な機能フラグ。ClickHouse Keeper にのみ適用されます。
* `availability_zone` ([String](/sql-reference/data-types/string)) — アベイラビリティゾーン
* `reason` ([LowCardinality(String)](/sql-reference/data-types/lowcardinality)) — 接続または切断の理由。
