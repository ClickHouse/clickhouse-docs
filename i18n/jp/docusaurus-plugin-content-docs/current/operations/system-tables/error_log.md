...
* `last_error_message` ([String](../../sql-reference/data-types/string.md)) — 直前のエラーのメッセージ。
* `last_error_query_id` ([String](../../sql-reference/data-types/string.md)) — 直前のエラーの原因となったクエリの ID (利用可能な場合) 。
