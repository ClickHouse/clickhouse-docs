...
<VersionHistory
  rows={[
  { id: "row-1", items: [{ label: "26.4" }, { label: "0" }, { label: "結合順序の最適化のために、推移的な等値結合述語を推論する新しい設定。" }] },
  { id: "row-2", items: [{ label: "26.4" }, { label: "0" }, { label: "結合順序の最適化のために、推移的な等値結合述語を推論する新しい設定。" }] }
]}
/>
...
<VersionHistory rows={[{"id": "row-1","items": [{"label": "26.4"},{"label": "0"},{"label": "New setting"}]}, {"id": "row-2","items": [{"label": "26.3"},{"label": "0"},{"label": "New setting"}]}]}/>
...
<VersionHistory
  rows={[
  { id: "row-1", items: [{ label: "26.4" }, { label: "0" }, { label: "デフォルトでは INSERT 時の統計情報の構築を無効にし、代わりにマージに依存します" }] },
  { id: "row-2", items: [{ label: "26.4" }, { label: "0" }, { label: "デフォルトでは INSERT 時の統計情報の構築を無効にし、代わりにマージに依存します" }] },
  { id: "row-3", items: [{ label: "24.6" }, { label: "1" }, { label: "INSERT 時の統計情報のマテリアライズを無効にできる新しい設定を追加しました" }] }
]}
/>
