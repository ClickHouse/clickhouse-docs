...
<VersionHistory rows={[{"id": "row-1","items": [{"label": "26.3"},{"label": "1"},{"label": "Statistics が GA（General Availability）になりました。"}]}, {"id": "row-2","items": [{"label": "24.6"},{"label": "0"},{"label": "設定名が変更されました。以前の名前は `allow_experimental_statistic` です。"}]}]}/>
...
<VersionHistory rows={[{"id": "row-1","items": [{"label": "26.3"},{"label": "1"},{"label": "Statistics が GA になりました"}]}]}/>
...
<VersionHistory rows={[{"id": "row-1","items": [{"label": "26.3"},{"label": "0"},{"label": "auto statistics を有効化した後に INSERT 時の統計情報のマテリアライズを無効化"}]}, {"id": "row-2","items": [{"label": "24.6"},{"label": "1"},{"label": "Added new setting to allow to disable materialization of statistics on insert"}]}]}/>
