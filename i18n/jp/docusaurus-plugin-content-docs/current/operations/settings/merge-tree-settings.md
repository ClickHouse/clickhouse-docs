...
<VersionHistory rows={[{"id": "row-1","items": [{"label": "26.3"},{"label": "minmax, uniq"},{"label": "自動統計をデフォルトで有効化"}]}, {"id": "row-2","items": [{"label": "26.2"},{"label": "minmax, uniq"},{"label": "自動統計をデフォルトで有効化"}]}, {"id": "row-3","items": [{"label": "25.10"},{"label": ""},{"label": "New setting"}]}]} />
