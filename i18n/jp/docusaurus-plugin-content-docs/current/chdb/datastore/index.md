...
<div style={{textAlign: 'center'}}>
  <img src="../images/datastore_architecture.png" alt="DataStore アーキテクチャ" style={{maxWidth: '700px', width: '100%'}} />
</div>
...
- [パフォーマンスモード](../configuration/performance-mode.md) - 最大スループットを実現する SQL ファーストのモード
