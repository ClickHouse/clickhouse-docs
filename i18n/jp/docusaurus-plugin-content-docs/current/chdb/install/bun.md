...
chDB-bun は、chDB 向けの実験的な FFI (Foreign Function Interface) バインディングを提供しており、外部依存なしで、Bun アプリケーションから ClickHouse クエリを直接実行できます。
...
### ステップ 2: chDB-bunをインストールする \{#install-chdb-bun\}
