...
chDB は、[ClickHouse](https://github.com/clickhouse/clickhouse) v25.8.2.1 をベースとした高速なインプロセス SQL OLAP エンジンです。
ClickHouse サーバー に接続せずに、プログラミング言語内で ClickHouse の機能を活用したい場合に使用できます。
