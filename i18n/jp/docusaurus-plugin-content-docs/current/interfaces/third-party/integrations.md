---
description: 'ClickHouse をさまざまなサードパーティ製システムやツールと連携させるためのドキュメント'
sidebar_label: '連携'
sidebar_position: 27
...
# サードパーティー開発者による連携ライブラリ

:::warning 免責事項
ClickHouse, Inc. は、以下に記載されているツールおよびライブラリを**保守しておらず**、その品質を確認するための十分なテストも実施していません。
公式な連携については、[インテグレーション ページ](/integrations)を参照してください。
:::
...
- [Graphite](https://graphiteapp.org)
  ...
  - [graphite-ch-optimizer](https://github.com/innogames/graphite-ch-optimizer) - [ロールアップ設定](../../engines/table-engines/mergetree-family/graphitemergetree.md#rollup-configuration)のルールが適用可能な場合、[\*GraphiteMergeTree](/engines/table-engines/mergetree-family/graphitemergetree)内の古くなったパーティションを最適化します
- [Grafana](https://grafana.com/)
  - [clickhouse-grafana](https://github.com/Altinity/clickhouse-grafana)
- [Prometheus](https://prometheus.io/)
  - [clickhouse_exporter](https://github.com/f1yegor/clickhouse_exporter)
  - [PromHouse](https://github.com/Percona-Lab/PromHouse)
  - [clickhouse_exporter](https://github.com/hot-wifi/clickhouse_exporter) ([Goクライアント](https://github.com/kshvakov/clickhouse/)を使用)
...
- [Sematext](https://sematext.com/)
  - [clickhouse統合](https://github.com/sematext/sematext-agent-integrations/tree/master/clickhouse)
    </details>
...
<details>
<summary>自動機械学習</summary>

- [MindsDB](https://mindsdb.com/)
  - [MindsDB](https://github.com/mindsdb/mindsdb) - ClickHouseと統合し、ClickHouseのデータを多様なAI/MLモデルからアクセス可能にします
    </details>
