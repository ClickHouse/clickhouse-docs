...
# サードパーティの開発者によるクライアントライブラリ

:::note
ClickHouse Inc は、以下に記載されているライブラリを保守しておらず、その品質を保証するための広範なテストも実施していません。
:::
...
- [kolya7k ClickHouse PHP拡張機能](https://github.com//kolya7k/clickhouse-php)
