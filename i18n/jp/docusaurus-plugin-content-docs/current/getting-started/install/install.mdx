...
<CardPrimary
    alignContent="center"
    description="クラスタのサイズ調整やスケーリングを気にせずに、すぐに構築を開始できます。サイズ調整、スケーリング、セキュリティ、信頼性、アップグレードは私たちが対応します。"
    icon="cloud"
    infoText="無料で始める"
...
または、以下からプラットフォーム、ディストリビューション、インストール方法を選択して、オープンソースのClickHouseのインストール手順を表示してください。
