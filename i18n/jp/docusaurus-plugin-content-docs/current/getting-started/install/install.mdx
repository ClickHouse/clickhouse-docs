...
<CardPrimary
    alignContent="center"
    description="クラスタのサイズ決定やスケーリングを行うことなく、すぐに構築を開始できます。サイズ決定、スケーリング
    、セキュリティ、信頼性、アップグレードはすべて当社にお任せください。"
    icon="cloud"
    infoText="無料で始める"
...
または、以下からプラットフォーム、ディストリビューション、インストール方法を選択して、
オープンソース版 ClickHouse のインストール手順を確認してください:
