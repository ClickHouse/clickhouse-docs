...
| [HackerNews Analyzer](instrument-application.md) | Node.js アプリケーションである HackerNews Analyzer を OpenTelemetry でインストルメントし、そのログ、メトリクス、トレースを Managed ClickStack に送信します |