...
### OpenTelemetry Java エージェントをダウンロードする \{#download-opentelemetry-java-agent\}
...
次に、OpenTelemetry collector 経由で ClickStack にテレメトリデータを送信するため、シェル環境で次の環境変数を設定する必要があります。
