...
<VerticalStepper headerLevel="h2">
  ...
  [ClickHouse Cloud](https://console.clickhouse.cloud) で Managed ClickStack サービスを作成するには、まず [ClickHouse Cloud クイックスタートガイド](/getting-started/quick-start/cloud) の **最初のステップ** を完了してください。
  ...
  <Image img={service_connect} size="lg" alt="サービス接続" border />
