...
:::tip OTel FYI を試す - OTel collector のドキュメントをシンプルに
[OTel FYI](https://otel.fyi) は、わかりやすく簡潔な OpenTelemetry collector のドキュメントを提供するコミュニティリソースです。OTel パイプラインを理解して設定する際に、ClickStack を補完する優れたリソースです。
:::
