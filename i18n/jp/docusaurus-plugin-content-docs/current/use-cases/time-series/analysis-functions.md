...
[`lagInFrame`](/docs/sql-reference/window-functions/lagInFrame)ウィンドウ関数を使用すると、次の期間の値にアクセスし、これらの変化を計算できます。
...
その後、[`arrayJoin()`](/docs/sql-reference/functions/array-join)を使用してデータを加工し、`bar()`を使用して視覚化できます：
