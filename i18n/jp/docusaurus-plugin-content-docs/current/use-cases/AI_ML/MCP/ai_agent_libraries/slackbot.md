...
description: 'ClickHouse MCP Server と対話できる SlackBot エージェントの構築方法を紹介します。'
...
このボットを使うと、自然言語で Slack から直接 ClickHouse データについて質問できます。このボットは
...
Slackドキュメントの[「Add apps to your Slack workspace」](https://slack.com/intl/en-gb/help/articles/202035138-Add-apps-to-your-Slack-workspace)の手順を参照してください。
