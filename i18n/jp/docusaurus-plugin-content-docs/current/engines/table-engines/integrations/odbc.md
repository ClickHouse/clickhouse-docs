...
This engine supports the [Nullable](/sql-reference/data-types/nullable) data type.
...
- Column types may differ from those in the source table. ClickHouse tries to [cast](/sql-reference/functions/type-conversion-functions) values to the ClickHouse data types.
- The [external_table_functions_use_nulls](/operations/settings/settings#external-table-functions-use-nulls) setting defines how to handle Nullable columns. Default value: 1. If 0, the table function does not make Nullable columns and inserts default values instead of nulls. This is also applicable for NULL values inside arrays.
...
- [ODBC dictionaries](/sql-reference/dictionaries#dictionary-sources#dicts-external_dicts_dict_sources-odbc)
