---
description: 'ClickHouse におけるサードパーティの利用状況と、サードパーティライブラリの追加および保守方法を説明するページ。'
...
ライブラリ用ディレクトリに外部コードのコピーをそのまま放り込むことは避けてください。
...
これらのブランチは変化し続ける対象であり、適切なバージョニングを難しくします。
