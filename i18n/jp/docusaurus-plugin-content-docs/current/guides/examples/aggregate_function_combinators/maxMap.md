...
[`Map`](/sql-reference/aggregate-functions/combinators#-map)コンビネータを[`max`](/sql-reference/aggregate-functions/reference/max)関数に適用することで、`maxMap`集約コンビネータ関数を使用してMap内の各キーごとの最大値を計算できます。
