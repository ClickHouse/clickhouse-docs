...
<Image img={sparsePrimaryIndexes01} size="lg" alt="スパースなプライマリインデックス 01" />
...
<Image img={sparsePrimaryIndexes02} size="lg" alt="スパースなプライマリインデックス 02" />
...
<Image img={sparsePrimaryIndexes03b} size="lg" alt="スパースなプライマリインデックス 03b" />
...
<Image img={sparsePrimaryIndexes04} size="lg" alt="スパースなプライマリインデックス 04" />
...
<Image img={sparsePrimaryIndexes05} size="lg" alt="スパースなプライマリインデックス 05" />
...
**先行キー・カラムのカーディナリティが低い場合**<a name="generic-exclusion-search-fast" />
...
<Image img={sparsePrimaryIndexes07} size="lg" alt="Sparse Primary Indices 06" />
...
**先行キー・カラムのカーディナリティが高い場合**<a name="generic-exclusion-search-slow" />

UserID のカーディナリティが高い場合、同じ UserID の値が複数のテーブル行およびグラニュールに分散している可能性は低くなります。これは、インデックスマークにおける URL 値が単調増加にはならないことを意味します:

<Image img={sparsePrimaryIndexes08} size="lg" alt="Sparse Primary Indices 06" />
...
クエリが検索している特定のURL値 (すなわち&#39;http://public&#95;search&#39;) は、各グラニュールグループに対して索引が格納している最小値と最大値の間に存在する可能性が非常に高いため、ClickHouseはそのグラニュールグループを選択せざるを得なくなります (クエリに一致する行が含まれている可能性があるため) 。
...
<Image img={sparsePrimaryIndexes10} size="lg" alt="スパースな主キーインデックス 10" />

これが、結果として得られた主キーです:

<Image img={sparsePrimaryIndexes11} size="lg" alt="スパースな主キーインデックス 11" />
...
<Image img={sparsePrimaryIndexes12b1} size="lg" alt="スパースなプライマリインデックス 12b1" />
...
<Image img={sparsePrimaryIndexes14a} size="lg" alt="スパース主インデックス 14a" />
...
<Image img={sparsePrimaryIndexes14b} size="lg" alt="スパース主インデックス 14b" />
...
<Image img={sparsePrimaryIndexes15a} size="lg" alt="スパースなプライマリインデックス 15a" />
...
<Image img={sparsePrimaryIndexes15b} size="lg" alt="スパースなプライマリインデックス 15b" />
