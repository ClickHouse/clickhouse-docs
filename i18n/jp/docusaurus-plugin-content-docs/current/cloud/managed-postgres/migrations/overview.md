...
## Supabase からの移行 \{#supabase\}

Supabase から移行する場合は、手順ごとに説明された [Supabase to Managed Postgres 移行 guide](https://github.com/iskakaushik/supa-auth-migrate/blob/main/MIGRATION.md) を参照してください。