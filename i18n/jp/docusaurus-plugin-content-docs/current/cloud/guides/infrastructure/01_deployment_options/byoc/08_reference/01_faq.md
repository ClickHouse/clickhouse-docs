...
<details>
  ...
  ドキュメント [supported regions](https://clickhouse.com/docs/cloud/reference/supported-regions) に記載されている **パブリックリージョン** はすべて BYOC デプロイメントで利用できます。
</details>
...
<details>
  <summary>BYOC VPC と S3 間のネットワーク通信はどのように機能しますか？</summary>
