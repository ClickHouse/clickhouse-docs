...
このガイドは、ClickHouse Cloud で Organization Admin ロールを持つユーザーを対象としています。
...
2. ユーザーがClickHouse Cloudにログインすると、自動的に`Member`ロールが割り当てられます。このロールはログインのみが可能で、その他のアクセス権限はありません
