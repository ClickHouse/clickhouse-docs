...
[system.session_log](/operations/system-tables/session_log)は、ログイン試行の成功・失敗と認証試行の発信元を記録します。この情報を使用して、ClickHouseインスタンスに対するクレデンシャルスタッフィング攻撃やブルートフォース攻撃を特定できます。
