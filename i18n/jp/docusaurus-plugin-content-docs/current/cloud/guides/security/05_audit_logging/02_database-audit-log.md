...
doc_type: 'guide'
keywords: ['監査ログ', 'データベースログ', 'コンプライアンス', 'セキュリティ', 'モニタリング']
---

ClickHouse では、デフォルトでデータベース監査ログが有効になっています。このページでは、セキュリティ関連のログに焦点を当てます。システムによって記録されるデータの詳細については、[system tables](/operations/system-tables/overview) のドキュメントを参照してください。
