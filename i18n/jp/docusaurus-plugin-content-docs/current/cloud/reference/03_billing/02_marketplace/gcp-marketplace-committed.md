...
description: 'GCP Marketplace（コミットメント契約）経由で ClickHouse Cloud を利用する'
...
コミットメント契約を通じて [GCP Marketplace](https://console.cloud.google.com/marketplace) から ClickHouse Cloud の利用を開始できます。コミットメント契約は Private Offer とも呼ばれ、一定期間にわたって ClickHouse Cloud の利用に対し、あらかじめ定められた金額の支出をお客様にお約束いただく契約形態です。
