...
title: 'クラウドマーケットプレイスでの従量課金 (PAYG) からコミット済み支出契約への課金移行'
description: '従量課金からコミット済み支出契約へ移行します。'
keywords: ['マーケットプレイス', '課金', 'PAYG', '従量課金', 'コミット済み支出契約']
doc_type: 'guide'
---

ClickHouse の組織が現在、クラウドマーケットプレイスの有効な従量課金 (PAYG) サブスクリプション (または注文) によって課金されており、同じクラウドマーケットプレイス経由でコミット済み支出契約による課金へ移行したい場合は、新しいオファーを承諾したうえで、利用しているクラウドサービスプロバイダーに応じて以下の手順に従ってください。
