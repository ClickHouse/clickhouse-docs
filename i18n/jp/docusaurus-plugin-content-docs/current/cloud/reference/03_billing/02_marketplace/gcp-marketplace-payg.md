...
description: 'GCP Marketplace（PAYG）経由で ClickHouse Cloud に登録します。'
...
PAYG（従量課金制）のパブリックオファーを通じて、[GCP Marketplace](https://console.cloud.google.com/marketplace) から ClickHouse Cloud の利用を開始できます。
