...
<ReleaseSchedule
  ...
  },
  {
   ...
   regular_progress: 'green',
   slow_progress: 'green',
   regular_delay_note: 'スケジュール済みのアップグレードウィンドウを持つサービスは、3月23日の翌週に、そのスケジュールされたウィンドウ内で 25.12 へアップグレードされます',
   slow_delay_note: 'スケジュール済みのアップグレードウィンドウを持つサービスは、4月13日の翌週に、そのスケジュールされたウィンドウ内で 25.12 へアップグレードされます',
 },
 {
