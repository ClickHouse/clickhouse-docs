...
* スケジュール済みのアップグレードウィンドウが設定されているサービスは、チャネルのロールアウト完了後の週に (UTC の月曜日 00:00 開始)、そのスケジュールされたウィンドウ内でアップグレードされます
...
<ReleaseSchedule
  releases={[
  {
    ...
    slow_progress: "green",
    fast_delay_note:
      "アップグレードウィンドウが設定されているサービスは、2026-04-15 からアップグレードされます。"
  },
  {
    ...
    slow_progress: "green",
    regular_delay_note:
      "スケジュール済みのアップグレードウィンドウを持つサービスは、3月23日の翌週に、そのスケジュールされたウィンドウ内で 25.12 へアップグレードされます",
    slow_delay_note:
      "スケジュール済みのアップグレードウィンドウを持つサービスは、4月13日の翌週に、そのスケジュールされたウィンドウ内で 25.12 へアップグレードされます"
  },
  {
