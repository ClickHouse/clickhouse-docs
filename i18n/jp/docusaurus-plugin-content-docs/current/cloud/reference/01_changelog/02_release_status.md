...
Enterprise ティアのサービスでは、すべてのリリースチャネルでスケジュール済みアップグレードが利用可能です。この機能により、アップグレードを実行する曜日と、その日の時間帯ウィンドウを設定できます。
...
- アップグレードウィンドウを設定しているサービスは、チャネルのロールアウト開始後に、設定されたウィンドウ内でアップグレードされます
...
<ReleaseSchedule releases={[
   {
     ...
     slow_progress: 'green',
     fast_delay_note: 'アップグレードウィンドウを設定しているサービスは、1 月 12 日の週に予定されたウィンドウ内で 25.10 へアップグレードされます',
   },
   {
    ...
    regular_progress: 'green',
    slow_progress: 'green',
    regular_delay_note: 'アップグレードウィンドウを設定しているサービスは、1 月 13 日以降、順次アップグレードされます。',
  }
]} />