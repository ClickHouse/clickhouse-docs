...
keywords: ['Cloud', 'リファレンス', 'アーキテクチャ', 'SharedMergeTree', 'コンピュート分離', 'Bring Your Own Cloud', '変更履歴', 'サポートされている Cloud リージョン', 'Cloud Compatibility']
title: '概要'
hide_title: true
...
| Page                                                          | Description                                                                        |
| ------------------------------------------------------------- | ---------------------------------------------------------------------------------- |
| [Architecture](/cloud/reference/architecture)                 | ストレージ、コンピュート、管理、セキュリティを含む ClickHouse Cloud のアーキテクチャについて解説します。                      |
