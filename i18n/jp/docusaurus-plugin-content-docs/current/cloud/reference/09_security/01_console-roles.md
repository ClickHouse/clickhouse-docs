...
| **クエリ API エンドポイント** ([詳細情報](/cloud/get-started/query-endpoints))                                 | クエリ API エンドポイント                                                                                                                      |
...
| control-plane:service:manage-clickpipes                                                              | ClickPipes 統合と関連設定を管理します。現在、**Data Sources** タブにアクセスするには `control-plane:service:manage` (「Manage and Delete Selected Services」) が必要です。 |
