下表は、クラウドプロバイダーおよびリージョンごとに、パブリックインターネット経由またはリージョン間でのアウトバウンド（エグレス）データ転送料金がどのように異なるかを示しています。
...
$^*$データ転送料金は、転送されたデータ 1 GB あたりの米ドル ($) です。
...
$^*$データ転送料金は、転送されたデータ量 1 GB あたりの米ドル建て料金です
