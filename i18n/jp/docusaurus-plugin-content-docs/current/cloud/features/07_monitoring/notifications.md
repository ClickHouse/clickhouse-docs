...
Cloud ユーザーは Cloud UI 経由で配信される通知をユーザーごとにカスタマイズできます。Cloud ユーザーは自分宛てのメールで受信する通知もカスタマイズできますが、カスタムメールアドレス宛てや Slack チャンネル宛てに配信される通知をカスタマイズできるのは、管理者権限を持つユーザーのみです。
