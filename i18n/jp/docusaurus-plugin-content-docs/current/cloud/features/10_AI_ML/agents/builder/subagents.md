...
Agent Builder で **Advanced settings** を開き、**Subagents** をオンにします。追加の設定項目が 2 つ表示されます。
...
* **ツールを多用する処理** — code interpreter のセッション、複数段階の Web 検索ループ、あるいは中間的なツール出力で親のコンテキストを圧迫するような処理。
