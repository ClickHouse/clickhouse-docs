---
title: ロールに割り当てられているユーザーとその逆を確認する方法
description: ClickHouse の `system.role_grants` テーブルをクエリして、ロールに割り当てられているユーザーや、特定のユーザーに割り当てられているロールを確認する方法を説明します。
date: 2023-09-07
tags: ['サーバー管理', 'システムテーブル', 'クラウド管理']
keywords: ['ユーザーロール']
---
...
ロールに割り当てられているユーザーおよびユーザーに割り当てられているロールを確認するにはどうすればよいですか？

## 回答 \{#answer\}

```sql
-- default でログイン中（管理者権限）
...
-- ユーザー 'foo' および 'bar' に割り当てられているロールは？
