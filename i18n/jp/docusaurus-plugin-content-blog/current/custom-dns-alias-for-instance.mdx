...
## 自己署名証明書を作成する \{#create-certificate\}
...
`MyCertificate.crt` という名前の証明書を作成します。詳細については [&quot;SSL 証明書の作成&quot;](/guides/sre/tls/configuring-tls#2-create-tls-certificates)
を参照してください。
...
## Nginx 設定を更新する \{#update-nginx-config\}
...
## hosts ファイルを更新する \{#update-hosts-file\}
...
## エイリアスを使用して Cloud に接続する \{#connect-to-cloud-using-alias\}
