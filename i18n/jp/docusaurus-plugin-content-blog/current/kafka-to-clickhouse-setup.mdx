...
# 1. Ubuntu 上で Kafka をセットアップする \{#1-setup-kafka-on-ubuntu\}
...
# 2. Wikimedia ストリームを Kafka に取り込む \{#2-ingest-the-wikimedia-stream-into-kafka\}
...
# 3. データを ClickHouse に取り込む \{#3-ingest-the-data-into-clickhouse\}
