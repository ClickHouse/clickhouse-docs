...
## Kafka にデータを取り込む \{#ingest-data-into-kafka\}
...
## ClickHouse にデータを取り込む \{#ingest-data-into-clickhouse\}
...
## ClickHouse で JSON データをクエリする \{#querying-json-data-in-clickhouse\}
