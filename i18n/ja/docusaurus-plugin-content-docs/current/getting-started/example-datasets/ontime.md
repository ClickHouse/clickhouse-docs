---
description: "航空便の定時性能に関するデータセット"
slug: /getting-started/example-datasets/ontime
sidebar_label: OnTime航空便データ
title: "OnTime"
---

このデータセットには、運輸統計局からのデータが含まれています。
...
（サーバーでメモリ不足やその他の問題が発生する場合は、`-P $(nproc)`の部分を削除してください）

## 保存されたコピーからのインポート {#import-from-a-saved-copy}

また、以下のクエリを使用して保存されたコピーからデータをインポートすることもできます:
...
Q2. 2000年から2008年までの週の日ごとの10分以上遅れたフライト数
...
Q6. 2000年から2008年までのより広い年範囲のリクエスト。
...
Q8. さまざまな年範囲の直接接続都市数別の最も人気のある目的地
...
Playground内でもデータを扱って楽しむことができます。[例](https://sql.clickhouse.com?query_id=M4FSVBVMSHY98NKCQP8N4K)。

このパフォーマンステストはVadim Tkachenkoによって作成されました。参照:
