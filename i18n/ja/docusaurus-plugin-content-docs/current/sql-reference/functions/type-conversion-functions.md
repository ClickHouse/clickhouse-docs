...
[`toInt8`](#toint8)と同様に、この関数は入力値を[Int8](../data-types/int-uint.md)型の値に変換しますが、エラーがあった場合にデフォルト値を返します。
...
- 成功した場合は64ビット整数値、そうでない場合は提供されたデフォルト値、または提供されていなければ`0`。[Int64](../data-types/int-uint.md)。
...
Like [`toInt256`](#toint256)、この関数は入力値を[Int256](../data-types/int-uint.md)型の値に変換しますが、エラーの場合は`NULL`を返します。
...
- 成功した場合は32ビット符号なし整数値、それ以外は`NULL`。[UInt32](../data-types/int-uint.md) / [NULL](../data-types/nullable.md)。
...
- 成功した場合は256ビット符号なし整数の値、失敗した場合は`NULL`。[UInt256](../data-types/int-uint.md) / [NULL](../data-types/nullable.md)。
...
- `expr` — 数値または数値の文字列表現を返す式。[式](../syntax.md/#syntax-expressions) / [文字列](../data-types/string.md)。
- `default`（オプション） — `Float32`型にパースできなかった場合に返すデフォルト値。[Float32](../data-types/float.md)。
...
デフォルト値が返される引数:
- バイナリおよび16進数値の文字列表現、例えば`SELECT toFloat32OrDefault('0xc0fe', CAST('0', 'Float32'));`など。

**返される値**

- 成功した場合は32ビットFloat値、失敗した場合は渡されたデフォルト値を返すか、渡されていなければ`0`を返します。[Float32](../data-types/float.md)。
...
サポートされていない引数:
- バイナリおよび16進数値の文字列表現、例えば`SELECT toFloat64('0xc0fe');`など。
...
サポートされていない引数（`0`を返す）:
- バイナリおよび16進数値の文字列表現、例えば`SELECT toFloat64OrZero('0xc0fe');`など。

**返される値**

- 64ビットFloat値が成功した場合は、その値、失敗した場合は`0`。[Float64](../data-types/float.md)。
...
サポートされていない引数（`\N`を返す）:
- バイナリおよび16進数値の文字列表現、例えば`SELECT toFloat64OrNull('0xc0fe');`など。

**返される値**

- 成功した場合は64ビットFloat値、失敗した場合は`\N`。[Float64](../data-types/float.md)。
...
- `expr` — 数値または数値の文字列表現を返す式。[式](../syntax.md/#syntax-expressions) / [文字列](../data-types/string.md)。
- `default`（オプション） — `Float64`型にパースできなかった場合に返すデフォルト値。[Float64](../data-types/float.md)。
...
デフォルト値が返される引数:
- バイナリおよび16進数値の文字列表現、例えば`SELECT toFloat64OrDefault('0xc0fe', CAST('0', 'Float64'));`など。

**返される値**

- 成功した場合は64ビットFloat値、失敗した場合は渡されたデフォルト値を返すか、渡されていなければ`0`を返します。[Float64](../data-types/float.md)。
...
- `expr` — 数字または数字の文字列表現を返す式です。 [式](../syntax.md/#syntax-expressions)。

サポートされている引数：
- (U)Int8/16/32/64/128/256型の値。
- (U)Int8/16/32/128/256の文字列表現。
- Float32/64型の値、`NaN`および`Inf`を含む。
- Float32/64の文字列表現、`NaN`および`Inf`を含む（大文字小文字を区別しません）。

**返される値**

- 16ビットのbrain-float値です。 [BFloat16](../data-types/float.md/#bfloat16)。
...
文字列入力値を[`BFloat16`](../data-types/float.md/#bfloat16)型の値に変換します。
...
- `x` — 数字の文字列表現です。 [文字列](../data-types/string.md)。
...
- 16ビットのbrain-float値、そうでなければ`0`です。 [BFloat16](../data-types/float.md/#bfloat16)。

:::note
この関数は、文字列表現からの変換時に精度の静かな損失を許可します。
:::
...
文字列入力値を[`BFloat16`](../data-types/float.md/#bfloat16)型の値に変換しますが、文字列が浮動小数点値を表さない場合、関数は`NULL`を返します。
...
- 16ビットのbrain-float値、そうでなければ`NULL`（`\N`）です。 [BFloat16](../data-types/float.md/#bfloat16)。
...
引数が[DateTime](../data-types/datetime.md)または[DateTime64](../data-types/datetime64.md)の場合、切り捨てられ、DateTimeの日時コンポーネントが残ります：
...
引数が[文字列](../data-types/string.md)の場合、[Date](../data-types/date.md)または[DateTime](../data-types/datetime.md)として解析されます。 [DateTime](../data-types/datetime.md)として解析された場合は、日付コンポーネントが使用されます：
...
引数が数字で、UNIXタイムスタンプのように見える場合（65535より大きい）、[DateTime](../data-types/datetime.md)として解釈され、現在のタイムゾーンで[Date](../data-types/date.md)に切り捨てられます。 タイムゾーン引数は、関数の第2引数として指定できます。[Date](../data-types/date.md)への切り捨てはタイムゾーンによって異なります：
...
上記の例では、同じUNIXタイムスタンプが異なるタイムゾーンで異なる日付として解釈される例を示しています。

引数が数値で65536未満の場合は、1970-01-01からの日数として解釈され、[Date](../data-types/date.md)に変換されます。これは、`Date`データ型の内部数値表現に対応します。 例：
...
引数がDate型の範囲に収まらない場合は、実装依存の動作が発生し、サポートされている最大日付に飽和したり、オーバーフローする可能性があります：
```sql
...
[date](#todate)と同じですが、無効な引数が受信された場合は[Date](../data-types/date.md)の下限値を返します。 サポートされる引数は[文字列](../data-types/string.md)のみです。
...
[date](#todate)と同じですが、無効な引数が受信された場合は`NULL`を返します。 サポートされる引数は[文字列](../data-types/string.md)のみです。
...
[date](#todate)のように、成功しなかった場合は、指定されている場合は第2引数、そうでなければ[Date](../data-types/date.md)の下限値を返します。
...
- `expr` — 値。 [文字列](../data-types/string.md)、 [Int](../data-types/int-uint.md)、 [Date](../data-types/date.md) または [DateTime](../data-types/datetime.md)。
- `time_zone` — タイムゾーン。 [文字列](../data-types/string.md)。

:::note
`expr`が数字の場合、それはUnixエポックの開始からの秒数として解釈されます（Unixタイムスタンプとして）。
`expr`が[文字列](../data-types/string.md)の場合、Unixタイムスタンプ、または日付/日付と時間の文字列表現として解釈される可能性があります。
したがって、短い数字の文字列表現（最大4桁）の解析は曖昧さのために明示的に無効にされています。たとえば、文字列`'1999'`は年（未完成の文字列の表現）またはUnixタイムスタンプの両方と解釈される可能性があります。より長い数字の文字列は許可されます。
:::
...
[DateTime](#todatetime)と同様ですが、無効な引数を受信した場合は[DateTime](../data-types/datetime.md)の下限値を返します。 サポートされる引数は[文字列](../data-types/string.md)のみです。
...
[DateTime](#todatetime)と同様ですが、無効な引数を受信した場合は`NULL`を返します。 サポートされる引数は[文字列](../data-types/string.md)のみです。
...
[DateTime](#todatetime)のように、成功しなかった場合は、指定された場合は第3引数、そうでなければ[DateTime](../data-types/datetime.md)の下限値を返します。
...
- `expr` — 値。 [文字列](../data-types/string.md)、 [UInt32](../data-types/int-uint.md) または [Date](../data-types/date.md)。

**返される値**

- カレンダー日付。 タイプは[Date32](../data-types/date32.md)。
...
[toDate32](#todate32)と同じですが、無効な引数を受信した場合は[Date32](../data-types/date32.md)の最小値を返します。
...
[toDate32](#todate32)と同じですが、無効な引数を受信した場合は`NULL`を返します。
...
引数を[Date32](../data-types/date32.md)データ型に変換します。 値が範囲外の場合、`toDate32OrDefault`は[Date32](../data-types/date32.md)でサポートされる下限の値を返します。 引数が[Date](../data-types/date.md)型の場合、その境界が考慮されます。 無効な引数を受信した場合はデフォルト値を返します。
...
- `expr` — 値。 [文字列](../data-types/string.md)、 [UInt32](../data-types/int-uint.md)、 [Float](../data-types/float.md) または [DateTime](../data-types/datetime.md)。
- `scale` - タイックサイズ（精度）：10<sup>-精度</sup>秒。 有効な範囲：[0: 9]。
- `timezone` （オプション） - 指定されたdatetime64オブジェクトのタイムゾーン。

**返される値**

- サブ秒精度のカレンダー日付と時刻。 [DateTime64](../data-types/datetime64.md)。
...
小数点なしでも、値はUnix Timestampとして処理されます。
...
[toDateTime64](#todatetime64)と同様ですが、無効な引数を受信した場合は[DateTime64](../data-types/datetime64.md)の最小値を返します。
...
- サブ秒精度のカレンダー日付と時刻、そうでなければ`DateTime64`の最小値：`1970-01-01 01:00:00.000`です。 [DateTime64](../data-types/datetime64.md)。
...
[toDateTime64](#todatetime64)と同様ですが、無効な引数を受信した場合は`NULL`を返します。
...
- サブ秒精度のカレンダー日付と時刻、そうでなければ`NULL`です。 [DateTime64](../data-types/datetime64.md)/[NULL](../data-types/nullable.md)。
...
[toDateTime64](#todatetime64)と同様ですが、無効な引数を受信した場合は、[DateTime64](../data-types/datetime64.md)のデフォルト値または指定されたデフォルトを返します。
...
- `scale` - タイックサイズ（精度）：10<sup>-精度</sup>秒。 有効な範囲：[0: 9]。
- `timezone` （オプション） - 指定されたDateTime64オブジェクトのタイムゾーン。
- `default` （オプション） - 無効な引数を受信した場合に返すデフォルト値。 [DateTime64](../data-types/datetime64.md)。

**返される値**

- サブ秒精度のカレンダー日付と時刻、そうでなければ最小値の[DateTime64]または提供された`default`値です。 [DateTime64](../data-types/datetime64.md)。
...
入力値を[`Decimal(9, S)`](../data-types/decimal.md)型の値に変換します。 エラーが発生した場合は例外を投げます。
...
- `expr` — 数字または数字の文字列表現を返す式です。 [式](../syntax.md/#syntax-expressions)。
- `S` — 小数部分の桁数を指定するスケールパラメータ（0〜9）です。 [UInt8](../data-types/int-uint.md)。
...
サポートされていない引数：
- Float32/64の値`NaN`および`Inf`（大文字小文字を区別しません）の値または文字列表現。
- バイナリおよび16進数値の文字列表現、例：`SELECT toDecimal32('0xc0fe', 1);`。

:::note
`expr`の値が`Decimal32`の範囲を超えた場合、オーバーフローが発生する可能性があります：`(-1 * 10^(9 - S), 1 * 10^(9 - S))`。
小数部に対する余分な桁は破棄されます（丸められません）。
整数部に対する余分な桁は例外を引き起こします。
:::

:::warning
変換において余分な桁が破棄され、浮動小数点演算命令が使用されるため、Float32/Float64入力を操作する際に予期しない動作をする可能性があります。
たとえば：`toDecimal32(1.15, 2)`は`1.14`と等しくなります。なぜなら、1.15 * 100の浮動小数点処理は114.99だからです。
整数型を使用するために文字列入力を使用できます：`toDecimal32('1.15', 2) = 1.15`
:::

**返される値**

- `Decimal(9, S)`型の値です。 [Decimal32(S)](../data-types/int-uint.md)。
...
- `expr` — 数字の文字列表現です。 [文字列](../data-types/string.md)。
- `S` — 小数部分の桁数を指定するスケールパラメータ（0〜9）です。 [UInt8](../data-types/int-uint.md)。
...
`expr`の値が`Decimal32`の範囲を超えた場合、オーバーフローが発生する可能性があります：`(-1 * 10^(9 - S), 1 * 10^(9 - S))`。
小数部に対する余分な桁は破棄されます（丸められません）。
整数部に対する余分な桁はエラーを引き起こします。
:::

**返される値**

- 成功した場合は`Decimal(9, S)`型の値、そうでなければ`0`を返します。 [Decimal32(S)](../data-types/decimal.md)。
...
[`toDecimal32`](#todecimal32)と同様に、この関数は入力値を[Nullable(Decimal(9, S))](../data-types/decimal.md)型の値に変換しますが、エラーが発生した場合は`0`を返します。
...
- 成功した場合は`Nullable(Decimal(9, S))`型の値、そうでなければ同じ型の`NULL`の値を返します。 [Decimal32(S)](../data-types/decimal.md)。
...
- `expr` — 数字の文字列表現です。 [文字列](../data-types/string.md)。
- `S` — 小数部分の桁数を指定するスケールパラメータ（0〜9）です。 [UInt8](../data-types/int-uint.md)。
- `default` （オプション） — 型が`Decimal32(S)`に変換できなかった場合に返すデフォルト値。 [Decimal32(S)](../data-types/decimal.md)。
...
:::warning
変換において余分な桁が破棄され、浮動小数点演算命令が使用されるため、Float32/Float64入力を操作する際に予期しない動作をする可能性があります。
たとえば：`toDecimal32OrDefault(1.15, 2)`は`1.14`と等しくなります。なぜなら、1.15 * 100の浮動小数点処理は114.99だからです。
整数型を使用するために文字列入力を使用できます：`toDecimal32OrDefault('1.15', 2) = 1.15`
:::

**返される値**

- 成功した場合は`Decimal(9, S)`型の値、そうでなければ渡されたデフォルト値または`0`を返します。 [Decimal32(S)](../data-types/decimal.md)。
...
- [`toDecimal32OrNull`](#todecimal32ornull)。
```
- Float32/64 の `NaN` および `Inf` の値または文字列表現（大文字小文字を区別しない）。
- バイナリおよび16進数値の文字列表現、例: `SELECT toDecimal64('0xc0fe', 1);`。

:::note
`expr` の値が `Decimal64` の範囲を超えるとオーバーフローが発生する可能性があります: `( -1 * 10^(18 - S), 1 * 10^(18 - S) )`。 
小数点以下の過剰な桁は捨てられます（丸められません）。 
整数部分の過剰な桁は例外を引き起こします。
:::

:::warning
Float32/Float64 入力を操作する場合、変換は余分な桁を省略し、予期しない方法で動作する可能性があります。これは、操作が浮動小数点命令を使用して実行されるためです。 
例えば: `toDecimal64(1.15, 2)` は `1.14` に等しいです。なぜなら、浮動小数点では 1.15 * 100 は 114.99 になるからです。 
文字列入力を使用すると、操作が基になる整数型を使用します: `toDecimal64('1.15', 2) = 1.15` 
:::
...
- `S` — 小数点以下の桁数を指定するスケールパラメータ（0 から 18 の間）。 [UInt8](../data-types/int-uint.md)。
...
- 成功した場合は `Decimal(18, S)` 型の値、失敗した場合は `0`（S 桁の小数を持つ）。 [Decimal64(S)](../data-types/decimal.md)。
...
- 成功した場合は `Nullable(Decimal(18, S))` 型の値、失敗した場合は同じ型の値 `NULL`。 [Decimal64(S)](../data-types/decimal.md)。
...
- `expr` — 数字の文字列表現。 [String](../data-types/string.md)。
- `S` — 小数点以下の桁数を指定するスケールパラメータ（0 から 18 の間）。 [UInt8](../data-types/int-uint.md)。
- `default`（オプション） — `Decimal64(S)` 型への解析が失敗した場合に返されるデフォルト値。 [Decimal64(S)](../data-types/decimal.md)。
...
:::warning
Float32/Float64 入力を操作する場合、変換は余分な桁を省略し、予期しない方法で動作する可能性があります。これは、操作が浮動小数点命令を使用して実行されるためです。 
例えば: `toDecimal64OrDefault(1.15, 2)` は `1.14` に等しいです。なぜなら、浮動小数点では 1.15 * 100 は 114.99 になるからです。 
文字列入力を使用すると、操作が基になる整数型を使用します: `toDecimal64OrDefault('1.15', 2) = 1.15` 
:::

**戻り値**

- 成功した場合は `Decimal(18, S)` 型の値、失敗した場合は渡されたデフォルト値（あれば）を返すか、そうでなければ `0` を返します。 [Decimal64(S)](../data-types/decimal.md)。
...
入力値をスケール `S` を持つ [`Decimal(38, S)`](../data-types/decimal.md) 型の値に変換します。エラーが発生した場合は例外をスローします。
...
- `expr` — 数字を返す式または数字の文字列表現。 [Expression](../syntax.md/#syntax-expressions)。
- `S` — 小数点以下の桁数を指定するスケールパラメータ（0 から 38 の間）。 [UInt8](../data-types/int-uint.md)。
...
サポートされていない引数:
- Float32/64 の値 `NaN` および `Inf` の値または文字列表現（大文字小文字を区別しない）。
...
:::warning
Float32/Float64 入力を操作する場合、変換は余分な桁を省略し、予期しない方法で動作する可能性があります。これは、操作が浮動小数点命令を使用して実行されるためです。 
例えば: `toDecimal128(1.15, 2)` は `1.14` に等しいです。なぜなら、浮動小数点では 1.15 * 100 は 114.99 になるからです。 
文字列入力を使用すると、操作が基になる整数型を使用します: `toDecimal128('1.15', 2) = 1.15` 
:::
...
- 成功した場合は `Decimal(38, S)` 型の値、失敗した場合は `0`（S 桁の小数を持つ）。 [Decimal128(S)](../data-types/decimal.md)。
...
- 成功した場合は `Nullable(Decimal(38, S))` 型の値、失敗した場合は同じ型の値 `NULL`。 [Decimal128(S)](../data-types/decimal.md)。
...
- `expr` — 数字の文字列表現。 [String](../data-types/string.md)。
- `S` — 小数点以下の桁数を指定するスケールパラメータ（0 から 38 の間）。 [UInt8](../data-types/int-uint.md)。
- `default`（オプション） — `Decimal128(S)` 型への解析が失敗した場合に返されるデフォルト値。 [Decimal128(S)](../data-types/decimal.md)。
...
:::warning
Float32/Float64 入力を操作する場合、変換は余分な桁を省略し、予期しない方法で動作する可能性があります。これは、操作が浮動小数点命令を使用して実行されるためです。 
例えば: `toDecimal128OrDefault(1.15, 2)` は `1.14` に等しいです。なぜなら、浮動小数点では 1.15 * 100 は 114.99 になるからです。 
文字列入力を使用すると、操作が基になる整数型を使用します: `toDecimal128OrDefault('1.15', 2) = 1.15` 
:::

**戻り値**

- 成功した場合は `Decimal(38, S)` 型の値、失敗した場合は渡されたデフォルト値（あれば）を返すか、そうでなければ `0` を返します。 [Decimal128(S)](../data-types/decimal.md)。
...
- `expr` — 数字を返す式または数字の文字列表現。 [Expression](../syntax.md/#syntax-expressions)。
- `S` — 小数点以下の桁数を指定するスケールパラメータ（0 から 76 の間）。 [UInt8](../data-types/int-uint.md)。
...
:::warning
Float32/Float64 入力を操作する場合、変換は余分な桁を省略し、予期しない方法で動作する可能性があります。これは、操作が浮動小数点命令を使用して実行されるためです。 
例えば: `toDecimal256(1.15, 2)` は `1.14` に等しいです。なぜなら、浮動小数点では 1.15 * 100 は 114.99 になるからです。 
文字列入力を使用すると、操作が基になる整数型を使用します: `toDecimal256('1.15', 2) = 1.15` 
:::
...
- 成功した場合は `Decimal(76, S)` 型の値、失敗した場合は `0`（S 桁の小数を持つ）。 [Decimal256(S)](../data-types/decimal.md)。
...
- 成功した場合は `Nullable(Decimal(76, S))` 型の値、失敗した場合は同じ型の値 `NULL`。 [Decimal256(S)](../data-types/decimal.md)。
...
[`toDecimal256`](#todecimal256) と同様に、この関数は入力値を [Decimal(76, S)](../data-types/decimal.md) 型の値に変換しますが、エラーの場合はデフォルト値を返します。
...
- `expr` — 数字の文字列表現。 [String](../data-types/string.md)。
- `S` — 小数点以下の桁数を指定するスケールパラメータ（0 から 76 の間）。 [UInt8](../data-types/int-uint.md)。
- `default`（オプション） — `Decimal256(S)` 型への解析が失敗した場合に返されるデフォルト値。 [Decimal256(S)](../data-types/decimal.md)。
...
:::warning
Float32/Float64 入力を操作する場合、変換は余分な桁を省略し、予期しない方法で動作する可能性があります。これは、操作が浮動小数点命令を使用して実行されるためです。 
例えば: `toDecimal256OrDefault(1.15, 2)` は `1.14` に等しいです。なぜなら、浮動小数点では 1.15 * 100 は 114.99 になるからです。 
文字列入力を使用すると、操作が基になる整数型を使用します: `toDecimal256OrDefault('1.15', 2) = 1.15` 
:::

**戻り値**

- 成功した場合は `Decimal(76, S)` 型の値、失敗した場合は渡されたデフォルト値（あれば）を返すか、そうでなければ `0` を返します。 [Decimal256(S)](../data-types/decimal.md)。
...
数字、文字列（ただし固定文字列ではない）、日付、および時刻付きの日付の間の変換のための関数。
これらの関数はすべて1つの引数を受け取ります。

文字列からまたは文字列への変換時、値は TabSeparated フォーマットとほとんどすべての他のテキストフォーマットに対して同じルールを使用してフォーマットまたは解析されます。 
文字列を解析できない場合は、例外がスローされてリクエストがキャンセルされます。

日付を数値に、またはその逆に変換する場合、日付は Unix エポックの開始からの日数に対応します。 
時刻付きの日付を数値に、またはその逆に変換する場合、時刻付きの日付は Unix エポックの開始からの秒数に対応します。

toDate/toDateTime 関数のための日時および日時付き形式は以下のように定義されています:
...
例外として、UInt32、Int32、UInt64、または Int64 数値型から日付に変換する場合、そして数値が 65536 以上の場合、その数値は Unix タイムスタンプとして解釈され（日数としてではなく）、日付に丸められます。 
これにより、一般的に `toDate(unix_timestamp)` と書くことができ、通常はエラーになるのですが、もっと厄介な `toDate(toDateTime(unix_timestamp))` と書く必要がなくなります。

日付と時間付きの日付の間の変換は、自然な方法で行われます: null 時間を追加するか、時間を削除することによって。

数値型の間の変換は、C++ における異なる数値型間の代入と同じルールを使用します。

加えて、DateTime 引数の toString 関数は、タイムゾーンの名前を含む2つ目の文字列引数を受け取ることができます。 例: `Asia/Yekaterinburg` この場合、時間は指定されたタイムゾーンに従ってフォーマットされます。
...
文字列のバイト数が N より少ない場合は、右側にヌルバイトでパディングされます。 
文字列のバイト数が N より多い場合は、例外がスローされます。
...
- 引数 `s` の N 長さの固定文字列。 [FixedString](../data-types/fixedstring.md)。
...
文字列または FixedString 引数を受け入れ、最初のゼロバイトで切り捨てられた文字列を返します。
...
- `scale` — 小数桁数、 [UInt8](../data-types/int-uint.md)。 
    * [Decimal](../data-types/decimal.md) と [Int, UInt](../data-types/int-uint.md) 型の最大スケールは 77 です（これは Decimal の最大の有効桁数です）。
    * [Float](../data-types/float.md) の最大スケールは 60 です。

**戻り値**

- 与えられた小数桁数（スケール）を持つ [String](../data-types/string.md) として表現された入力値。
    要求されたスケールが元の数値のスケールより小さい場合は、数値は通常の算術に従って丸められます。
...
入力値を UInt8 型の値として解釈し再解釈を行います。 [`CAST`](#cast) と異なり、この関数は元の値を保持しようとはしません。ターゲット型が入力型を表現できない場合、出力は無意味です。
...
入力値をUInt16型として扱い、バイトの再解釈を行います。[`CAST`](#cast)とは異なり、この関数は元の値を保持しようとはしません。ターゲット型が入力型を表現できない場合、出力は無意味になります。
...
- 再解釈された値`x`をUInt16として返します。[UInt16](../data-types/int-uint.md/#uint8-uint16-uint32-uint64-uint128-uint256-int8-int16-int32-int64-int128-int256)。
...
入力値をUInt32型として扱い、バイトの再解釈を行います。[`CAST`](#cast)とは異なり、この関数は元の値を保持しようとはしません。ターゲット型が入力型を表現できない場合、出力は無意味になります。
...
- 再解釈された値`x`をUInt32として返します。[UInt32](../data-types/int-uint.md/#uint8-uint16-uint32-uint64-uint128-uint256-int8-int16-int32-int64-int128-int256)。
...
入力値をUInt64型として扱い、バイトの再解釈を行います。[`CAST`](#cast)とは異なり、この関数は元の値を保持しようとはしません。ターゲット型が入力型を表現できない場合、出力は無意味になります。
...
- 再解釈された値`x`をUInt64として返します。[UInt64](../data-types/int-uint.md/#uint8-uint16-uint32-uint64-uint128-uint256-int8-int16-int32-int64-int128-int256)。
...
入力値をUInt128型として扱い、バイトの再解釈を行います。[`CAST`](#cast)とは異なり、この関数は元の値を保持しようとはしません。ターゲット型が入力型を表現できない場合、出力は無意味になります。
...
- 再解釈された値`x`をUInt128として返します。[UInt128](../data-types/int-uint.md/#uint8-uint16-uint32-uint64-uint128-uint256-int8-int16-int32-int64-int128-int256)。
...
入力値をUInt256型として扱い、バイトの再解釈を行います。[`CAST`](#cast)とは異なり、この関数は元の値を保持しようとはしません。ターゲット型が入力型を表現できない場合、出力は無意味になります。
...
- 再解釈された値`x`をUInt256として返します。[UInt256](../data-types/int-uint.md/#uint8-uint16-uint32-uint64-uint128-uint256-int8-int16-int32-int64-int128-int256)。
...
入力値をInt8型として扱い、バイトの再解釈を行います。[`CAST`](#cast)とは異なり、この関数は元の値を保持しようとはしません。ターゲット型が入力型を表現できない場合、出力は無意味になります。
...
- 再解釈された値`x`をInt8として返します。[Int8](../data-types/int-uint.md/#int-ranges)。
...
入力値をInt16型として扱い、バイトの再解釈を行います。[`CAST`](#cast)とは異なり、この関数は元の値を保持しようとはしません。ターゲット型が入力型を表現できない場合、出力は無意味になります。
...
- 再解釈された値`x`をInt16として返します。[Int16](../data-types/int-uint.md/#int-ranges)。
...
入力値をInt32型として扱い、バイトの再解釈を行います。[`CAST`](#cast)とは異なり、この関数は元の値を保持しようとはしません。ターゲット型が入力型を表現できない場合、出力は無意味になります。
...
- 再解釈された値`x`をInt32として返します。[Int32](../data-types/int-uint.md/#int-ranges)。
...
入力値をInt64型として扱い、バイトの再解釈を行います。[`CAST`](#cast)とは異なり、この関数は元の値を保持しようとはしません。ターゲット型が入力型を表現できない場合、出力は無意味になります。
...
- 再解釈された値`x`をInt64として返します。[Int64](../data-types/int-uint.md/#int-ranges)。
...
入力値をInt128型として扱い、バイトの再解釈を行います。[`CAST`](#cast)とは異なり、この関数は元の値を保持しようとはしません。ターゲット型が入力型を表現できない場合、出力は無意味になります。
...
- 再解釈された値`x`をInt128として返します。[Int128](../data-types/int-uint.md/#int-ranges)。
...
入力値をInt256型として扱い、バイトの再解釈を行います。[`CAST`](#cast)とは異なり、この関数は元の値を保持しようとはしません。ターゲット型が入力型を表現できない場合、出力は無意味になります。
...
- 再解釈された値`x`をInt256として返します。[Int256](../data-types/int-uint.md/#int-ranges)。
...
入力値をFloat32型として扱い、バイトの再解釈を行います。[`CAST`](#cast)とは異なり、この関数は元の値を保持しようとはしません。ターゲット型が入力型を表現できない場合、出力は無意味になります。
...
- 再解釈された値`x`をFloat32として返します。[Float32](../data-types/float.md)。
...
入力値をFloat64型として扱い、バイトの再解釈を行います。[`CAST`](#cast)とは異なり、この関数は元の値を保持しようとはしません。ターゲット型が入力型を表現できない場合、出力は無意味になります。
...
- 再解釈された値`x`をFloat64として返します。[Float64](../data-types/float.md)。
...
文字列、固定文字列、または数値を受け取り、ホスト順序（リトルエンディアン）で数値としてバイトを解釈します。解釈された数値からUnix Epochの始まりからの日数として日付を返します。
...
- `x`: Unix Epochの始まりからの日数。[(U)Int*](../data-types/int-uint.md)、[Float](../data-types/float.md)、[Date](../data-types/date.md)、[DateTime](../data-types/datetime.md)、[UUID](../data-types/uuid.md)、[String](../data-types/string.md)または[FixedString](../data-types/fixedstring.md)。
...
:::note
提供された文字列が長さが不足している場合、関数はその文字列が必要な数のヌルバイトでパディングされたかのように動作します。文字列が必要な長さを超える場合、余分なバイトは無視されます。
:::
...
これらの関数は、文字列を受け取り、文字列の先頭に配置されたバイトをホスト順序（リトルエンディアン）で数値として解釈します。Unix Epochの開始からの秒数として時間を解釈し、日付と時間を返します。
...
- `x`: Unix Epochの始まりからの秒数。[(U)Int*](../data-types/int-uint.md)、[Float](../data-types/float.md)、[Date](../data-types/date.md)、[DateTime](../data-types/datetime.md)、[UUID](../data-types/uuid.md)、[String](../data-types/string.md)または[FixedString](../data-types/fixedstring.md)。
...
この関数は、数値、日付、または日付と時間を受け取り、ホスト順序（リトルエンディアン）で対応する値を表すバイトを含む文字列を返します。ヌルバイトは末尾から削除されます。たとえば、UInt32型の値255は1バイトの長さの文字列です。
...
- 値`x`を表すバイトを含む文字列。[String](../data-types/fixedstring.md)。
...
この関数は、数値、日付、または日付と時間を受け取り、ホスト順序（リトルエンディアン）で対応する値を表すバイトを含むFixedStringを返します。ヌルバイトは末尾から削除されます。たとえば、UInt32型の値255は1バイトの長さのFixedStringです。
...
- 値`x`を表すバイトを含むFixedString。[FixedString](../data-types/fixedstring.md)。
...
:::note
ここで示されたUUID関数に加えて、専用の[UUID関数のドキュメント](../functions/uuid-functions.md)があります。
:::

16バイトの文字列を受け取り、各8バイトの半分をリトルエンディアンのバイト順序で解釈することによりUUIDを返します。文字列が長さ不足の場合、関数は必要な数のヌルバイトでパディングされたかのように動作します。文字列が16バイトを超える場合、末尾の余分なバイトは無視されます。
...
ソースのメモリ内バイトシーケンスをそのまま利用し、`x`の値を目的の型に再解釈します。
...
入力値を指定されたデータ型に変換します。[reinterpret](#reinterpret)関数とは異なり、`CAST`は新しいデータ型を使用して同じ値を表示しようとします。変換できない場合は例外が発生します。
...
:::note
入力値がターゲット型の制約に収まらない場合、結果はオーバーフローします。たとえば、`CAST(-1, 'UInt8')`は`255`を返します。
:::
...
[cast](#cast)との違いは、`accurateCast`は型`T`の範囲に収まらない場合、数値型のオーバーフローを許可しない点です。たとえば、`accurateCast(-1, 'UInt8')`は例外をスローします。
...
入力値`x`を指定されたデータ型`T`に変換します。常に[Nullable](../data-types/nullable.md)型を返し、キャスト値がターゲット型に収まらない場合は[NULL](../syntax.md/#null-literal)を返します。
...
入力値`x`を指定されたデータ型`T`に変換します。キャスト値がターゲット型に収まらない場合は、デフォルト型値または指定された`default_value`を返します。
...
`n`年の間隔を返します。データ型は[IntervalYear](../data-types/special-data-types/interval.md)です。
...
- `n` — 年数。整数またはその文字列表現、浮動小数点数。[(U)Int*](../data-types/int-uint.md)/[Float*](../data-types/float.md)/[String](../data-types/string.md)。
...
`n`四半期の間隔を返します。データ型は[IntervalQuarter](../data-types/special-data-types/interval.md)です。
...
- `n` — 四半期数。整数またはその文字列表現、浮動小数点数。[(U)Int*](../data-types/int-uint.md)/[Float*](../data-types/float.md)/[String](../data-types/string.md)。
...
`n`月の間隔を返します。データ型は[IntervalMonth](../data-types/special-data-types/interval.md)です。
...
- `n` — 月数。整数またはその文字列表現、浮動小数点数。[(U)Int*](../data-types/int-uint.md)/[Float*](../data-types/float.md)/[String](../data-types/string.md)。
...
`n`週間の間隔を返します。データ型は[IntervalWeek](../data-types/special-data-types/interval.md)です。
...
- `n` — 週間数。整数またはその文字列表現、浮動小数点数。[(U)Int*](../data-types/int-uint.md)/[Float*](../data-types/float.md)/[String](../data-types/string.md)。
...
`n` 日の間隔を返します。データ型は [IntervalDay](../data-types/special-data-types/interval.md) です。
...
- `n` — 日数。整数またはそれに相当する文字列表現、浮動小数点数。[(U)Int*](../data-types/int-uint.md)/[Float*](../data-types/float.md)/[String](../data-types/string.md)。
...
`n` 時間の間隔を返します。データ型は [IntervalHour](../data-types/special-data-types/interval.md) です。
...
- `n` — 時間数。整数またはそれに相当する文字列表現、浮動小数点数。[(U)Int*](../data-types/int-uint.md)/[Float*](../data-types/float.md)/[String](../data-types/string.md)。
...
`n` 分の間隔を返します。データ型は [IntervalMinute](../data-types/special-data-types/interval.md) です。
...
- `n` — 分数。整数またはそれに相当する文字列表現、浮動小数点数。[(U)Int*](../data-types/int-uint.md)/[Float*](../data-types/float.md)/[String](../data-types/string.md)。
...
`n` 秒の間隔を返します。データ型は [IntervalSecond](../data-types/special-data-types/interval.md) です。
...
- `n` — 秒数。整数またはそれに相当する文字列表現、浮動小数点数。[(U)Int*](../data-types/int-uint.md)/[Float*](../data-types/float.md)/[String](../data-types/string.md)。
...
`n` ミリ秒の間隔を返します。データ型は [IntervalMillisecond](../data-types/special-data-types/interval.md) です。
...
- `n` — ミリ秒数。整数またはそれに相当する文字列表現、浮動小数点数。[(U)Int*](../data-types/int-uint.md)/[Float*](../data-types/float.md)/[String](../data-types/string.md)。
...
`n` マイクロ秒の間隔を返します。データ型は [IntervalMicrosecond](../data-types/special-data-types/interval.md) です。
...
- `n` — マイクロ秒数。整数またはそれに相当する文字列表現、浮動小数点数。[(U)Int*](../data-types/int-uint.md)/[Float*](../data-types/float.md)/[String](../data-types/string.md)。
...
`n` ナノ秒の間隔を返します。データ型は [IntervalNanosecond](../data-types/special-data-types/interval.md) です。
...
- `n` — ナノ秒数。整数またはそれに相当する文字列表現、浮動小数点数。[(U)Int*](../data-types/int-uint.md)/[Float*](../data-types/float.md)/[String](../data-types/string.md)。
...
[MySQL形式の文字列](https://dev.mysql.com/doc/refman/8.0/en/date-and-time-functions.html#function_date-format)に従って、[String](../data-types/string.md) を [DateTime](../data-types/datetime.md) に変換します。この関数は [formatDateTime](../functions/date-time-functions.md#date_time_functions-formatDateTime) 関数の逆の操作です。
...
- `str` — 解析する文字列
- `format` — フォーマット文字列。省略可能。指定されない場合は `%Y-%m-%d %H:%i:%s` となります。
- `timezone` — [タイムゾーン](/operations/server-configuration-parameters/settings.md#timezone)。省略可能。

**戻り値**

MySQLスタイルのフォーマット文字列に従って解析された [DateTime](../data-types/datetime.md) 値を返します。

**サポートされているフォーマット指定子**

[formatDateTime](../functions/date-time-functions.md#date_time_functions-formatDateTime) にリストされているすべてのフォーマット指定子がサポートされていますが、次のものは除外されます。
- %Q: 四半期 (1-4)
...
[parseDateTime](#parsedatetime) の動作は同じですが、処理できない日付フォーマットに出会った場合はゼロ日付を返します。

## parseDateTimeOrNull {#parsedatetimeornull}

[parseDateTime](#parsedatetime) の動作は同じですが、処理できない日付フォーマットに出会った場合は `NULL` を返します。

エイリアス: `str_to_date`.

## parseDateTimeInJodaSyntax {#parsedatetimeinjodasyntax}

[parseDateTime](#parsedatetime) に似ていますが、フォーマット文字列は MySQL 様式ではなく [Joda](https://joda-time.sourceforge.net/apidocs/org/joda/time/format/DateTimeFormat.html) です。この関数は [formatDateTimeInJodaSyntax](../functions/date-time-functions.md#date_time_functions-formatDateTimeInJodaSyntax) 関数の逆の操作です。
...
- `str` — 解析する文字列
- `format` — フォーマット文字列。省略可能。指定されない場合は `yyyy-MM-dd HH:mm:ss` となります。
- `timezone` — [タイムゾーン](/operations/server-configuration-parameters/settings.md#timezone)。省略可能。

**戻り値**

Jodaスタイルのフォーマット文字列に従って解析された [DateTime](../data-types/datetime.md) 値を返します。

**サポートされているフォーマット指定子**

[formatDateTimeInJoda](../functions/date-time-functions.md#date_time_functions-formatDateTime) にリストされているすべてのフォーマット指定子がサポートされていますが、次のものは除外されます。
- S: 秒の小数部
- z: タイムゾーン
- Z: タイムゾーンオフセット/ID
...
[parseDateTimeInJodaSyntax](#parsedatetimeinjodasyntax) の動作は同じですが、処理できない日付フォーマットに出会った場合はゼロ日付を返します。

## parseDateTimeInJodaSyntaxOrNull {#parsedatetimeinjodasyntaxornull}

[parseDateTimeInJodaSyntax](#parsedatetimeinjodasyntax) の動作は同じですが、処理できない日付フォーマットに出会った場合は `NULL` を返します。

## parseDateTime64 {#parsedatetime64}

[MySQL形式の文字列](https://dev.mysql.com/doc/refman/8.0/en/date-and-time-functions.html#function_date-format) に従って、[String](../data-types/string.md) を [DateTime64](../data-types/datetime64.md) に変換します。
...
- `str` — 解析する文字列
- `format` — フォーマット文字列。省略可能。指定されない場合は `%Y-%m-%d %H:%i:%s.%f` となります。
- `timezone` — [タイムゾーン](/operations/server-configuration-parameters/settings.md#timezone)。省略可能。

**戻り値**

MySQLスタイルのフォーマット文字列に従って解析された [DateTime64](../data-types/datetime64.md) 値を返します。
戻り値の精度は6です。

## parseDateTime64OrZero {#parsedatetime64orzero}

[parseDateTime64](#parsedatetime64) の動作は同じですが、処理できない日付フォーマットに出会った場合はゼロ日付を返します。

## parseDateTime64OrNull {#parsedatetime64ornull}

[parseDateTime64](#parsedatetime64) の動作は同じですが、処理できない日付フォーマットに出会った場合は `NULL` を返します。

## parseDateTime64InJodaSyntax {#parsedatetime64injodasyntax}

[Joda形式](https://joda-time.sourceforge.net/apidocs/org/joda/time/format/DateTimeFormat.html) のフォーマット文字列に従って、[String](../data-types/string.md) を [DateTime64](../data-types/datetime64.md) に変換します。
...
Jodaスタイルのフォーマット文字列に従って解析された [DateTime64](../data-types/datetime64.md) 値を返します。
戻り値の精度はフォーマット文字列内の `S` プレースホルダの数に等しい（ただし最大6）。

## parseDateTime64InJodaSyntaxOrZero {#parsedatetime64injodasyntaxorzero}

[parseDateTime64InJodaSyntax](#parsedatetime64injodasyntax) の動作は同じですが、処理できない日付フォーマットに出会った場合はゼロ日付を返します。

## parseDateTime64InJodaSyntaxOrNull {#parsedatetime64injodasyntaxornull}

[parseDateTime64InJodaSyntax](#parsedatetime64injodasyntax) の動作は同じですが、処理できない日付フォーマットに出会った場合は `NULL` を返します。

## parseDateTimeBestEffort {#parsedatetimebesteffort}
## parseDateTime32BestEffort {#parsedatetime32besteffort}

[文字列](../data-types/string.md) 表現の日付と時刻を [DateTime](../data-types/datetime.md/#data_type-datetime) データ型に変換します。

関数は [ISO 8601](https://en.wikipedia.org/wiki/ISO_8601)、[RFC 1123 - 5.2.14 RFC-822 日付と時刻の仕様](https://tools.ietf.org/html/rfc1123#page-55)、ClickHouse およびその他のいくつかの日付と時刻の形式を解析します。
...
- `time_zone` — タイムゾーン。関数は `time_string` をこのタイムゾーンに従って解析します。 [String](../data-types/string.md)。
...
- 日付のみを含む文字列: `YYYY`、`YYYYMM`、`YYYY*MM`、`DD/MM/YYYY`、`DD-MM-YY` など。
- 日と時刻を含む文字列: `DD`、`DD hh`、`DD hh:mm`。この場合、`MM` は `01` に置き換えられます。
- 日付と時刻にタイムゾーンオフセット情報を含む文字列: `YYYY-MM-DD hh:mm:ss ±h:mm` など。例えば、`2020-12-12 17:36:00 -5:00`。
- [syslog タイムスタンプ](https://datatracker.ietf.org/doc/html/rfc3164#section-4.1.2): `Mmm dd hh:mm:ss`。例えば、`Jun  9 14:20:32`。

すべての区切り付き形式では、関数は完全名または月名の最初の3文字で表現された月の名前を解析します。例: `24/DEC/18`、`24-Dec-18`、`01-September-2018`。年が指定されていない場合、現在の年とみなされます。その結果得られた DateTime が未来の日付（たとえ現在の瞬間から1秒でも遅れている場合も）である場合、現在の年は前の年に置き換えられます。
...
この関数は、ISO 日付形式（たとえば、`YYYY-MM-DD hh:mm:ss`）および月と日成分があいまいに抽出できる他の日付形式（たとえば、`YYYYMMDDhhmmss`、`YYYY-MM`、`DD hh`、または `YYYY-MM-DD hh:mm:ss ±h:mm`）の [parseDateTimeBestEffort](#parsedatetimebesteffort) と同様に機能します。月と日成分を明確に抽出できない場合（たとえば、`MM/DD/YYYY`、`MM-DD-YYYY`、または `MM-DD-YY`）は、`DD/MM/YYYY`、`DD-MM-YYYY`、または `DD-MM-YY` の代わりに米国の日付形式を優先します。例外として、月が12よりも大きく31以下である場合は、この関数は [parseDateTimeBestEffort](#parsedatetimebesteffort) の動作に戻ります。たとえば、`15/08/2020` は `2020-08-15` として解析されます。

## parseDateTimeBestEffortOrNull {#parsedatetimebesteffortornull}
## parseDateTime32BestEffortOrNull {#parsedatetime32besteffortornull}

[parseDateTimeBestEffort](#parsedatetimebesteffort) の動作は同じですが、処理できない日付フォーマットに出会った場合は `NULL` を返します。

## parseDateTimeBestEffortOrZero {#parsedatetimebesteffortorzero}
## parseDateTime32BestEffortOrZero {#parsedatetime32besteffortorzero}

[parseDateTimeBestEffort](#parsedatetimebesteffort) の動作は同じですが、処理できない日付フォーマットに出会った場合はゼロ日付またはゼロ日時を返します。

## parseDateTimeBestEffortUSOrNull {#parsedatetimebesteffortusornull}

[parseDateTimeBestEffortUS](#parsedatetimebesteffortus) の動作は同じですが、処理できない日付フォーマットに出会った場合は `NULL` を返します。

## parseDateTimeBestEffortUSOrZero {#parsedatetimebesteffortusorzero}

[parseDateTimeBestEffortUS](#parsedatetimebesteffortus) の動作は同じですが、処理できない日付フォーマットに出会った場合はゼロ日付（`1970-01-01`）またはゼロ日時（`1970-01-01 00:00:00`）を返します。
...
- `time_zone` — [タイムゾーン](/operations/server-configuration-parameters/settings.md#timezone)。関数は `time_string` をこのタイムゾーンに従って解析します。省略可能。 [String](../data-types/string.md)。
...
[parseDateTime64BestEffort](#parsedatetime64besteffort) と同様ですが、あいまいな場合は米国の日付形式（`MM/DD/YYYY` など）を優先します。

## parseDateTime64BestEffortOrNull {#parsedatetime64besteffortornull}

[parseDateTime64BestEffort](#parsedatetime64besteffort) の動作は同じですが、処理できない日付フォーマットに出会った場合は `NULL` を返します。

## parseDateTime64BestEffortOrZero {#parsedatetime64besteffortorzero}

[parseDateTime64BestEffort](#parsedatetime64besteffort) の動作は同じですが、処理できない日付フォーマットに出会った場合はゼロ日付またはゼロ日時を返します。

## parseDateTime64BestEffortUSOrNull {#parsedatetime64besteffortusornull}

[parseDateTime64BestEffort](#parsedatetime64besteffort) の動作は同じですが、あいまいな場合は米国の日付形式（`MM/DD/YYYY` など）を優先し、処理できない日付フォーマットに出会った場合は `NULL` を返します。

## parseDateTime64BestEffortUSOrZero {#parsedatetime64besteffortusorzero}

[parseDateTime64BestEffort](#parsedatetime64besteffort) の動作は同じですが、あいまいな場合は米国の日付形式（`MM/DD/YYYY` など）を優先し、処理できない日付フォーマットに出会った場合はゼロ日付またはゼロ日時を返します。

## toLowCardinality {#tolowcardinality}

入力パラメータを同じデータ型の [LowCardinality](../data-types/lowcardinality.md) バージョンに変換します。

`LowCardinality` データ型からデータを変換するには、[CAST](#cast) 関数を使用します。たとえば、`CAST(x as String)` です。
...
- `expr` — [式](../syntax.md/#syntax-expressions) で、サポートされているデータ型のうちの1つを生成します。 [supported data types](../data-types/index.md/#data_types)。
...
`DateTime64` を固定秒精度の `Int64` 値に変換します。入力値はその精度に応じて適切に拡大または縮小されます。
...
`DateTime64` を固定ミリ秒精度の `Int64` 値に変換します。入力値はその精度に応じて適切に拡大または縮小されます。
...
`DateTime64` を固定マイクロ秒精度の `Int64` 値に変換します。入力値はその精度に応じて適切に拡大または縮小されます。
...
`DateTime64` を固定ナノ秒精度の `Int64` 値に変換します。入力値はその精度に応じて適切に拡大または縮小されます。
...
`Int64` を固定秒精度の `DateTime64` 値に変換します。入力値はその精度に応じて適切に拡大または縮小されます。

:::note
入力値は UTC タイムスタンプとして扱われ、与えられた（または暗黙の）タイムゾーンではありません。
:::
...
- `value` が精度 `0` の DateTime64 に変換されます。 [DateTime64](../data-types/datetime64.md)。
...
`Int64` を固定ミリ秒精度の `DateTime64` 値に変換します。入力値はその精度に応じて適切に拡大または縮小されます。
...
- `value` が精度 `3` の DateTime64 に変換されます。 [DateTime64](../data-types/datetime64.md)。
...
`Int64` を固定マイクロ秒精度の `DateTime64` 値に変換します。入力値はその精度に応じて適切に拡大または縮小されます。
...
- `value` が精度 `6` の DateTime64 に変換されます。 [DateTime64](../data-types/datetime64.md)。
...
`Int64` を固定ナノ秒精度の `DateTime64` 値に変換します。入力値はその精度に応じて適切に拡大または縮小されます。
...
- `value` が精度 `9` の DateTime64 に変換されます。 [DateTime64](../data-types/datetime64.md)。
...
- `format` — テキストフォーマット。たとえば、[CSV](/interfaces/formats.md/#csv)、[TSV](/interfaces/formats.md/#tabseparated)。
- `x`,`y`, ... — 式。
...
**注意**: フォーマットに接頭辞/接尾辞が含まれている場合、それは各行に書き込まれます。
...
任意の式を指定されたフォーマットに従って文字列に変換します。`formatRow`とは異なり、この関数は最後の`\n`を削除します。
