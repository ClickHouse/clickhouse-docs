...
ウィンドウパーティション内の行の相対的なランク（すなわちパーセンタイル）を返します。

**構文**

エイリアス: `percentRank`（ケースセンシティブ）
...
デフォルトで必要なウィンドウフレームの定義は `RANGE BETWEEN UNBOUNDED PRECEDING AND UNBOUNDED FOLLOWING` です。

ウィンドウ関数の構文についての詳細は、[ウィンドウ関数 - 構文](./index.md/#syntax)をご覧ください。
