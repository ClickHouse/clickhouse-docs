...
[R2DBC](https://r2dbc.io/) は、ClickHouse向けの非同期Javaクライアントのラッパーです。
...
<dependency>
    ...
    <!-- SPI 0.9.1.RELEASE 用に clickhouse-r2dbc_0.9.1 に変更 -->
    <artifactId>clickhouse-r2dbc</artifactId>
    <version>0.7.1</version>
    <!-- すべての依存関係を含むuber jarを使用します。小さいjarのためにclassifierをhttpまたはgrpcに変更 -->
