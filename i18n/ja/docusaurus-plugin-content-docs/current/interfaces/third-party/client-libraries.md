...
description: サードパーティのクライアントライブラリ
---

# サードパーティ開発者によるクライアントライブラリ

:::note
ClickHouse Incは、以下に記載されたライブラリを**管理しておらず**、その品質を保証するために広範なテストを行っていません。
:::
...
### PHP {#php}
 ...
 - [kolya7k ClickHouse PHP拡張](https://github.com//kolya7k/clickhouse-php)
