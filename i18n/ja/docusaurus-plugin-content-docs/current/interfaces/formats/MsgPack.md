...
ClickHouseは、[MessagePack](https://msgpack.org/)データファイルの読み込みと書き込みをサポートしています。
...
| 設定                                                                                                                                  | 説明                                                                                        | デフォルト |
|---------------------------------------------------------------------------------------------------------------------------------------|---------------------------------------------------------------------------------------------|-----------|
| [`input_format_msgpack_number_of_columns`](/operations/settings/settings-formats.md/#input_format_msgpack_number_of_columns)       | 挿入されたMsgPackデータの列数。データからの自動スキーマ推論に使用されます。                             | `0`       |
