以下の表は、クラウドプロバイダーとリージョンによるインターネット経由またはクロスリージョンのデータ転送料金の違いを示しています。
...
$^*$データ転送料金は転送されたデータのGBあたりの$で示されています。
...
<table style={{ textAlign: 'center' }}>
    ...
    <tr>
        ...
        <th rowSpan="2">オリジンリージョン</th>
        <th rowSpan="2">パブリックインターネットエグレス</th>
        <th colSpan="5">デスティネーションリージョン</th>
    </tr>
    <tr>
        <th>同一リージョン</th>
        <th>北アメリカ</th>
