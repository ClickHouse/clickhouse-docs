---
title: Как определить количество и размеры широких и компактных частей
description: 'В этой статье базы знаний описано, как определить количество частей по их типу — широкие и компактные.'
date: 2026-01-12
...
Следующий запрос можно использовать для подсчёта числа частей по типам:
...
Выполните приведённый ниже запрос, чтобы получить размеры широких и компактных частей:
...
:::note Размер компактной части отображается как ноль
Обратите внимание, что размеры столбцов не вычисляются в компактных частях и поэтому выше отображаются как `0`.
:::
