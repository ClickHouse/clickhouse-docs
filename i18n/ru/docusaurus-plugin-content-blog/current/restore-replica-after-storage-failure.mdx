...
<VerticalStepper headerLevel="h2">
  ## Скопируйте конфигурацию доступа с исправной реплики \{#copy-access-config\}
  ...
  ## Создайте резервную копию каталога metadata с исправной реплики \{#back-up-the-metadata-folder-from-the-healthy-replica\}
  ...
  ## Восстановите metadata на проблемной реплике \{#restore-the-metadata-on-the-faulty-replica\}
  ...
  ## Создайте флаг принудительного восстановления \{#create-force-restore-flag\}
  ...
  ## Перезапустите проблемную реплику \{#restart-faulty-replica\}
