...
3. Преобразуйте трейс в удобный формат, например trace event: `llvm-xray convert --symbolize --instr_map=./build/programs/clickhouse --output-format=trace_event xray-log.clickhouse.ZqKprE |
