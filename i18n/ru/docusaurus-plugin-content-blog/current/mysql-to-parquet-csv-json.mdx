...
## Экспорт данных MySQL в Parquet, CSV или JSON с помощью ClickHouse \{#exporting-mysql-data-to-parquet-csv-or-json-using-clickhouse\}
...
## Экспорт из MySQL в Parquet \{#export-mysql-to-parquet\}
...
## Экспорт MySQL в CSV \{#export-mysql-to-csv\}
...
## Экспорт MySQL в JSON \{#export-mysql-to-json\}
