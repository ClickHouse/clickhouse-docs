---
title: Простой пример схемы извлечения данных JSON с использованием приёмной таблицы и материализованного представления
description: "Простой пример схемы извлечения данных JSON с использованием приёмной таблицы и материализованного представления"
date: 2024-05-20
tags: ['Форматы данных']
keywords: ['JSON', 'приёмная таблица', 'материализованное представление']
---
