...
## Конвертация файлов из Parquet в CSV или JSON \{#converting-files-from-parquet-to-csv-or-json\}
...
## Доступ к данным с помощью табличной функции \{#accessing-the-data-using-a-table-function\}
...
## Преобразуйте файл Parquet в CSV \{#convert-the-parquet-file-to-a-csv\}
...
## Преобразование файла Parquet в JSON \{#convert-the-parquet-file-to-a-json\}
...
## Преобразование CSV в Parquet \{#convert-csv-to-parquet\}
