...
## Добавление столбца в таблицу \{#adding-a-column-to-a-table\}
...
## Добавление нового столбца \{#adding-a-new-column\}
...
## Изменение значения по умолчанию столбца \{#modifying-a-columns-default-value\}
...
## Управление позицией столбца в таблице \{#controlling-column-position-in-table\}
