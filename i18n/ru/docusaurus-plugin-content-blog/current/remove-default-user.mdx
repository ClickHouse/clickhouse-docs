...
## Удаление пользователя `default` \{#removing-the-default-user\}
...
## Запуск исполняемого файла напрямую \{#running-the-executable-directly\}
...
## Docker или локальная установка \{#docker-or-installed\}
