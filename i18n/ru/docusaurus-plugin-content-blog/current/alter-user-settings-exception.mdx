...
## Включение управления доступом через SQL \{#enable-sql-driven-access-control\}

Вы можете включить для пользователя по умолчанию систему управления доступом и учётными записями через SQL. Соответствующие шаги описаны на этой [странице](/operations/access-rights#enabling-access-control).