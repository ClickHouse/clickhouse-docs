...
description: Узнайте, как использовать фильтрующие агрегаты в ClickHouse с агрегатными комбинаторами `-If` и `-Distinct`, чтобы упростить запись запросов и расширить аналитические возможности.
date: 2023-03-01
tags: ['Functions']
...
## Использование фильтрующих агрегатов \{#using-filtered-aggregates\}
