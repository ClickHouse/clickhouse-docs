...
description: Узнайте, как использовать предложение `ON CLUSTER` и `clusterAllReplicas` для выполнения операторов SYSTEM и запросов на всех узлах сервиса ClickHouse Cloud.
date: 2023-03-01
