...
description: "Узнайте, как выполнять приём (ингестию) данных из топика Kafka в ClickHouse с помощью движка таблицы Kafka, материализованных представлений и таблиц MergeTree."
date: 2024-04-27
tags: ['Приём данных']
keywords: ['Kafka']
---
...
# 1. Настройка Kafka на Ubuntu \{#1-setup-kafka-on-ubuntu\}
...
# 2. Приём потока Wikimedia в Kafka \{#2-ingest-the-wikimedia-stream-into-kafka\}
...
# 3. Выполните приём данных в ClickHouse \{#3-ingest-the-data-into-clickhouse\}
