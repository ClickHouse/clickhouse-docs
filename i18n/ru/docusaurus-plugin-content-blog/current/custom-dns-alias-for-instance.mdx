...
создадим сертификат с именем `MyCertificate.crt`. Обратитесь к разделу [&quot;Create SSL certificates&quot;](/guides/sre/configuring-ssl#2-create-ssl-certificates)
...
## Подключение к Cloud с использованием псевдонима
