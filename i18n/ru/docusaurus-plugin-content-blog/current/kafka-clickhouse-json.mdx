...
description: "Узнайте, как загружать JSON‑сообщения из Apache Kafka напрямую в один столбец типа JSON в ClickHouse, используя движок таблицы Kafka и тип данных JSON."
date: 2024-11-06
...
## Приём данных в Kafka \{#ingest-data-into-kafka\}
...
## Приём данных в ClickHouse \{#ingest-data-into-clickhouse\}
...
## Запросы к данным JSON в ClickHouse \{#querying-json-data-in-clickhouse\}
