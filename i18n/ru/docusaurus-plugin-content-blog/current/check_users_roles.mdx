...
description: Узнайте, как выполнять запросы к системной таблице `system.role_grants` в ClickHouse, чтобы найти пользователей, назначенных ролям, и роли, назначенные конкретным пользователям.
date: 2023-09-07
