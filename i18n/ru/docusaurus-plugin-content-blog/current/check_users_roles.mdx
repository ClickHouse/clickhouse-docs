...
description: Узнайте, как выполнять запросы к системной таблице `system.role_grants` в ClickHouse, чтобы найти пользователей, назначенных на роли, и роли, назначенные конкретным пользователям.
date: 2023-09-07
tags: ['Администрирование сервера', 'Системные таблицы', 'Управление облаком']
...
Как проверить, какие пользователи назначены на роли и какие роли назначены пользователям?

## Ответ \{#answer\}

```sql
-- Вход выполнен как default (права администратора)
...
-- назначить роль 'role_a' пользователям 'foo' и 'bar'
...
-- назначить роль 'role_b' пользователю 'bar'
...
-- Каким пользователям назначена роль 'role_a'?
...
-- Какие роли назначены пользователям 'foo' и 'bar'?
...
-- вход выполнен как пользователь 'foo'
...
-- вход выполнен как пользователь 'bar'
