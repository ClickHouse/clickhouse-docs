...
1. Вы можете использовать [утилиту JQ](https://jqlang.github.io/jq/) для извлечения значения поля `state`:
...
1. Выполнение той же команды для активно работающего сервиса выведет:
