...
Ваш идентификатор хранилища (warehouse ID) совпадает с идентификатором рабочего пространства (Workspace ID).
Для идентификатора элемента данных (Data Item ID) мы рекомендуем использовать ваш идентификатор LakeHouse (LakeHouse ID).
