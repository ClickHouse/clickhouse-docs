...
Вы можете использовать официальную [конфигурацию docker-compose для Nessie](https://projectnessie.org/guides/), которая предоставляет полноценную среду с Nessie, хранилищем версий в памяти и MinIO для объектного хранения.
