...
ClickHouse поддерживает интеграцию с несколькими каталогами (Unity, Glue, REST, Polaris и т. д.). В этом руководстве пошагово описывается, как выполнять запросы к вашим данным с помощью ClickHouse и спецификации [REST Catalog](https://github.com/apache/iceberg/blob/main/open-api/rest-catalog-open-api.yaml/).
...
## Выполнение запросов к таблицам REST-каталога в ClickHouse \{#querying-rest-catalog-tables-using-clickhouse\}
...
1. Среда Spark ещё не создала таблицы-примеры
