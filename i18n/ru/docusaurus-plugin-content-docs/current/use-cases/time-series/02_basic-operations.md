---
title: 'Базовые операции с временными рядами'
...
Допустим, мы хотим понять общее количество хитов в окне не по календарным дням, а за 24-часовой период, смещённый от 18:00.
