---
title: 'Эффективность хранения временных рядов'
...
После того как мы рассмотрели, как выполнять запросы к нашему набору данных со статистикой Wikipedia, сосредоточимся на оптимизации хранения в ClickHouse.
В этом разделе показаны практические методы снижения требований к хранению при сохранении производительности запросов.
