...
Это важно как для метрик типа gauge, так и для метрик-счётчиков (counter).
...
При анализе временных рядов часто полезно понимать скорость возникновения событий, то есть число событий в единицу времени.
Этот запрос вычисляет скорость просмотров страниц в секунду, деля почасовые суммы на количество секунд в часе (3600).
