...
Чтобы обеспечить запись этого значения для всех последующих данных, мы можем изменить наше материализованное представление с помощью синтаксиса `ALTER TABLE`, как показано ниже:
