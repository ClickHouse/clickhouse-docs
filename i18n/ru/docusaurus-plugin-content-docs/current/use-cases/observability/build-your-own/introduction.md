...
## Когда стоит использовать ClickHouse для обсервабилити \{#when-should-you-use-clickhouse-for-observability\}

Использование ClickHouse для данных обсервабилити предполагает переход к обсервабилити на основе SQL. Рекомендуем [эту статью в блоге](https://clickhouse.com/blog/the-state-of-sql-based-observability) для ознакомления с историей обсервабилити на основе SQL, но, если коротко:

Обсервабилити на основе SQL подходит вам, если:

* Вы или члены вашей команды хорошо знакомы с SQL (или хотите его выучить).
...
* Вы ожидаете рост до средних или больших объемов данных обсервабилити под управлением (или даже очень больших объемов).
* Вы хотите контролировать TCO (совокупную стоимость владения) и избежать неконтролируемого роста расходов на обсервабилити.
* Вы не можете или не хотите мириться с короткими периодами хранения данных обсервабилити только ради сокращения затрат.

Обсервабилити на основе SQL может быть не для вас, если:

* Изучение (или генерация!) SQL не привлекает вас или членов вашей команды.
* Вы ищете готовое, сквозное решение для обсервабилити.
* Объемы ваших данных обсервабилити слишком малы, чтобы дать существенный эффект (например, &lt;150 ГиБ), и не ожидается, что они будут расти.
...
* Вы предпочитаете подождать, пока экосистема станет более зрелой, а обсервабилити на основе SQL — более «под ключ».
