...
| Раздел | Описание |
|------|-------------|
| [Bindplane](/use-cases/observability/clickstack/integrations/host-logs) | Bindplane — это нативный для OpenTelemetry конвейер телеметрии, который обеспечивает централизованное управление коллекторами OpenTelemetry. |