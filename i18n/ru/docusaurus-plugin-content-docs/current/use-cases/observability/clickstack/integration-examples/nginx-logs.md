...
Это руководство показывает, как организовать мониторинг Nginx с помощью ClickStack, настроив коллектор OpenTelemetry для сбора логов доступа Nginx. Вы узнаете, как:
...
Для пользователей, которые хотят протестировать интеграцию с nginx перед настройкой производственных систем, мы предоставляем демонстрационный набор данных с предварительно сгенерированными журналами доступа nginx и реалистичными паттернами трафика.

<VerticalStepper headerLevel="h4">

#### Загрузить демонстрационный набор данных {#download-sample}
...
- Комбинацию успешных запросов и ошибок
- Реалистичное время отклика и объёмы данных в байтах
