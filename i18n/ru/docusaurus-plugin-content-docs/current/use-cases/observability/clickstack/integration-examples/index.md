...
| Раздел | Описание |
|------|-------------|
| [Generic Host Logs](/use-cases/observability/clickstack/integrations/host-logs) | Краткое руководство по Kafka Metrics |
| [EC2 Host Logs](/use-cases/observability/clickstack/integrations/host-logs/ec2) | Краткое руководство по Kafka Metrics |
