...
ClickStack поставляется со стандартной конфигурацией ClickHouse, рассчитанной на масштаб с многотерабайтными объёмами данных, однако вы можете свободно модифицировать и оптимизировать её под свою нагрузку.
