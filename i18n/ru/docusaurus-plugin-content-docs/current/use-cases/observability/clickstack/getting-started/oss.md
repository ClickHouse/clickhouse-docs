...
Вы можете использовать облачную версию ClickStack в локальном режиме, доступную по адресу [play-clickstack.clickhouse.com](https://play-clickstack.clickhouse.com).
