...
<VerticalStepper>
  ...
  Перейдите по адресу [http://localhost:8080](http://localhost:8080) для доступа к интерфейсу HyperDX при локальном развёртывании. Если вы используете HyperDX в ClickHouse Cloud, выберите ваш сервис и `HyperDX` в левом меню.

  ## Исследование системных логов \{#explore-system-logs\}
