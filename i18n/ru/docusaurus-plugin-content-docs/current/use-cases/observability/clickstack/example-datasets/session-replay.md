...
title: 'Демо воспроизведения сессий'
sidebar_position: 4
pagination_prev: null
pagination_next: null
description: 'Интерактивное демо-приложение, показывающее, как настроить инструментирование веб-приложения для воспроизведения сессий в ClickStack'
doc_type: 'guide'
...
:::note[Если кратко]
В этом руководстве описывается процесс инструментирования веб-приложения для записи и воспроизведения сессий с помощью ClickStack Browser SDK. В отличие от других примерных наборов данных, которые загружают заранее сгенерированные данные, это демо предоставляет интерактивное приложение, в котором вы генерируете данные сессий своими действиями.
