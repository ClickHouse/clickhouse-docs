...
ClickStack создан для эффективной обработки рабочих нагрузок с высокой кардинальностью, используя столбцово-ориентированную архитектуру ClickHouse, гибкую схему для атрибутов с высокой кардинальностью и полностью параллельный движок выполнения. Это обеспечивает выполнение запросов с задержкой менее секунды по огромным наборам данных, быстрые агрегации на больших временных диапазонах и глубокий анализ отдельных трейсов.
