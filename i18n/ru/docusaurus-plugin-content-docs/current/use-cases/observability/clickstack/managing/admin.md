...
Административные операции, как правило, сводятся к выполнению DDL-команд. Доступные возможности зависят от того, используете ли вы управляемый ClickStack или ClickStack Open Source.
