...
title: 'Elixir'
doc_type: 'guide'
keywords: ['Elixir ClickStack SDK', 'Elixir observability', 'HyperDX Elixir', 'Elixir logging SDK', 'интеграция ClickStack с Elixir']
---
...
_🚧 Инструментарий OpenTelemetry для метрик и трассировки скоро появится!_
