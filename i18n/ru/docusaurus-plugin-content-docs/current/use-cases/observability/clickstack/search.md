...
doc_type: 'guide'
keywords: ['clickstack', 'поиск', 'логи', 'обсервабилити', 'полнотекстовый поиск']
---
...
Вы можете сохранять поисковые запросы для быстрого доступа в будущем. После сохранения ваши запросы будут отображаться на странице `Saved Searches`, что позволит легко возвращаться к часто используемым запросам без необходимости создавать их заново.

<Image img={saved_search_listing} alt="Страница списка сохранённых поисковых запросов" size="lg" />
