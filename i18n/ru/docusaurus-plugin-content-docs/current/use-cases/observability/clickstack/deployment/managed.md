...
При использовании собственной схемы рекомендуется создать источник логов и убедиться, что указаны все необходимые поля — подробности см. в разделе [&quot;Log source settings&quot;](/use-cases/observability/clickstack/config#logs).
