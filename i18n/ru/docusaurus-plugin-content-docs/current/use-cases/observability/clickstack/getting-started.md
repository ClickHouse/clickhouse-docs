...
Вы можете разворачивать ClickStack поверх ClickHouse Cloud, получая полностью управляемый и защищённый бэкенд при сохранении полного контроля над ингестией, схемой и процессами обсервабилити.
...
При подключении к демо‑серверу вы можете изучать данные, используя [инструкции по демонстрационным данным](/use-cases/observability/clickstack/getting-started/remote-demo-data).
