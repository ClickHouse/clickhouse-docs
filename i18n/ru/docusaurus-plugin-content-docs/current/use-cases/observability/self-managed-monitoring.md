...
title: 'Мониторинг в самостоятельном управлении'
sidebar_label: 'Мониторинг в самостоятельном управлении'
description: 'Руководство по мониторингу в самостоятельном управлении'
doc_type: 'guide'
...
Запрашивает производственные системные таблицы, что добавляет нагрузку мониторинга и препятствует переходу в энергосберегающий режим простоя
...
- [Docker Compose](/use-cases/observability/clickstack/deployment/docker-compose): развертывает каждый компонент (ClickHouse, HyperDX, OTel collector, MongoDB) по отдельности.
