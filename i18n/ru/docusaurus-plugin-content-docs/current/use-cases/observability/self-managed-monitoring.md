...
description: 'Руководство по самостоятельно управляемому мониторингу'
doc_type: 'guide'
...
**Самостоятельно управляемый ClickHouse с открытым исходным кодом**
...
Запрашивает производственные системные таблицы, что добавляет нагрузку мониторинга и препятствует переходу в режим простоя для экономии затрат
