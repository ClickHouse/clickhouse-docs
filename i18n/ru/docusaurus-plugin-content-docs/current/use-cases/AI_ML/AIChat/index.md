...
> В этом руководстве описано, как включить и использовать функцию AI Chat в консоли ClickHouse Cloud.
...
2. На левой боковой панели нажмите на значок с искрой с надписью «Ask AI».
...
1. При первом использовании отображается диалоговое окно с описанием обработки данных и сторонних субпроцессоров LLM.
...
1. Введите ваш вопрос (например, «Создать материализованное представление для агрегации ежедневных событий по пользователям»).
...
## Понимание шагов «размышления» агента {#thinking-steps}

В режиме агента вы можете видеть раскрываемые промежуточные шаги «размышления» или планирования. Они обеспечивают прозрачность процесса формирования ответа ассистентом. Сворачивайте или разворачивайте их по необходимости.

<Image img={img_thinking} alt='Шаги размышления' size='md' />


## Начало нового чата {#new-chats}
...
1. В нижней части отображается список недавних чатов.
2. Выберите чат, чтобы загрузить его сообщения.
