...
title: 'Использование AI-чата в ClickHouse Cloud'
pagination_prev: null
pagination_next: null
description: 'Руководство по включению и использованию функции AI-чата в консоли ClickHouse Cloud'
...
1. У вас должен быть доступ к организации ClickHouse Cloud с включенными функциями AI (обратитесь к администратору организации или в службу поддержки, если функции недоступны).
...
Если ответ генерируется слишком долго или уходит в сторону:
