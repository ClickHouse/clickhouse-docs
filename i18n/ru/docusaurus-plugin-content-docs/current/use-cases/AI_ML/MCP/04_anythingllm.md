...
description: 'В этом руководстве описывается, как развернуть AnythingLLM с сервером ClickHouse MCP с использованием Docker.'
...
Дождитесь, пока для `Mcp ClickHouse` не будет установлено значение `On`
