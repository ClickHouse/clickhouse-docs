...
[песочницей SQL ClickHouse](https://sql.clickhouse.com/).
...
<Link to='https://cloud.clickhouse.com/'>
  <CardHorizontal
    ...
    badgeText=''
    description="
Если у вас еще нет аккаунта Cloud, начните работу с ClickHouse Cloud сегодня и
получите $300 в виде кредитов. По окончании 30-дневного бесплатного пробного периода вы можете продолжить работу с 
тарифным планом с оплатой по факту использования или связаться с нами, чтобы узнать больше о скидках на объем.
...
Откройте файл `librechat.yaml` и добавьте следующую конфигурацию в конец файла:
...
Это загрузит модель на локальный компьютер, если она ещё не установлена.
...
Создайте бесплатную учетную запись LibreChat, если у вас её ещё нет, и войдите в систему. Теперь вы должны
