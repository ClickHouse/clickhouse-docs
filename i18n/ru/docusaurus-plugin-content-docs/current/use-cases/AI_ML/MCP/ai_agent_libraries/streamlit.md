...
description: 'Узнайте, как создать веб-агента на базе ИИ с помощью Streamlit и сервера ClickHouse MCP'
...
В этом руководстве вы узнаете, как создать веб-агента на базе ИИ с использованием [Streamlit](https://streamlit.io/), который может взаимодействовать с [SQL-песочницей ClickHouse](https://sql.clickhouse.com/) через [MCP-сервер ClickHouse](https://github.com/ClickHouse/mcp-clickhouse) и [Agno](https://github.com/agno-agi/agno).
...
Это откроет веб-браузер и перейдет по адресу `http://localhost:8501`, где вы
