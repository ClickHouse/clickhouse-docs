...
sidebar_label: 'Удаленный MCP ClickHouse Cloud'
title: 'Включение удаленного сервера MCP ClickHouse Cloud'
pagination_prev: null
pagination_next: null
description: 'В этом руководстве объясняется, как включить и использовать удаленный MCP ClickHouse Cloud'
keywords: ['ИИ', 'ClickHouse Cloud', 'MCP']
...
> В этом руководстве описывается, как включить и использовать удалённый MCP-сервер ClickHouse Cloud. В качестве примера мы будем использовать Claude Code в роли MCP-клиента, однако можно использовать любой LLM-клиент с поддержкой MCP.
...
1. В рабочем каталоге выполните следующую команду для добавления конфигурации MCP-сервера ClickHouse Cloud в Claude Code. В этом примере MCP-сервер в конфигурации Claude Code назван `clickhouse_cloud`
...
<Image img={img6} alt='Сведения о MCP в Claude Code' size='md' />
