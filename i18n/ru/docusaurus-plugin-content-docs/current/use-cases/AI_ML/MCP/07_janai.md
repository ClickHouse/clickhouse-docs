...
title: 'Настройка сервера ClickHouse MCP для работы с Jan.ai'
pagination_prev: null
pagination_next: null
description: 'В этом руководстве описывается, как настроить Jan.ai для работы с сервером ClickHouse MCP.'
...
Чтобы установить ClickHouse MCP Server, нужно нажать на значок `+` и заполнить форму следующим образом:

<Image img={MCPForm} alt='Добавление MCP-сервера' size='md' />

После этого нужно включить ClickHouse Server, если он еще не включен:
