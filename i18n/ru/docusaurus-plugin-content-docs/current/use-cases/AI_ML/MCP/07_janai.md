...
<VerticalStepper headerLevel="h2">
  ...
  Чтобы установить сервер ClickHouse MCP, нажмите на значок `+`, а затем заполните форму следующими данными:
  ...
  Инструменты сервера ClickHouse MCP теперь будут отображаться в окне чата:

  <Image img={MCPTool} alt="Инструменты сервера ClickHouse MCP" size="md" />

  ## Общение с сервером ClickHouse MCP через Jan.ai \{#chat-to-clickhouse-mcp-server\}
