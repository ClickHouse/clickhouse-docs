...
description: 'В этом руководстве рассказывается, как развернуть Open WebUI с сервером ClickHouse MCP с использованием Docker.'
...
После этого рядом с иконкой инструмента на панели чата должна появиться цифра `1`:

<Image img={ToolsAvailable} alt='Доступные инструменты Open WebUI' size='md' />

Нажав на иконку инструмента, можно просмотреть список доступных инструментов:
...
Они настраиваются через меню настроек, но в этот раз необходимо перейти на вкладку `Connections`:
