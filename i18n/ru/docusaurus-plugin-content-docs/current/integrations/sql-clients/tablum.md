...
description: 'TABLUM.IO — это SaaS-платформа управления данными с поддержкой ClickHouse «из коробки».'
...
:::note
Вы можете установить самостоятельно размещённую версию TABLUM.IO на вашем Linux-сервере в Docker.
:::


## 1. Регистрация или вход в сервис {#1-sign-up-or-sign-in-to-the-service}

Сначала зарегистрируйтесь в TABLUM.IO, используя адрес электронной почты, или войдите через аккаунт Google или Facebook.
...
Перейдите на вкладку **Dataset**. Выберите недавно созданный коннектор ClickHouse из выпадающего списка. В правой панели отобразится список доступных таблиц и схем.
