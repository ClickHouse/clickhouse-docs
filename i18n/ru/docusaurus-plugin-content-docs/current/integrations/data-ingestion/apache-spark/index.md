...
1. [Spark Connector](./apache-spark/spark-native-connector) — коннектор Spark реализует `DataSourceV2` и имеет собственный каталог. На сегодняшний день это рекомендуемый способ интеграции ClickHouse и Spark.
