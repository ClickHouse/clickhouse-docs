...
Коннектор ClickHouse Spark без проблем работает с Databricks. В этом руководстве рассматриваются настройка, установка и сценарии использования для платформы Databricks.
