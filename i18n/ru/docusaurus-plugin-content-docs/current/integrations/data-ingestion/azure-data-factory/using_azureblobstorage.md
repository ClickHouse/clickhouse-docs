...
Функция предоставляет табличный интерфейс, который позволяет выполнять выборку, вставку и
...
эффективного использования этой функции. Для получения более подробной информации и описания дополнительных параметров
...
:::info
Для получения дополнительной информации о параметрах конфигурации и автоматическом выводе схемы при запросе внешних источников, таких как Azure Blob Storage, см. [Автоматический вывод схемы из входных данных](https://clickhouse.com/docs/interfaces/schema-inference)
:::
