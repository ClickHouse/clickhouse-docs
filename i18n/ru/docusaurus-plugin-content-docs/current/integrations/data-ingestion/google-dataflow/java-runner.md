...
sidebar_position: 2
description: 'Пользователи могут загружать данные в ClickHouse с помощью Java Runner для Google Dataflow'
...
# Java-раннер Dataflow

<ClickHouseSupportedBadge/>

Java-раннер Dataflow позволяет выполнять пользовательские конвейеры Apache Beam в сервисе Dataflow в Google Cloud. Такой подход обеспечивает максимальную гибкость и хорошо подходит для продвинутых ETL-процессов.
...
**Примечание**: Данный подход предполагает знакомство с фреймворком Beam и наличие навыков программирования. Если вы предпочитаете решение без написания кода, рассмотрите возможность использования [предопределенных шаблонов ClickHouse](./templates).
