...
В следующих примерах показан очень простой способ загрузки структурированных и полуструктурированных данных JSON. Для более сложных JSON, включая вложенные структуры, см. руководство [**Проектирование схемы JSON**](/integrations/data-formats/json/schema).
