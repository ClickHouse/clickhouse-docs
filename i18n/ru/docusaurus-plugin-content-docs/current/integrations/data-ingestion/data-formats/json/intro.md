...
* [JSON schema inference](/integrations/data-formats/json/inference) - Использование автоматического вывода schema JSON для выполнения запросов к JSON и создания схем таблиц.
* [Designing JSON schema](/integrations/data-formats/json/schema) - Как спроектировать и оптимизировать schema JSON.
...
* [Other approaches to modeling JSON](/integrations/data-formats/json/other-approaches) - Устаревшие подходы к моделированию JSON. **Не рекомендуется.**