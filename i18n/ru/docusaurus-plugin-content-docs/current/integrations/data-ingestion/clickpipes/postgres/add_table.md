...
В ряде случаев бывает полезно добавить в конвейер конкретные таблицы. По мере масштабирования транзакционной или аналитической нагрузки такая необходимость возникает всё чаще.
