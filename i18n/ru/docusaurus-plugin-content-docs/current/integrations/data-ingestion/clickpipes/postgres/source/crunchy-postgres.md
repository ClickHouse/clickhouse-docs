...
2. Предоставьте доступ только для чтения к схеме, из которой вы реплицируете таблицы, пользователю `clickpipes_user`. В примере ниже показано предоставление разрешений для схемы `public`. Если необходимо предоставить доступ к нескольким схемам, выполните эти три команды для каждой схемы.
...
Добавьте [IP-адреса ClickPipes](../../index.md#list-of-static-ips) в белый список, создав правила брандмауэра в Crunchy Bridge.

<Image
  size='lg'
  img={firewall_rules_crunchy_bridge}
  alt='Где находятся правила брандмауэра в Crunchy Bridge?'
  border
/>
...
<Image
  ...
  alt='Добавление правил брандмауэра для ClickPipes'
  border
/>
