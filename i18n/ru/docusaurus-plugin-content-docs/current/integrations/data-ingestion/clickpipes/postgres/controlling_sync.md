...
Интервал синхронизации может быть установлен в любое положительное целое значение, но рекомендуется держать его выше 10 секунд.
...
### Тонкая настройка параметров синхронизации для снижения роста replication slot {#tweaking}
