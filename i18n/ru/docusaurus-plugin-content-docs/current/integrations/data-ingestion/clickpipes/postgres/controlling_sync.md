...
Этот документ описывает, как контролировать синхронизацию Postgres ClickPipe, когда ClickPipe работает в режиме **CDC (Running)**.
...
Существует два основных способа управления синхронизацией Postgres ClickPipe. ClickPipe начнет отправку данных, когда сработает одна из приведенных ниже настроек.
...
Рассмотрим, как использовать эти настройки для управления большим слотом репликации канала CDC.
