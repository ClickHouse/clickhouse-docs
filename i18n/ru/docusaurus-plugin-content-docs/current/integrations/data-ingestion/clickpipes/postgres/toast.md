...
Обратитесь к [этой статье в блоге](https://xata.io/blog/replica-identity-full-performance) за рекомендациями по вопросам производительности при использовании `REPLICA IDENTITY FULL`.
...
3. Для операций DELETE значения TOAST-столбцов в ClickHouse будут указаны как NULL или пустые.
