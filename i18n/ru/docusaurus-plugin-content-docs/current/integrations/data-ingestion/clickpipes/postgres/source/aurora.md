...
Этот раздел можно пропустить, если для вашего экземпляра Aurora уже задан следующий параметр:
...
1. Создайте новую группу параметров для вашей версии Aurora PostgreSQL с необходимой настройкой:
