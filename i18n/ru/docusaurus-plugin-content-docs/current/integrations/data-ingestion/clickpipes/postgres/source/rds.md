...
Вы можете пропустить этот раздел, если в вашем экземпляре RDS уже задан следующий параметр:

* `rds.logical_replication = 1`

Этот параметр обычно уже настроен, если вы ранее использовали другой инструмент репликации данных.
