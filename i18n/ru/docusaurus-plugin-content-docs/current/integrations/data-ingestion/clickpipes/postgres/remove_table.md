...
В некоторых случаях имеет смысл исключить отдельные таблицы из Postgres ClickPipe — например, если таблица не нужна для вашего аналитического сценария: пропустив её, можно сократить затраты на хранение и репликацию в ClickHouse.
