---
title: 'Удаление отдельных таблиц из конвейера ClickPipe'
description: 'Удаление отдельных таблиц из конвейера ClickPipe'
...
В некоторых случаях имеет смысл исключить отдельные таблицы из Postgres ClickPipe — например, если какая‑то таблица не нужна для ваших аналитических задач, её пропуск может сократить затраты на хранение и репликацию в ClickHouse.
