...
В некоторых сценариях может быть полезно приостановить Postgres ClickPipe. Например, вы можете захотеть выполнить аналитику по уже имеющимся данным в неизменном состоянии. Или, возможно, вы проводите обновление Postgres. Ниже описано, как приостановить и возобновить работу Postgres ClickPipe.
