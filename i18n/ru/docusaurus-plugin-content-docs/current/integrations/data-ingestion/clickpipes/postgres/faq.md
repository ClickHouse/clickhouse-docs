...
Используйте [materialized views](/materialized-views) над целевыми таблицами CDC. Materialized views в ClickHouse работают как триггеры на вставку, поэтому каждая строка, реплицируемая из Postgres, может быть преобразована, объединена с таблицами-справочниками или обогащена дополнительными столбцами перед записью в итоговую целевую таблицу.
