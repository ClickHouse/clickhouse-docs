...
Для Postgres версии 13 и ниже диапазонное сканирование по CTID выполняется медленнее, и эти параметры становятся более критичными. В таких случаях рассмотрите следующий процесс для улучшения производительности:
...
3. **Создайте новый pipe с оптимизированными настройками**: Как правило, увеличьте число строк в snapshot на партицию до значения от 1 миллиона до 10 миллионов, в зависимости от ваших конкретных требований и нагрузки, которую может выдержать ваш экземпляр Postgres.

Эти корректировки должны существенно повысить производительность начальной загрузки, особенно для старых версий Postgres. Если вы используете Postgres 14 или более позднюю версию, эти настройки оказывают меньшее влияние благодаря улучшенной поддержке диапазонного сканирования по CTID.
