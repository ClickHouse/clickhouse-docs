...
1. Вам может потребоваться выполнить значительные изменения схемы исходных таблиц, которые нарушат работу существующего ClickPipe и потребуют перезапуска. Вы можете просто нажать «Повторная синхронизация» после внесения изменений.
