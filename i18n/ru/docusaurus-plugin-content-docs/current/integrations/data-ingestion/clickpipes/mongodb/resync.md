...
doc_type: "guide"
keywords: ["clickpipes", "mongodb", "cdc", "прием данных", "синхронизация в реальном времени"]
---
...
4. Затем таблицы `_resync` заменяются исходными таблицами. Строки с мягким удалением переносятся из исходных таблиц в таблицы `_resync` перед заменой.
...
1. На вкладке «Источники данных» выберите MongoDB ClickPipe, который требуется повторно синхронизировать.
2. Перейдите на вкладку **Настройки**.
3. Нажмите кнопку **Повторная синхронизация**.

<Image img={resync_button} border size='md' />

4. Появится диалоговое окно для подтверждения. Нажмите «Повторная синхронизация» еще раз.
5. Перейдите на вкладку **Метрики**.
6. Дождитесь, пока статус конвейера не станет **Setup** или **Snapshot**.
...
9. После завершения замены конвейер перейдет в состояние **Running** и выполнит CDC, если эта функция включена.
