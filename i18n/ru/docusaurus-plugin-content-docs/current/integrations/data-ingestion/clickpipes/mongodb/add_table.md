...
В ряде случаев бывает полезно добавить в конвейер отдельные таблицы. Такая необходимость часто возникает по мере масштабирования транзакционной или аналитической нагрузки.
