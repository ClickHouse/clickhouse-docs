...
В ряде случаев бывает полезно добавить в pipe отдельные таблицы. По мере роста вашей транзакционной или аналитической нагрузки такая необходимость возникает всё чаще.
