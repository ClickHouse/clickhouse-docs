...
* Использование большого количества партиций может привести к увеличению задержки. ClickPipes ограничивает количество партиций, которые каждая реплика будет читать одновременно, в зависимости от размера реплики — от 10 (XS) до 240 (XL). Если имеется много партиций без данных или с небольшим объемом данных, обработка этих сообщений может задерживаться.
