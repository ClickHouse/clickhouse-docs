...
* Размер отдельных сообщений по умолчанию ограничен 2 МБ (в несжатом виде) при использовании минимального размера реплики (XS) и 8 МБ (в несжатом виде) для более крупных реплик. Сообщения, превышающие этот предел, будут отклонены с ошибкой. Если вам нужны сообщения большего размера, свяжитесь со службой поддержки.
...
* Размер пакета достиг максимального значения (100 000 строк или 28 МБ на 1 ГБ памяти пода)
