...
Если вы аутентифицируетесь в MSK с помощью ARN роли IAM, необходимо настроить отношения доверия между вашим экземпляром ClickHouse Cloud и этой ролью, чтобы эту роль можно было принимать.
...
ClickPipes не предоставляет никаких гарантий относительно задержки. Если у вас есть жёсткие требования к низкой задержке, пожалуйста, [свяжитесь с нами](https://clickhouse.com/company/contact?loc=clickpipes).
