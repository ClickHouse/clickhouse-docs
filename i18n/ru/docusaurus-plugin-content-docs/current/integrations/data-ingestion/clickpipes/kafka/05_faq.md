...
Нет, ClickPipes для Kafka предназначен для чтения данных из топиков Kafka, а не для записи в них. Для записи данных в топик Kafka необходимо использовать выделенный producer Kafka.
...
Работают оба варианта. Мы настоятельно рекомендуем использовать политику общего доступа на **уровне пространства имён** для получения данных из нескольких Event Hubs.
