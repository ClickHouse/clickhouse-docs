...
<details>
  <summary>Почему в интерфейсе настройки ClickPipes я не вижу некоторые топики Kafka?</summary>

  По умолчанию интерфейс обнаружения топиков ClickPipes отображает до 1 500 топиков. Если в вашем кластере Kafka больше 1 500 топиков, некоторые из них могут не появиться в раскрывающемся списке. Чтобы убедиться, что нужный топик существует, проверьте это напрямую с помощью клиента Kafka с теми же учётными данными. Если топик существует и вам нужно увеличить лимит отображения свыше 1 500, обратитесь в службу поддержки ClickHouse.
</details>
