...
<VerticalStepper type="numbered" headerLevel="h2">
  ...
  **3.** Создайте встроенную политику для роли IAM с [необходимыми правами доступа](/01_overview.md/#permissions) для чтения объектов из S3 и управления сообщениями в очереди SQS. Замените `<bucket-arn>` и `<sqs-queue-arn>` соответствующими значениями:
