...
В ряде случаев бывает полезно добавлять в конвейер отдельные таблицы. Такая необходимость обычно возникает по мере масштабирования ваших транзакционных или аналитических нагрузок.
