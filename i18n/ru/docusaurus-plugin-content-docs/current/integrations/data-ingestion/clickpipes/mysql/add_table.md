...
description: 'Описывает шаги по добавлению отдельных таблиц в ClickPipe.'
...
В ряде случаев бывает полезно добавить в конвейер отдельные таблицы. Это становится типичной необходимостью по мере масштабирования вашей транзакционной или аналитической нагрузки.
