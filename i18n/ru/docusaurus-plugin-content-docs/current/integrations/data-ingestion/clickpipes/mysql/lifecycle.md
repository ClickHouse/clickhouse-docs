...
Если в конвейере происходит невосстановимая ошибка, он переходит в состояние `Failed`. Вы можете обратиться в службу поддержки или [повторно выполнить синхронизацию](./resync) конвейера, чтобы восстановить его из этого состояния.
