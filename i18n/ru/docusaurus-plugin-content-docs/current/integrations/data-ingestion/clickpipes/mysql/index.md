...
doc_type: 'guide'
keywords: ['MySQL', 'ClickPipes', 'CDC', 'отслеживание изменений данных', 'репликация базы данных']
---
...
:::info
Загрузка данных из MySQL в ClickHouse Cloud через ClickPipes доступна в режиме открытой бета-версии.
:::

Вы можете использовать ClickPipes для загрузки данных из исходной базы данных MySQL в ClickHouse Cloud. Исходная база данных MySQL может быть развернута в локальной инфраструктуре (on-premises) или в облаке с использованием таких сервисов, как Amazon RDS, Google Cloud SQL и другие.
...
4. Заполните параметры подключения к исходной базе данных MySQL, которую вы настроили на этапе выполнения предварительных требований.
   ...
   Для получения дополнительной информации обратитесь к руководствам по настройке исходной базы данных MySQL, ссылки на которые приведены [в верхней части этой страницы](#prerequisites).
   :::
...
:::note
Убедитесь, что вы внесли [IP-адреса ClickPipes](../clickpipes#list-of-static-ips) в белый список правил брандмауэра для SSH-бастионного хоста, чтобы ClickPipes мог установить SSH-туннель.
:::
...
Наконец, обратитесь к странице ["Часто задаваемые вопросы по ClickPipes для MySQL"](/integrations/clickpipes/mysql/faq) для получения дополнительной информации о распространенных проблемах и способах их решения.
