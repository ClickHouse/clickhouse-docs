...
Ниже приведены статические IP-адреса NAT (разделенные по регионам), которые ClickPipes использует для подключения к вашим внешним сервисам. Добавьте IP-адреса, соответствующие региону вашего инстанса, в список разрешенных IP-адресов, чтобы разрешить трафик. Для конвейеров, работающих с объектным хранилищем, вам также следует добавить [IP-адреса кластера ClickHouse](/manage/data-sources/cloud-endpoints-api) в список разрешенных IP-адресов.
