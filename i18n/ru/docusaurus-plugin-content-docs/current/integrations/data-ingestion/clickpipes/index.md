...
Ниже приведены статические NAT IP-адреса (разделённые по регионам), которые ClickPipes использует для подключения к вашим внешним сервисам. Добавьте IP-адреса региона, соответствующего вашему экземпляру, в список разрешённых IP-адресов, чтобы разрешить трафик. В случае конвейеров объектного хранилища вам также следует добавить [IP-адреса кластера ClickHouse](/manage/data-sources/cloud-endpoints-api) в список разрешённых IP-адресов.
...
| **ap-southeast-1** (с 18 марта 2026 г.)  | `13.215.65.134`, `18.139.118.108`, `47.130.197.47`, `54.251.134.219`, `54.254.98.29`, `54.255.153.106`                                      |
