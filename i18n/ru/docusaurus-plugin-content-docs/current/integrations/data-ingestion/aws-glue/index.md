...
[Amazon Glue](https://aws.amazon.com/glue/) — это полностью управляемый бессерверный сервис интеграции данных от Amazon Web Services (AWS). Он упрощает процессы обнаружения, подготовки и преобразования данных для аналитики, машинного обучения и разработки приложений.
...
:::note
JAR-файлы, используемые в коннекторе Glue, собраны для `Spark 3.3`, `Scala 2` и `Python 3`. Убедитесь, что выбрали эти версии при настройке задания Glue.
:::
...
<Image
  ...
  size='md'
  alt='Параметры пути к JAR в Glue Notebook'
  force='true'
/>
