...
[Amazon Glue](https://aws.amazon.com/glue/) — это полностью управляемый бессерверный сервис интеграции данных, предоставляемый Amazon Web Services (AWS). Он упрощает задачи по обнаружению, подготовке и преобразованию данных для аналитики, машинного обучения и разработки приложений.
...
1. <h3 id='subscribe-to-the-connector'>Подписка на коннектор</h3>
   Чтобы получить доступ к коннектору в вашей учетной записи, подпишитесь на
   ClickHouse AWS Glue Connector в AWS Marketplace.
...
3. <h3 id='activate-the-connector'>
   ...
   Задайте имя подключения и нажмите «Создать» (на этом этапе не требуется указывать
...
4. <h3 id='use-in-glue-job'>Использование в задании Glue</h3>
   ...
   Коннектор автоматически внедрит необходимые JAR-файлы в среду выполнения задания.
...
:::note
JAR-файлы, используемые в коннекторе Glue, собраны для `Spark 3.3`, `Scala 2` и `Python 3`. Убедитесь, что выбраны эти версии при настройке задания Glue.
:::
