...
EMQX предоставляет мощный [движок правил](https://docs.emqx.com/en/cloud/latest/data_integration/rules.html), который может трансформировать и обогащать исходные MQTT-сообщения перед их отправкой во внешние системы.
