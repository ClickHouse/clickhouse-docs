...
приёмника и загрузить тестовый набор данных.
...
6.  Подключитесь к вашему экземпляру ClickHouse с помощью предпочитаемого SQL-клиента и проверьте созданную таблицу:
