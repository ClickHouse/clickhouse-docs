...
Из-за своей сложности эта материализация описана на отдельной странице. **[Перейдите к руководству по materialized view](/integrations/dbt/materialization-materialized-view)**, чтобы ознакомиться с полной документацией.
