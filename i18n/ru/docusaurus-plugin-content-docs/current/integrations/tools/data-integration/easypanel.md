...
[Easypanel](https://easypanel.io) — это современная панель управления сервером. Вы можете использовать Easypanel для развертывания ClickHouse на своём сервере.

[![Развернуть в Easypanel](https://easypanel.io/img/deploy-on-easypanel-40.svg)](https://easypanel.io/docs/templates/clickhouse)
