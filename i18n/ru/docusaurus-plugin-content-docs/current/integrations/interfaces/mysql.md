...
Для совместимости со всеми клиентами MySQL рекомендуется указывать пароль пользователя в конфигурационном файле в виде [двойного SHA1](/operations/settings/settings-users#user-namepassword).
Если пароль пользователя задан с использованием [SHA256](/sql-reference/functions/hash-functions#SHA256), некоторые клиенты не смогут пройти аутентификацию (mysqljs и старые версии консольных утилит MySQL и MariaDB).
