...
# Потоковая передача больших наборов результатов построчно
...
#### Потоковая передача блоков строк
...
# Потоковая передача блоками строк (эффективнее построчной обработки)
...
#### Потоковая передача DataFrame из Pandas
...
# Потоковая передача результатов запроса в виде Pandas DataFrames
...
#### Потоковая обработка пакетов Arrow
...
#### Запрос к DataFrame на основе Arrow
...
# Потоковая передача пакетами DataFrames (показан пример с polars)
...
#### Примеры преобразования несовпадающих типов ClickHouse/Arrow
...
# Возвращать все типы Date как базовые значения epoch (в секундах или днях)
...
```python
# Возвращать все столбцы UUID в виде строки
...
```python
# Возвращать значения IPv6 из столбца `dev_address` в виде строк
