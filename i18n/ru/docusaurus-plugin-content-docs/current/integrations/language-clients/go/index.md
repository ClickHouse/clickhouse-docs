...
Примечание: поскольку отображения представляют кортеж, они должны иметь тип `map[string]interface{}`. В настоящее время типы значений не являются строго типизированными.
