...
description: 'Looker Studio, ранее Google Data Studio, — это онлайн-инструмент для преобразования данных в настраиваемые информативные отчеты и дашборды.'
title: 'Looker Studio'
doc_type: 'guide'
integration:
  - support_level: 'core'
...
Сначала войдите на https://lookerstudio.google.com, используя учетную запись Google, и создайте новый источник данных:
...
Найдите официальный коннектор MySQL от Google (с названием просто **MySQL**):
...
он может отличаться в зависимости от конфигурации вашего сервера.

<Image
  size='md'
  img={looker_studio_03}
  alt='Указание параметров подключения ClickHouse через MySQL в Looker Studio'
  border
/>
<br />
...
В завершение вы сможете просмотреть полученную структуру таблицы и при необходимости скорректировать типы данных.

<Image
  size='md'
  img={looker_studio_06}
  alt='Просмотр полученной структуры таблицы ClickHouse в Looker Studio'
  border
/>
<br />

Теперь можно приступить к исследованию данных или созданию нового отчета!


## Использование Looker Studio с ClickHouse Cloud {#using-looker-studio-with-clickhouse-cloud}

При использовании ClickHouse Cloud необходимо сначала включить интерфейс MySQL. Это можно сделать в диалоговом окне подключения на вкладке «MySQL».
