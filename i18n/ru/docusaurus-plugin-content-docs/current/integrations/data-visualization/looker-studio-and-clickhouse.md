...
description: 'Looker Studio, ранее известный как Google Data Studio, — это онлайн-инструмент для преобразования данных в настраиваемые и информативные отчёты и панели мониторинга.'
title: 'Looker Studio'
doc_type: 'guide'
integration:
...
Сначала войдите на https://lookerstudio.google.com под своей учетной записью Google и создайте новый источник данных:
...
<Image size="md" img={looker_studio_03} alt="Указание параметров MySQL-подключения к ClickHouse в Looker Studio" border />
...
В итоге вы увидите автоматически определённую структуру таблицы и при необходимости сможете скорректировать типы данных.

<Image size="md" img={looker_studio_06} alt="Просмотр автоматически определённой структуры таблицы ClickHouse в Looker Studio" border />
...
В интерфейсе Looker Studio выберите опцию &quot;Enable SSL&quot;. SSL-сертификат ClickHouse Cloud подписан [Let&#39;s Encrypt](https://letsencrypt.org/certificates/). Этот корневой сертификат можно скачать [здесь](https://letsencrypt.org/certs/isrgrootx1.pem).

<Image size="md" img={looker_studio_mysql_cloud} alt="Конфигурация подключения Looker Studio с настройками SSL для ClickHouse Cloud" border />
