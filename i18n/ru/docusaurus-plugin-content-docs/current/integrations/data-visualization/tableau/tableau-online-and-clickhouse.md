...
description: 'Tableau Online раскрывает потенциал данных и позволяет людям, где бы они ни находились, принимать решения быстрее и с большей уверенностью.'
...
Войдите на сайт Tableau Cloud и добавьте новый публикуемый источник данных.
...
<Image
  ...
  alt='Диалоговое окно подключения MySQL в Tableau Desktop с включенной опцией SSL и полями для сервера, имени пользователя, пароля и сертификата'
  border
/>
<br />
...
<Image
  ...
  alt='Диалоговое окно публикации Tableau Desktop с опциями Authentication и выбранным Embedded password'
  border
/>
<br />
...
<Image
  ...
  alt="Диалоговое окно публикации Tableau Desktop с отмеченной опцией 'Update workbook to use the published data source'"
  border
/>
<br />
