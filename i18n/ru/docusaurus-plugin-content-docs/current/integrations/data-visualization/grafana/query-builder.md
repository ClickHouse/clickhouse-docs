...
* [Logs](#logs): оптимизирован для построения запросов к логам. Лучше всего работает в представлении Explore с [настроенными значениями по умолчанию](./config.md#logs).
...
* [Traces](#traces): оптимизирован для поиска и просмотра трейсов. Лучше всего работает в представлении Explore с [настроенными значениями по умолчанию](./config.md#traces).
