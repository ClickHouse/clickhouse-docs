...
keywords: ['clickhouse', 'Omni', 'подключение', 'интеграция', 'ui']
description: 'Omni — это корпоративная платформа для BI, дата‑приложений и встроенной аналитики, которая помогает исследовать данные и делиться аналитическими выводами в режиме реального времени.'
title: 'Omni'
doc_type: 'guide'
---
...
Omni может подключаться к ClickHouse Cloud или локально развернутому кластеру через официальный источник данных ClickHouse.
