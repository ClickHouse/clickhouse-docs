...
description: 'RocketBI — это платформа бизнес-аналитики в формате self-service, которая помогает быстро анализировать данные, создавать визуализации с помощью drag-and-drop и совместно работать с коллегами прямо в веб-браузере.'
title: 'ЦЕЛЬ: СОЗДАТЬ СВОЮ ПЕРВУЮ ПАНЕЛЬ'
doc_type: 'guide'
---
...
# Цель: создать свою первую панель в Rocket.BI

<CommunityMaintainedBadge/>

В этом руководстве вы установите и создадите простую панель в Rocket.BI.
Вот как она выглядит:

<Image size="md" img={rocketbi_01} alt="Панель Rocket BI, показывающая метрики продаж с диаграммами и ключевыми показателями (KPI)" border />
<br/>

Вы можете посмотреть [эту панель по ссылке.](https://demo.rocket.bi/dashboard/sales-dashboard-7?token=7eecf750-cbde-4c53-8fa8-8b905fec667e)



## Установка {#install}

Запустите RocketBI с помощью готовых Docker-образов.
...
Откройте браузер, перейдите по адресу `localhost:5050` и войдите с учетными данными: `hello@gmail.com/123456`
...
## Давайте создадим дашборд {#lets-build-the-dashboard}
...
<Image
  size='md'
  img={rocketbi_03}
  alt='Панель настройки элемента управления метриками Rocket BI с выбранными полями и настройками агрегации'
  border
/>
<br />

Переименуйте фильтры и сохраните элемент управления на дашборд

<Image
  size='md'
  img={rocketbi_04}
  alt='Элемент управления метриками с переименованными фильтрами, готовый к сохранению на дашборд'
  border
/>
...
Добавьте дополнительные варианты с различными диапазонами. Например, год, месяц, день или день недели.

<Image
  size='md'
  img={rocketbi_06}
  alt='Настройка диапазона дат с различными вариантами временных периодов: год, месяц и день'
  border
/>
<br />
...
<Image
  size='md'
  img={rocketbi_07}
  alt='Элемент управления диапазоном дат с переименованными фильтрами, готовый к сохранению на дашборд'
  border
/>
...
Затем перейдите на вкладку управления графиком

<Image
  size='md'
  img={rocketbi_10}
  alt='Интерфейс вкладки управления графиком с параметрами настройки визуализации'
  border
/>
<br />
...
<Image
  size='md'
  img={rocketbi_12}
  alt='Панель настроек графика с параметрами настройки круговой диаграммы'
  border
/>
<br />
...
<Image
  size='md'
  img={rocketbi_15}
  alt='Интерфейс создания столбчатой диаграммы с накоплением для данных временных рядов'
  border
/>
<br />
...
<Image
  size='md'
  img={rocketbi_16}
  alt='Настройка управления графиком с метриками на оси Y и диапазоном дат на оси X'
  border
/>
<br />
...
<Image
  size='md'
  img={rocketbi_18}
  alt='Готовый дашборд с числовыми графиками KPI, круговой диаграммой и визуализацией временных рядов'
  border
/>
<br />
