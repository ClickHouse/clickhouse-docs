...
[Chartbrew](https://chartbrew.com) — это платформа визуализации данных, которая позволяет пользователям создавать дашборды и отслеживать данные в режиме реального времени. Она поддерживает несколько источников данных, включая ClickHouse, и предоставляет интерфейс без необходимости писать код для построения графиков и отчётов.
...
<Image
  img={chartbrew_06}
  size='lg'
  alt='AI-ассистент для SQL-запросов к ClickHouse в Chartbrew'
/>
...
2. Просмотрите набор данных, чтобы убедиться в корректности структуры результатов запроса.
3. Выберите тип диаграммы (например, линейная, столбчатая или круговая диаграмма) и добавьте её на дашборд.
4. Нажмите **Complete dataset** для завершения настройки.
