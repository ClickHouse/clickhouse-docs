...
[Hashboard](https://hashboard.com) — это интерактивный инструмент для исследования данных, который позволяет любому сотруднику вашей организации отслеживать метрики и получать прикладные инсайты. Hashboard выполняет SQL-запросы в реальном времени к вашей базе данных ClickHouse и особенно полезен для сценариев самообслуживаемого, разового анализа данных.
...
2. Откройте страницу настроек, нажав на значок шестерёнки на боковой панели навигации.
