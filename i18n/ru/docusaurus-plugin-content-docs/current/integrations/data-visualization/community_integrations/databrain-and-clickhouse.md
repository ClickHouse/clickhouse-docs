...
description: 'Databrain — это платформа встраиваемой аналитики, которая бесшовно интегрируется с ClickHouse для создания клиентских панелей мониторинга, метрик и визуализаций данных.'
...
[Databrain](https://usedatabrain.com) — это платформа встраиваемой аналитики, которая позволяет создавать интерактивные панели мониторинга, метрики и визуализации данных и делиться ими с клиентами. Databrain подключается к ClickHouse через интерфейс HTTPS, что упрощает визуализацию и анализ данных ClickHouse в современном и удобном интерфейсе.

<Image size="md" img={databrain_01} alt="Интерфейс панели мониторинга Databrain с визуализацией данных ClickHouse" border />
...
4. Сохраните метрику, чтобы повторно использовать её на разных панелях мониторинга.

### Создание панелей мониторинга \{#build-dashboards\}

1. Нажмите **Create Dashboard**, чтобы начать создание панели мониторинга.

2. Добавляйте метрики на панель мониторинга, перетаскивая сохранённые метрики.

3. Настройте компоновку и внешний вид панели мониторинга.

<Image size="md" img={databrain_06} alt="Панель мониторинга Databrain с несколькими визуализациями ClickHouse" border />

4. Поделитесь панелью мониторинга с вашей командой или встроите её в приложение.
...
* **Встраиваемая аналитика**: встраивайте панели мониторинга и метрики напрямую в ваши приложения
...
* [Построение метрик](https://docs.usedatabrain.com/getting-started/core-concepts/metrics)