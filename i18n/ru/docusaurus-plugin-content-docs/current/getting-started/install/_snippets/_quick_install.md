...
Если вам не нужно устанавливать ClickHouse для production-окружения, самый быстрый способ начать работу — запустить установочный скрипт с помощью curl. Скрипт автоматически определит подходящий бинарный файл для вашей ОС.
