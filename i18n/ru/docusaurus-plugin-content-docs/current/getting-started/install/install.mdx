...
<CardPrimary
    alignContent="center"
    description="Начните работу мгновенно, без необходимости подбирать размер и масштабировать кластер. Мы берём на себя выбор конфигурации, масштабирование, безопасность, надёжность и обновления."
    icon="cloud"
...
по установке для ClickHouse с открытым исходным кодом:
