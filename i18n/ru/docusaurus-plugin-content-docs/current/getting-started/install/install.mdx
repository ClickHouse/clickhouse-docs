...
<CardPrimary
    alignContent="center"
    description="Начните работу мгновенно, без необходимости выбирать размер и масштабировать кластер. Мы берём на себя выбор размера, масштабирование, безопасность, надёжность и обновления."
    icon="cloud"
