...
<CardPrimary
    alignContent="center"
    description="Начните работу мгновенно, без подбора размеров и масштабирования кластера. Мы возьмём на себя размеры, масштабирование, безопасность, надёжность и обновления."
    icon="cloud"
...
Или выберите ниже платформу, дистрибутив и метод установки, чтобы просмотреть инструкции по установке для открытой версии ClickHouse:
