...
title: 'Учебное руководство и примеры наборов данных'
...
Кроме того, примерные наборы данных позволяют на практике работать с ClickHouse,
осваивать важные приёмы и подходы и видеть, как использовать множество мощных
функций ClickHouse. Примерные наборы данных включают:

{/* Приведённая ниже таблица автоматически генерируется при сборке 
