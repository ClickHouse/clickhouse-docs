...
<VerticalStepper type="numbered">
  ...
  * `message`: тип данных [String](../../sql-reference/data-types/string.md), который заменяет такие типы, как `VARCHAR`, `BLOB`, `CLOB` и другие типы в сторонних системах управления базами данных
  ...
  * первичные ключи в ClickHouse ***не уникальны*** для каждой строки таблицы
  ...
  <Image img={client_details} size="md" alt="параметры подключения для clickhouse client" border />
