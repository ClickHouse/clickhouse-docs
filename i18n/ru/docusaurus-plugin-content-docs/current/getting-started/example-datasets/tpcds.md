...
Вы можете либо использовать исходные определения таблиц в tools/tpcds.sql, либо «оптимизированные» определения таблиц с корректно заданными первичными ключами и типами столбцов LowCardinality там, где это имеет смысл.
...
::::warning
TPC-DS в значительной степени использует коррелированные подзапросы, которые на момент написания этой документации (сентябрь 2024 года) не поддерживаются ClickHouse ([issue #6697](https://github.com/ClickHouse/ClickHouse/issues/6697)).
