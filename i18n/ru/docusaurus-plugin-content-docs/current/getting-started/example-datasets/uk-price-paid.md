---
description: 'Узнайте, как использовать проекции для улучшения производительности запросов, которые вы часто выполняете, используя датасет о ценах на недвижимость в Великобритании, который содержит данные о ценах, уплаченных за недвижимость в Англии и Уэльсе.'
sidebar_label: 'Цены на недвижимость в Великобритании'
sidebar_position: 1
slug: /getting-started/example-datasets/uk-price-paid
title: 'Датасет цен на недвижимость в Великобритании'
---
...
- Игнорирование поля [UUid](../../sql-reference/data-types/uuid.md), так как оно не нужно для анализа.
...
- Преобразование поля `is_new` из строкового значения единичного символа (`Y`/`N`) в поле [UInt8](/sql-reference/data-types/int-uint) с 0 или 1.
...
### Протестируйте это в Плейграунде {#playground}

Датасет также доступен в [Онлайн Плейграунде](https://sql.clickhouse.com?query_id=TRCWH5ZETY4SEEK8ISCCAX).
