---
description: 'Узнайте, как использовать проекции для повышения производительности часто выполняемых запросов на примере набора данных о недвижимости в Великобритании, содержащего данные о ценах, уплаченных за объекты недвижимости в Англии и Уэльсе'
...
doc_type: 'guide'
keywords: ['пример набора данных', 'недвижимость в великобритании', 'пример данных', 'недвижимость', 'начало работы']
---

Этот набор данных содержит цены, уплаченные за объекты недвижимости в Англии и Уэльсе. Данные доступны с 1995 года, а размер набора данных в несжатом виде составляет около 4 GiB (в ClickHouse он займет всего около 278 MiB).
...
- Содержит данные HM Land Registry © Crown copyright and database right 2021. Эти данные лицензированы в соответствии с Open Government Licence v3.0.
...
- игнорирование поля [UUid](../../sql-reference/data-types/uuid.md), поскольку оно не требуется для анализа
...
- удаление последних двух столбцов, поскольку они имеют одинаковое значение (0)
...
В 2020 году с ценами на жилье что-то произошло! Впрочем, это вряд ли удивительно...
...
Эти запросы можно ускорить с помощью проекций. Примеры использования с этим набором данных см. в разделе ["Проекции"](/data-modeling/projections).
