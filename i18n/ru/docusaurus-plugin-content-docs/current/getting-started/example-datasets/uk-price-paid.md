---
description: 'Узнайте, как использовать проекции для повышения производительности часто выполняемых запросов на примере набора данных о недвижимости Великобритании, который содержит данные о ценах, уплаченных за объекты недвижимости в Англии и Уэльсе'
...
Этот набор данных содержит сведения о ценах, уплаченных за объекты недвижимости в Англии и Уэльсе. Данные доступны, начиная с 1995 года, а размер набора данных в несжатом виде составляет около 4 GiB (что в ClickHouse займет всего около 278 MiB).
