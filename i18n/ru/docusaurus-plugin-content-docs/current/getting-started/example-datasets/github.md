...
Мы ограничиваем анализ текущими файлами. Для краткости вывод ограничен глубиной 2 и 5 файлами на каждую корневую папку. При необходимости скорректируйте эти параметры.
