...
### Импорт данных о хитах {#import-the-hits-data}
...
### Импорт данных о визитах {#import-the-visits-data}
...
Наборы данных hits и visits используются в тестовых процедурах ClickHouse, этот запрос — один из запросов тестового набора. Остальные
тесты указаны в разделе *Next Steps* в
конце этой страницы.
...
:::note
Набор тестов использует имя базы данных `test`, а таблицы называются `hits` и `visits`. Вы можете переименовать свою базу данных и таблицы или изменить SQL в тестовом файле.
:::