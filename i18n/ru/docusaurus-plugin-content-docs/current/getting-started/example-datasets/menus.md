...
description: 'Набор данных, содержащий 1,3 миллиона записей исторических данных о меню
  гостиниц, ресторанов и кафе с перечнем блюд и их ценами.'
...
Данные взяты из архивов библиотеки, и они могут быть неполными и неудобными для статистического анализа. Тем не менее они получились очень «аппетитными».
Размер составляет всего 1,3 миллиона записей о блюдах в меню — это очень небольшой объем данных для ClickHouse, но это всё равно хороший пример.
...
- `MenuItem` — элемент меню. Блюдо с указанием цены на определённой странице меню: ссылки на блюдо и страницу меню.
...
Параметр `format_csv_allow_single_quotes` отключён, так как для полей данных используются только двойные кавычки, а одинарные кавычки могут встречаться внутри значений и не должны вводить парсер CSV в заблуждение.

Параметр [input_format_null_as_default](/operations/settings/formats#input_format_null_as_default) отключён, так как данные не содержат [NULL](/operations/settings/formats#input_format_null_as_default). В противном случае ClickHouse будет пытаться разобрать последовательности `\N` и может ошибочно интерпретировать символ `\` в данных.
...
│ 1900 │    1014 │                 0.34 │ ▋                                │ Икра из анчоусов на тосте                                                                                                           │
│ 1910 │    1588 │                 1.35 │ ██▋                              │ 1/1 булочка (Brötchen) с икрой                                                                                                      │
│ 1920 │     927 │                 1.37 │ ██▋                              │ АСТРАХАНСКАЯ ИКРА                                                                                                                   │
│ 1930 │     289 │                 1.91 │ ███▋                             │ Астраханская икра                                                                                                                   │
│ 1940 │     201 │                 0.83 │ █▋                               │ (СПЕЦПРЕДЛОЖЕНИЕ) Бутерброд с отечественной икрой                                                                                   │
│ 1950 │      81 │                 2.27 │ ████▌                            │ Икра белуги                                                                                                                         │
│ 1960 │     126 │                 2.21 │ ████▍                            │ Икра белуги                                                                                                                         │
│ 1970 │     105 │                 0.95 │ █▊                               │ ИКРА БЕЛУГИ МАЛОСОЛЬНАЯ С АМЕРИКАНСКОЙ ЗАПРАВКОЙ                                                                                    │
│ 1980 │      12 │                 7.22 │ ██████████████▍                  │ Подлинная икра белуги из Ирана — лучшая в мире чёрная икра, подаётся на льду с гарниром и образцом охлаждённой 100‑градусной русской водки │
│ 1990 │      74 │                14.42 │ ████████████████████████████▋    │ Салат с авокадо: свежесрезанное авокадо с икрой                                                                                     │
│ 2000 │       3 │                 7.82 │ ███████████████▋                 │ Взбитый картофельный суп с икрой форели                                                                                             │
│ 2010 │       6 │                15.58 │ ███████████████████████████████▏ │ «УСТРИЦЫ И ЖЕМЧУГ»: сабайон из жемчужного тапиоки с устрицами Island Creek и российской икрой севрюги                               │
└──────┴─────────┴──────────────────────┴──────────────────────────────────┴─────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────┘
```

По крайней мере, у них есть икра и водка. Очень неплохо.
