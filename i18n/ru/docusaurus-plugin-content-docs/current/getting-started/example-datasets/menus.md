...
'description': 'Набор данных, содержащий 1.3 миллиона записей исторических данных
  о меню отелей, ресторанов и кафе с блюдами и их ценами.'
'sidebar_label': 'Новый Йорк Публичная Библиотека "Что на меню?" Набор данных'
'slug': '/getting-started/example-datasets/menus'
'title': 'Новый Йорк Публичная Библиотека "Что на меню?" Набор данных'
'doc_type': 'reference'
---
