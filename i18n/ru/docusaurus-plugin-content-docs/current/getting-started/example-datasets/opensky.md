---
description: 'Данные в этом наборе данных получены и очищены из полного набора данных OpenSky для иллюстрации изменения воздушного движения во время пандемии COVID-19.'
slug: /getting-started/example-datasets/opensky
sidebar_label: Данные о воздушном движении
title: 'Краудсорсинговые данные о воздушном движении от Сети OpenSky 2020'
---
...
"Краудсорсинговые данные о воздушном движении от Сети OpenSky 2019–2020"
Earth System Science Data 13(2), 2021
https://doi.org/10.5194/essd-13-357-2021

## Загрузить набор данных {#download-dataset}
...
- Мы также попросили парсить [DateTime](../../sql-reference/data-types/datetime.md) поля с помощью расширенного парсера ([--date_time_input_format best_effort](/operations/settings/formats#date_time_input_format)), чтобы распознавать формат ISO-8601 с учетом смещений часового пояса.

В итоге, `clickhouse-client` выполнит вставку. Он будет читать входные данные в формате [CSVWithNames](../../interfaces/formats.md#csvwithnames).
...
### Количество рейсов из трех основных московских аэропортов, еженедельно {#flights-from-moscow}
...
Вы можете протестировать другие запросы к этому набору данных, используя интерактивный ресурс [Онлайн-площадка](https://sql.clickhouse.com). Например, [вот так](https://sql.clickhouse.com?query_id=BIPDVQNIGVEZFQYFEFQB7O). Однако, пожалуйста, обратите внимание, что вы не можете создавать временные таблицы здесь.
