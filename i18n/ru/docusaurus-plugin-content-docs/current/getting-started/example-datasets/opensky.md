---
description: 'Данные в этом наборе данных получены и очищены из полного набора данных OpenSky, чтобы проиллюстрировать развитие воздушного трафика во время пандемии COVID-19.'
sidebar_label: 'Данные о воздушном трафике'
slug: /getting-started/example-datasets/opensky
title: 'Данные о воздушном трафике с открытых источников от The OpenSky Network 2020'
---
...
"Данные о воздушном трафике с открытых источников от OpenSky Network 2019–2020"
...
- Мы также попросили разобрать поля [DateTime](../../sql-reference/data-types/datetime.md) с расширенным разбором ([--date_time_input_format best_effort](/operations/settings/formats#date_time_input_format)), чтобы распознать формат ISO-8601 с указанными часовыми смещениями.

Наконец, `clickhouse-client` выполнит вставку. Он будет читать входные данные в формате [CSVWithNames](../../interfaces/formats.md#csvwithnames). 
...
Вы можете протестировать другие запросы к этому набору данных, используя интерактивный ресурс [Онлайн-площадка](https://sql.clickhouse.com). Например, [вот так](https://sql.clickhouse.com?query_id=BIPDVQNIGVEZFQYFEFQB7O). Однако обратите внимание, что вы не можете создавать временные таблицы здесь.
