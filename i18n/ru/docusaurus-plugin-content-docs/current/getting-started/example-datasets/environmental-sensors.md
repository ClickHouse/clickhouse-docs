...
Этот запрос займет некоторое время — это примерно 1,67 ТиБ несжатых данных:
...
1,67 ТиБ данных сжаты до 310 ГиБ, а число строк — 20,69 млрд:
...
<Image img={sensors_02} size="md" alt="Слишком жаркие и влажные дни"/>