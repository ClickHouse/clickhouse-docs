...
На этой странице приведены практические рекомендации по выбору подходящей структуры словаря, пониманию того, когда словари обеспечивают более высокую производительность, чем соединения, а когда — нет, а также по мониторингу использования словарей.
