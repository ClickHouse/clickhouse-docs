...
<VerticalStepper level="h2">
  ...
  Набор данных содержит около 30 миллионов строк о ценах на недвижимость в Англии и Уэльсе с 1995 года.
  ...
  чтобы убедиться, что таблица создана на всех узлах кластера:
