...
description: 'Примеры из реальной практики стратегий оптимизации производительности'
---
...
_Это руководство является частью коллекции материалов, полученных на встречах сообщества. Для получения дополнительных практических решений и рекомендаций вы можете [просмотреть материалы по конкретным проблемам](./community-wisdom.md)._
...
Дополнительную информацию о кардинальности и первичных индексах см. в следующих разделах:
...
Когда запрос выполняется медленно, не ограничивайтесь анализом средних значений. Задайте вопрос: «Почему ЭТОТ конкретный запрос был медленным?» и изучите фактические паттерны использования ресурсов.
...
- [Материализованные представления: практический опыт сообщества](./materialized-views.md)
