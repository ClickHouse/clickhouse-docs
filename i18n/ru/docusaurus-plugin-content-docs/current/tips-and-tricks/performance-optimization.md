...
*Это руководство — часть подборки выводов, полученных на встречах сообщества. Чтобы ознакомиться с другими практическими решениями и полезными наблюдениями, вы можете [перейти к обзору по конкретным проблемам](./community-wisdom.md).*
*Возникли сложности с материализованными представлениями? Ознакомьтесь с руководством сообщества [материализованные представления](./materialized-views.md).*
*Если вы сталкиваетесь с медленными запросами и хотите увидеть больше примеров, у нас также есть руководство [Оптимизация запросов](/optimize/query-optimization).*
