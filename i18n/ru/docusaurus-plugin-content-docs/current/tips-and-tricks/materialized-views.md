...
*Это руководство входит в подборку выводов, сделанных по итогам встреч сообщества. Больше практических решений и полезных наблюдений можно найти в [материалах по конкретным проблемам](./community-wisdom.md).*
*Базу данных замедляет слишком большое количество частей? Ознакомьтесь с руководством сообщества [Слишком большое количество частей](./too-many-parts.md).*
