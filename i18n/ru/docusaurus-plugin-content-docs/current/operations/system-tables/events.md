...
keywords: ['системная таблица', 'events']
...
* `event` ([String](../../sql-reference/data-types/)) — Название события.
...
### Количество обработанных Keeper пакетов запросов на чтение \{#keeperreadbatchcount\}

Число пакетов запросов на чтение, обработанных Keeper

### KeeperReadBatchTotalRequests \{#keeperreadbatchtotalrequests\}

Общее количество запросов на чтение, обработанных Keeper в пакетах
...
Сколько частей перемещено в устаревший каталог
