...
- `case_insensitive` ([UInt8](../../sql-reference/data-types/)) — Свойство, показывающее, можно ли использовать имя типа данных в запросе без учёта регистра. Например, `Date` и `date` являются допустимыми вариантами.
