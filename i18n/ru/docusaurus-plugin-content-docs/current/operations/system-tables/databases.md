---
description: 'Системная таблица, содержащая сведения о базах данных, доступных
...
Содержит сведения о базах данных, доступных текущему пользователю.
...
* `comment` ([String](../../sql-reference/data-types/)) — Комментарий базы данных.
