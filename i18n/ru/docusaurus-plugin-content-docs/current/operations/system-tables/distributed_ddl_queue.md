---
description: 'Системная таблица, содержащая информацию о распределенных ddl запросах (запросы, использующие предложение ON CLUSTER), которые были выполнены в кластере.'
...
Содержит информацию о [распределенных ddl запросах (предложение ON CLUSTER)](../../sql-reference/distributed-ddl.md), которые были выполнены в кластере.
...
- `initiator_host` ([Nullable(String)](../../sql-reference/data-types/string.md)) - Хост, инициировавший DDL операцию
