...
* `changes` ([Array(Tuple(name String, previous&#95;value String, new&#95;value String, reason String))](../../sql-reference/data-types/)) — Список изменений настроек, повлиявших на поведение ClickHouse.
