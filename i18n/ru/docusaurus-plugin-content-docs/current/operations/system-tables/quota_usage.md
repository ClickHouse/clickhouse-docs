...
description: 'Системная таблица, содержащая информацию о контроль доступа текущего'
...
- `quota_key` ([String](../../sql-reference/data-types/string.md)) — Значение ключа. Например, если ключи = \[`ip address`\], `quota_key` может иметь значение '192.168.1.1'.
...
- `result_rows` ([Nullable](../../sql-reference/data-types/nullable.md)([UInt64](../../sql-reference/data-types/int-uint.md))) — Общее количество строк, полученных в результате.
