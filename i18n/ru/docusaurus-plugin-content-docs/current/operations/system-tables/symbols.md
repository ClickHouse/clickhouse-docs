...
* `symbol` ([String](../../sql-reference/data-types/)) — Имя символа в бинарном файле. Оно манглировано. Вы можете применить `demangle(symbol)`, чтобы получить читаемое имя.
* `symbol_demangled` ([Nullable(String)](../../sql-reference/data-types/)) — Деманглированное имя символа, используемое для инструментирования XRay.
* `function_id` ([Nullable(Int32)](../../sql-reference/data-types/)) — Идентификатор функции в карте инструментирования XRay.
* `address_begin` ([UInt64](../../sql-reference/data-types/)) — Начальный адрес символа в бинарном файле.
* `address_end` ([UInt64](../../sql-reference/data-types/)) — Конечный адрес символа в бинарном файле.
