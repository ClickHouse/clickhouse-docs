...
keywords: ['системная таблица', 'часовые пояса']
...
Содержит список часовых поясов, поддерживаемых сервером ClickHouse. Этот список часовых поясов может изменяться в зависимости от версии ClickHouse.
