...
Утилита для выполнения операций с дисками ClickHouse, аналогичных операциям в файловой системе. Может работать как в интерактивном, так и в неинтерактивном режиме.
