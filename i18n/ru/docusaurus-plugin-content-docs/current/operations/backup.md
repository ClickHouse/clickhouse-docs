...
### Назначить пароль для резервной копии
...
### Создание базового (начального) бэкапа
...
## BACKUP/RESTORE с использованием диска S3
...
## Настройки для запрета одновременного выполнения резервного копирования и восстановления
