...
<VersionHistory rows={[{"id": "row-1","items": [{"label": "26.4"},{"label": "1800"},{"label": "Интервал фонового обновления набора реплик по умолчанию увеличен до 30 минут"}]}, {"id": "row-2","items": [{"label": "26.3"},{"label": "300"},{"label": "Новая настройка"}]}, {"id": "row-3","items": [{"label": "26.2"},{"label": "300"},{"label": "Новая настройка"}]}]} />
