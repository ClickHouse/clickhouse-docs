...
<VersionHistory rows={[{"id": "row-1","items": [{"label": "26.3"},{"label": "minmax, uniq"},{"label": "Автоматический сбор статистики включён по умолчанию"}]}, {"id": "row-2","items": [{"label": "25.10"},{"label": ""},{"label": "Новая настройка"}]}]}/>
