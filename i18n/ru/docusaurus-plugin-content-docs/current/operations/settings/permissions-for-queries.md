...
При использовании метода `GET` в [HTTP-интерфейсе](../../interfaces/http.md) значение `readonly = 1` устанавливается автоматически. Для изменения данных используйте метод `POST`.
