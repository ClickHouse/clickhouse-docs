...
<VersionHistory rows={[{"id": "row-1","items": [{"label": "26.3"},{"label": "0"},{"label": "Настройка для унаследованного поведения, позволяющая функциям h3 принимать некорректные входные данные"}]}]}/>
