---
sidebar_position: 1
sidebar_label: 'Бета-функции и экспериментальные возможности'
title: 'Бета-функции и экспериментальные возможности'
description: 'В ClickHouse есть бета-функции и экспериментальные возможности. На этой странице документации рассматривается их определение.'
...
Примечание: убедитесь, что вы используете актуальное значение настройки ClickHouse [compatibility](/operations/settings/settings#compatibility), чтобы иметь возможность использовать недавно добавленную функцию.
...
{/* Внутреннее содержимое тегов ниже во время сборки будет заменено таблицей, сгенерированной из исходного кода.
