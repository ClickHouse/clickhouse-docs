...
description: 'В ClickHouse есть бета- и экспериментальные функции. На этой странице документации приводятся их определения.'
...
Примечание: убедитесь, что вы используете актуальную версию параметра [compatibility](/operations/settings/settings#compatibility) ClickHouse для работы с недавно добавленными функциями.
...
## Настройки в бета-версии {#beta-settings}
