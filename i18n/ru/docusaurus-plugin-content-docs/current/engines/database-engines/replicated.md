...
| `allow_skipping_old_temporary_tables_ddls_of_refreshable_materialized_views` | false                          | Если включено, при обработке DDL в реплицируемых базах данных по возможности пропускается создание и обмен DDL временных таблиц refreshable materialized view                                                                                                                                                                                                              |
