...
:::note
В ClickHouse Cloud репликация управляется за вас. Пожалуйста, создавайте свои таблицы без добавления аргументов. Например, в приведенном ниже тексте вы замените:
