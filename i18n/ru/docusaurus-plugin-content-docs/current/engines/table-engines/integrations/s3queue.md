...
:::note Названия настроек (24.7+)
Начиная с версии 24.7, настройки S3Queue можно задавать с префиксом `s3queue_` или без него:
...
Обе формы поддерживаются в 24.7+. В примерах на этой странице используется современный синтаксис без префикса.
:::
