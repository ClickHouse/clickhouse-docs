...
## Обновление данных словарей с помощью LIFETIME {#refreshing-dictionary-data-using-lifetime}
...
##### Пример подключения PostgreSQL {#example-of-connecting-postgresql}
...
## Словари полигонов {#polygon-dictionaries}
...
### Использование словаря Regular Expression Tree в ClickHouse Cloud {#use-regular-expression-tree-dictionary-in-clickhouse-cloud}
