---
description: 'Расширение табличной функции paimon, позволяющее параллельно обрабатывать файлы из Apache Paimon на многих узлах указанного кластера.'
...
- Описание всех остальных аргументов совпадает с описанием аргументов в эквивалентной табличной функции [paimon](/sql-reference/table-functions/paimon.md).

**Возвращаемое значение**

Таблица с указанной структурой для чтения данных из указанной таблицы Paimon в кластере.
