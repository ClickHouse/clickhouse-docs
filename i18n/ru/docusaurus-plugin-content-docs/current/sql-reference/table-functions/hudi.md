---
description: 'Предоставляет интерфейс, подобный таблице, только для чтения к таблицам Apache Hudi в Amazon S3.'
sidebar_label: 'hudi'
sidebar_position: 85
...
- [Функция таблицы hudi cluster](/sql-reference/table-functions/hudiCluster.md)
