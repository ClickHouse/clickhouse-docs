---
description: 'Позволяет параллельно обрабатывать файлы из URL на множестве узлов указанного кластера.'
...
Шаблоны в `{ }` используются для генерации набора шардов или указания резервных (failover) адресов. Поддерживаемые типы шаблонов и примеры см. в описании функции [remote](remote.md#globs-in-addresses).
