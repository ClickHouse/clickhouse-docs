...
Шаблоны в `{ }` используются для формирования набора сегментов или указания резервных адресов. Поддерживаемые типы шаблонов и примеры см. в описании функции [remote](remote.md#globs-in-addresses).
