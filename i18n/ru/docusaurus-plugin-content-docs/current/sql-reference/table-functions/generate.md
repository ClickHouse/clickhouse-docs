---
description: 'Генерирует случайные данные в соответствии с заданной схемой. Позволяет заполнять тестовые таблицы этими данными. Не все типы поддерживаются.'
...
Генерирует случайные данные в соответствии с заданной схемой.
...
В сочетании с [generateRandomStructure](../../sql-reference/functions/other-functions.md#generateRandomStructure):
...
С использованием начального значения генератора случайных чисел как для случайной структуры, так и для случайных данных:
