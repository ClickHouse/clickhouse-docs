...
Представляет содержимое проекции в таблицах MergeTree. Может использоваться для внутреннего анализа.
...
| Аргумент     | Описание                                      |
| ------------ | --------------------------------------------- |
| `database`   | Имя базы данных, из которой читается проекция. |
| `table`      | Имя таблицы, из которой читается проекция.     |
| `projection` | Проекция, из которой выполняется чтение.       |


## Возвращаемое значение {#returned_value}

Табличный объект со столбцами, предоставляемыми заданной проекцией.
