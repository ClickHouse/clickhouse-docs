...
и не ~~[https://storage.cloud.google.com](https://storage.cloud.google.com)~~.
:::
...
Доступ на основе ролей для S3 в ClickHouse Cloud описан [здесь](/cloud/data-sources/secure-s3#setup).
