...
Функция [dense_rank](./dense_rank.md) предоставляет такое же поведение, но без пропусков в ранжировании.
...
Следующий пример основан на примере, представленном в видеоинструкции [Ранжирование оконных функций в ClickHouse](https://youtu.be/Yku9mmBYm_4?si=XIMu1jpYucCQEoXA).
