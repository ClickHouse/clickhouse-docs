---
description: 'Документация для функции окна rank'
sidebar_label: 'rank'
sidebar_position: 6
...
Для получения более подробной информации о синтаксисе функций окон см. [Функции окон - Синтаксис](./index.md/#syntax).

**Возвращаемое значение**

- Число для текущей строки в её разделе, включая пропуски. [UInt64](../data-types/int-uint.md).
