...
keywords: ['clickhouse', 'docs', 'sql справочник', 'sql команды', 'sql', 'синтаксис']
slug: /sql-reference
...
ClickHouse поддерживает декларативный язык запросов, основанный на SQL, который в большинстве случаев идентичен стандарту ANSI SQL.
