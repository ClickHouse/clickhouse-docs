...
Это означает, что в какой-то момент Bitcoin и Ethereum торговались выше $100, а DOGEFI и Bitcoin Diamond никогда не торговались выше $100 (по крайней мере, по имеющимся у нас в этом примере данным).
