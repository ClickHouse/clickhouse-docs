...
Для пользователя по умолчанию ограничьте максимальное время выполнения запросов до половины секунды в течение 30 минут, и ограничьте максимальное количество запросов до 321 и максимально допустимое количество ошибок до 10 в течение 5 кварталов:
