...
Вы можете читать столбцы из полигонных словарей с помощью запроса SELECT, просто включите параметр `store_polygon_key_column = 1` в конфигурации словаря или соответствующем DDL-запросе.
