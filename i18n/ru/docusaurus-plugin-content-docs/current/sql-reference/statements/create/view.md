...
Обратите внимание, что на materialized view влияет настройка [optimize&#95;on&#95;insert](/operations/settings/settings#optimize_on_insert). Данные объединяются перед вставкой в представление.
