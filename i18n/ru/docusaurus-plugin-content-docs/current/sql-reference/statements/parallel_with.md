...
Выполняет команды `statement1`, `statement2`, `statement3`, ... параллельно друг с другом. Результат выполнения этих команд отбрасывается.

Параллельное выполнение команд во многих случаях может быть быстрее, чем их последовательный запуск. Например, `statement1 PARALLEL WITH statement2 PARALLEL WITH statement3` скорее всего будет выполнено быстрее, чем `statement1; statement2; statement3`.
