...
description: 'Документация по знаковым и беззнаковым целочисленным типам данных в ClickHouse,
  с разрядностью от 8 до 256 бит'
...
ClickHouse предоставляет ряд целочисленных типов данных фиксированной длины
со знаком (`Int`) или без знака (беззнаковые `UInt`) с размером от одного до 32 байт.
...
Целочисленные типы имеют следующие диапазоны значений:
...
Беззнаковые целочисленные типы имеют следующие диапазоны значений:
