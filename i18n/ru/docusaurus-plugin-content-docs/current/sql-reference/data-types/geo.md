...
`Geometry` — это общий тип для всех перечисленных выше типов. Он эквивалентен типу Variant, объединяющему эти типы. При использовании типа Geometry необходимо включить следующую настройку: `SET allow_suspicious_variant_types = 1`
