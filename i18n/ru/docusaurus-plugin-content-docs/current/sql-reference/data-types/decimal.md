...
Знаковые числа с фиксированной запятой, сохраняющие точность при сложении, вычитании и умножении. При делении младшие значащие разряды отбрасываются (без округления).
...
## Проверка переполнения \{#overflow-checks\}
