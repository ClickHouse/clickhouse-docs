...
Системная таблица [system.data_type_families](/operations/system-tables/data_type_families) содержит сведения обо всех доступных типах данных.
В ней также указано, является ли тип данных псевдонимом другого типа данных и чувствительно ли его имя к регистру (например, `bool` и `BOOL`).