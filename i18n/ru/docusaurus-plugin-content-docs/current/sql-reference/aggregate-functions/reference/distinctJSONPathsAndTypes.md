...
Вычисляет список уникальных путей и их типов данных, хранящихся в столбце [JSON](../../data-types/newjson.md).
...
* Отсортированное отображение путей и типов, [Map(String, Array(String))](../../data-types/map.md).
