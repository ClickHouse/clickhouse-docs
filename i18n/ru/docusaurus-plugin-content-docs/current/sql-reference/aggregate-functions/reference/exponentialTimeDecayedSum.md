...
* `x` — Интервал времени, за который вес значения убывает до 1/e. [Integer](../../../sql-reference/data-types/int-uint.md), [Float](../../../sql-reference/data-types/float.md) или [Decimal](../../../sql-reference/data-types/decimal.md).

**Возвращаемые значения**

* Возвращает сумму значений скользящего среднего с экспоненциальным сглаживанием в заданный момент времени. [Float64](../../data-types/float.md).
