---
description: 'Вычисляет максимум по массиву `value` в соответствии с ключами, заданными в массиве `key`.'
...
* Передача кортежа, содержащего массивы ключей и значений, эквивалентна передаче двух отдельных массивов ключей и значений.
