...
* `timestamp` — метка времени выборки. Может быть отдельным значением или массивом. - `value` — значение временного ряда, соответствующее этой метке времени. Может быть отдельным значением или массивом.
