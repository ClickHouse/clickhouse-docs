...
* Общая длина объединения всех диапазонов (отрезков числовой оси). В зависимости от типа аргументов возвращаемое значение может иметь тип [UInt64](/sql-reference/data-types/int-uint#integer-ranges) или [Float64](/sql-reference/data-types/float).
