...
Функция использует [округление к нулю](https://en.wikipedia.org/wiki/Rounding#Rounding_towards_zero). Отбрасываются десятичные знаки, незначимые для результирующего типа данных.
