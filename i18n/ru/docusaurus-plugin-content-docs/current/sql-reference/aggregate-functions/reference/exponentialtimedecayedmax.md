...
description: "Возвращает максимальное значение вычисленного экспоненциально сглаженного скользящего среднего по индексу `t` во времени по сравнению с `t-1`."
---

## exponentialTimeDecayedMax {#exponentialtimedecayedmax}

Возвращает максимальное значение вычисленного экспоненциально сглаженного скользящего среднего по индексу `t` во времени по сравнению с `t-1`.
...
- Возвращает максимальное значение экспоненциально сглаженного взвешенного скользящего среднего на `t` и `t-1`. [Float64](../../data-types/float.md).
