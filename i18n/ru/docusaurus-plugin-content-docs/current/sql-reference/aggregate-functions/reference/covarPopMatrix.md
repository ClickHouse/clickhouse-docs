...
Добавлена в версии: v23.2.0

Возвращает матрицу генеральной ковариации между N переменными.
...
* `x1[, x2, ...]` — произвольное количество аргументов. [`(U)Int*`](/sql-reference/data-types/int-uint) или [`Float*`](/sql-reference/data-types/float) или [`Decimal`](/sql-reference/data-types/decimal)

**Возвращаемое значение**

Возвращает матрицу ковариации генеральной совокупности. [`Array(Array(Float64))`](/sql-reference/data-types/array)

**Примеры**

**Простой пример вычисления матрицы ковариации генеральной совокупности**
