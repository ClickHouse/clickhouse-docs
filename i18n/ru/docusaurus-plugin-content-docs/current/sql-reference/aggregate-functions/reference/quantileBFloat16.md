...
Вычисляет приближённый [квантиль](https://en.wikipedia.org/wiki/Quantile) выборки из чисел типа [bfloat16](https://en.wikipedia.org/wiki/Bfloat16_floating-point_format).
...
Функция представляет собой быстрый оцениватель квантиля с максимальной относительной погрешностью `0.78125%` (и средней относительной погрешностью приблизительно `0.27%`), что соответствует точности 7-битной мантиссы `bfloat16`.
