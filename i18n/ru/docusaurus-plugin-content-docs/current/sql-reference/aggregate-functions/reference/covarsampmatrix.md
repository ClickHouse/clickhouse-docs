...
Возвращает выборочную матрицу ковариации по N переменным.
...
- Выборочная матрица ковариации. [Array](../../data-types/array.md)([Array](../../data-types/array.md)([Float64](../../data-types/float.md))).
