...
* `t` — Время. Тип: [Integer](../../../sql-reference/data-types/int-uint.md), [Float](../../../sql-reference/data-types/float.md) или [Decimal](../../../sql-reference/data-types/decimal.md), а также [DateTime](../../data-types/datetime.md) или [DateTime64](../../data-types/datetime64.md).
...
* Возвращает значение накопленного экспоненциального затухания в заданный момент времени. [Float64](../../data-types/float.md).
