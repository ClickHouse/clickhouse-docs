...
* Отсортированный словарь путей и типов [Map(String, Array(String))](../../data-types/map.md).
...
Если в JSON-декларации указаны пути с заданными типами, эти пути всегда будут включены в результат функций `distinctJSONPaths/distinctJSONPathsAndTypes`, даже если во входных данных отсутствовали значения для этих путей.
