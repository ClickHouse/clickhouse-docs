...
Впервые представлена в версии: v21.12.0
...
Впервые представлена в: v21.12.0
...
Впервые появилось в версии v22.1.0
...
Возвращает нижнюю границу (включительно) соответствующего tumbling-окна.
...
Возвращает нижнюю (включительную) границу соответствующего tumbling-окна. [`DateTime`](/sql-reference/data-types/datetime)
