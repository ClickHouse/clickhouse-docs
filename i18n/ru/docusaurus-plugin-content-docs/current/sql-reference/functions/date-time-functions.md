...
:::note
Для совместимости со стандартом SQL следующие функции — `NOW`, `CURRENT_TIMESTAMP`, `TODAY` и `CURRENT_DATE` — можно использовать без круглых скобок.
:::

{/* 
  Внутреннее содержимое следующих тегов во время сборки фреймворка документации
...
**Вычисление возраста в разных единицах измерения**
...
**Вычисление разницы между датами в разных единицах**
...
Впервые представлена в: v22.6.0
...
**Синтаксис стандартного SQL без круглых скобок**
...
Представлена начиная с версии v1.1.0
...
**Эквивалент функции dateDiff с единицей измерения «секунды»**
...
**ISO‑неделя может относиться к другому календарному году**
...
Впервые представлена в версии v25.3.0
...
`date` — дата или дата со временем. `Date` или `DateTime` или `DateTime64`
...
**Стандартный синтаксис SQL без круглых скобок**
