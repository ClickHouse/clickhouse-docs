...
Все функции в этом разделе принимают ноль или один аргумент. Единственное использование аргумента (если предоставлен) заключается в предотвращении [устранения общих подвыражений](/sql-reference/functions/overview#common-subexpression-elimination), чтобы два разных выполнения одной и той же случайной функции в строке возвращали разные случайные значения.
...
```response
1569354847 -- Примечание: Фактический вывод будет случайным числом, а не указанным в примере.
```
...
```response
15030268859237645412 -- Примечание: Фактический вывод будет случайным числом, а не указанным в примере.
```
...
```response
0.3452178901234567 - Примечание: Фактический вывод будет случайным числом Float64 в диапазоне от 0 до 1, а не указанным в примере.
```
...
Возвращает случайное число Float64, полученное из [нормального распределения](https://en.wikipedia.org/wiki/Normal_distribution).
...
Возвращает случайное число Float64, полученное из [логнормального распределения](https://en.wikipedia.org/wiki/Log-normal_distribution).
...
Возвращает случайное число UInt64, полученное из [биномиального распределения](https://en.wikipedia.org/wiki/Binomial_distribution).
...
Возвращает случайное число UInt64, полученное из [негативного биномиального распределения](https://en.wikipedia.org/wiki/Negative_binomial_distribution).
...
Возвращает случайное число UInt64, полученное из [распределения Пуассона](https://en.wikipedia.org/wiki/Poisson_distribution).
...
Возвращает случайное число UInt64, полученное из [бернуллиевского распределения](https://en.wikipedia.org/wiki/Bernoulli_distribution).
...
Возвращает случайное число Float64, полученное из [экспоненциального распределения](https://en.wikipedia.org/wiki/Exponential_distribution).
...
Возвращает случайное число Float64, полученное из [распределения хи-квадрат](https://en.wikipedia.org/wiki/Chi-squared_distribution) - распределения суммы квадратов k независимых стандартных нормальных случайных переменных.
...
Возвращает случайное число Float64, полученное из [распределения Стьюдента](https://en.wikipedia.org/wiki/Student%27s_t-distribution).
...
Возвращает случайное число Float64, полученное из [распределения F](https://en.wikipedia.org/wiki/F-distribution).
...
Генерирует строку с случайным набором [ASCII](https://en.wikipedia.org/wiki/ASCII#Printable_characters) символов. Все символы печатаемы. Если вы передаете `length < 0`, поведение функции непредсказуемо.
...
- Строка со случайным набором печатаемых [ASCII](https://en.wikipedia.org/wiki/ASCII#Printable_characters) символов. [String](../data-types/string.md)
