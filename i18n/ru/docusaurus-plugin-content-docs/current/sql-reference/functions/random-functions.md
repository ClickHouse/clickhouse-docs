...
Все функции в этом разделе принимают ноль или один аргумент. Единственное использование аргумента (если он предоставлен) - это предотвращение [устранения общих подвыражений](/sql-reference/functions/overview#common-subexpression-elimination), так что два разных выполнения одной и той же случайной функции в пределах строки возвращают разные случайные значения.
...
```response
0.3452178901234567 - Примечание: Фактический вывод будет случайным Float64 числом между 0 и 1, а не конкретным числом, показанным в примере.
```
...
Возвращает случайное Float64 число, выборка из [нормального распределения](https://en.wikipedia.org/wiki/Normal_distribution).
...
Возвращает случайное Float64 число, выборка из [логнормального распределения](https://en.wikipedia.org/wiki/Log-normal_distribution).
...
Возвращает случайное UInt64 число, выборка из [биномиального распределения](https://en.wikipedia.org/wiki/Binomial_distribution).
...
Возвращает случайное UInt64 число, выборка из [негативного биномиального распределения](https://en.wikipedia.org/wiki/Negative_binomial_distribution).
...
Возвращает случайное UInt64 число, выборка из [распределения Пуассона](https://en.wikipedia.org/wiki/Poisson_distribution).
...
Возвращает случайное UInt64 число, выборка из [распределения Бернулли](https://en.wikipedia.org/wiki/Bernoulli_distribution).
...
Возвращает случайное Float64 число, выборка из [экспоненциального распределения](https://en.wikipedia.org/wiki/Exponential_distribution).
...
Возвращает случайное Float64 число, выборка из [распределения Хи-квадрат](https://en.wikipedia.org/wiki/Chi-squared_distribution) - распределение суммы квадратов k независимых стандартных нормально распределенных случайных переменных.
...
Возвращает случайное Float64 число, выборка из [t-распределения Стьюдента](https://en.wikipedia.org/wiki/Student%27s_t-distribution).
...
Возвращает случайное Float64 число, выборка из [F-распределения](https://en.wikipedia.org/wiki/F-distribution).
...
Генерирует строку с случайным набором печатаемых [ASCII](https://en.wikipedia.org/wiki/ASCII#Printable_characters) символов. Все символы печатаемы. Если вы передаете `length < 0`, поведение функции не определено.
