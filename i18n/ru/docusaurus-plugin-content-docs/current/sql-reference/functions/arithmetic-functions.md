...
Возвращает `1`, если аргумент типа Float32, Float64 или BFloat16 не является бесконечностью и не является `NaN`,
...
* `x` — Число, которое нужно проверить на конечность. [`Float*`](/sql-reference/data-types/float) или [`BFloat16`](/sql-reference/data-types/float)
...
Возвращает `1`, если аргумент типа Float32, Float64 или BFloat16 является бесконечным числом; в противном случае функция возвращает `0`.
...
* `x` — Число для проверки на бесконечность. [`Float*`](/sql-reference/data-types/float) или [`BFloat16`](/sql-reference/data-types/float)
...
Возвращает `1`, если аргумент типа Float32, Float64 или BFloat16 является `NaN`, в противном случае возвращает `0`.
...
* `x` — Аргумент, проверяемый на значение `NaN`. [`Float*`](/sql-reference/data-types/float) или [`BFloat16`](/sql-reference/data-types/float)
...
Функция впервые появилась в версии v21.11.0
...
Впервые представлена в версии: v21.11.0
...
Также можно складывать дату и время. Сложение `Date` и `Time`
даёт `DateTime`. Сложение `Date` и `Time64`, либо `Date32` и
`Time` или `Time64`, даёт `DateTime64`.
