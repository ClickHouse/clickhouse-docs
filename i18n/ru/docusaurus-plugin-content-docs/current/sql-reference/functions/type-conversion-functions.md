...
ClickHouse использует [такое же поведение, как программы на C++](https://en.cppreference.com/w/cpp/language/implicit_conversion).

Функции `to<type>` и [cast](#cast) ведут себя по-разному в некоторых случаях, например, в случае [LowCardinality](../data-types/lowcardinality.md): [cast](#cast) удаляет признак [LowCardinality](../data-types/lowcardinality.md), тогда как функции `to<type>` нет. То же касается [Nullable](../data-types/nullable.md), это поведение не совместимо со стандартом SQL, и его можно изменить с помощью настройки [cast_keep_nullable](../../operations/settings/settings.md/#cast_keep_nullable).

:::note
Обратите внимание на потенциальную потерю данных, если значения типа данных преобразуются в меньший тип данных (например, из `Int64` в `Int32`) или между несовместимыми типами данных (например, из `String` в `Int`). Убедитесь, что результат соответствует ожиданиям.
:::
...
Преобразует входное значение в значение типа [`Bool`](../data-types/boolean.md). Выдает исключение в случае ошибки.
...
Преобразует входное значение в значение типа [`Int8`](../data-types/int-uint.md). Выдает исключение в случае ошибки.
...
:::note
Функция использует [округление к нулю](https://en.wikipedia.org/wiki/Rounding#Rounding_towards_zero), что означает, что дробные цифры чисел отбрасываются.
:::
...
- 8-битное целое значение, если успешно, иначе `0`. [Int8](../data-types/int-uint.md).
...
- 8-битное целое значение, если успешно, иначе `NULL`. [Int8](../data-types/int-uint.md) / [NULL](../data-types/nullable.md).
...
- `default` (опционально) — Значение по умолчанию, которое следует вернуть, если преобразование в тип `Int8` не удалось. [Int8](../data-types/int-uint.md).
...
- 8-битное целое значение, если успешно, иначе возвращается значение по умолчанию, если оно было передано, или `0`, если нет. [Int8](../data-types/int-uint.md).
...
Преобразует входное значение в значение типа [`Int16`](../data-types/int-uint.md). Выдает исключение в случае ошибки.
...
- 16-битное целое значение, если успешно, иначе `0`. [Int16](../data-types/int-uint.md).
...
- 16-битное целое значение, если успешно, иначе `NULL`. [Int16](../data-types/int-uint.md) / [NULL](../data-types/nullable.md).
...
- `expr` — Выражение, возвращающее число или строковое представление числа. [Выражение](/sql-reference/syntax#expressions) / [String](../data-types/string.md).
- `default` (опционально) — Значение по умолчанию, которое следует вернуть, если преобразование в тип `Int16` не удалось. [Int16](../data-types/int-uint.md).
...
- 16-битное целое значение, если успешно, иначе возвращает значение по умолчанию, если оно было передано, или `0`, если нет. [Int16](../data-types/int-uint.md).
...
Преобразует входное значение в значение типа [`Int32`](../data-types/int-uint.md). Выдает исключение в случае ошибки.
...
- 32-битное целое значение, если успешно, иначе `0`. [Int32](../data-types/int-uint.md)
...
- 32-битное целое значение, если успешно, иначе `NULL`. [Int32](../data-types/int-uint.md) / [NULL](../data-types/nullable.md).
...
- `expr` — Выражение, возвращающее число или строковое представление числа. [Выражение](/sql-reference/syntax#expressions) / [String](../data-types/string.md).
- `default` (опционально) — Значение по умолчанию, которое следует вернуть, если преобразование в тип `Int32` не удалось. [Int32](../data-types/int-uint.md).
...
- 32-битное целое значение, если успешно, иначе возвращает значение по умолчанию, если оно было передано, или `0`, если нет. [Int32](../data-types/int-uint.md).
...
Преобразует входное значение в значение типа [`Int64`](../data-types/int-uint.md). Выдает исключение в случае ошибки.
...
- 64-битное целое значение, если успешно, иначе `0`. [Int64](../data-types/int-uint.md).
...
- 64-битное целое значение, если успешно, иначе `NULL`. [Int64](../data-types/int-uint.md) / [NULL](../data-types/nullable.md).
...
- `expr` — Выражение, возвращающее число или строковое представление числа. [Выражение](/sql-reference/syntax#expressions) / [String](../data-types/string.md).
- `default` (опционально) — Значение по умолчанию, которое следует вернуть, если преобразование в тип `Int64` не удалось. [Int64](../data-types/int-uint.md).
...
- 64-битное целое значение, если успешно, иначе возвращает значение по умолчанию, если было передано, или `0`, если нет. [Int64](../data-types/int-uint.md).
...
Преобразует входное значение в значение типа [`Int128`](../data-types/int-uint.md). Вызывает исключение в случае ошибки.
...
- `expr` — Выражение, возвращающее число или строковое представление числа. [Выражение](/sql-reference/syntax#expressions) / [Строка](../data-types/string.md).
- `default` (необязательный) — Значение по умолчанию для возврата, если преобразование в тип `Int128` невозможно. [Int128](../data-types/int-uint.md).
...
- 128-битное целое число, если успешно, в противном случае возвращает значение по умолчанию, если оно передано, или `0`, если не передано. [Int128](../data-types/int-uint.md).
...
Преобразует входное значение в значение типа [`Int256`](../data-types/int-uint.md). Вызывает исключение в случае ошибки.
...
- `expr` — Выражение, возвращающее число или строковое представление числа. [Выражение](/sql-reference/syntax#expressions) / [Строка](../data-types/string.md).
- `default` (необязательный) — Значение по умолчанию для возврата, если преобразование в тип `Int256` невозможно. [Int256](../data-types/int-uint.md).
...
- 256-битное целое число, если успешно, в противном случае возвращает значение по умолчанию, если оно передано, или `0`, если не передано. [Int256](../data-types/int-uint.md).
...
Преобразует входное значение в значение типа [`UInt8`](../data-types/int-uint.md). Вызывает исключение в случае ошибки.
...
- `expr` — Выражение, возвращающее число или строковое представление числа. [Выражение](/sql-reference/syntax#expressions) / [Строка](../data-types/string.md).
- `default` (необязательный) — Значение по умолчанию для возврата, если преобразование в тип `UInt8` невозможно. [UInt8](../data-types/int-uint.md).
...
- 8-битное беззнаковое целое число, если успешно, в противном случае возвращает значение по умолчанию, если оно передано, или `0`, если не передано. [UInt8](../data-types/int-uint.md).
...
Преобразует входное значение в значение типа [`UInt16`](../data-types/int-uint.md). Вызывает исключение в случае ошибки.
...
- `expr` — Выражение, возвращающее число или строковое представление числа. [Выражение](/sql-reference/syntax#expressions) / [Строка](../data-types/string.md).
- `default` (необязательный) — Значение по умолчанию для возврата, если преобразование в тип `UInt16` невозможно. [UInt16](../data-types/int-uint.md).
...
- 16-битное беззнаковое целое число, если успешно, в противном случае возвращает значение по умолчанию, если оно передано, или `0`, если не передано. [UInt16](../data-types/int-uint.md).
...
Преобразует входное значение в значение типа [`UInt32`](../data-types/int-uint.md). Вызывает исключение в случае ошибки.
...
, что означает, что она обрезает дробные цифры чисел.
:::
...
- 32-битное беззнаковое целое число, если успешно, иначе `NULL`. [UInt32](../data-types/int-uint.md) / [NULL](../data-types/nullable.md).

:::note
Функция использует [округление к нулю](https://en.wikipedia.org/wiki/Rounding#Rounding_towards_zero), то есть она отсекает дробные цифры чисел.
:::
...
Если значение `default` не передано, вернется `0` в случае ошибки.
...
- `default` (необязательный) — значение по умолчанию, которое будет возвращено, если преобразование в тип `UInt32` не удалось. [UInt32](../data-types/int-uint.md).
...
- 32-битное беззнаковое целое число, если успешно, иначе возвращает значение по умолчанию, если передано, или `0`, если нет. [UInt32](../data-types/int-uint.md).
...
- 64-битное целое число без знака. [UInt64](../data-types/int-uint.md).
...
- 64-битное беззнаковое целое число, если успешно, иначе `0`. [UInt64](../data-types/int-uint.md).
...
- 64-битное беззнаковое целое число, если успешно, иначе `NULL`. [UInt64](../data-types/int-uint.md) / [NULL](../data-types/nullable.md).
...
- `expr` — выражение, возвращающее число или строковое представление числа. [Expression](/sql-reference/syntax#expressions) / [String](../data-types/string.md).
- `default` (необязательный) — значение по умолчанию, которое будет возвращено, если преобразование в тип `UInt64` не удалось. [UInt64](../data-types/int-uint.md).
...
- 64-битное беззнаковое целое число, если успешно, иначе возвращает значение по умолчанию, если передано, или `0`, если нет. [UInt64](../data-types/int-uint.md).
...
- 128-битное целое число без знака. [UInt128](../data-types/int-uint.md).
...
- 128-битное беззнаковое целое число, если успешно, иначе `0`. [UInt128](../data-types/int-uint.md).
...
- 128-битное беззнаковое целое число, если успешно, иначе `NULL`. [UInt128](../data-types/int-uint.md) / [NULL](../data-types/nullable.md).
...
- `expr` — выражение, возвращающее число или строковое представление числа. [Expression](/sql-reference/syntax#expressions) / [String](../data-types/string.md).
- `default` (необязательный) — значение по умолчанию, которое будет возвращено, если преобразование в тип `UInt128` не удалось. [UInt128](../data-types/int-uint.md).
...
- 128-битное беззнаковое целое число, если успешно, иначе возвращает значение по умолчанию, если передано, или `0`, если нет. [UInt128](../data-types/int-uint.md).
...
- 256-битное беззнаковое целое число, если успешно, иначе `0`. [UInt256](../data-types/int-uint.md).
...
- 256-битное беззнаковое целое число, если успешно, иначе `NULL`. [UInt256](../data-types/int-uint.md) / [NULL](../data-types/nullable.md).
...
- `expr` — выражение, возвращающее число или строковое представление числа. [Expression](/sql-reference/syntax#expressions) / [String](../data-types/string.md).
- `default` (необязательный) — значение по умолчанию, которое будет возвращено, если преобразование в тип `UInt256` не удалось. [UInt256](../data-types/int-uint.md).
...
- 256-битное беззнаковое целое число, если успешно, иначе возвращает значение по умолчанию, если передано, или `0`, если нет. [UInt256](../data-types/int-uint.md).
...
- Строковые представления Float32/64, включая `NaN` и `Inf` (нечувствительно к регистру).
...
- 32-битное значение с плавающей запятой, если успешно, иначе `0`. [Float32](../data-types/float.md).
...
- 32-битное значение с плавающей запятой, если успешно, иначе `\N`. [Float32](../data-types/float.md).
...
- `expr` — выражение, возвращающее число или строковое представление числа. [Expression](/sql-reference/syntax#expressions) / [String](../data-types/string.md).
- `default` (необязательный) — значение по умолчанию, которое будет возвращено, если преобразование в тип `Float32` не удалось. [Float32](../data-types/float.md).
...
- 32-битное значение с плавающей запятой, если успешно, иначе возвращает значение по умолчанию, если передано, или `0`, если нет. [Float32](../data-types/float.md).
...
- Строковые представления (U)Int8/16/32/128/256.
- Значения типа Float32/64, включая `NaN` и `Inf`.
- Строковые представления типа Float32/64, включая `NaN` и `Inf` (нечувствительно к регистру).
...
- 64-битное значение типа Float, если успешно, иначе `0`. [Float64](../data-types/float.md).
...
- 64-битное значение типа Float, если успешно, иначе `\N`. [Float64](../data-types/float.md).
...
- `expr` — Выражение, возвращающее число или строковое представление числа. [Expression](/sql-reference/syntax#expressions) / [String](../data-types/string.md).
- `default` (необязательный) — Значение по умолчанию для возврата, если преобразование в тип `Float64` не удалось. [Float64](../data-types/float.md).
...
- 64-битное значение типа Float, если успешно, иначе возвращается значение по умолчанию, если оно передано, или `0`, если не передано. [Float64](../data-types/float.md).
...
- 16-битное значение типа brain-float. [BFloat16](/sql-reference/data-types/float#bfloat16).
...
Преобразует строковое входное значение в значение типа [`BFloat16`](/sql-reference/data-types/float#bfloat16). Если строка не представляет собой число с плавающей запятой, функция возвращает ноль.
...
- 16-битное значение типа brain-float, иначе `0`. [BFloat16](/sql-reference/data-types/float#bfloat16).
...
Преобразует строковое входное значение в значение типа [`BFloat16`](/sql-reference/data-types/float#bfloat16), но если строка не представляет собой число с плавающей запятой, функция возвращает `NULL`.
...
- 16-битное значение типа brain-float, иначе `NULL` (`\N`). [BFloat16](/sql-reference/data-types/float#bfloat16).
...
Если аргумент имеет тип [DateTime](../data-types/datetime.md) или [DateTime64](../data-types/datetime64.md), он обрезает его и оставляет только компонент даты:
...
Если аргумент является [String](../data-types/string.md), он парсится как [Date](../data-types/date.md) или [DateTime](../data-types/datetime.md). Если он был распарсен как [DateTime](../data-types/datetime.md), используется компонент даты:
...
Если аргумент является числом и выглядит как UNIX временная метка (больше 65535), он интерпретируется как [DateTime](../data-types/datetime.md), затем обрезается до [Date](../data-types/date.md) в текущем часовом поясе. Аргумент часового пояса может быть указан как второй аргумент функции. Обрезка до [Date](../data-types/date.md) зависит от часового пояса:
...
Если аргумент является числом и меньше 65536, он интерпретируется как количество дней с 1970-01-01 (первого UNIX дня) и преобразуется в [Date](../data-types/date.md). Это соответствует внутреннему числовому представлению типа `Date`. Пример:
...
То же самое, что и [toDate](#todate), но возвращает нижнюю границу типа [Date](../data-types/date.md), если получен неверный аргумент. Поддерживается только аргумент [String](../data-types/string.md).
...
То же самое, что и [toDate](#todate), но возвращает `NULL`, если получен неверный аргумент. Поддерживается только аргумент [String](../data-types/string.md).
...
Как и [toDate](#todate), но в случае неудачи возвращает значение по умолчанию, которое либо является вторым аргументом (если указано), либо, в противном случае, нижней границей типа [Date](../data-types/date.md).
...
:::note
Если `expr` — это число, оно интерпретируется как количество секунд с начала эпохи Unix (как метка времени Unix).
Если `expr` — это [String](../data-types/string.md), он может интерпретироваться как метка времени Unix или как строковое представление даты / даты с временем.
Таким образом, парсинг коротких строковых представлений чисел (до 4 цифр) явно отключен из-за двусмысленности, например, строка `'1999'` может быть как годом (недостаточное строковое представление типа Date / DateTime), так и меткой времени Unix. Более длинные числовые строки разрешены.
:::
...
То же самое, что и [toDateTime](#todatetime), но возвращает нижнюю границу типа [DateTime](../data-types/datetime.md), если получен неверный аргумент. Поддерживается только аргумент [String](../data-types/string.md).
...
То же самое, что и [toDateTime](#todatetime), но возвращает `NULL`, если получен неверный аргумент. Поддерживается только аргумент [String](../data-types/string.md).
...
Как и [toDateTime](#todatetime), но в случае неудачи возвращает значение по умолчанию, которое либо является третьим аргументом (если задано), либо, в противном случае, нижней границей типа [DateTime](../data-types/datetime.md).
...
Преобразует аргумент в тип [Date32](../data-types/date32.md). Если значение выходит за пределы, `toDate32` возвращает граничные значения, поддерживаемые [Date32](../data-types/date32.md). Если аргумент имеет тип [Date](../data-types/date.md), учитываются его границы.
...
То же самое, что и [toDate32](#todate32), но возвращает минимальное значение типа [Date32](../data-types/date32.md), если получен неверный аргумент.
...
То же самое, что и [toDate32](#todate32), но возвращает `NULL`, если получен неверный аргумент.
...
Преобразует аргумент в тип [Date32](../data-types/date32.md). Если значение выходит за пределы, `toDate32OrDefault` возвращает нижнюю границу, поддерживаемую [Date32](../data-types/date32.md). Если аргумент имеет тип [Date](../data-types/date.md), учитываются его границы. Возвращает значение по умолчанию, если получен неверный аргумент.
...
- Календарная дата и время с точностью до долей секунды. [DateTime64](../data-types/datetime64.md).
...
Как и [toDateTime64](#todatetime64), эта функция преобразует входное значение в значение типа [DateTime64](../data-types/datetime64.md), но возвращает минимальное значение [DateTime64](../data-types/datetime64.md), если получен неверный аргумент.
...
- Календарная дата и время с точностью до долей секунды, иначе минимальное значение `DateTime64`: `1970-01-01 01:00:00.000`. [DateTime64](../data-types/datetime64.md).
...
Как и [toDateTime64](#todatetime64), эта функция преобразует входное значение в значение типа [DateTime64](../data-types/datetime64.md), но возвращает `NULL`, если получен неверный аргумент.
...
- Календарная дата и время с точностью до долей секунды, иначе `NULL`. [DateTime64](../data-types/datetime64.md)/[NULL](../data-types/nullable.md).
...
либо предоставленное значение по умолчанию, если получен неверный аргумент.
...
- Календарная дата и время с точностью до долей секунды, иначе минимальное значение `DateTime64` или значение `default`, если оно предоставлено. [DateTime64](../data-types/datetime64.md).
...
- `expr` — Выражение, возвращающее число или строковое представление числа. [Expression](/sql-reference/syntax#expressions).
- `S` — Параметр масштаба от 0 до 9, указывающий, сколько знаков может содержать дробная часть числа. [UInt8](../data-types/int-uint.md).
...
Неподдерживаемые аргументы:
- Значения или строковые представления Float32/64 значений `NaN` и `Inf` (без учета регистра).
...
Неподдерживаемые аргументы:
- Строковые представления Float32/64 значений `NaN` и `Inf`.
...
- Значение типа `Nullable(Decimal(9, S))`, если операция успешна, иначе значение `NULL` того же типа. [Decimal32(S)](../data-types/decimal.md).
...
- `expr` — Строковое представление числа. [String](../data-types/string.md).
- `S` — Параметр масштаба от 0 до 9, указывающий, сколько цифр может содержать дробная часть числа. [UInt8](../data-types/int-uint.md).
- `default` (необязательный) — Значение по умолчанию, которое возвращается, если преобразование в тип `Decimal32(S)` не удалось. [Decimal32(S)](../data-types/decimal.md).
...
- Значение типа `Decimal(9, S)`, если операция успешна, в противном случае возвращает значение по умолчанию, если оно передано, или `0`, если нет. [Decimal32(S)](../data-types/decimal.md).
...
- `expr` — Выражение, возвращающее число или строковое представление числа. [Expression](/sql-reference/syntax#expressions).
- `S` — Параметр масштаба от 0 до 18, указывающий, сколько цифр может содержать дробная часть числа. [UInt8](../data-types/int-uint.md).
...
- Значение типа `Decimal(18, S)`, если операция успешна, иначе `0` с `S` десятичными знаками. [Decimal64(S)](../data-types/decimal.md).
...
- Значение типа `Nullable(Decimal(18, S))`, если операция успешна, иначе значение `NULL` того же типа. [Decimal64(S)](../data-types/decimal.md).
...
- `expr` — Строковое представление числа. [String](../data-types/string.md).
- `S` — Параметр масштаба от 0 до 18, указывающий, сколько цифр может содержать дробная часть числа. [UInt8](../data-types/int-uint.md).
- `default` (необязательный) — Значение по умолчанию, которое возвращается, если преобразование в тип `Decimal64(S)` не удалось. [Decimal64(S)](../data-types/decimal.md).
...
- Значение типа `Decimal(18, S)`, если операция успешна, в противном случае возвращает значение по умолчанию, если оно передано, или `0`, если нет. [Decimal64(S)](../data-types/decimal.md).
...
- `expr` — Выражение, возвращающее число или строковое представление числа. [Expression](/sql-reference/syntax#expressions).
- `S` — Параметр масштаба от 0 до 38, указывающий, сколько цифр может содержать дробная часть числа. [UInt8](../data-types/int-uint.md).
...
- Значение типа `Decimal(38, S)` если операция успешна, иначе `0` с `S` десятичными знаками. [Decimal128(S)](../data-types/decimal.md).
...
- Значение типа `Nullable(Decimal(38, S))`, если операция успешна, иначе значение `NULL` того же типа. [Decimal128(S)](../data-types/decimal.md).
...
- `expr` — Строковое представление числа. [String](../data-types/string.md).
- `S` — Параметр масштаба от 0 до 38, указывающий, сколько цифр может содержать дробная часть числа. [UInt8](../data-types/int-uint.md).
- `default` (необязательный) — Значение по умолчанию, которое возвращается, если преобразование в тип `Decimal128(S)` не удалось. [Decimal128(S)](../data-types/decimal.md).
...
- Значение типа `Decimal(38, S)`, если операция успешна, иначе возвращает значение по умолчанию, если оно передано, или `0`, если нет. [Decimal128(S)](../data-types/decimal.md).
...
- Значение типа `Decimal(76, S)`, если операция успешна, иначе `0` с `S` десятичными знаками. [Decimal256(S)](../data-types/decimal.md).
...
- Значение типа `Nullable(Decimal(76, S))`, если операция успешна, иначе значение `NULL` того же типа. [Decimal256(S)](../data-types/decimal.md).
...
- `expr` — Строковое представление числа. [String](../data-types/string.md).
- `S` — Параметр масштаба от 0 до 76, указывающий, сколько цифр может содержать дробная часть числа. [UInt8](../data-types/int-uint.md).
- `default` (необязательный) — Значение по умолчанию, которое возвращается, если преобразование в тип `Decimal256(S)` не удалось. [Decimal256(S)](../data-types/decimal.md).
...
- Значение типа `Decimal(76, S)`, если операция успешна, иначе возвращает значение по умолчанию, если оно передано, или `0`, если нет. [Decimal256(S)](../data-types/decimal.md).
...
В качестве исключения, если осуществляется преобразование из типов чисел UInt32, Int32, UInt64 или Int64 в Date, и если число больше или равно 65536, число интерпретируется как Unix timestamp (а не как количество дней) и округляется до даты. Это позволяет поддерживать распространенное использование `toDate(unix_timestamp)`, что в противном случае вызвало бы ошибку и потребовало бы более громоздкого `toDate(toDateTime(unix_timestamp))`.
...
Дополнительно, функция toString с аргументом DateTime может принимать второй аргумент String, содержащий название временной зоны. Пример: `Asia/Yekaterinburg`. В этом случае время форматируется в соответствии с указанной временной зоной.
...
Преобразует аргумент типа [String](../data-types/string.md) в тип [FixedString(N)](../data-types/fixedstring.md) (строка фиксированной длины N). Если строка содержит меньше байт, чем N, она дополняется нулевыми байтами справа. Если строка содержит больше байт, чем N, выбрасывается исключение.
...
- `number` — Значение, представляющее собой строку, [Int, UInt](../data-types/int-uint.md), [Float](../data-types/float.md), [Decimal](../data-types/decimal.md).
...
- Входное значение, представленное в виде [String](../data-types/string.md) с заданным количеством дробных цифр (scale). Число округляется вверх или вниз в соответствии с общими арифметическими правилами, если запрашиваемая шкала меньше шкалы исходного числа.
...
Выполняет переинтерпретацию байтов, рассматривая входное значение как значение типа UInt8. В отличие от [`CAST`](#cast), функция не пытается сохранить исходное значение — если целевой тип не может представить входной тип, вывод становится бессмысленным.
...
- `x`: значение, которое нужно переинтерпретировать как UInt8. [(U)Int*](../data-types/int-uint.md), [Float](../data-types/float.md), [Date](../data-types/date.md), [DateTime](../data-types/datetime.md), [UUID](../data-types/uuid.md), [String](../data-types/string.md) или [FixedString](../data-types/fixedstring.md).
...
Выполняет переинтерпретацию байтов, рассматривая входное значение как значение типа UInt16. В отличие от [`CAST`](#cast), функция не пытается сохранить исходное значение — если целевой тип не может представить входной тип, вывод становится бессмысленным.
...
- `x`: значение, которое нужно переинтерпретировать как UInt16. [(U)Int*](../data-types/int-uint.md), [Float](../data-types/float.md), [Date](../data-types/date.md), [DateTime](../data-types/datetime.md), [UUID](../data-types/uuid.md), [String](../data-types/string.md) или [FixedString](../data-types/fixedstring.md).
...
Выполняет переинтерпретацию байтов, рассматривая входное значение как значение типа UInt32. В отличие от [`CAST`](#cast), функция не пытается сохранить исходное значение — если целевой тип не может представить входной тип, вывод становится бессмысленным.
...
- `x`: значение, которое нужно переинтерпретировать как UInt32. [(U)Int*](../data-types/int-uint.md), [Float](../data-types/float.md), [Date](../data-types/date.md), [DateTime](../data-types/datetime.md), [UUID](../data-types/uuid.md), [String](../data-types/string.md) или [FixedString](../data-types/fixedstring.md).
...
Выполняет переинтерпретацию байтов, рассматривая входное значение как значение типа UInt64. В отличие от [`CAST`](#cast), функция не пытается сохранить исходное значение — если целевой тип не может представить входной тип, вывод становится бессмысленным.
...
- `x`: значение, которое нужно переинтерпретировать как UInt64. [(U)Int*](../data-types/int-uint.md), [Float](../data-types/float.md), [Date](../data-types/date.md), [DateTime](../data-types/datetime.md), [UUID](../data-types/uuid.md), [String](../data-types/string.md) или [FixedString](../data-types/fixedstring.md).
...
Выполняет переинтерпретацию байтов, рассматривая входное значение как значение типа UInt128. В отличие от [`CAST`](#cast), функция не пытается сохранить исходное значение — если целевой тип не может представить входной тип, вывод становится бессмысленным.
...
- `x`: значение, которое нужно переинтерпретировать как UInt128. [(U)Int*](../data-types/int-uint.md), [Float](../data-types/float.md), [Date](../data-types/date.md), [DateTime](../data-types/datetime.md), [UUID](../data-types/uuid.md), [String](../data-types/string.md) или [FixedString](../data-types/fixedstring.md).
...
Выполняет переинтерпретацию байтов, рассматривая входное значение как значение типа UInt256. В отличие от [`CAST`](#cast), функция не пытается сохранить исходное значение — если целевой тип не может представить входной тип, вывод становится бессмысленным.
...
- `x`: значение, которое нужно переинтерпретировать как UInt256. [(U)Int*](../data-types/int-uint.md), [Float](../data-types/float.md), [Date](../data-types/date.md), [DateTime](../data-types/datetime.md), [UUID](../data-types/uuid.md), [String](../data-types/string.md) или [FixedString](../data-types/fixedstring.md).
...
Выполняет переинтерпретацию байтов, рассматривая входное значение как значение типа Int8. В отличие от [`CAST`](#cast), функция не пытается сохранить исходное значение — если целевой тип не может представить входной тип, вывод становится бессмысленным.
...
- `x`: значение, которое нужно переинтерпретировать как Int8. [(U)Int*](../data-types/int-uint.md), [Float](../data-types/float.md), [Date](../data-types/date.md), [DateTime](../data-types/datetime.md), [UUID](../data-types/uuid.md), [String](../data-types/string.md) или [FixedString](../data-types/fixedstring.md).
...
Выполняет переинтерпретацию байтов, рассматривая входное значение как значение типа Int16. В отличие от [`CAST`](#cast), функция не пытается сохранить исходное значение — если целевой тип не может представить входной тип, вывод становится бессмысленным.
...
- `x`: значение, которое нужно переинтерпретировать как Int16. [(U)Int*](../data-types/int-uint.md), [Float](../data-types/float.md), [Date](../data-types/date.md), [DateTime](../data-types/datetime.md), [UUID](../data-types/uuid.md), [String](../data-types/string.md) или [FixedString](../data-types/fixedstring.md).
...
Выполняет переинтерпретацию байтов, рассматривая входное значение как значение типа Int32. В отличие от [`CAST`](#cast), функция не пытается сохранить исходное значение — если целевой тип не может представить входной тип, вывод становится бессмысленным.
...
- `x`: значение, которое нужно переинтерпретировать как Int32. [(U)Int*](../data-types/int-uint.md), [Float](../data-types/float.md), [Date](../data-types/date.md), [DateTime](../data-types/datetime.md), [UUID](../data-types/uuid.md), [String](../data-types/string.md) или [FixedString](../data-types/fixedstring.md).
...
Выполняет переинтерпретацию байтов, рассматривая входное значение как значение типа Int64. В отличие от [`CAST`](#cast), функция не пытается сохранить исходное значение — если целевой тип не может представить входной тип, вывод становится бессмысленным.
...
- `x`: значение, которое нужно переинтерпретировать как Int64. [(U)Int*](../data-types/int-uint.md), [Float](../data-types/float.md), [Date](../data-types/date.md), [DateTime](../data-types/datetime.md), [UUID](../data-types/uuid.md), [String](../data-types/string.md) или [FixedString](../data-types/fixedstring.md).
...
Выполняет переинтерпретацию байтов, рассматривая входное значение как значение типа Int128. В отличие от [`CAST`](#cast), функция не пытается сохранить исходное значение — если целевой тип не может представить входной тип, вывод становится бессмысленным.
...
- `x`: значение, которое нужно переинтерпретировать как Int128. [(U)Int*](../data-types/int-uint.md), [Float](../data-types/float.md), [Date](../data-types/date.md), [DateTime](../data-types/datetime.md), [UUID](../data-types/uuid.md), [String](../data-types/string.md) или [FixedString](../data-types/fixedstring.md).
...
Выполняет переинтерпретацию байтов, рассматривая входное значение как значение типа Int256. В отличие от [`CAST`](#cast), функция не пытается сохранить исходное значение — если целевой тип не может представить входной тип, вывод становится бессмысленным.
...
- `x`: значение, которое нужно переинтерпретировать как Int256. [(U)Int*](../data-types/int-uint.md), [Float](../data-types/float.md), [Date](../data-types/date.md), [DateTime](../data-types/datetime.md), [UUID](../data-types/uuid.md), [String](../data-types/string.md) или [FixedString](../data-types/fixedstring.md).
...
Выполняет переинтерпретацию байтов, рассматривая входное значение как значение типа Float32. В отличие от [`CAST`](#cast), функция не пытается сохранить исходное значение — если целевой тип не может представить входной тип, вывод становится бессмысленным.
...
- `x`: значение, которое нужно переинтерпретировать как Float32. [(U)Int*](../data-types/int-uint.md), [Float](../data-types/float.md), [Date](../data-types/date.md), [DateTime](../data-types/datetime.md), [UUID](../data-types/uuid.md), [String](../data-types/string.md) или [FixedString](../data-types/fixedstring.md).
...
Выполняет переинтерпретацию байтов, рассматривая входное значение как значение типа Float64. В отличие от [`CAST`](#cast), функция не пытается сохранить исходное значение — если целевой тип не может представить входной тип, вывод становится бессмысленным.
...
- `x`: значение, которое нужно переинтерпретировать как Float64. [(U)Int*](../data-types/int-uint.md), [Float](../data-types/float.md), [Date](../data-types/date.md), [DateTime](../data-types/datetime.md), [UUID](../data-types/uuid.md), [String](../data-types/string.md) или [FixedString](../data-types/fixedstring.md).
...
- `x`: значение, которое нужно переинтерпретировать в строку. [(U)Int*](../data-types/int-uint.md), [Float](../data-types/float.md), [Date](../data-types/date.md), [DateTime](../data-types/datetime.md).
...
:::note
В дополнение к функциям UUID, перечисленным здесь, есть специализированная [документация по функциям UUID](../functions/uuid-functions.md).
:::
...
Преобразует входное значение в указанный тип данных. В отличие от функции [reinterpret](#reinterpret), `CAST` пытается представить одно и то же значение с помощью нового типа данных. Если преобразование невозможно, выбрасывается исключение. Поддерживается несколько вариантов синтаксиса.
...
:::note
Если входное значение не укладывается в пределы целевого типа, результат переполняется. Например, `CAST(-1, 'UInt8')` возвращает `255`.
:::
...
Разница с [cast](#cast) заключается в том, что `accurateCast` не позволяет переполнение числовых типов во время преобразования, если значение типа `x` не помещается в границы типа `T`. Например, `accurateCast(-1, 'UInt8')` выдает исключение.
...
Преобразует входное значение `x` в указанный тип данных `T`. Возвращает значение по умолчанию или `default_value`, если указано, если преобразованное значение не может быть представлено в целевом типе.
...
Возвращает интервал из `n` лет типа [IntervalYear](../data-types/special-data-types/interval.md).
...
- Интервал из `n` лет. [IntervalYear](../data-types/special-data-types/interval.md).
...
Возвращает интервал из `n` кварталов типа [IntervalQuarter](../data-types/special-data-types/interval.md).
...
Возвращает интервал из `n` месяцев типа [IntervalMonth](../data-types/special-data-types/interval.md).
...
- Интервал из `n` месяцев. [IntervalMonth](../data-types/special-data-types/interval.md).
...
Возвращает интервал из `n` недель типа [IntervalWeek](../data-types/special-data-types/interval.md).
...
- Интервал из `n` недель. [IntervalWeek](../data-types/special-data-types/interval.md).
...
Возвращает интервал из `n` дней типа [IntervalDay](../data-types/special-data-types/interval.md).
...
- Интервал из `n` дней. [IntervalDay](../data-types/special-data-types/interval.md).
...
Возвращает интервал из `n` часов типа [IntervalHour](../data-types/special-data-types/interval.md).
...
- Интервал из `n` часов. [IntervalHour](../data-types/special-data-types/interval.md).
...
Возвращает интервал из `n` минут типа [IntervalMinute](../data-types/special-data-types/interval.md).
...
- Интервал из `n` минут. [IntervalMinute](../data-types/special-data-types/interval.md).
...
Возвращает интервал из `n` секунд типа [IntervalSecond](../data-types/special-data-types/interval.md).
...
- Интервал из `n` секунд. [IntervalSecond](../data-types/special-data-types/interval.md).
...
Возвращает интервал из `n` миллисекунд типа [IntervalMillisecond](../data-types/special-data-types/interval.md).
...
- Интервал из `n` миллисекунд. [IntervalMilliseconds](../data-types/special-data-types/interval.md).
...
Возвращает интервал из `n` микросекунд типа [IntervalMicrosecond](../data-types/special-data-types/interval.md).
...
- Интервал из `n` микросекунд. [IntervalMicrosecond](../data-types/special-data-types/interval.md).
...
Возвращает интервал из `n` наносекунд типа [IntervalNanosecond](../data-types/special-data-types/interval.md).
...
- Интервал из `n` наносекунд. [IntervalNanosecond](../data-types/special-data-types/interval.md).
...
Эта функция является обратной операцией функции [formatDateTime](/sql-reference/functions/date-time-functions#formatdatetime).
...
Возврат значения [DateTime](../data-types/datetime.md), разобранного из входной строки в соответствии со строкой формата в стиле MySQL.
...
Так же, как и для [parseDateTime](#parsedatetime), за исключением того, что он возвращает нулевую дату, когда встречает формат даты, который невозможно обработать.

## parseDateTimeOrNull {#parsedatetimeornull}

Так же, как и для [parseDateTime](#parsedatetime), за исключением того, что возвращает `NULL`, когда встречает формат даты, который невозможно обработать.

Псевдоним: `str_to_date`.

## parseDateTimeInJodaSyntax {#parsedatetimeinjodasyntax}

Аналогично [parseDateTime](#parsedatetime), за исключением того, что строка формата находится в [Joda](https://joda-time.sourceforge.net/apidocs/org/joda/time/format/DateTimeFormat.html) вместо MySQL синтаксиса.

Эта функция является обратной операцией функции [formatDateTimeInJodaSyntax](/sql-reference/functions/date-time-functions#formatdatetimeinjodasyntax).
...
Возврат значения [DateTime](../data-types/datetime.md), разобранного из входной строки в соответствии со строкой формата в стиле Joda.
...
Так же, как и для [parseDateTimeInJodaSyntax](#parsedatetimeinjodasyntax), за исключением того, что возвращает нулевую дату, когда встречает формат даты, который невозможно обработать.

## parseDateTimeInJodaSyntaxOrNull {#parsedatetimeinjodasyntaxornull}

Так же, как и для [parseDateTimeInJodaSyntax](#parsedatetimeinjodasyntax), за исключением того, что возвращает `NULL`, когда встречает формат даты, который невозможно обработать.
...
Возврат значения [DateTime64](../data-types/datetime64.md), разобранного из входной строки в соответствии со строкой формата в стиле MySQL.
Точность возвращаемого значения составляет 6.

## parseDateTime64OrZero {#parsedatetime64orzero}

Так же, как и для [parseDateTime64](#parsedatetime64), за исключением того, что возвращает нулевую дату, когда встречает формат даты, который невозможно обработать.

## parseDateTime64OrNull {#parsedatetime64ornull}

Так же, как и для [parseDateTime64](#parsedatetime64), за исключением того, что возвращает `NULL`, когда встречает формат даты, который невозможно обработать.
...
Возврат значения [DateTime64](../data-types/datetime64.md), разобранного из входной строки в соответствии со строкой формата в стиле Joda.
Точность возвращаемого значения равна количеству `S` заполнителей в строке формата (но не более 6).

## parseDateTime64InJodaSyntaxOrZero {#parsedatetime64injodasyntaxorzero}

Так же, как и для [parseDateTime64InJodaSyntax](#parsedatetime64injodasyntax), за исключением того, что возвращает нулевую дату, когда встречает формат даты, который невозможно обработать.

## parseDateTime64InJodaSyntaxOrNull {#parsedatetime64injodasyntaxornull}

Так же, как и для [parseDateTime64InJodaSyntax](#parsedatetime64injodasyntax), за исключением того, что возвращает `NULL`, когда встречает формат даты, который невозможно обработать.
...
Функция разбирает [ISO 8601](https://en.wikipedia.org/wiki/ISO_8601), [RFC 1123 - 5.2.14 RFC-822 Date and Time Specification](https://tools.ietf.org/html/rfc1123#page-55), форматы даты и времени ClickHouse и некоторые другие.
...
Для всех форматов с разделителем функция разбирает названия месяцев, выраженные их полным названием или первыми тремя буквами названия месяца. Примеры: `24/DEC/18`, `24-Dec-18`, `01-September-2018`.
...
- `time_string`, преобразованное в тип данных [DateTime](../data-types/datetime.md).
...
Эта функция ведет себя как [parseDateTimeBestEffort](#parsedatetimebesteffort) для ISO форматов даты, например, `YYYY-MM-DD hh:mm:ss`, и других форматов даты, где компоненты месяца и даты могут быть однозначно извлечены, например, `YYYYMMDDhhmmss`, `YYYY-MM`, `DD hh`, или `YYYY-MM-DD hh:mm:ss ±h:mm`. Если компоненты месяца и даты нельзя однозначно извлечь, например, `MM/DD/YYYY`, `MM-DD-YYYY` или `MM-DD-YY`, она предпочитает американский формат даты вместо `DD/MM/YYYY`, `DD-MM-YYYY` или `DD-MM-YY`. В качестве исключения, если месяц больше 12 и меньше или равен 31, эта функция возвращается к поведению [parseDateTimeBestEffort](#parsedatetimebesteffort), например, `15/08/2020` разобран как `2020-08-15`.

## parseDateTimeBestEffortOrNull {#parsedatetimebesteffortornull}
## parseDateTime32BestEffortOrNull {#parsedatetime32besteffortornull}

Так же, как и для [parseDateTimeBestEffort](#parsedatetimebesteffort), за исключением того, что возвращает `NULL`, когда встречает формат даты, который невозможно обработать.

## parseDateTimeBestEffortOrZero {#parsedatetimebesteffortorzero}
## parseDateTime32BestEffortOrZero {#parsedatetime32besteffortorzero}

Так же, как и для [parseDateTimeBestEffort](#parsedatetimebesteffort), за исключением того, что возвращает нулевую дату или нулевое время даты, когда встречает формат даты, который невозможно обработать.

## parseDateTimeBestEffortUSOrNull {#parsedatetimebesteffortusornull}

Так же, как и функция [parseDateTimeBestEffortUS](#parsedatetimebesteffortus), за исключением того, что возвращает `NULL`, когда встречает формат даты, который невозможно обработать.

## parseDateTimeBestEffortUSOrZero {#parsedatetimebesteffortusorzero}

Так же, как и функция [parseDateTimeBestEffortUS](#parsedatetimebesteffortus), за исключением того, что возвращает нулевую дату (`1970-01-01`) или нулевую дату с временем (`1970-01-01 00:00:00`), когда встречает формат даты, который невозможно обработать.

## parseDateTime64BestEffort {#parsedatetime64besteffort}

Так же, как и функция [parseDateTimeBestEffort](#parsedatetimebesteffort), но также разбирает миллисекунды и микросекунды и возвращает тип данных [DateTime](/sql-reference/data-types/datetime).
...
Так же, как и для [parseDateTime64BestEffort](#parsedatetime64besteffort), за исключением того, что эта функция предпочитает американский формат даты (`MM/DD/YYYY` и т.д.) в случае неясности.

## parseDateTime64BestEffortOrNull {#parsedatetime64besteffortornull}

Так же, как и для [parseDateTime64BestEffort](#parsedatetime64besteffort), за исключением того, что возвращает `NULL`, когда встречает формат даты, который невозможно обработать.

## parseDateTime64BestEffortOrZero {#parsedatetime64besteffortorzero}

Так же, как и для [parseDateTime64BestEffort](#parsedatetime64besteffort), за исключением того, что возвращает нулевую дату или нулевую дату с временем, когда встречает формат даты, который невозможно обработать.

## parseDateTime64BestEffortUSOrNull {#parsedatetime64besteffortusornull}

Так же, как для [parseDateTime64BestEffort](#parsedatetime64besteffort), за исключением того, что эта функция предпочитает американский формат даты (`MM/DD/YYYY` и т.д.) в случае неясности и возвращает `NULL`, когда встречает формат даты, который невозможно обработать.

## parseDateTime64BestEffortUSOrZero {#parsedatetime64besteffortusorzero}

Так же, как для [parseDateTime64BestEffort](#parsedatetime64besteffort), за исключением того, что эта функция предпочитает американский формат даты (`MM/DD/YYYY` и т.д.) в случае неясности и возвращает нулевую дату или нулевую дату с временем, когда встречает формат даты, который невозможно обработать.
...
- `expr` — [Выражение](/sql-reference/syntax#expressions), resulting in one of the [supported data types](/sql-reference/data-types).
...
Преобразует `DateTime64` в значение `Int64` с фиксированной миллисекундной точностью. Входное значение масштабируется вверх или вниз в зависимости от его точности.
...
Преобразует `DateTime64` в значение `Int64` с фиксированной точностью микросекунд. Входное значение масштабируется вверх или вниз в зависимости от его точности.
...
Преобразует `DateTime64` в значение `Int64` с фиксированной точностью наносекунд. Входное значение масштабируется вверх или вниз в зависимости от его точности.
...
Преобразует `Int64` в значение `DateTime64` с фиксированной точностью секунды и необязательной часовой зоной. Входное значение масштабируется вверх или вниз в зависимости от его точности.
...
- `timezone` — (необязательный) название часовой зоны результата. [String](../data-types/string.md).
...
Преобразует `Int64` в значение `DateTime64` с фиксированной точностью миллисекунд и необязательной часовой зоной. Входное значение масштабируется вверх или вниз в зависимости от его точности.
...
Преобразует `Int64` в значение `DateTime64` с фиксированной точностью микросекунд и необязательной часовой зоной. Входное значение масштабируется вверх или вниз в зависимости от его точности.
...
Преобразует `Int64` в значение `DateTime64` с фиксированной точностью наносекунд и необязательной часовой зоной. Входное значение масштабируется вверх или вниз в зависимости от его точности.
