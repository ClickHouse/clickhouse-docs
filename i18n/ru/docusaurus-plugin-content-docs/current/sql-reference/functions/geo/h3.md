...
* 1 — число является допустимым индексом H3. [UInt8](../../data-types/int-uint.md).
* 0 — число не является допустимым индексом H3. [UInt8](../../data-types/int-uint.md).
...
* Массив, содержащихся индексов H3. [Array](../../data-types/array.md)([UInt64](../../data-types/int-uint.md)).
...
Возвращает шестиугольники (с указанным разрешением), покрывающие переданную геометрию — Ring или (Multi)Polygon — с использованием экспериментальных режимов включения H3.

Эта функция сопоставляет `flags` с режимами включения H3:
...
* `geometry` может быть одним из следующих [гео-типов данных](../../data-types/geo.md) или лежащих в их основе примитивных типов:
  * [Ring](../../data-types/geo.md#ring)
  * [Polygon](../../data-types/geo.md#polygon)
  * [MultiPolygon](../../data-types/geo.md#multipolygon)
* `resolution` — разрешение индекса. Диапазон: `[0, 15]`. [UInt8](../../data-types/int-uint.md).
* `flags` — режим охвата. Диапазон: `[0, 3]`. Используйте целочисленные литералы, такие как `0`, `1`, `2` и `3`, или значения [UInt32](../../data-types/int-uint.md) (например, `toUInt32(2)`). Значения передаются в H3 API как `UInt32`. Другие встроенные целочисленные типы преобразуются с точным приведением.
...
* Номер шестиугольного индекса. В случае ошибки возвращает 0. [UInt64](../../data-types/int-uint.md).
...
Возвращает расстояние по дуге большого круга (формула гаверсинуса, haversine) между парами точек GeoCoord (широта/долгота), в километрах.
...
* Расстояние по формуле гаверсинуса (по дуге большого круга) в километрах. [Float64](../../data-types/float.md).
...
Возвращает расстояние по «дуге большого круга» (great-circle distance) или по формуле «haversine» между парами точек GeoCoord (широта/долгота) в радианах.
...
* `start` — номер шестиугольного индекса, представляющий начальную точку. [UInt64](../../data-types/int-uint.md).
* `end` — номер шестиугольного индекса, представляющий конечную точку. [UInt64](../../data-types/int-uint.md).
...
* `index` — номер шестиугольного индекса, представляющего исходную ячейку. [UInt64](../../data-types/int-uint.md).
...
* `edge` — индекс гексагона, представляющего однонаправленное ребро. [UInt64](../../data-types/int-uint.md).
...
Возвращает координаты, определяющие однонаправленное ребро.
