...
`geo_data` может быть одним из следующих [геометрических типов Geo-данных](../../data-types/geo.md) или соответствующих им примитивных типов:
...
MULTIPOLYGON из многомерного массива кортежей:
...
#### Многоугольник, описывающий территорию Зимбабве {#polygon-representing-zimbabwe}
