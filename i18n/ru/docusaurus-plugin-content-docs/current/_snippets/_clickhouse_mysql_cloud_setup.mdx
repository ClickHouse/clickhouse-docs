title: 'Создание пользователей MySQL в ClickHouse Cloud'
sidebar_label: 'Создание пользователей MySQL'
keywords: ['MySQL', 'ClickHouse Cloud', 'пользователи', 'аутентификация', 'настройки']
description: 'Инструкция по созданию нескольких пользователей MySQL в ClickHouse Cloud.'
```
