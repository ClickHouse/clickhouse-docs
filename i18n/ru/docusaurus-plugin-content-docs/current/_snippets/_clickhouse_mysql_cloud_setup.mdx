title: 'Создание нескольких MySQL пользователей в ClickHouse Cloud'
sidebar_label: 'Создание нескольких MySQL пользователей'
keywords: ['ClickHouse', 'MySQL', 'пользователи', 'репликация', 'база данных']
description: 'Инструкция по созданию нескольких MySQL пользователей в ClickHouse Cloud.'
```
