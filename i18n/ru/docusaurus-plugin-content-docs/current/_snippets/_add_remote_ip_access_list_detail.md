...
<details>
  ...
  В списке сервисов ClickHouse Cloud выберите сервис, с которым будете работать, и перейдите в раздел **Settings**. Если в IP Access List нет IP-адреса или диапазона адресов удалённой системы, которой нужно подключаться к вашему сервису ClickHouse Cloud, вы можете решить проблему с помощью **Add IPs**:
  ...
  <Image size="md" img={ip_allow_list_add_current_ip} alt="Добавьте текущий IP-адрес в IP Access List в ClickHouse Cloud" border />
</details>
