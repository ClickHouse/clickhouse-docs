...
<details>
    <summary>Создание корзин GCS и HMAC-ключа</summary>
...
<Image
  size='md'
  img={GCS_bucket_1}
  alt='Создание корзины GCS в регионе US East 1'
  border
/>
...
<Image
  size='md'
  img={GCS_bucket_2}
  alt='Создание корзины GCS в регионе US East 4'
  border
/>
...
Откройте **Cloud Storage > Settings > Interoperability** и либо выберите существующий **Access key**, либо нажмите **CREATE A KEY FOR A SERVICE ACCOUNT**. В данном руководстве описывается процесс создания нового ключа для новой сервисной учетной записи.
...
Если в проекте отсутствует сервисная учетная запись, нажмите **CREATE NEW ACCOUNT**.
...
Третий шаг является необязательным и не рассматривается в данном руководстве. Вы можете предоставить пользователям соответствующие привилегии в соответствии с вашими политиками безопасности.
