...
Пользователи могут применить режим `APPEND` при построении [архитектуры Medallion](https://clickhouse.com/blog/building-a-medallion-architecture-for-bluesky-json-data-with-clickhouse).
