...
* У вас есть возможность вынести обработку из ClickHouse во внешние системы, такие как [Flink](/integrations/data-ingestion/apache-flink/flink-connector.md), где можно управлять обогащением данных в реальном времени или их уплощением (flattening).
