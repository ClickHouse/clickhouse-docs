...
ClickHouse имеет экспериментальную поддержку E2K (Elbrus-2000) и может быть собран только в нативном режиме с минимальной конфигурацией, с использованием специально собранных для E2K библиотек, таких как boost, jemalloc, libunwind и zstd.
