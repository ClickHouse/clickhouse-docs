...
Работу по денормализации можно выполнять либо в ClickHouse, либо в upstream‑системах, например с использованием [Apache Flink](/integrations/data-ingestion/apache-flink/flink-connector.md).
...
Аналогично, такие ссылки тоже не встречаются слишком часто:
