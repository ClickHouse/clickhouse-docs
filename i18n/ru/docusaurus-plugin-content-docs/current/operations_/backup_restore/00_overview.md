...
| [Резервное копирование/восстановление с использованием конечной точки S3](./02_s3_endpoint.md)           | Описывает резервное копирование/восстановление на конечную точку S3 и с нее                   |
...
| [Резервное копирование с помощью снимков](./05_snapshot.md)                                               | Легковесные снимки для таблиц SharedMergeTree с использованием облачного объектного хранилища |
