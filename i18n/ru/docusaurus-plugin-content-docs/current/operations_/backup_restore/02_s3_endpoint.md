...
title: 'Резервное копирование и восстановление в/из S3-эндпоинта'
doc_type: 'guide'
---
...
В этой статье рассматривается создание резервных копий и их восстановление в корзину S3 или из неё
