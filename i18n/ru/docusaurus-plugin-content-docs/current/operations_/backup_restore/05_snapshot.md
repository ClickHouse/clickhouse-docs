---
description: 'Как создавать и восстанавливать облегчённые снимки облачных таблиц с использованием облачного объектного хранилища.'
...
# Резервное копирование и восстановление снимков \{#snapshot-backup-and-restore\}
