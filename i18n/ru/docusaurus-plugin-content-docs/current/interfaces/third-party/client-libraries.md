---
description: 'Обзор доступных сторонних клиентских библиотек для различных языков программирования'
...
:::note
Компания ClickHouse Inc **не** поддерживает перечисленные ниже библиотеки и не проводила их всестороннее тестирование для оценки качества.
:::
...
- [Расширение PHP для ClickHouse от kolya7k](https://github.com//kolya7k/clickhouse-php)
