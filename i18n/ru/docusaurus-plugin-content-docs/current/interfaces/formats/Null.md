...
Это может показаться странным, но важно отметить, что несмотря на отсутствие вывода, запрос всё равно обрабатывается,
а при использовании клиента командной строки данные передаются клиенту.
...
Запрос обработает данные, но не выведет никакого результата.
