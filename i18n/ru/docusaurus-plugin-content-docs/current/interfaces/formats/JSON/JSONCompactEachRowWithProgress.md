---
alias: []
description: 'Документация о формате JSONCompactEachRowWithProgress'
input_format: false
...
- Сначала выводит метаданные с названиями и типами столбцов
- Каждая строка — отдельный JSON-объект с ключом "row", содержащим массив значений
