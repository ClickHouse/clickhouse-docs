...
Чтобы прочитать данные, выведенные в этом формате, вы можете использовать [MySQLDump](../formats/MySQLDump.md) как входной формат.
...
| [`output_format_sql_insert_quote_names`](../../operations/settings/settings-formats.md/#output_format_sql_insert_quote_names)             | Обрамлять имена столбцов символами "\`".            | `true`       |
