...
Это полезно для вычисления «отпечатка» результата, например, в ситуациях, когда передача данных является узким местом.
...
Чтение данных с использованием формата `Hash`:
...
Запрос обработает данные, но не выведет результат.
