...
| `DURATION`                              | [Interval](/sql-reference/data-types/special-data-types/interval.md) (наносекунда/микросекунда/миллисекунда/секунда) | `DURATION`                  |
| `INT64`                                 | [Interval](/sql-reference/data-types/special-data-types/interval.md) (минута/час/день/неделя/месяц/квартал/год)      | `INT64`                     |
...
|--------------------------------------------------------------------------------------------------------------------------|---------------------------------------------------------------------------------------------------------------------------|------------------------|
| `input_format_arrow_allow_missing_columns`                                                                               | Разрешать отсутствие столбцов при чтении входных форматов Arrow                                                           | `1`                    |
...
| `input_format_arrow_skip_columns_with_unsupported_types_in_schema_inference`                                             | Пропускать столбцы с неподдерживаемыми типами при выводе (определении) схемы для формата Arrow                            | `0`                    |
