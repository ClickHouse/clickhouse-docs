...
Также выводит две строки заголовка с названиями и типами столбцов, аналогично формату [TabSeparatedWithNamesAndTypes](../TabSeparated/TabSeparatedWithNamesAndTypes.md).
...
Используйте следующий текстовый файл с именем `football.txt`:
