...
Преимущество в производительности обусловлено фундаментальным архитектурным различием:

| Аспект                  | NVMe-хранилище (управляемый Postgres) | Сетевое хранилище (Provisioned IOPS)           |
|-------------------------|---------------------------------------|------------------------------------------------|
...
| **Масштабирование производительности** | Масштабируется линейно с ростом параллелизма | Ограничено выделенными IOPS                    |

Для получения дополнительной информации о преимуществах производительности NVMe-хранилища см. [NVMe-powered performance](/cloud/managed-postgres#nvme-performance).
...
* [Обзор управляемого Postgres](/cloud/managed-postgres)
