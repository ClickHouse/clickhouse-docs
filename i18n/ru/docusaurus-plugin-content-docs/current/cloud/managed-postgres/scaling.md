...
:::tip
Из соображений безопасности вам может не удаться переключиться на типы инстансов, объём хранилища которых близок к текущему объёму используемого хранилища. Чтобы избежать проблем, всегда выбирайте типы инстансов с запасом по сравнению с текущим используемым объёмом.
:::
