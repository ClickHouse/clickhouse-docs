...
либо драйвер JDBC или ODBC, предоставляемый вендором системы.
...
:::info Важно
В примерах в этом руководстве используются команды Linux для запуска `clickhouse-local` (`./clickhouse-local`).
