...
из вашей текущей системы баз данных в облачное объектное хранилище, а затем на втором шаге перенести эти данные в таблицу ClickHouse Cloud.
...
масштабируется до PB благодаря [надежной поддержке в ClickHouse Cloud](https://clickhouse.com/blog/getting-data-into-clickhouse-part-3-s3) высокопараллельного чтения из облачного объектного хранилища.
Также вы можете использовать сложные и сжатые форматы, такие как [Parquet](/interfaces/formats/Parquet).
