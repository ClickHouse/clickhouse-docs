...
Примеры ниже охватывают распространённые шаблоны запросов и показывают, как оптимизировать их в ClickHouse. Они используют полный [набор данных Stack Overflow](/getting-started/example-datasets/stackoverflow) (до апреля 2024 года) на эквивалентных ресурсах в PostgreSQL и ClickHouse (8 vCPU, 32GiB RAM).
...
───────
Year:                   2023
MostViewedQuestionTitle: Как решить ошибку "error: externally-managed-environment" при использовании pip 3?
MaxViewCount:           506822
...
Это значительно проще (и быстрее), чем выполнение эквивалентного запроса в Postgres:
...
Функции условных выражений и массивов значительно упрощают запросы. Следующий запрос вычисляет теги (у которых более 10 000 вхождений) с наибольшим процентным ростом с 2022 по 2023 год. Обратите внимание, насколько лаконичен следующий запрос ClickHouse благодаря условным выражениям, функциям массивов и возможности повторно использовать псевдонимы в предложениях HAVING и SELECT.
