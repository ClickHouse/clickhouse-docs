...
## Что такое Обзервабилити? {#what-is-observability}

Обзервабилити — это понимание внутреннего состояния системы по её выходным данным.
...
Современная Обзервабилити, или Observability 2.0, использует принципиально иной
...
Чтобы лучше понять, как Обзервабилити развивалась и как она работает на практике, 
...
Обзервабилити помогает не только быстрее решать проблемы — она позволяет 
