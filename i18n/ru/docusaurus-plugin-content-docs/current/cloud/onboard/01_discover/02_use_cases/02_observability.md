...
keywords: ['сценарии использования', 'наблюдаемость']
...
распределённые системы делают всё более трудным понимание того, что происходит внутри наших 
приложений. Когда что-то идёт не так, командам необходимо быстро понять,
...
реализация эффективной наблюдаемости не является простой задачей — она требует 
понимания как технических концепций, так и организационных задач.
...
2. **Метрики** — числовые измерения, собираемые с течением времени. К ним относятся счётчики,
   датчики и гистограммы, которые помогают отслеживать производительность системы, использование ресурсов и ключевые показатели эффективности бизнеса.
...
анализировать и сопоставлять данные по всем трём столпам для получения значимых сведений
о поведении системы.


## Преимущества наблюдаемости {#the-benefits-of-observability}

Хотя технические аспекты наблюдаемости — журналы, метрики и трассировки — хорошо
...
производительность, могут привести к увеличению дополнительной выручки за счет улучшения качества кода.
...
3. Повышение производительности: возможность выявлять и оптимизировать узкие места производительности
   помогает поддерживать отзывчивые сервисы, удерживающие клиентов
...
демонстрирует это. Она позволяет нашим ключевым инженерам искать исторические паттерны во всех кластерах, помогая предотвращать
повторяющиеся проблемы.

### Экономия затрат за счет снижения текучести кадров {#cost-savings-from-decreased-employee-churn}

Одним из наиболее недооцениваемых преимуществ является влияние на удовлетворенность и удержание команды.
...
- Снижению стресса во время дежурства благодаря лучшему управлению инцидентами
...
Внедрение наблюдаемости в организации — это преобразующий шаг к получению более глубокого понимания производительности и надежности системы. Однако этот путь не обходится без трудностей. Стремясь раскрыть весь потенциал наблюдаемости, организации сталкиваются с различными препятствиями, которые могут затруднить прогресс. Рассмотрим некоторые из них.
