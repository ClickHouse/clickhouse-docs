...
ClickHouse Cloud позволяет подключать привычные вам инструменты и сервисы.
...
| Confluent Cloud                                    | <Confluentsvg class="image" alt="Confluent Cloud logo" style={{width: '3rem'}}/>                 | Потоковая передача | Стабильный      | Используйте всю мощь Confluent и ClickHouse Cloud благодаря прямой интеграции.                      |
...
## Интеграции клиентских библиотек {#language-client-integrations}
...
Помимо ClickPipes и клиентских библиотек, ClickHouse поддерживает множество других интеграций, включая базовые интеграции,
