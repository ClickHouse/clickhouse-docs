...
*📹 Хотите узнать больше? [**Посмотрите сквозной разбор**](https://langfuse.com/watch-demo?tab=evaluation) Langfuse Evaluation и того, как использовать его для улучшения вашего LLM‑приложения.*
