...
В настоящее время мы отправляем уведомления, связанные с биллингом (ошибка платежа, превышение заданного порога потребления и т. д.), а также уведомления, связанные с событиями масштабирования (масштабирование завершено, масштабирование заблокировано и т. д.).

:::note
Уведомления о пороге кредита в настоящее время доступны только для организаций с контрактами на обязательный объем расходов. Организации с оплатой по мере использования (PAYG) не получают эти уведомления.
:::