...
Пользователи Cloud могут настраивать уведомления, отображаемые в Cloud UI, и эти настройки применяются к каждому пользователю индивидуально. Пользователи Cloud также могут настраивать уведомления, отправляемые на их собственные адреса электронной почты, но только пользователи с правами администратора могут настраивать уведомления, отправляемые на произвольные адреса электронной почты, а также уведомления, доставляемые в каналы Slack.
