...
- **Вертикальное масштабирование**:
  ...
  - Пользовательские профили (`highMemory`) не поддерживают вертикальное автомасштабирование или ручное вертикальное масштабирование. Однако такие сервисы можно масштабировать вертикально через поддержку.

:::note
Масштабирование в ClickHouse Cloud происходит с использованием подхода, который мы называем ["Make Before Break" (MBB)](/cloud/features/mbb).
...
Устраняя разрыв между удалением существующих реплик и добавлением новых, MBB обеспечивает более плавный и менее disruptive процесс масштабирования.
Это особенно полезно в сценариях масштабирования вверх, когда высокая загрузка ресурсов вызывает необходимость в дополнительной емкости, поскольку преждевременное удаление реплик только усугубило бы нехватку ресурсов.
