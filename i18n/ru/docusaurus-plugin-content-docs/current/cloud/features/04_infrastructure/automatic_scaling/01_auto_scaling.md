...
- **Вертикальное масштабирование**:
  ...
  - Пользовательский профиль (`highMemory`) не поддерживает вертикальное автомасштабирование или ручное вертикальное масштабирование. Однако такие сервисы можно масштабировать вертикально, обратившись в службу поддержки.
