...
:::warning[Настройте IP Access List для вашего сервиса]
Когда вы создаёте сервис ClickHouse Cloud, по умолчанию для списка разрешённых IP-адресов установлено значение &#39;Allow from anywhere.&#39; Мы настоятельно рекомендуем как можно скорее ограничить доступ конкретными IP-адресами или диапазонами. Сервисы с параметром `Allow from anywhere` могут периодически выводиться из состояния простоя в активное состояние интернет-краулерами и сканерами, которые ищут общедоступные IP-адреса, что может привести к непредвиденным расходам.
:::
