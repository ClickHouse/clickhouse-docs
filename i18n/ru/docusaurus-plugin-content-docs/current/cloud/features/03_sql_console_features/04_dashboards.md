...
Функция панелей мониторинга SQL Console позволяет собирать визуализации, созданные на основе сохранённых запросов, и обмениваться ими. Начните с сохранения запросов и создания их визуализаций, затем добавьте визуализации запросов на панель мониторинга и сделайте её интерактивной с помощью параметров запроса.
