...
description: "Это руководство поможет вам протестировать API ClickHouse Cloud с использованием Postman"
doc_type: "guide"
keywords: ["api", "postman", "rest api", "управление облаком", "интеграция"]
---
...
Это руководство поможет вам протестировать API ClickHouse Cloud с использованием [Postman](https://www.postman.com/product/what-is-postman/).
...
- В возвращенных результатах должны содержаться данные вашей организации со статусом "status": 200. (Если вы получили "status" 400 без информации об организации, конфигурация настроена неправильно).
...
- В меню центральной панели в разделе Params необходимо указать `organizationid`.
...
- Измените это значение на `orgid` в фигурных скобках `{{orgid}}` (После того как вы установили это значение ранее, появится меню с этим значением):
...
- В возвращенных результатах должен содержаться список ваших сервисов и их данные со статусом "status": 200. (Если вы получили "status" 400 без информации о сервисах, конфигурация настроена неправильно).
