...
<VerticalStepper headerLevel="h3">
  ...
  На этом этапе настройка еще не завершена, и ваша организация ClickHouse Cloud пока не тарифицируется через маркетплейс. Теперь вам нужно нажать **Set up your account** в подписке AWS Marketplace, чтобы перейти в ClickHouse Cloud и завершить настройку.
  ...
  После завершения этого шага ваша организация будет подключена к этой подписке AWS, и все использование будет тарифицироваться через вашу учетную запись AWS.
