...
description: 'Подписка на ClickHouse Cloud через GCP Marketplace (PAYG).'
...
Начните работу с ClickHouse Cloud в [GCP Marketplace](https://console.cloud.google.com/marketplace) с помощью публичного предложения с оплатой по мере использования (PAYG, Pay-as-you-go).
...
5. Обратите внимание, что на данном этапе настройка ещё не завершена. Необходимо перейти в ClickHouse Cloud, нажав на **Set up your account** и зарегистрировавшись в ClickHouse Cloud.
