...
title: 'Список изменений v24.8 для Cloud'
description: 'Список изменений релиза v24.8 с ускоренным циклом выпуска'
