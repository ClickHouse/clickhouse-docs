...
Плановые обновления доступны во всех каналах релизов для сервисов в тарифе Enterprise. Эта функция позволяет настроить временное окно в заданный день недели для выполнения обновлений.
...
- Сервисы с настроенными окнами обновления обновляются в своё запланированное окно после начала развёртывания по соответствующему каналу
