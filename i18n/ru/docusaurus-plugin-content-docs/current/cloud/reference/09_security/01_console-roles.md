...
| control-plane:service:manage-clickpipes                                                                   | Управление интеграцией ClickPipes и связанными настройками. Для доступа к вкладке **Data Sources** в настоящее время также требуется `control-plane:service:manage` («Управление и удаление выбранных сервисов»). |
