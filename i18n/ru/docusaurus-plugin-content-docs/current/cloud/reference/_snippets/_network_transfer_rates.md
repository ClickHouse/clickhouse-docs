В таблице ниже показано, как меняются расходы на исходящую передачу данных (egress) через общедоступный интернет или между регионами в зависимости от облачного провайдера и региона.
...
<table style={{ textAlign: 'center' }}>
    <thead >
        <tr>
            ...
            <th>В пределах того же региона</th>
            <th>Межрегиональный трафик <br/>(все Tier 1)</th>
        </tr>
    </thead>
    <tbody>
        <tr>
...
$^*$Тарифы на передачу данных указаны в $ за ГБ переданных данных
