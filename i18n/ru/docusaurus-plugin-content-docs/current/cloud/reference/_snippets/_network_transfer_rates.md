Таблица ниже показывает, как меняются расходы на передачу данных за выход через публичный интернет или между регионами в зависимости от облачного провайдера и региона.
