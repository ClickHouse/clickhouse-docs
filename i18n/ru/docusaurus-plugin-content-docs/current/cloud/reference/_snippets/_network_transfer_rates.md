Таблица ниже показывает, как меняется стоимость исходящего трафика (egress) при передаче данных через общедоступный интернет или между регионами в зависимости от облачного провайдера и региона.
...
$^*$Плата за передачу данных указана в долларах США за 1 ГБ переданных данных