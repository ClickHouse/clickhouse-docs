...
2. **Внешние резервные копии (в собственном бакете клиента)**

Вы можете [экспортировать резервные копии](/cloud/manage/backups/export-backups-to-own-cloud-account) в объектное хранилище в своём аккаунте — в том же регионе или в другом регионе.
...
Вы можете [экспортировать резервные копии](/cloud/manage/backups/export-backups-to-own-cloud-account) в собственный бакет облачного провайдера.
