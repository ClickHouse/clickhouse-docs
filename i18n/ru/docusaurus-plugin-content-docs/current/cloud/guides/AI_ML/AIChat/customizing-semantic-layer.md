...
# Настройка чата ClickHouse Assistant с помощью семантического слоя \{#customize-clickhouse-assistant-chat-with-a-semantic-layer\}

Агента чата ClickHouse Assistant можно настроить так, чтобы он понимал вашу специфическую бизнес‑логику, структуры данных и предметную область с помощью **AGENTS.md** — специального сохранённого запроса, который выступает в роли семантического слоя поверх системного промпта агента.
