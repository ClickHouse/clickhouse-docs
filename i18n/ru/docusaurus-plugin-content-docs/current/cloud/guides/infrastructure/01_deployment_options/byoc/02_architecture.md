...
<BYOCOrgHierarchy style={{width: '100%', maxWidth: '960px'}} title="Иерархия организаций BYOC, показывающая связь между организациями, облачными аккаунтами, регионами и инфраструктурой BYOC" />
...
:::note
Смешивать учетные записи AWS и проекты GCP в рамках одной организации можно только для клиентов, которые не были настроены через [маркетплейс облачного провайдера](/cloud/marketplace/marketplace-billing).
:::
