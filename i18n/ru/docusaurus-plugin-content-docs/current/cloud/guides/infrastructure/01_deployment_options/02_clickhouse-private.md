...
Клиенты, заинтересованные в ClickHouse Private, могут [связаться с нами](https://clickhouse.com/company/contact), чтобы назначить ознакомительный созвон для обсуждения своего сценария использования. Запросы, соответствующие минимальным требованиям по масштабу и предполагающие поддерживаемые конфигурации, будут рассмотрены — обратите внимание, что ресурсы для онбординга ограничены. Настройка выполняется по руководству по установке для конкретной среды с использованием образов и Helm-чартов из AWS ECR.