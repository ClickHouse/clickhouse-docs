...
sidebar_label: 'Настройка инфраструктуры'
...
На этой странице описаны различные варианты настройки инфраструктуры, доступные для вашего развертывания BYOC. Эти настройки позволяют настраивать сетевую инфраструктуру, безопасность и вычислительные ресурсы в соответствии с вашими конкретными требованиями.
