...
description: 'Руководство для организаций, переходящих от быстрого старта к развертываниям ClickHouse Cloud корпоративного уровня'
keywords: ['готовность к промышленной эксплуатации', 'корпоративный', 'saml', 'sso', 'terraform', 'мониторинг', 'резервное копирование', 'аварийное восстановление']
doc_type: 'guide'
---
...
Провайдер Terraform поддерживает создание сервисов, списки доступа по IP-адресам и управление пользователями. Функции, не поддерживаемые провайдером, необходимо настраивать через консоль или обратившись в службу поддержки ClickHouse.
...
Для полноценной настройки, включая подробную конфигурацию Prometheus/Grafana и расширенные правила оповещения, см. [руководство по обсервабилити в ClickHouse Cloud](/use-cases/observability/cloud-monitoring#prometheus).
...
ClickHouse Cloud предоставляет автоматические резервные копии с настраиваемыми периодами хранения. Оцените вашу текущую конфигурацию резервного копирования с точки зрения требований к соответствию и восстановлению. Если у вас есть особые требования к соответствию в части расположения резервных копий или шифрования, вы можете настроить ClickHouse Cloud на хранение резервных копий в собственных облачных бакетах хранилища (BYOB). Для настройки BYOB свяжитесь со службой поддержки ClickHouse.
