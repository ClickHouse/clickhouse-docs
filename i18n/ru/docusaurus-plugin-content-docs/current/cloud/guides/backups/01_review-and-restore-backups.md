...
Оценка общей стоимости резервного копирования требует настройки расписания. Перед настройкой расписания вы можете использовать [калькулятор цен](https://clickhouse.com/pricing), чтобы получить оценку ежемесячной стоимости, указав следующие данные:
