...
Вы можете использовать команды `BACKUP` и `RESTORE`, чтобы экспортировать резервные копии в свои бакеты,
в дополнение к резервному копированию и восстановлению [через пользовательский интерфейс](/cloud/manage/backups/backup-restore-via-ui).
