...
Помимо создания и восстановления резервных копий [через пользовательский интерфейс](/cloud/manage/backups/backup-restore-via-ui), пользователи могут использовать команды `BACKUP` и `RESTORE` для экспорта резервных копий в свои бакеты хранилища.
...
Полные команды резервного копирования и восстановления смотрите в разделе [сводка команд резервного копирования](/operations/backup#command-summary).
