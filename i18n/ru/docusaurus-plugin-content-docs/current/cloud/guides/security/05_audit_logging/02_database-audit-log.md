...
description: 'На этой странице описано, как можно просматривать журнал аудита базы данных'
doc_type: 'guide'
...
:::tip Срок хранения журнала
Информация записывается непосредственно в системные таблицы и по умолчанию хранится в течение 30 дней. Этот период может быть дольше или короче и зависит от частоты слияний в системе. Пользователи могут предпринять дополнительные меры для более длительного хранения журнала или экспорта журнала в систему управления информацией и событиями безопасности (SIEM) для долгосрочного хранения. Подробности ниже.
:::
