...
description: 'На этой странице показаны методы, которые клиенты могут использовать для выявления потенциальных событий, связанных с безопасностью'
doc_type: 'guide'
keywords: ['byoc', 'security', 'playbook', 'лучшие практики', 'соответствие требованиям']
---
