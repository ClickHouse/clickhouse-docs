...
sidebar_label: 'Управление назначениями ролей для SQL-консоли'
title: 'Настройка назначений ролей для SQL-консоли'
description: 'Руководство по управлению назначениями ролей для SQL-консоли'
doc_type: 'guide'
...
:::warning
Эта настройка устарела и была заменена новой настройкой на экране создания ролей в организациях, перешедших на пользовательские роли. Дополнительные сведения см. в разделе [Управление пользователями в Cloud](/cloud/security/manage-cloud-users).
:::
