...
description: 'В этой статье описаны основы определения SQL‑пользователей и ролей, а также применения соответствующих привилегий и разрешений к базам данных, таблицам, строкам и столбцам.'
...
# Часто используемые запросы для управления доступом

:::tip Самостоятельное управление
Если вы работаете с самоуправляемым ClickHouse, ознакомьтесь с разделом [SQL users and roles](/guides/sre/user-management/index.md).
:::

В этой статье рассматриваются основы создания SQL-пользователей и ролей и применения соответствующих привилегий и прав к базам данных, таблицам, строкам и столбцам.
