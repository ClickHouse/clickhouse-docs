...
keywords: ['столбцы нативного протокола', 'типы столбцов', 'типы данных', 'типы данных протокола', 'двоичное кодирование']
doc_type: 'reference'
---
...
Псевдоним для `FixedString(16)`, значение UUID представлено в бинарном виде.
...
Псевдоним типа `UInt8`, где `0` соответствует false (ложь), а `1` — true (истина).
