...
Общие сведения см. в разделе [Типы данных](/sql-reference/data-types/).
...
IPv6 является псевдонимом типа `FixedString(16)` и представлен непосредственно в двоичном формате.
...
Псевдоним для `Int8` или `Int16`, где каждое целое число сопоставлено со строковым значением (`String`).
