...
|-------|-------------------|---------------------------|
| 0     | [Hello](#hello)   | Начало рукопожатия       |
...
Например, мы — `Go Client` версии 1.10, который поддерживает версию протокола `54451` и
...
На стороне клиента используйте в качестве значений по умолчанию базу данных `"default"`, имя пользователя `"default"` и `""` (пустую строку)
в качестве пароля.
