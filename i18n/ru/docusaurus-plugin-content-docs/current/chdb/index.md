...
sidebar_label: 'Обзор'
slug: /chdb
description: 'chDB — это встраиваемый SQL OLAP-движок, основанный на ClickHouse и работающий в том же процессе'
...
- **Поддержка множества форматов данных** — Ввод и вывод данных в форматах Parquet, CSV, JSON, Arrow, ORC и [70+ других форматах](/interfaces/formats)
- **Минимальное копирование данных** — Из C++ в Python с использованием [Python memoryview](https://docs.python.org/3/c-api/memoryview.html)
...
* [Python](install/python.md) - [Справочник по API](api/python.md)
* [Go](install/go.md)
...
* Если вы используете Python, см. [руководство разработчика по началу работы](getting-started.md) или курс [chDB on-demand](https://learn.clickhouse.com/user_catalog_class/show/1901178). Также есть руководства, показывающие, как выполнять типовые задачи, например:
  * [JupySQL](guides/jupysql.md)
  * [Выполнение запросов к Pandas](guides/querying-pandas.md)
  * [Выполнение запросов к Apache Arrow](guides/querying-apache-arrow.md)
  * [Выполнение запросов к данным в S3](guides/querying-s3-bucket.md)
  * [Выполнение запросов к файлам Parquet](guides/querying-parquet.md)
...
<Image img={dfBench} alt='Результаты бенчмарка производительности DataFrame' size="md"/>
...
- Узнайте больше о chDB и сценариях его использования в [блоге](https://clickhouse.com/blog/welcome-chdb-to-clickhouse)
- Пройдите [онлайн-курс chDB в формате on-demand](https://learn.clickhouse.com/user_catalog_class/show/1901178)
