...
`chDB-go` предоставляет привязки для Go к `chDB`, позволяя выполнять запросы ClickHouse прямо в ваших Go‑приложениях без каких-либо внешних зависимостей.
...
chDB-go включает в себя интерфейс командной строки для выполнения быстрых запросов:
...
- **Эффективное использование памяти** — обрабатывайте большие объёмы данных, не загружая их целиком в память
