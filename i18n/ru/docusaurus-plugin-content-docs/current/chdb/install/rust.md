...
chDB для Rust предоставляет как статический, так и с сохранением состояния режимы выполнения запросов.
...
* `bindgen` (v0.70.1) - генерация FFI-привязок из заголовков C
* `tempdir` (v0.3.7) - работа с временными каталогами в тестах
* `thiserror` (v1) - утилиты для обработки ошибок

## Обработка ошибок \{#error-handling\}

chDB для Rust предоставляет всестороннюю обработку ошибок с помощью перечисления `Error`:
