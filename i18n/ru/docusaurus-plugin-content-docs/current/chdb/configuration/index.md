...
DataStore предоставляет широкий набор настроек для выбора движка выполнения, режима совместимости, логирования, кэширования, профилирования и коррекции типов данных (Dtype).
