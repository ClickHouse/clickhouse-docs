...
DataStore предоставляет методы построения запросов в стиле SQL, которые компилируются в оптимизированные SQL-запросы. Все операции являются ленивыми до тех пор, пока не потребуются результаты.
