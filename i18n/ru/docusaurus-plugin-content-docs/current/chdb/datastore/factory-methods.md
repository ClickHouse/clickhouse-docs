...
DataStore предоставляет более 20 фабричных методов для создания экземпляров из различных источников данных, включая локальные файлы, базы данных, облачные хранилища и озёра данных.
