...
description: 'Узнайте, как запрашивать данные в S3 бакете с помощью chDB.'
keywords: ['chdb', 's3']
---
...
## Вывод файлов в S3 бакете {#listing-files-in-an-s3-bucket}

Начнем с вывода всех файлов в [S3 бакете, который содержит отзывы Amazon](/getting-started/example-datasets/amazon-reviews).  
...
## Запрос файлов в S3 бакете {#querying-files-in-an-s3-bucket}
...
## Запрос файлов в частном S3 бакете {#querying-files-in-a-private-s3-bucket}
...
Альтернативным способом является использование [именованных коллекций](/operations/named-collections), но этот подход пока не поддерживается chDB.
