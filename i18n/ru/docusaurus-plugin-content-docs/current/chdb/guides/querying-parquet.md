...
Большая часть данных в мире хранится в хранилищах Amazon S3.
...
Мы можем сделать это, изменив приведённый выше запрос — удалим `ParquetMetadata` и затем, например, вычислим наиболее популярный `star_rating` по всем отзывам:
