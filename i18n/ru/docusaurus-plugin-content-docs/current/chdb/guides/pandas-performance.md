...
DataStore обеспечивает значительный прирост производительности по сравнению с pandas во многих операциях. В этом руководстве объясняется, почему это так и как оптимизировать рабочие нагрузки.
...
### 1. Включите режим повышенной производительности для тяжёлых нагрузок \{#use-performance-mode\}
...
Подробности см. в разделах [Execution Engine](../configuration/execution-engine.md) и [Performance Mode](../configuration/performance-mode.md).
:::