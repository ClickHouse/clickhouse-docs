...
[Apache Arrow](https://arrow.apache.org/) — это стандартизированный колоночно-ориентированный формат представления данных в памяти, который получил широкое распространение в сообществе специалистов по работе с данными.
