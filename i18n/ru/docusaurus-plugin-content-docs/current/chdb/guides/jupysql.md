...
[JupySQL](https://jupysql.ploomber.io/en/latest/quick-start.html) — это библиотека Python, которая позволяет выполнять SQL в Jupyter блокнотах и в оболочке IPython. В этом руководстве мы научимся запрашивать данные с помощью chDB и JupySQL.
...
Мы будем использовать один из наборов данных [Jeff Sackmann's tennis_atp](https://github.com/JeffSackmann/tennis_atp), который содержит метаданные о игроках и их рейтингах с течением времени. Давайте начнем с загрузки файлов с рейтингами:
...
## Импортирование CSV файлов в chDB {#importing-csv-files-into-chdb}
...
<Image img={PlayersPerRank} size="md" alt="Гистограмма рангов игроков в наборе данных ATP" />
