...
Краткий ответ — «да». В ClickHouse есть несколько механизмов, позволяющих освобождать место на диске за счет удаления старых данных. Каждый из них предназначен для разных сценариев.
