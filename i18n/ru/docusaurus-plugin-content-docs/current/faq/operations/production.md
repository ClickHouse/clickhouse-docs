...
toc_hidden: true
toc_priority: 10
description: 'На этой странице содержатся рекомендации о том, какую версию ClickHouse использовать в продакшене'
doc_type: 'guide'
keywords: ['продакшен', 'развертывание', 'версии', 'лучшие практики', 'стратегия обновления']
---
