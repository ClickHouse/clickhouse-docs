...
toc_hidden: true
toc_priority: 101
description: 'Отвечает на часто задаваемый вопрос о том, можно ли использовать ClickHouse как key-value хранилище?'
doc_type: 'reference'
keywords: ['key-value', 'модель данных', 'сценарий использования', 'проектирование схемы', 'паттерн хранения']
---
