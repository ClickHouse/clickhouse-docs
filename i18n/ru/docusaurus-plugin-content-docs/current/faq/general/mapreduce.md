...
title: 'Почему бы не использовать что‑нибудь вроде MapReduce?'
toc_hidden: true
toc_priority: 110
description: 'На этой странице объясняется, почему стоит использовать ClickHouse вместо MapReduce'
keywords: ['MapReduce']
doc_type: 'reference'
---
