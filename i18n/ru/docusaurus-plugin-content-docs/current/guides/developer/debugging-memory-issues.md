...
sidebar_position: 1
description: 'Запросы, которые помогут вам отлаживать проблемы с памятью.'
...
При возникновении проблем с памятью или утечки памяти полезно знать, какие запросы и ресурсы потребляют значительное количество памяти. Ниже вы можете найти запросы, которые помогут вам отладить проблемы с памятью, обнаруживая, какие запросы, базы данных и таблицы можно оптимизировать:
...
## Список метрик по использованию памяти {#list-metrics-for-memory-usage}
