...
<VerticalStepper headerLevel="h2">
  ...
  3. Обновите и добавьте следующие настройки кластера на `chnode1` и `chnode2`. `chnode3` будет использоваться для кворума ClickHouse Keeper.
     ...
     Следующий пример создаёт кластер с одним сегментом и двумя репликами на двух серверах (по одному на каждом узле).
  ...
  6. Настройте OpenSSL с сертификатами и путями
     ...
     Дополнительные сведения см. [на этой странице](/operations/server-configuration-parameters/settings/#openssl)
...
## Настройка OpenSSL для автономного ClickHouse Keeper \{#1-create-a-clickhouse-deployment\}
...
## Режимы проверки OpenSSL и обработчики сертификатов \{#2-create-tls-certificates\}
