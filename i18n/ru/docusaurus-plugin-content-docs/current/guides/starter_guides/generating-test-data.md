...
Создание случайных данных полезно при тестировании новых сценариев использования или оценке производительности вашей реализации.
В ClickHouse доступен [широкий набор функций для генерации случайных данных](/sql-reference/functions/random-functions), которые во многих случаях избавляют от необходимости во внешнем генераторе данных.

В данном руководстве приведено несколько примеров генерации случайных наборов данных в ClickHouse с различными требованиями к случайности.
...
**Сценарий использования**: Моделирование поступления событий, сконцентрированных вокруг определённого периода (например, часа пик).
...
- Три оценки на каждый интерес для каждого пользователя
...
Вы также можете использовать начальное значение (seed), чтобы каждый раз получать одну и ту же структуру:
...
Изучите первую строку как пример сгенерированных данных:
