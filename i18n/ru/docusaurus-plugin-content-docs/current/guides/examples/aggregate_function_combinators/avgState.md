...
бинарном формате, который оптимизирован для эффективного хранения и вычислений, а не для
удобства чтения человеком. Это бинарное состояние содержит всю информацию, необходимую для
вычисления среднего значения.

Чтобы использовать его, применим комбинатор `Merge`:
