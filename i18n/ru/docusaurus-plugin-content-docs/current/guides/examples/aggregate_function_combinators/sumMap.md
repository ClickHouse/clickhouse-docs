...
для вычисления суммы значений в Map по каждому ключу с использованием агрегатной функции-комбинатора `sumMap`.



## Пример использования {#example-usage}

В этом примере мы создадим таблицу, которая хранит коды статусов и их количества для различных временных интервалов,
где каждая строка содержит Map с соответствием кодов статусов их количествам. Мы будем использовать
`sumMap`, чтобы вычислить общее количество для каждого кода статуса в каждом временном интервале.
...
Функция `sumMap` вычислит общую сумму для каждого кода статуса в каждом временном интервале. Например:
