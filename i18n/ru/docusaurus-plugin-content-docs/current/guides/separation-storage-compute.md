...
Скопируйте следующий XML в созданный файл, заменив `BUCKET`, `ACCESS_KEY_ID`, `SECRET_ACCESS_KEY` на реквизиты корзины AWS, в которой вы хотите хранить данные:
...
Вы также можете заменить `access_key_id` и `secret_access_key` следующим параметром, который позволит получить учетные данные из переменных окружения и метаданных Amazon EC2:

```bash
<use_environment_credentials>true</use_environment_credentials>
```

После создания файла конфигурации необходимо изменить владельца файла на пользователя и группу clickhouse:
...
Чтобы проверить правильность настройки диска S3, создадим таблицу и выполним к ней запрос.
...
В консоли AWS, если данные были успешно вставлены в S3, вы должны увидеть, что ClickHouse создал новые файлы в указанном бакете.
