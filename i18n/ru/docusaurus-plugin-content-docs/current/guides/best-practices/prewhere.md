...
sidebar_position: 21
description: 'PREWHERE снижает объем I/O, избегая чтения лишних данных столбцов.'
...
[Предложение PREWHERE](/sql-reference/statements/select/prewhere) — это оптимизация выполнения запросов в ClickHouse. Оно снижает объем I/O и ускоряет запросы, позволяя избежать лишнего чтения данных и отфильтровывать нерелевантные данные до чтения с диска столбцов, не участвующих в фильтрации.
