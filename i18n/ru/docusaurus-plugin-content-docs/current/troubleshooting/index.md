...
Возникли проблемы с ClickHouse? Здесь вы найдёте решения наиболее распространённых из них.
...
- [Настройка резервного копирования и восстановления](/docs/operations/backup/overview)
...
4. **Получите профессиональную поддержку** — [Поддержка ClickHouse Cloud](https://clickhouse.com/support/program)