...
## Как происходит обновление refreshable materialized view? \{#how-do-you-refresh-a-refreshable-materialized-view\}
...
Дополнительные сведения см. в документации [по управлению refreshable materialized view](/sql-reference/statements/system#managing-refreshable-materialized-views).
