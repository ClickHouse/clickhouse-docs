...
일반적으로 [max&#95;threads](/operations/settings/settings/#max_threads) 설정은 병렬 읽기 스레드 수와 병렬 쿼리 처리 스레드 수를 [제어합니다](https://clickhouse.com/company/events/query-performance-introspection):
