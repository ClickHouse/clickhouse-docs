...
이 예제에서는 [CTE](/sql-reference/statements/select/with)를 사용하여 두 쿼리 각각의 각 행에 대한 [cityHash](/sql-reference/functions/hash-functions#cityHash64) 값의 합을 계산하고, 두 결과 집합이 동일할 경우 `1`을 반환합니다.
