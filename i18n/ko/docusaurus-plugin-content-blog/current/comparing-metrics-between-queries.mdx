...
description: ClickHouse에서 두 쿼리의 메트릭을 비교하는 예제 쿼리입니다.
tags: ['성능 및 최적화']
...
## 두 쿼리 간 메트릭 비교 \{#compare-metrics-between-two-queries\}

두 쿼리 간 메트릭을 비교하려면 먼저 두 쿼리의 `query_id`를 확인해야 합니다.
