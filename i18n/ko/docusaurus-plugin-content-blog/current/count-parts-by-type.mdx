---
title: 와이드 또는 콤팩트 파트의 개수와 크기 찾기
description: '이 지식베이스 문서는 파트 유형(와이드 또는 콤팩트)별 파트 개수를 확인하는 방법을 보여줍니다.'
date: 2026-01-12
tags: ['문제 해결']
keywords: ['콤팩트 파트', '와이드 파트']
---
...
다음 쿼리를 사용하여 유형별 파트 개수를 셀 수 있습니다:
...
아래 쿼리를 실행하여 wide 파트와 compact 파트의 크기를 조회합니다:
...
:::note Compact 파트 크기가 0으로 표시됨
Compact 파트에서는 컬럼 크기가 계산되지 않아 위에서는 `0`으로 표시됩니다.
:::
