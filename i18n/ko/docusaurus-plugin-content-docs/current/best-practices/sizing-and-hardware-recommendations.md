...
sidebar_label: '규모 산정 및 하드웨어 권장 사항'
sidebar_position: 4
title: '규모 산정 및 하드웨어 권장 사항'
description: '이 가이드는 오픈 소스 버전 사용자를 위한 하드웨어, 컴퓨트 리소스, 메모리, 디스크 구성에 대한 일반적인 권장 사항을 다룹니다.'
doc_type: 'guide'
keywords: ['규모 산정', '하드웨어', '용량 계획', '모범 사례', '성능']
---

이 가이드는 오픈 소스 버전 사용자를 위한 하드웨어, 컴퓨트 리소스, 메모리, 디스크 구성에 대한 일반적인 권장 사항을 다룹니다. 구성을 단순화하려면 [ClickHouse Cloud](https://clickhouse.com/cloud) 사용을 권장합니다. ClickHouse Cloud는 인프라 관리와 관련된 비용을 최소화하면서 워크로드에 맞게 자동으로 확장 및 조정합니다.
