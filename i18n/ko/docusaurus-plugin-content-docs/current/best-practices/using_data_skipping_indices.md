...
* **tokenbf&#95;v1 / ngrambf&#95;v1**: *(사용 중단됨)* 문자열 내 토큰 또는 문자 시퀀스를 검색하도록 설계된 특수한 블룸 필터 변형입니다. 특히 로그 데이터나 텍스트 검색 사용 사례에 유용합니다. ClickHouse 버전 &gt;= 26.2에서는 text 인덱스를 대신 사용하므로 더 이상 사용되지 않습니다.
