...
- 뮤테이션이 적용될 때까지 대기해야 하므로 테스트 `00715_fetch_merged_or_mutated_part_zookeeper`를 셸 스크립트로 다시 작성하여 불안정(flapping) 상태를 수정합니다. [#6977](https://github.com/ClickHouse/ClickHouse/pull/6977) ([Alexander Kazakov](https://github.com/Akazz))
...
* TSan 경고 &#39;lock-order-inversion&#39; 문제를 수정했습니다. [#6740](https://github.com/ClickHouse/ClickHouse/pull/6740) ([Vasily Nemkov](https://github.com/Enmk))
