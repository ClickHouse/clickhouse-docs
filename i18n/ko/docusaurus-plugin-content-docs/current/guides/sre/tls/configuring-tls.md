...
<VerticalStepper headerLevel="h2">
  ...
  6. 인증서와 경로를 사용해 OpenSSL을 구성합니다
     ...
     자세한 내용은 [이 페이지](/operations/server-configuration-parameters/settings/#openssl)를 참조하십시오
  ...
  9. MySQL 및 PostgreSQL용 기본 에뮬레이션 포트를 비활성화합니다:
     ```xml
...
## OpenSSL 검증 모드와 인증서 handler \{#2-create-tls-certificates\}
