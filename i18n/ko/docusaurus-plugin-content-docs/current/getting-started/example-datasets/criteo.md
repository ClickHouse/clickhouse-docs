---
description: 'Criteo 클릭 로그 1테라바이트'
sidebar_label: 'Criteo 1TB 클릭 로그'
...
title: 'Criteo의 테라바이트 클릭 로그'
doc_type: 'guide'
---

다음 주소에서 데이터를 다운로드하십시오: http://labs.criteo.com/downloads/download-terabyte-click-logs/
...
원시 로그 데이터를 변환하여 두 번째 테이블에 저장하십시오:
