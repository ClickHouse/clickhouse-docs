...
[Play에서 실행](https://sql.clickhouse.com?query_id=OKGZBACRHVGCRAGCZAJKMF)
...
### 어떤 작성자가 다른 작성자의 코드를 다시 작성하는 경향이 있는지 보여주는 작성자 매트릭스 \{#matrix-of-authors-that-shows-what-authors-tends-to-rewrite-another-authors-code\}
...
### 저장소 전체의 코드 연령 분포 \{#distribution-of-code-age-across-repository\}
...
### 코드가 저장소에 남아 있을 확률이 가장 높은 요일은 언제입니까? \{#what-weekday-does-the-code-have-the-highest-chance-to-stay-in-the-repository\}
...
이 쿼리는 파일 경로와 코드 라인의 내용을 사용하여 코드 라인을 고유하게 식별한다는 점에서 [어느 요일에 추가된 코드가 저장소에 남아 있을 확률이 가장 높은가](#what-weekday-does-the-code-have-the-highest-chance-to-stay-in-the-repository)와 동일한 원리를 사용합니다.
