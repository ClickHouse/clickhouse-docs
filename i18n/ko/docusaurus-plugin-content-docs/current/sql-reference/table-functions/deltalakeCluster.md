---
description: '이 함수는 deltaLake 테이블 함수의 확장입니다.'
...
* 선택 사항인 `extra_credentials` 파라미터를 사용하여 ClickHouse Cloud에서 역할 기반 액세스를 위한 `role_arn`을 전달할 수 있습니다. 구성 단계는 [Secure S3](/cloud/data-sources/secure-s3)를 참조하십시오.
