...
입력 데이터와 크기가 동일한 배열을 반환합니다. Decimal이 아닌 입력의 경우 배열에는 Float64 값이 포함됩니다. Decimal 입력의 경우 배열에는 입력 scale의 Decimal 값이 포함됩니다. [`Array`](/sql-reference/data-types/array)
