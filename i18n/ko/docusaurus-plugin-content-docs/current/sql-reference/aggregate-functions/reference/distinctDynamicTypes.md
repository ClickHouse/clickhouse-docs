---
description: 'Dynamic 컬럼에 저장된 서로 다른 데이터 타입 목록을 반환합니다.'
...
* `dynamic` — Dynamic 컬럼. [`Dynamic`](/sql-reference/data-types/dynamic)

**반환 값**

정렬된 데이터 타입 이름 목록을 반환합니다. [`Array(String)`](/sql-reference/data-types/array)
