---
'description': 'N 변수를 기반으로 상관 행렬을 계산합니다.'
...
- `x` — 변수 숫자에 관계없이 매개변수. [`(U)Int8/16/32/64`](../../data-types/int-uint.md), [`Float*`](../../data-types/float.md).

**반환값**

- 상관 행렬. [`Array`](../../data-types/array.md)([`Array`](../../data-types/array.md)([`Float64`](../../data-types/float.md))).
