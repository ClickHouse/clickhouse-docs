---
description: 'GROUPING 집계 FUNCTION 문서입니다.'
...
### 여러 개의 GROUP BY SQL 문과 GROUPING SETS 비교 \{#comparing-multiple-group-by-statements-with-grouping-sets\}
