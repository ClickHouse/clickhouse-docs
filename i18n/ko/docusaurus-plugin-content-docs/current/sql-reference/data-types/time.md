...
[Time](time.md) 값은 [Date](date.md) 또는 [Date32](date32.md) 값에 더해 [DateTime](datetime.md) 또는 [DateTime64](datetime64.md) 값을 만들 수 있습니다:
...
지원되는 모든 조합과 결과 유형에 대한 자세한 내용은 [날짜 및 시간 덧셈](../operators/index.md#date-time-addition)을 참조하십시오.
