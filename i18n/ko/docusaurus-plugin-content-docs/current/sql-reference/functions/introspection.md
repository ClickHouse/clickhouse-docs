...
이 장에서 설명하는 함수들을 사용하여 쿼리 프로파일링을 위해 [ELF](https://en.wikipedia.org/wiki/Executable_and_Linkable_Format) 및 [DWARF](https://en.wikipedia.org/wiki/DWARF)를 내부 검사할 수 있습니다.

:::note
이러한 함수는 실행 속도가 느리고 보안상 주의가 필요합니다.
:::

내부 검사 함수가 올바르게 동작하려면 다음을 수행해야 합니다.
...
* [allow&#95;introspection&#95;functions](../../operations/settings/settings.md#allow_introspection_functions) 설정을 1로 지정합니다.
  ...
  보안상의 이유로 내부 검사 함수는 기본적으로 비활성화되어 있습니다.
