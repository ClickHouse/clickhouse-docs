...
### 논리 연산자를 사용한 데이터 필터링 \{#example-filtering-with-logical-operators\}
...
### UInt8 컬럼을 조건으로 사용하기 \{#example-uint8-column-as-condition\}

[이전 예시](#example-filtering-with-logical-operators)에서 사용한 테이블을 보면, 컬럼 이름을 조건으로 직접 사용할 수 있습니다:
...
### 비교 연산자 사용하기 \{#example-using-comparison-operators\}

아래 예시에서는 위의 [예시](#example-filtering-with-logical-operators)에 나오는 테이블과 데이터를 사용합니다. 결과는 간결성을 위해 생략합니다.
