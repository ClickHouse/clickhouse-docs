...
`COLLATE`는 [LowCardinality](../../../sql-reference/data-types/lowcardinality.md), [널 허용](../../../sql-reference/data-types/nullable.md), [Array](../../../sql-reference/data-types/array.md), [Tuple](../../../sql-reference/data-types/tuple.md)에서 지원됩니다.

`COLLATE`를 사용한 정렬은 바이트 기준의 일반적인 정렬보다 효율이 떨어지므로, 소량의 행에 대한 최종 정렬에만 사용할 것을 권장합니다.

## Collation 예시 \{#collation-examples\}

[String](../../../sql-reference/data-types/string.md) 값만 있는 예시:
...
[널 허용](../../../sql-reference/data-types/nullable.md) 데이터 타입 예시:
...
[Array](../../../sql-reference/data-types/array.md)을(를) 사용한 예시:
...
[LowCardinality](../../../sql-reference/data-types/lowcardinality.md) 문자열을 사용한 예시:
...
[Tuple](../../../sql-reference/data-types/tuple.md)을 사용한 예시:
...
## ORDER BY Expr WITH FILL 수정자 \{#order-by-expr-with-fill-modifier\}

이 수정자는 [LIMIT ... WITH TIES 수정자](/sql-reference/statements/select/limit#limit--with-ties-modifier)와 함께 사용할 수도 있습니다.
