...
`IPV4_PREFIX_BITS` 및 `IPV6_PREFIX_BITS` 옵션은 `KEYED BY`가 `ip_address` 또는 `forwarded_ip_address`일 때만 사용할 수 있습니다. 이 옵션은 [system.quotas](../../../operations/system-tables/quotas.md) 테이블의 필드에 해당합니다.
