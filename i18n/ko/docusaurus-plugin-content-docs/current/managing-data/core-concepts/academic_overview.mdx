...
* <Anchor id="page-13-5" />[61] Pandas. 2024. Pandas 데이터프레임. 2024-06-20에 https://pandas.([https://pandas.pydata.org/](https://pandas.pydata.org/)) [pydata.org/](https://pandas.pydata.org/)에서 검색함.
