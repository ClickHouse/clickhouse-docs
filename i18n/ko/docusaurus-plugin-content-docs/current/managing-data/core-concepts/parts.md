...
또한 ClickHouse는 모든 테이블의 모든 파트에 대한 정보를 [system.parts](/operations/system-tables/parts) 시스템 테이블에 저장하며, 다음 쿼리는 위의 예시 테이블에 대해 현재 활성 상태인 모든 파트 목록과 각 파트의 머지 수준, 그리고 이들 파트에 저장된 행 수를 [반환합니다](https://sql.clickhouse.com/?query=U0VMRUNUCiAgICBuYW1lLAogICAgbGV2ZWwsCiAgICByb3dzCkZST00gc3lzdGVtLnBhcnRzCldIRVJFIChkYXRhYmFzZSA9ICd1aycpIEFORCAoYHRhYmxlYCA9ICd1a19wcmljZV9wYWlkX3NpbXBsZScpIEFORCBhY3RpdmUKT1JERVIgQlkgbmFtZSBBU0M7\&run_query=true\&tab=results):
