---
description: 'Linux 시스템에서 소스 코드로 ClickHouse를 빌드하기 위한 단계별 가이드'
...
ClickHouse 소스 코드를 변경하지 않는 경우, [Quick Start](https://clickhouse.com/docs/get-started/quick-start)에 설명된 대로 사전 빌드된 ClickHouse를 설치할 수 있습니다.
:::
