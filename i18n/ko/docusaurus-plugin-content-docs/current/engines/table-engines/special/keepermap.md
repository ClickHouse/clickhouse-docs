---
description: '이 엔진을 사용하면 Keeper/ZooKeeper 클러스터를 선형화 가능한 쓰기와 순차적 일관성이 보장되는 읽기를 제공하는 일관된 키-값 저장소로 사용할 수 있습니다.'
...
여기서 경로에는 다른 임의의 유효한 ZooKeeper 경로를 사용할 수 있습니다.
...
* 기본 키 이외의 컬럼들은 해당 순서대로 바이너리로 직렬화되며, 직렬화된 키로 정의된 결과 노드의 값으로 저장됩니다.
...
또한 키 개수에는 4개라는 소프트 한도(소프트 리밋)가 있습니다.
