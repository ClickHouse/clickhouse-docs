...
시스템에 chDB 라이브러리(libchdb)를 설치합니다.
...
### 2단계: 헤더 포함 \{#include-headers\}

프로젝트에 chDB 헤더 파일을 포함하십시오:
...
### 기본 연결 및 쿼리 \{#basic-connection-queries\}
