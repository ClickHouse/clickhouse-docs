---
title: 'SQL 레퍼런스'
sidebar_label: 'SQL 레퍼런스'
slug: /chdb/reference/sql-reference
description: 'chDB용 SQL 레퍼런스'
keywords: ['chdb', 'sql 레퍼런스']
doc_type: 'reference'
---
...
| [SQL 문](/sql-reference/statements)          |
...
자세한 내용과 예시는 [ClickHouse SQL Reference](/sql-reference)를 참조하십시오.