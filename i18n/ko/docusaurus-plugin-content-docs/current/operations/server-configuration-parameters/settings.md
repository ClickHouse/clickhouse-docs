...
<SettingsInfoBlock type="Bool" default_value="0" changeable_without_restart="아니요" />`/webterminal` HTTP endpoint에서 실험적 웹 터미널 인터페이스를 활성화합니다. WebSocket을 통해 브라우저에서 대화형 `clickhouse-client` session을 사용할 수 있습니다.
...
<SettingsInfoBlock type="UInt64" default_value="1073741824" changeable_without_restart="Yes" />Iceberg 메타데이터 캐시의 최대 크기(바이트 단위)입니다. 0은 비활성화를 의미합니다.
