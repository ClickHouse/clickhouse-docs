...
<SettingsInfoBlock type="UInt64" default_value="0" changeable_without_restart="Yes" />[`concurrent_threads_soft_limit_num`](#concurrent_threads_soft_limit_num)와 동일하지만, 값이 코어 수에 대한 비율로 지정됩니다.
