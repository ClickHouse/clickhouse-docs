...
* `event_date` ([Date](../../sql-reference/data-types/date.md)) — 비동기 삽입이 발생한 날짜입니다.
* `event_time` ([DateTime](../../sql-reference/data-types/datetime.md)) — 비동기 삽입 실행이 완료된 날짜와 시간입니다.
* `event_time_microseconds` ([DateTime64](../../sql-reference/data-types/datetime64.md)) — 비동기 삽입 실행이 완료된 날짜와 시간(마이크로초 정밀도)입니다.
