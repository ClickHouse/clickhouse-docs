...
* `hostname` ([LowCardinality(String)](/sql-reference/data-types/lowcardinality)) — 서버의 호스트명.
* `event_date` ([Date](/sql-reference/data-types/date)) — 그룹이 플러시된 날짜.
* `event_time` ([DateTime](/sql-reference/data-types/datetime)) — 그룹이 플러시된 시각.
* `session_id` ([Int64](/sql-reference/data-types/int-uint)) — 세션 ID.
* `parent_path` ([String](/sql-reference/data-types/string)) — 경로 접두사.
* `operation` ([Enum16(&#39;Close&#39; = -11, &#39;Error&#39; = -1, &#39;Watch&#39; = 0, &#39;Create&#39; = 1, &#39;Remove&#39; = 2, &#39;Exists&#39; = 3, &#39;Get&#39; = 4, &#39;Set&#39; = 5, &#39;GetACL&#39; = 6, &#39;SetACL&#39; = 7, &#39;SimpleList&#39; = 8, &#39;Sync&#39; = 9, &#39;Heartbeat&#39; = 11, &#39;List&#39; = 12, &#39;Check&#39; = 13, &#39;Multi&#39; = 14, &#39;Create2&#39; = 15, &#39;Reconfig&#39; = 16, &#39;CheckWatch&#39; = 17, &#39;RemoveWatch&#39; = 18, &#39;MultiRead&#39; = 22, &#39;Auth&#39; = 100, &#39;SetWatch&#39; = 101, &#39;SetWatch2&#39; = 105, &#39;AddWatch&#39; = 106, &#39;FilteredList&#39; = 500, &#39;CheckNotExists&#39; = 501, &#39;CreateIfNotExists&#39; = 502, &#39;RemoveRecursive&#39; = 503, &#39;CheckStat&#39; = 504, &#39;TryRemove&#39; = 505, &#39;FilteredListWithStatsAndData&#39; = 506, &#39;ListRecursive&#39; = 507, &#39;SessionID&#39; = 997)](/sql-reference/data-types/enum)) — ZooKeeper 작업 유형.
* `is_subrequest` ([UInt8](/sql-reference/data-types/int-uint)) — 이 작업이 Multi 또는 MultiRead 작업 내의 하위 요청인지 여부.
* `count` ([UInt32](/sql-reference/data-types/int-uint)) — (session&#95;id, parent&#95;path, operation, 컴포넌트, is&#95;subrequest) 그룹의 작업 수.
* `errors` ([Map(Enum8(&#39;ZNOWATCHER&#39; = -121, &#39;ZNOTREADONLY&#39; = -119, &#39;ZSESSIONMOVED&#39; = -118, &#39;ZNOTHING&#39; = -117, &#39;ZCLOSING&#39; = -116, &#39;ZAUTHFAILED&#39; = -115, &#39;ZINVALIDACL&#39; = -114, &#39;ZINVALIDCALLBACK&#39; = -113, &#39;ZSESSIONEXPIRED&#39; = -112, &#39;ZNOTEMPTY&#39; = -111, &#39;ZNODEEXISTS&#39; = -110, &#39;ZNOCHILDRENFOREPHEMERALS&#39; = -108, &#39;ZBADVERSION&#39; = -103, &#39;ZNOAUTH&#39; = -102, &#39;ZNONODE&#39; = -101, &#39;ZAPIERROR&#39; = -100, &#39;ZOUTOFMEMORY&#39; = -10, &#39;ZINVALIDSTATE&#39; = -9, &#39;ZBADARGUMENTS&#39; = -8, &#39;ZOPERATIONTIMEOUT&#39; = -7, &#39;ZUNIMPLEMENTED&#39; = -6, &#39;ZMARSHALLINGERROR&#39; = -5, &#39;ZCONNECTIONLOSS&#39; = -4, &#39;ZDATAINCONSISTENCY&#39; = -3, &#39;ZRUNTIMEINCONSISTENCY&#39; = -2, &#39;ZSYSTEMERROR&#39; = -1, &#39;ZOK&#39; = 0), UInt32)](/sql-reference/data-types/map)) — (session&#95;id, parent&#95;path, operation, 컴포넌트, is&#95;subrequest) 그룹의 오류.
* `average_latency` ([Float64](/sql-reference/data-types/float)) — (session&#95;id, parent&#95;path, operation, 컴포넌트, is&#95;subrequest) 그룹의 모든 작업에 대한 평균 지연 시간이며, 단위는 마이크로초입니다. 하위 요청의 지연 시간은 이를 포함하는 Multi 또는 MultiRead 작업에 귀속되므로 0입니다.
* `component` ([LowCardinality(String)](/sql-reference/data-types/lowcardinality)) — 이 이벤트를 발생시킨 컴포넌트.
