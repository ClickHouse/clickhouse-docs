---
description: '`system.asynchronous_metrics`의 이력 값을 포함하며,
  일정한 시간 간격(기본적으로 1초)마다 한 번씩 저장되는 시스템 테이블입니다.'
...
`system.asynchronous_metrics`의 이력 값을 포함하며, 일정한 시간 간격(기본값은 1초)마다 한 번씩 저장됩니다. 기본적으로 활성화되어 있습니다.
...
* [asynchronous&#95;metric&#95;log setting](../../operations/server-configuration-parameters/settings.md#asynchronous_metric_log) — 이 설정의 활성화 및 비활성화.
