---
description: '현재 사용자에게 사용 가능한 데이터베이스에 대한 정보를 포함하는 시스템 테이블입니다.'
...
* `comment` ([String](../../sql-reference/data-types/)) — 데이터베이스 설명.
* `is_external` ([UInt8](../../sql-reference/data-types/)) — 외부 데이터베이스인지 여부(예: PostgreSQL/DataLakeCatalog).
...
사용자가 사용할 수 있는 모든 데이터베이스를 확인합니다.
