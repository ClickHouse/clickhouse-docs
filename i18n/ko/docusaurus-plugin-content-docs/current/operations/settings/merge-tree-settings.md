...
<VersionHistory rows={[{"id": "row-1","items": [{"label": "26.4"},{"label": "1800"},{"label": "기본 replica set 백그라운드 업데이트 간격을 30분으로 늘림"}]}, {"id": "row-2","items": [{"label": "26.3"},{"label": "300"},{"label": "새 설정"}]}, {"id": "row-3","items": [{"label": "26.2"},{"label": "300"},{"label": "새 설정"}]}]} />
