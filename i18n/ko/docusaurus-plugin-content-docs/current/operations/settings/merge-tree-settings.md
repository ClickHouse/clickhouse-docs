...
<VersionHistory rows={[{"id": "row-1","items": [{"label": "26.2"},{"label": "1"},{"label": "기본적으로 min_age_to_force_merge_seconds가 설정된 경우에도 파트 크기 제한"}]}, {"id": "row-2","items": [{"label": "25.1"},{"label": "0"},{"label": "새 설정"}]}, {"id": "row-3","items": [{"label": "25.1"},{"label": "0"},{"label": "min_age_to_force_merge의 최대 바이트 수를 제한하는 새 설정 추가"}]}]} />
