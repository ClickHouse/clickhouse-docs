...
SQL 기반 [액세스 제어 및 계정 관리](/operations/access-rights#access-control-usage)가 활성화된 경우, LDAP 서버를 통해 인증된 사용자도 [CREATE USER](/sql-reference/statements/create/user) SQL 문을 사용하여 생성할 수 있습니다.
