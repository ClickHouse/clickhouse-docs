...
<VerticalStepper headerLevel="h3">
  ...
  * 추가 스크립트 또는 데이터 파일 참조
  ...
  :::warning[심볼릭 링크는 허용되지 않습니다]
  ClickHouse Cloud는 심볼릭 링크가 포함된 UDF 아카이브를 거부합니다. ZIP 번들에는 일반 파일과 디렉터리만 포함되어야 합니다. 심볼릭 링크가 포함된 업로드는 유효성 검사에 실패합니다.
  :::
