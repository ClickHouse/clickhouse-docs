...
<details>
  ...
  [지원 리전](https://clickhouse.com/docs/cloud/reference/supported-regions) 문서에 나열된 모든 **공개 리전**에서 BYOC 배포를 사용할 수 있습니다.
</details>
...
<details>
  <summary>BYOC VPC와 S3 간의 네트워크 통신은 어떻게 동작합니까?</summary>
