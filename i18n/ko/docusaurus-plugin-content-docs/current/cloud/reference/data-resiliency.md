...
사용자는 자신의 계정에 있는 자체 객체 스토리지로, 동일 리전 또는 다른 리전에 [백업을 내보낼](/cloud/manage/backups/export-backups-to-own-cloud-account) 수 있습니다.
...
백업을 자체 클라우드 제공업체의 버킷으로 [내보낼 수 있습니다](/cloud/manage/backups/export-backups-to-own-cloud-account).
...
:::note
외부 버킷으로의 백업/복원은 현재 [Transparent Data Encryption (TDE)](/cloud/security/cmek#transparent-data-encryption-tde)를 사용하는 서비스에서는 지원되지 않습니다.
:::
