...
:::tip
첫 번째 인보이스 결제가 성공적으로 완료되면 임계값은 5,000달러(USD)로 상향됩니다. 두 번째 인보이스 결제가 성공적으로 완료되면 임계값은 10,000달러(USD)로 상향됩니다. 임계값 금액을 조정하려면 [지원팀에 문의](mailto:support@clickhouse.com)하십시오.
:::
