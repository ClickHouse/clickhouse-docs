...
주기 중 누적 금액이 1,000달러(USD)에 도달하면 청구가 앞당겨질 수 있습니다
...
### 약정 계약 과금 \{#committed-spend-contract\}

조직의 크레딧은 다음 방법으로 약정 계약을 통해 구매할 수 있습니다.
...
2. 영업팀에 연락하여 지원되는 Cloud 마켓플레이스(AWS, GCP, Azure 중 하나)의
   ...
   오퍼 조건에 따라 해당 마켓플레이스에 보고되지만, 실제 인보이스는 그
...
신용카드 기반 [종량제(PAYG)](#direct-payg) 과금의 미납 인보이스 제한이 적용되며,
...
다만, 약정 계약 고객의 경우 데이터 삭제를 시작하기 전에 미납 인보이스에 대해
