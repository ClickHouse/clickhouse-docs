...
<VerticalStepper headerLevel="h3">
  ...
  ### 조직에 Marketplace 구독 추가 \{#add-marketplace-subscription\}

  성공적으로 로그인한 후, 이 Marketplace 구독으로 청구할 새 조직을 생성할지, 아니면 이 구독에 청구를 연결할 기존 조직을 선택할지 결정합니다.

  <Image img={aws_marketplace_payg_8} size="md" alt="Marketplace 구독 추가" border />
...
문제가 발생하면 [지원팀](https://clickhouse.com/support/program)에 문의해 주십시오.