...
### 환불은 어디에서 확인할 수 있습니까? \{#where-can-i-see-my-refunds\}

ClickHouse Cloud 콘솔에서 Organization &gt; Billing으로 이동하십시오. Refunds 섹션은 Invoices 및 Credits 아래에 표시됩니다. 확인하려면 Organization Admin 또는 Billing Admin 권한이 있어야 합니다.

### 환불이 반영되기까지 얼마나 걸리나요? \{#how-long-does-it-take-for-a-refund-to-appear\}

환불은 당사에서 처리되면 반영됩니다. 신용카드 환불의 경우, 은행에 따라 명세서에 반영되기까지 추가 시간이 소요될 수 있습니다.
