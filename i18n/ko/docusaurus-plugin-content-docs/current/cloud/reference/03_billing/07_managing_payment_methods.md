...
1. ClickHouse Cloud Cloud Console의 **Billing** 페이지로 이동합니다.
...
ClickHouse Cloud 콘솔을 통하지 않고도 클라우드 마켓플레이스에서 조직의 마켓플레이스 구독을 직접 설정하거나 업데이트할 수 있습니다.
...
이 절차를 완료하면 선택한 조직의 과금이 새 마켓플레이스 구독에 연결되고, ClickHouse Cloud 콘솔의 과금 페이지에도 해당 업데이트가 반영됩니다.
