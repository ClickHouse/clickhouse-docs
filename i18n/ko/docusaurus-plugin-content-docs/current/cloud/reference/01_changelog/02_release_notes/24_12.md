...
* 워크로드 및 리소스 관리를 설명하는 SQL 구문이 추가되었습니다. [문서](/operations/workload-scheduling)를 참조하십시오. [#69187](https://github.com/ClickHouse/ClickHouse/pull/69187) ([Sergei Trifonov](https://github.com/serxa)).
