...
* 예약된 업그레이드 윈도우가 설정된 서비스는 채널 배포가 종료된 다음 주(월요일 00:00 UTC 시작)의 예약된 업그레이드 윈도우 동안 업그레이드됩니다
...
<ReleaseSchedule
 ...
 },
 {
   ...
   regular_progress: 'green',
   slow_progress: 'green',
   regular_delay_note: '예약된 업그레이드 윈도우가 있는 서비스는 3월 16일 이후 주의 예약된 윈도우 동안 25.10으로 업그레이드됩니다',
 },
 {
