...
아래에 표시된 날짜는 각 릴리스 채널에 대해 ClickHouse가 해당 릴리스를 **롤아웃하기 시작하는 시점**을 의미하며, 개별 서비스가 실제로 업그레이드되는 시점을 의미하지 않습니다.

* 롤아웃은 자동으로 이루어지며, 여러 주에 걸쳐 점진적으로 진행됩니다
* 예약 업그레이드 시간대가 설정된 서비스는 채널 롤아웃이 종료된 다음 주(월요일 00:00 UTC 시작)의 예약 업그레이드 시간대 동안 업그레이드됩니다
* 롤아웃 일시 중지(예: holiday freeze) 또는 상태 모니터링으로 인해 롤아웃 완료가 지연될 수 있습니다
...
<ReleaseSchedule
  releases={[
  {
    ...
    slow_progress: "green",
    fast_delay_note:
      "업그레이드 시간대가 있는 서비스는 2026-04-15부터 업그레이드됩니다."
  },
  {
    ...
    slow_progress: "green",
    regular_delay_note:
      "예약 업그레이드 시간대가 설정된 서비스는 3월 23일 다음 주의 예약 업그레이드 시간대에 25.12로 업그레이드됩니다",
    slow_delay_note:
      "예약 업그레이드 시간대가 설정된 서비스는 4월 13일 다음 주의 예약 업그레이드 시간대에 25.12로 업그레이드됩니다"
  },
  {
