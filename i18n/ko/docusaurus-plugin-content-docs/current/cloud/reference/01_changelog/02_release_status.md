...
<ReleaseSchedule
  ...
  },
  {
   ...
   regular_progress: 'green',
   slow_progress: 'green',
   regular_delay_note: '예약 업그레이드 시간대가 설정된 서비스는 3월 23일 다음 주의 예약 업그레이드 시간대에 25.12로 업그레이드됩니다',
   slow_delay_note: '예약 업그레이드 시간대가 설정된 서비스는 4월 13일 다음 주의 예약 업그레이드 시간대에 25.12로 업그레이드됩니다',
 },
 {
