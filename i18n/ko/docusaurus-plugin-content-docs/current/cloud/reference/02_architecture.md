...
자가 관리형 ClickHouse 인스턴스나 다른 데이터베이스/데이터 웨어하우스와 비교했을 때 ClickHouse Cloud의 주요 장점은 [레플리카를 추가하여(수평 확장)](/cloud/features/autoscaling/horizontal#manual-horizontal-scaling) 동시성을 쉽게 높일 수 있다는 점입니다.