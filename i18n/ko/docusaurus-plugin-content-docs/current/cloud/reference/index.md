...
이 섹션은 ClickHouse Cloud의 보다 기술적인 세부 정보를 다루는 참조 가이드이며, 다음 페이지들로 구성됩니다:

| Page                                                          | Description                                                         |
| ------------------------------------------------------------- | ------------------------------------------------------------------- |
| [Architecture](/cloud/reference/architecture)                 | 저장소, 컴퓨트, 관리, 보안을 포함한 ClickHouse Cloud의 아키텍처를 설명합니다.                |
