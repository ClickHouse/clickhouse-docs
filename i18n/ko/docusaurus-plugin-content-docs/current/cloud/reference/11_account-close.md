...
## 계정 해지 준비 \{#preparing-for-closure\}

계정 해지를 요청하기 전에 다음 단계를 수행하여 계정을 준비하십시오.

<VerticalStepper headerLevel="h3">
  ### 1. 유지해야 할 데이터는 모두 내보내십시오.
  ...
  > 이렇게 하면 계정에 추가 요금이 발생하지 않습니다

  ### 3. 해지를 요청할 관리자를 제외한 모든 사용자를 제거하십시오.

  > 이렇게 하면 해지를 막을 수 있는 예기치 않은 계정 활동을 방지할 수 있습니다

  ### 4. 모든 요금이 납부되었는지 &#39;Usage&#39; 및 &#39;Billing&#39; 탭에서 확인하십시오.
