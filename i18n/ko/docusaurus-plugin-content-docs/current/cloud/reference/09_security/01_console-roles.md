...
| **Query API endpoint** ([자세한 정보](/cloud/get-started/query-endpoints))                         | Query API endpoint                                                                                                                   |
| control-plane:service:view-query-api-endpoints                                             | Query API endpoint와 해당 구성을 확인합니다.                                                                                                    |
| control-plane:service:manage-query-api-endpoints                                           | Query API endpoint를 생성하고 관리합니다.                                                                                                      |
