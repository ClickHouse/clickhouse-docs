...
description: 'Cloud에 파일을 업로드하는 방법'
doc_type: 'guide'
---
...
<VerticalStepper headerLevel="h2">
  ...
  * `Null`
  ...
  파티셔닝 키 표현식과 프라이머리 키 표현식을 지정할 수 있습니다.
  ...
  SQL 콘솔에서 삽입 쿼리를 열 수 있습니다. 이 쿼리는 `URL` 테이블 함수를 사용하여
  ...
  실패한 삽입에 대한 오류 메시지를 기반으로 테이블 구성을 수정하거나
  데이터를 정제해야 할 수도 있습니다.
