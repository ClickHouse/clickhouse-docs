...
# ClickHouse는 분산 JOIN을 지원하나요? \{#does-clickhouse-support-distributed-joins\}

예, ClickHouse는 클러스터에서 분산 JOIN을 지원합니다.
...
ClickHouse의 조인에 대한 보다 일반적인 정보는 [&quot;JOIN 절&quot;](/sql-reference/statements/select/join#supported-types-of-join) 페이지를 참조하십시오.