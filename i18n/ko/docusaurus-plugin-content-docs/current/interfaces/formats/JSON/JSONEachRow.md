...
description: 'JSONEachRow 형식에 대한 문서'
...
이 포맷에서는 ClickHouse가 각 행을 개행으로 구분된 개별 JSON Object로 출력합니다.

## 사용 예시 \{#example-usage\}

### 데이터 삽입 \{#inserting-data\}

다음과 같은 데이터가 들어 있는 `football.json`이라는 이름의 JSON 파일을 사용합니다.
...
이름을 알 수 없는 데이터 컬럼은 [input&#95;format&#95;skip&#95;unknown&#95;fields](/operations/settings/settings-formats.md/#input_format_skip_unknown_fields) 설정이 1로 설정되어 있으면 가져오는 과정에서 건너뜁니다.
