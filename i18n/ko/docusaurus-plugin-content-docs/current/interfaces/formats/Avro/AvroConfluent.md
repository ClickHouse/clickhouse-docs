...
Kafka consumer의 오류를 디버깅하고 수집 진행 상황을 모니터링하려면 [`system.kafka_consumers` system table](../../../operations/system-tables/kafka_consumers.md)에서 쿼리를 실행합니다. 배포에 레플리카가 여러 개 있는 경우(예: ClickHouse Cloud) [`clusterAllReplicas`](../../../sql-reference/table-functions/cluster.md) 테이블 함수를 사용해야 합니다.
...
스키마 해석 관련 문제가 발생하면 [kafkacat](https://github.com/edenhill/kafkacat)과 [clickhouse-local](/operations/utilities/clickhouse-local.md)을 사용하여 문제를 진단할 수 있습니다.
