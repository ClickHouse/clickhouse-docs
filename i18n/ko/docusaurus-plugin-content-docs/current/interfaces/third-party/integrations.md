---
description: 'ClickHouse를 다양한 타사 시스템 및 도구와 통합하는 방법에 대한 문서'
sidebar_label: '통합'
sidebar_position: 27
...
- [Graphite](https://graphiteapp.org)
  ...
  - [graphite-ch-optimizer](https://github.com/innogames/graphite-ch-optimizer) - [rollup configuration](../../engines/table-engines/mergetree-family/graphitemergetree.md#rollup-configuration)의 규칙을 적용할 수 있는 경우 [\*GraphiteMergeTree](/engines/table-engines/mergetree-family/graphitemergetree)의 오래된 파티션을 최적화합니다.
...
- [MindsDB](https://mindsdb.com/)
  - [MindsDB](https://github.com/mindsdb/mindsdb) - ClickHouse와 통합되어 ClickHouse의 데이터를 다양한 AI/ML 모델에서 활용할 수 있도록 합니다.
</details>

## 프로그래밍 언어 에코시스템 \{#programming-language-ecosystems\}
...
- [Hadoop](http://hadoop.apache.org)
  - [clickhouse-hdfs-loader](https://github.com/jaykelin/clickhouse-hdfs-loader) ([JDBC](../../sql-reference/table-functions/jdbc.md) 사용)
</details>
