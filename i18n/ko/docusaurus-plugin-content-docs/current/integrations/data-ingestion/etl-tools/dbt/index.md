...
| [머티리얼라이즈](/integrations/dbt/materializations)                                   | 사용 가능한 머티리얼라이즈와 해당 설정                     |
| [가이드](/integrations/dbt/guides)                                                   | ClickHouse와 함께 dbt를 사용하는 방법에 대한 가이드         |
| [구체화된 뷰(Materialized views)](/integrations/dbt/materialization-materialized-view) | materialized&#95;view 머티리얼라이즈에 대한 구체적인 문서 |
