...
description: 'Estuary 통합을 사용해 다양한 소스를 ClickHouse로 스트리밍합니다'
...
<VerticalStepper headerLevel="h3">
  ### Estuary 구체화된 뷰(Materialization) 생성
  ...
  3. ClickHouse가 topic 메시지를 감지합니다. 테이블 정보를 구성하기 위해 **Parse information** 섩션으로 계속 진행할 수 있습니다.
