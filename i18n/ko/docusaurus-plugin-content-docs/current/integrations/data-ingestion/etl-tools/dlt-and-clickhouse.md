...
<a href="https://dlthub.com/docs/intro" target="_blank">dlt</a>는 다양한 데이터 소스에서, 그리고 흔히 정돈되지 않은 데이터까지도 잘 구조화된 실시간 데이터셋으로 적재할 수 있도록 Python 스크립트에 추가할 수 있는 오픈 소스 라이브러리입니다.
