---
'title': 'MySQL ClickPipe의 동기화 제어'
'description': 'MySQL ClickPipe의 동기를 제어하는 문서'
'slug': '/integrations/clickpipes/mysql/sync_control'
'sidebar_label': '동기화 제어'
'keywords':
- 'MySQL ClickPipe'
- 'ClickPipe sync control'
- 'MySQL CDC replication'
- 'ClickHouse MySQL connector'
- 'database synchronization ClickHouse'
'doc_type': 'guide'
---
