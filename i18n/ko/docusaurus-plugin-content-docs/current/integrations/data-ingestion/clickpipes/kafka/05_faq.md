...
<details>
  <summary>Event Hubs에서 데이터가 반환되지 않는 이유는 무엇입니까?</summary>
...
<details>
  ...
  예. Event Hubs 인스턴스로의 트래픽을 제한하려면, [문서화된 정적 NAT IP](/integrations/clickpipes#list-of-static-ips)를 구성에 추가하십시오.
</details>
