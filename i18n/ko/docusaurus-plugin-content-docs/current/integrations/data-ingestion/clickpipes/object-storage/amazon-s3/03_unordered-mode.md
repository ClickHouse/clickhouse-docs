...
<VerticalStepper type="numbered" headerLevel="h2">
  ...
  **3.** S3에서 객체를 읽고 SQS 대기열의 메시지를 관리하는 데 필요한 [필수 권한](/integrations/clickpipes/object-storage/s3/overview#permissions)을 포함하는 IAM 역할의 인라인 정책을 생성하십시오. `<bucket-arn>`과 `<sqs-queue-arn>`을 적절한 값으로 교체하십시오:
