...
최신 설치 및 시작 안내는 [Moose Stack 문서](https://docs.fiveonefour.com/moosestack/getting-started/from-clickhouse)를 참조하십시오.
...
<VerticalStepper headerLevel="h3">
  ...
  * [Moose API](https://docs.fiveonefour.com/moosestack/apis)를 사용하여 REST API를 구축합니다.
  * [Moose Workflows](https://docs.fiveonefour.com/moosestack/workflows) 또는 [Moose Streaming](https://docs.fiveonefour.com/moosestack/workflows)을 사용하여 데이터를 수집하거나 변환합니다.
  * [Moose Build](https://docs.fiveonefour.com/moosestack/deploying) 및 [Moose Migrate](https://docs.fiveonefour.com/moosestack/migrate)를 사용하여 운영 환경으로 전환하는 방안을 검토합니다.
</VerticalStepper>
