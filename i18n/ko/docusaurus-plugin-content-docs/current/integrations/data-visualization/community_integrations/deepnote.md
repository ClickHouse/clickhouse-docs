...
**_참고:_** ClickHouse에 대한 연결이 IP Access List로 보호되어 있는 경우 Deepnote의 IP 주소를 허용해야 할 수 있습니다. 자세한 내용은 [Deepnote 문서](https://deepnote.com/docs/securing-connections)를 참조하십시오.
