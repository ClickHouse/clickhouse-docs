...
ClickHouse는 여러 카탈로그(Unity, Glue, Polaris 등)와의 통합을 지원합니다. 이 가이드에서는 ClickHouse를 통해 [BigLake 메타스토어](https://cloud.google.com/biglake/docs)에 있는 Iceberg 테이블을 쿼리하는 단계를 안내합니다.
