...
<VerticalStepper headerLevel="h2">
  ...
  현재 기준으로 MCP 서버는 Jan.ai에서 실험적 기능입니다.
  실험적 기능 토글을 사용해 MCP 서버를 활성화할 수 있습니다:
  ...
  ClickHouse MCP 서버를 설치하려면 `+` 아이콘을 클릭한 다음 다음과 같이 양식을 채웁니다:
  ...
  이제 ClickHouse MCP 서버의 도구가 채팅 대화 상자에 표시됩니다:
