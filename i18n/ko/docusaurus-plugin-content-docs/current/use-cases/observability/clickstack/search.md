...
검색을 저장해 두면 나중에 빠르게 다시 사용할 수 있습니다. 검색을 저장하면 `Saved Searches` 페이지에 표시되어, 자주 사용하는 검색 쿼리를 다시 구성하지 않고도 쉽게 다시 실행할 수 있습니다.

<Image img={saved_search_listing} alt="저장된 검색 목록 페이지" size="lg" />
