...
환경에 맞게 리소스 규모 산정 가정을 더 구체적으로 조정하는 방법에 대한 자세한 내용은 [&quot;환경에 맞게 리소스 규모 산정 가정 구체화하기&quot;](/use-cases/observability/clickstack/estimating-resources#refining-sizing-assumptions)를 참조하십시오.
