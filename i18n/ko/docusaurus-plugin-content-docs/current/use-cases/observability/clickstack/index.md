...
:::tip OTel FYI 사용해 보기 - OTel collector 문서를 더 쉽게
[OTel FYI](https://otel.fyi)는 명확하고 간결한 OpenTelemetry collector 문서를 제공하는 커뮤니티 리소스입니다. OTel 파이프라인을 이해하고 구성할 때 ClickStack과 함께 활용하기 좋은 자료입니다.
:::
