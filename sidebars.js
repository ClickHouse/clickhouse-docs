          ...
          items: [
              ...
              },
              {
                ...
                items: [
                  {
                    type: 'autogenerated',
                    dirName: 'en/integrations/migration/etl-tools'
                  },
                ]
              },
              {
                ...
                items: [
                  {
                    type: 'autogenerated',
                    dirName: 'en/integrations/migration/databases'
                  },
                ]
              },
              {
                type: 'doc',
                label: 'S3 to ClickHouse Cloud',
                id: 'en/integrations/migration/s3-to-clickhouse'
              },
          ]
        },
         {
