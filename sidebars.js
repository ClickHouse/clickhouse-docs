          ...
          items: [
            {
              ...
              collapsible: true,
              items: [
                'integrations/tools/data-integration/pg_clickhouse/introduction',
                'integrations/tools/data-integration/pg_clickhouse/tutorial',
                'integrations/tools/data-integration/pg_clickhouse/reference',
              ],
            },
          ],
        },
  ...
  integrations: [
    ...
    },
    {
      ...
      items: [
        ...
        {
          type: 'category',
          label: 'ClickPipes for Kinesis',
          collapsed: true,
          collapsible: true,
          link: {
            type: 'doc',
            id: 'integrations/data-ingestion/clickpipes/kinesis/index',
          },
          items: [
            {
              type: 'autogenerated',
              dirName: 'integrations/data-ingestion/clickpipes/kinesis',
            },
          ],
        },
        {
  ...
  serverAdmin: [
    {
      ...
      items: [
        ...
        {
          type: 'category',
          label: 'ClickHouse Operator',
          collapsed: true,
          collapsible: true,
          items: [
            {
              type: 'autogenerated',
              dirName: 'kubernetes-operator',
            },
          ],
        },
  ...
  clickstack: [
    {
      ...
      items: [
        'use-cases/observability/clickstack/overview',
        {
          ...
          link: {
            type: 'doc',
            id: 'use-cases/observability/clickstack/getting-started/index',
          },
          items: [
            {
              type: 'autogenerated',
              dirName: 'use-cases/observability/clickstack/getting-started',
            },
          ],
        },
        {
          ...
          items: [
            {
              ...
              link: {
                type: 'doc',
                id: 'use-cases/observability/clickstack/deployment/oss/index',
              },
              items: [
                {
                  type: 'autogenerated',
                  dirName: 'use-cases/observability/clickstack/deployment/oss',
                },
              ],
            },
            'use-cases/observability/clickstack/deployment/managed',
          ],
        },
        {
          type: 'category',
          ...
          items: [
            ...
            'use-cases/observability/clickstack/ingesting-data/trace-sampling',
            {
              ...
              link: {
                type: 'doc',
                id: 'use-cases/observability/clickstack/ingesting-data/integration-examples/index',
              },
              collapsed: true,
              collapsible: true,
              items: [
        ...
        'use-cases/observability/clickstack/session-replay',
        {
          ...
          link: {
            type: 'doc',
            id: 'use-cases/observability/clickstack/managing/index',
          },
          collapsed: false,
          collapsible: true,
          items: [
