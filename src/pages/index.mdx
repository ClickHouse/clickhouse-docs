...
import IconOperator from '@site/src/icons/IconOperator';
...
export const SearchClickHouse = ({children, color}) => {
    return (
        <div className='home-page-section home-page-section-search'>
            ...
            <div className='home-page-search-bar-wrapper'>
                <SearchBar className='home-page-search-bar'/>
            </div>
        </div>
    )
}
        ...
        <div className='home-page-section'>
            ...
            <div>
                <div className='home-page-button-container'>
                    <HomePageOptionButton svgIcon={<IconTerminal iconWidth='28px'/>} link='/docs/interfaces/client'>
                        <Translate id="homepage.connect.clickhouseClient">ClickHouse Client</Translate>
...
export const DeployClickHouse = ({children, color}) => {
    return (
        <div className='home-page-section'>
            ...
            <div className='home-page-button-container deploy-button-grid'>
                ...
                <HomePageOptionButton svgIcon={<IconOperator iconWidth='28px'/>}
                                      link='/docs/clickhouse-operator/overview'>
                    <Translate id="homepage.deploy.ClickHouseCluster">ClickHouse Operator</Translate>
                </HomePageOptionButton>
            </div>
        </div>
    )
